...
public class NumberstoWordsConversion {
	...
	public static String convertToIndianCurrency(String num) {
		...
		String paise = (decimal) > 0 ? " And Paise " + words.get(Integer.valueOf(decimal - decimal % 10)) + " " + words.get(Integer.valueOf(decimal % 10)) : "";
...
//		System.out.println("56721351.61 = " + NumberstoWordsConversion.convertToIndianCurrency("56721351.61"));
//	}
