...
import com.dci.tenant.finance.balanceSheet.BalanceSheetBean;
import com.dci.tenant.finance.profitandlossnew.ProfitAndLossBean;
...
public class ReceiptPaymentServiceImpl implements ReceiptPaymentService {
	...
	public List<ReceiptPaymentBean> getGLTransactionLevel1(ReceiptPaymentBean objGeneralLedgerBean) {
		return objGeneralLedgerDao.getGLTransactionLevel1(objGeneralLedgerBean);
	}
	@Override
	...
	// account head
	@Override
	public boolean exportGeneralLedgerExcel(String sFilePath, ReceiptPaymentBean objGeneralLedgerBean) {
		boolean isSuccess = false;

		List<ReceiptPaymentBean> lGeneralLedgerList = objGeneralLedgerDao.getConsolidatedGeneralLedgerList(objGeneralLedgerBean);
		try {
	...
	public void setExcelMainHeaderByAccountHead(SXSSFSheet excelSheet, XSSFCellStyle my_style, ReceiptPaymentBean objGeneralLedgerBean ) {
	...
	public void setExcelHeaderByAccountHead(SXSSFSheet excelSheet, XSSFCellStyle my_style1) {
		try {
			...
			cell3.setCellValue("Voucher Type");
...
*/
	...
	public void setExcelRowsByAccountHead(SXSSFWorkbook workbook, SXSSFSheet excelSheet, List<ReceiptPaymentBean> lGeneralLedgerList, XSSFCellStyle my_style1, XSSFCellStyle my_style2, XSSFCellStyle my_style3, CellStyle cellDateStyle) {
		int record = 5, sno = 1;
		...
		try {
			...
			for (ReceiptPaymentBean objGeneralLedgerBean : lGeneralLedgerList) {
				...
				cell3.setCellValue(checkNullValue(objGeneralLedgerBean.getVochuertype()));

				
				
				Cell cell4 = row.createCell(4);
				cell4.setCellStyle(my_style2);
				cell4.setCellValue(checkNullValue("Paragon"));
...
*/
	...
	public void setExcelMainHeaderSubLedger(SXSSFSheet excelSheet, XSSFCellStyle my_style, ReceiptPaymentBean objGeneralLedgerBean, String acctHead) {
	...
	public void setExcelMainHeaderSubLedgerSubgroup(SXSSFSheet excelSheet, XSSFCellStyle my_style, ReceiptPaymentBean objGeneralLedgerBean, String acctHead) {
	...
	public void setExcelRows(SXSSFWorkbook workbook, HSSFSheet excelSheet, List<ReceiptPaymentBean> lGeneralLedgerList, XSSFCellStyle my_style1, XSSFCellStyle my_style2, XSSFCellStyle my_style3) {
		int record = 3, sno = 1;
	...
	@Override
	public boolean exportGeneralLedgerExcelSecondary(String sFilePath, ReceiptPaymentBean objGeneralLedgerBean) {

		List<ReceiptPaymentBean> lGeneralLegerList = objGeneralLedgerDao.getGeneralLedgerList(objGeneralLedgerBean);
		try {
			// Blank workbook
			SXSSFWorkbook workbook = new SXSSFWorkbook();
			workbook.setCompressTempFiles(true);
		...
		try {
			...
			for (ReceiptPaymentBean objGeneralLedgerBean : lGeneralLedgerList) {
				...
				if (objGeneralLedgerBean.getlTransactionList().size() > 0) {
					for (ReceiptPaymentBean objGeneralLedgerTransBean : objGeneralLedgerBean.getlTransactionList()) {
	...
	// through sub ledger
	@Override
	public ReceiptPaymentResultBean exportSubLedgerExcel(String exportFilesPath, ReceiptPaymentBean objGeneralLedgerBean) throws IOException, WriteException {
		...
		try {
			...
			List<ReceiptPaymentBean> objGeneralLedgerOPBean = new ArrayList<>();
	...
	public void setExcelHeaderSubLedger(SXSSFSheet excelSheet, XSSFCellStyle my_style1, ReceiptPaymentBean objGeneralLedgerBean) {
		try {
	...
	// sub ledger
	public void setExcelRowsSubLedgerWithMultiple(SXSSFWorkbook workbook, SXSSFSheet excelSheet, List<ReceiptPaymentBean> objGeneralLedgerBeanOP, List<ReceiptPaymentBean> lGeneralLedgerList, ReceiptPaymentBean objGeneralLedgerBean, XSSFCellStyle my_style1, XSSFCellStyle my_style2, XSSFCellStyle my_style3, XSSFCellStyle my_style_green, XSSFCellStyle my_style_green_right_align, XSSFCellStyle my_style_red, XSSFCellStyle my_style_red_right_align) {
		int record = 3, sno = 1;
		try {
			...
			for (ReceiptPaymentBean op : objGeneralLedgerBeanOP) {
				Row rowah = excelSheet.createRow(record++);
				rowah.setHeight((short) 350);
				...
				if (lGeneralLedgerList.size() > 0) {
					for (ReceiptPaymentBean objGeneralLedgerTransBean : lGeneralLedgerList) {
	...
	public void setExcelRowsSubLedger(SXSSFWorkbook workbook, SXSSFSheet excelSheet, ReceiptPaymentBean objGeneralLedgerBeanOP, List<ReceiptPaymentBean> lGeneralLedgerList, XSSFCellStyle my_style1, XSSFCellStyle my_style2, XSSFCellStyle my_style3, XSSFCellStyle my_style_green, XSSFCellStyle my_style_green_right_align, XSSFCellStyle my_style_red, XSSFCellStyle my_style_red_right_align, ReceiptPaymentBean objGeneralLedgerOPBean, ReceiptPaymentBean inputbean) {
		int record = 5, sno = 1;
	...
	// Excel Export
	@Override
	public boolean exportGeneralLedgerExcelOP(String exportFilesPath, ReceiptPaymentBean objGeneralLedgerBean) {
		String acctHead = "";
	...
	@Override
	public boolean exportTransactionLevelExcel(String exportFilesPath, ReceiptPaymentBean objGeneralLedgerBean) {
	...
	public List<ReceiptPaymentBean> getGLBankDetail(ReceiptPaymentBean objGeneralLedgerBean) {
		// TODO Auto-generated method stub
		return objGeneralLedgerDao.getGLBankDetail(objGeneralLedgerBean);
	}

	@Override
	public List<ReceiptPaymentBean> getGLBankDetailPayemnt(ReceiptPaymentBean objGeneralLedgerBean) {
		// TODO Auto-generated method stub
		return objGeneralLedgerDao.getGLBankDetailPayemnt(objGeneralLedgerBean);
	}
	...
	//	List<ReceiptPaymentBean> lGeneralLedgerTransactionList = new ArrayList<>();
		...
		List<ReceiptPaymentBean> Listbean = new ArrayList<>();
		List<ReceiptPaymentBean> Listbean2 = new ArrayList<>();
		List<ReceiptPaymentBean> Listbean3 = new ArrayList<>();
		List<ReceiptPaymentBean> Listbean4 = new ArrayList<>();
		...
		try {
			...
			PdfWriter	writer = PdfWriter.getInstance(document,
					new FileOutputStream(exportFilesPath + "/ReceiptPayment.pdf"));
			document.addAuthor("tg");
			document.addCreationDate();
			document.addProducer();
			document.addCreator("tg");
			document.addTitle("ReceiptPayment");
			...
			//Listbean = objGeneralLedgerDao.getGLTransactionLevel(rpreport);
			
			Listbean = objGeneralLedgerDao.getGLTransactionLevel(rpreport);
			Listbean2 = objGeneralLedgerDao.getGLTransactionLevel1(rpreport);
			Listbean3 = objGeneralLedgerDao.getGLBankDetail(rpreport);
			Listbean4 = objGeneralLedgerDao.getGLBankDetailPayemnt(rpreport);																										
																							
			/*if (rpreport.getCompanyCode().equalsIgnoreCase("ALL")) {
				Listbean = objGeneralLedgerDao.getGLTransactionLevel(rpreport);
			} */
			...
			paragraphmain = new Paragraph("Receipt And Payment \n",bfBold123);
			...
			Font bfBold25 = new Font(FontFamily.HELVETICA, 8,  Font.BOLD, new BaseColor(0, 0, 0)); 
			   ...
			   table.getDefaultCell().setBorder(0);
				...
				table.addCell("\n");			    			    
				 ...
				 DecimalFormat df = new DecimalFormat("0.00");
				   ...
				   float[] columnWidths = {5f, 5f, 5f, 4f};
				   ...
				   insertCell(table1, "PREVIOUS YEAR", Element.ALIGN_CENTER, 1, bfBold12);
				   insertCell(table1, "ACCOUNT NAME", Element.ALIGN_CENTER, 1, bfBold12);	
				   insertCell(table1, "", Element.ALIGN_CENTER, 1, bfBold12);
				   insertCell(table1, "AMOUNT", Element.ALIGN_CENTER, 1, bfBold12);				  
				   				   				   
				   double amount=0, amount1=0, amount2=0, amount3=0 ;
						   ...
						   insertCell(table1, "RECEIPT", Element.ALIGN_CENTER, 1, bfBold25);
						   insertCell(table1, "", Element.ALIGN_CENTER, 1, bfBold25);	
						   insertCell(table1, "", Element.ALIGN_CENTER, 1, bfBold25);
						   insertCell(table1, "", Element.ALIGN_CENTER, 1, bfBold25);	
						   
						  /* table1.setHeaderRows(1);//setHeaderRows(1);
						   //create section heading by cell merging
						   insertCell(table1, "Balance from last year A/C", Element.ALIGN_LEFT, 4, bfBold12);*/
						
					for (ReceiptPaymentBean objBalanceSheetAHBean : Listbean3) {
						   BaseColor color = BaseColor.BLACK;
						   
						   
						
						insertCell(table1, "" +df1.format(objBalanceSheetAHBean.getPreAmount()) + "" , Element.ALIGN_LEFT,color, 1, bf12);
						   insertCell(table1, "" +objBalanceSheetAHBean.getAcctName()+"" , Element.ALIGN_LEFT,color, 1, bf12);
						   insertCell(table1, "" +df.format(objBalanceSheetAHBean.getAmoount())+"" , Element.ALIGN_RIGHT,color, 1, bf12);
							   insertCell(table1, "" +df.format(objBalanceSheetAHBean.getAmount())+"" , Element.ALIGN_RIGHT,color, 1, bf12);
							   
							   amount = amount + objBalanceSheetAHBean.getAmoount();
					}
					
					 insertCell(table1, "", Element.ALIGN_RIGHT, 3, bfBold12);
					   insertCell(table1, df.format(amount), Element.ALIGN_RIGHT, 1, bfBold12);
					   double amounttotal =amount, receipt=0;
					
				   for (ReceiptPaymentBean detail : Listbean) {
					   
					   BaseColor color = BaseColor.BLACK;

					   insertCell(table1, "" +df1.format(detail.getPreAmount()) + "" , Element.ALIGN_LEFT,color, 1, bf12);
					   insertCell(table1, "" +detail.getAcctName()+"" , Element.ALIGN_LEFT,color, 1, bf12);
					   insertCell(table1, ""+"" , Element.ALIGN_RIGHT,color, 1, bf12);
						   insertCell(table1, "" +(detail.getAmount())+"" , Element.ALIGN_RIGHT,color, 1, bf12);
						   
						   amount1 = amount1 + detail.getAmount();
						   
						   receipt = amount1 + amounttotal;


				   }

					 insertCell(table1, "TOTAL", Element.ALIGN_RIGHT, 3, bfBold12);
					   insertCell(table1, df.format(receipt), Element.ALIGN_RIGHT, 1, bfBold12);
		}
					if (Listbean2.size() > 0) {
						
						insertCell(table1, "PAYMENT", Element.ALIGN_CENTER, 1, bfBold25);
						   insertCell(table1, "", Element.ALIGN_CENTER, 1, bfBold25);	
						   insertCell(table1, "", Element.ALIGN_CENTER, 1, bfBold25);
						   insertCell(table1, "", Element.ALIGN_CENTER, 1, bfBold25);	
						for (ReceiptPaymentBean objBalanceSheetSGBean : Listbean2) {
							...
							insertCell(table1, "" +df1.format(objBalanceSheetSGBean.getPreAmount()) + "" , Element.ALIGN_LEFT,color, 1, bf12);
							   insertCell(table1, "" +objBalanceSheetSGBean.getAcctName()+"" , Element.ALIGN_LEFT,color, 1, bf12);
							   insertCell(table1, ""+"" , Element.ALIGN_RIGHT,color, 1, bf12);
								   insertCell(table1, "" +df.format(objBalanceSheetSGBean.getAmount())+"" , Element.ALIGN_RIGHT,color, 1, bf12);
								   amount2 = amount2 + objBalanceSheetSGBean.getAmount();

						}
							
						insertCell(table1, "", Element.ALIGN_RIGHT, 3, bfBold12);
						   insertCell(table1, df.format(amount2), Element.ALIGN_RIGHT, 1, bfBold12);
						   double payamt =amount2, paymnt=0;
								for (ReceiptPaymentBean objBalanceSheetAHBean1 : Listbean4) {
									   BaseColor color = BaseColor.BLACK;

									
									insertCell(table1, "" +df1.format(objBalanceSheetAHBean1.getPreAmount()) + "" , Element.ALIGN_LEFT,color, 1, bf12);
									   insertCell(table1, "" +objBalanceSheetAHBean1.getAcctName()+"" , Element.ALIGN_LEFT,color, 1, bf12);
									   insertCell(table1, "" +df.format(objBalanceSheetAHBean1.getAmoount())+"" , Element.ALIGN_RIGHT,color, 1, bf12);
										   insertCell(table1, "" +df.format(objBalanceSheetAHBean1.getAmount())+"" , Element.ALIGN_RIGHT,color, 1, bf12);	
										   
										   amount3 = amount3 + objBalanceSheetAHBean1.getAmoount() ;
										   paymnt = amount3 + payamt;
								}	
								insertCell(table1, "TOTAL", Element.ALIGN_RIGHT, 3, bfBold12);
								   insertCell(table1, df.format(paymnt), Element.ALIGN_RIGHT, 1, bfBold12);
						}
