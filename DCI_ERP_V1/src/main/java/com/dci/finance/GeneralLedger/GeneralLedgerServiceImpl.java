...
public class GeneralLedgerServiceImpl implements GeneralLedgerService {
	...
	// account head
	@Override
	public boolean exportGeneralLedgerExcel(String sFilePath, GeneralLedgerBean objGeneralLedgerBean) {
		boolean isSuccess = false;

		List<GeneralLedgerBean> lGeneralLedgerList = objGeneralLedgerDao
				.getConsolidatedGeneralLedgerList(objGeneralLedgerBean);
		try {
			 ...
			 * 
			 * // HSSFWorkbook workbook = new HSSFWorkbook(); XSSFCellStyle
			 * my_style = (XSSFCellStyle) workbook.createCellStyle();
			 ...
			 * )); Font font = workbook.createFont(); font.setFontHeight((short)
			 * 200); font.setFontName("Arial");
			 * font.setColor(HSSFColor.YELLOW.index);
			 * font.setBoldweight(Font.BOLDWEIGHT_BOLD);
			 * font.setFontHeightInPoints((short) 15); my_style.setFont(font);
			 * XSSFCellStyle my_style1 = (XSSFCellStyle)
			 ...
			 * my_style1.setDataFormat(HSSFDataFormat.getBuiltinFormat(
			 * "#,##0.00")); Font font1 = workbook.createFont();
			 * font1.setFontHeight((short) 200); font1.setFontName("Arial");
			 * font1.setColor(HSSFColor.BLACK.index);
			 * font1.setBoldweight(Font.BOLDWEIGHT_BOLD);
			 * font1.setFontHeightInPoints((short) 10);
			 * my_style1.setFont(font1); XSSFCellStyle my_style2 =
			 ...
			 * my_style2.setDataFormat(HSSFDataFormat.getBuiltinFormat(
			 * "#,##0.00"));
			 * 
			 * XSSFCellStyle my_style3 = (XSSFCellStyle)
			 * workbook.createCellStyle();
			 ...
			 * my_style3.setDataFormat(HSSFDataFormat.getBuiltinFormat(
			 * "#,##0.00"));
			 * 
			 * XSSFCellStyle my_style_green = (XSSFCellStyle)
			 * workbook.createCellStyle();
			 ...
			 * my_style_green.setDataFormat(HSSFDataFormat.getBuiltinFormat(
			 * "#,##0.00"));
			 * 
			 ...
			 * 
			 * XSSFCellStyle my_style_green_right_align = (XSSFCellStyle)
			 * workbook.createCellStyle();
			 * my_style_green_right_align.setBorderLeft(XSSFCellStyle.
			 * BORDER_THIN);
			 * my_style_green_right_align.setBorderRight(XSSFCellStyle.
			 * BORDER_THIN);
			 * my_style_green_right_align.setBorderTop(XSSFCellStyle.BORDER_THIN
			 * ); my_style_green_right_align.setBorderBottom(XSSFCellStyle.
			 * BORDER_THIN);
			 * my_style_green_right_align.setAlignment(my_style.ALIGN_RIGHT);
			 * my_style_green_right_align.setDataFormat(HSSFDataFormat.
			 * getBuiltinFormat("#,##0.00"));
			 * font_green.setColor(HSSFColor.GREEN.index);
			 * font_green.setBoldweight(Font.BOLDWEIGHT_BOLD);
			 * my_style_green_right_align.setFont(font_green);
			 * 
			 * XSSFCellStyle my_style_red = (XSSFCellStyle)
			 * workbook.createCellStyle();
			 ...
			 * 
			 * XSSFCellStyle my_style_red_right_align = (XSSFCellStyle)
			 * workbook.createCellStyle();
			 ...
			 * my_style_red_right_align.setBorderBottom(XSSFCellStyle.
			 * BORDER_THIN);
			 * my_style_red_right_align.setAlignment(my_style.ALIGN_RIGHT);
			 * my_style_red_right_align.setDataFormat(HSSFDataFormat.
			 * getBuiltinFormat("#,##0.00"));
			 * font_red.setColor(HSSFColor.RED.index);
			 * font_red.setBoldweight(Font.BOLDWEIGHT_BOLD);
			 * my_style_red_right_align.setFont(font_red);
			 * 
			 * XSSFCellStyle my_style_narration = (XSSFCellStyle)
			 * workbook.createCellStyle();
			 ...
			 * my_style_narration.setDataFormat(HSSFDataFormat.getBuiltinFormat(
			 * "#,##0.00"));
			 * 
			 * CellStyle cellDateStyle = workbook.createCellStyle();
			 * CreationHelper createHelper = workbook.getCreationHelper();
			 * cellDateStyle.setDataFormat(createHelper.createDataFormat().
			 ...
			 * "#,##0.00"));
			 * 
			 * // Create a blank sheet SXSSFSheet excelSheet = (SXSSFSheet)
			...
			my_style4.setAlignment(HSSFCellStyle.ALIGN_RIGHT);
			...
			font_green.setColor(HSSFColor.GREEN.index);
			font_green.setBoldweight(org.apache.poi.ss.usermodel.Font.BOLDWEIGHT_BOLD);
			my_style_green.setFont(font_green);
			...
			// set Data
			setExcelRowsByAccountHead(workbook, excelSheet, lGeneralLedgerList, my_style1, my_style2, my_style3,
					my_style4, cellDateStyle);

			// export excell
			String sFileUrl = writeExcel(workbook, sFilePath);
			if (lGeneralLedgerList.isEmpty()) {
				isSuccess = false;
			} else {
				isSuccess = true;
	...
	public void setExcelMainHeaderByAccountHead(HSSFSheet excelSheet, HSSFCellStyle my_style,
			GeneralLedgerBean objGeneralLedgerBean) {
		Row row = excelSheet.createRow((short) 0);
		excelSheet.addMergedRegion(new CellRangeAddress(0, 0, 0, 13));
		...
		excelSheet.addMergedRegion(new CellRangeAddress(1, 1, 0, 13));
		...
		excelSheet.addMergedRegion(new CellRangeAddress(2, 2, 0, 13));
		...
		excelSheet.addMergedRegion(new CellRangeAddress(3, 3, 0, 13));
		Cell cell3 = row3.createCell((short) 0);
		cell3.setCellValue("General Ledger");
		cell3.setCellStyle(my_style);

	}

	public void setExcelHeaderByAccountHead(HSSFSheet excelSheet, HSSFCellStyle my_style1) {
		try {
			...
			cell1.setCellValue("Organization");
			...
			cell26.setCellValue("Fund Type");

			Cell cell3 = row.createCell(4);
			cell3.setCellStyle(my_style1);
			cell3.setCellValue("Main Account code");

			Cell cell4 = row.createCell(5);
			cell4.setCellStyle(my_style1);
			cell4.setCellValue("Main Account name");
			...
			cell7.setCellValue("Transaction Dt");

			Cell cell8 = row.createCell(8);
			cell8.setCellStyle(my_style1);
			cell8.setCellValue("Party Inv No");
			 ...
			 * 
			 * Cell cell11 = row.createCell(11); cell11.setCellStyle(my_style1);
			 * cell11.setCellValue("Exchange Rate");
			 */
			/*
			 * Cell cell10 = row.createCell(12); cell10.setCellStyle(my_style1);
			 * cell10.setCellValue("Amount Local");
			 */
	...
	public void setExcelRowsByAccountHead(HSSFWorkbook workbook, HSSFSheet excelSheet,
			List<GeneralLedgerBean> lGeneralLedgerList, HSSFCellStyle my_style1, HSSFCellStyle my_style2,
			HSSFCellStyle my_style3, HSSFCellStyle my_style4, CellStyle cellDateStyle) {
		int record = 5, sno = 1;
		...
		try {
			...
			for (GeneralLedgerBean objGeneralLedgerBean : lGeneralLedgerList) {
				...
				cell1.setCellValue(checkNullValue(objGeneralLedgerBean.getCompanyCode()));

				Cell cell2 = row.createCell(2);
				cell2.setCellStyle(my_style2);
				cell2.setCellValue(checkNullValue(objGeneralLedgerBean.getCompanyName()));

				Cell cell26 = row.createCell(3);
				cell26.setCellStyle(my_style2);
				cell26.setCellValue(checkNullValue(objGeneralLedgerBean.getCostCentername()));

				Cell cell3 = row.createCell(4);
				cell3.setCellStyle(my_style2);
				cell3.setCellValue(checkNullValue(objGeneralLedgerBean.getAccountHeadCode()));

				Cell cell4 = row.createCell(5);
				cell4.setCellStyle(my_style2);
				cell4.setCellValue(checkNullValue(objGeneralLedgerBean.getAccountHeadName()));

				Cell cell7 = row.createCell(6);
				cell7.setCellStyle(my_style2);
				cell7.setCellValue(checkNullValue(objGeneralLedgerBean.getTransactionNo()));

				Cell cell8 = row.createCell(7);
				cell8.setCellStyle(dateCellStyle2);
				cell8.setCellValue(checkNullValue(objGeneralLedgerBean.getTransactionDate()));

				Cell cell9 = row.createCell(8);
				cell9.setCellStyle(my_style2);
				cell9.setCellValue(checkNullValue(objGeneralLedgerBean.getPartyInvoiceNo()));

				Cell cell10 = row.createCell(9);
				cell10.setCellStyle(my_style2);
				cell10.setCellValue(checkNullValue(objGeneralLedgerBean.getNarration()));

				/*
				 * Cell cell11 = row.createCell(10);
				 * cell11.setCellStyle(my_style2);
				 * cell11.setCellValue(checkNullValue(objGeneralLedgerBean.
				 * getCurrency()));
				 * 
				 * Cell cell12 = row.createCell(11);
				 * cell12.setCellStyle(my_style2);
				 * cell12.setCellValue(objGeneralLedgerBean.getExchangeRate());
				 */

				/*
				 * Cell cell11 = row.createCell(11);
				 * cell11.setCellStyle(my_style2);
				 * cell11.setCellValue(objGeneralLedgerBean.getTcCredit());
				 */
				Cell cell11 = row.createCell(10);
				cell11.setCellStyle(my_style4);
				cell11.setCellValue(objGeneralLedgerBean.getBcCredit());
			 ...
			 */
			/*
			 * Cell cellahTcCrdt15 = rowTotal.createCell(9);
			 * cellahTcCrdt15.setCellStyle(my_style1);
			 * cellahTcCrdt15.setCellValue(dTotalTCCreditAmt);
			 */

			Cell cellahBcCrdt16 = rowTotal.createCell(10);
	...
	public void setExcelMainHeaderSubLedger(HSSFSheet excelSheet, HSSFCellStyle my_style,
			GeneralLedgerBean objGeneralLedgerBean, String acctHead) {
	...
	public void setExcelMainHeaderSubLedgerSubgroup(HSSFSheet excelSheet, HSSFCellStyle my_style,
			GeneralLedgerBean objGeneralLedgerBean, String acctHead) {
	...
	public void setExcelRows(SXSSFWorkbook workbook, HSSFSheet excelSheet, List<GeneralLedgerBean> lGeneralLedgerList,
	...
	@Override
	public boolean exportGeneralLedgerExcelSecondary(String sFilePath, GeneralLedgerBean objGeneralLedgerBean) {

		List<GeneralLedgerBean> lGeneralLegerList = objGeneralLedgerDao.getGeneralLedgerList(objGeneralLedgerBean);
		try {
			// Blank workbook
			/*
			 * SXSSFWorkbook workbook = new SXSSFWorkbook();
			 ...
			 * my_style.setAlignment(my_style.ALIGN_CENTER);
			 * my_style.setFillForegroundColor(HSSFColor.BLUE_GREY.index);
			 * my_style.setFillPattern(my_style.SOLID_FOREGROUND); Font font =
			 * workbook.createFont(); font.setFontHeight((short) 200);
			 * font.setFontName("Arial"); font.setColor(HSSFColor.YELLOW.index);
			 * font.setBoldweight(Font.BOLDWEIGHT_BOLD);
			 * font.setFontHeightInPoints((short) 15); my_style.setFont(font);
			 * XSSFCellStyle my_style1 = (XSSFCellStyle)
			 * workbook.createCellStyle();
			 ...
			 * my_style1.setAlignment(my_style.ALIGN_CENTER);
			 * my_style1.setFillForegroundColor(HSSFColor.YELLOW.index);
			 * my_style1.setFillPattern(my_style.SOLID_FOREGROUND); Font font1 =
			 * workbook.createFont(); font1.setFontHeight((short) 200);
			 * font1.setFontName("Arial");
			 * font1.setColor(HSSFColor.BLACK.index);
			 * font1.setBoldweight(Font.BOLDWEIGHT_BOLD);
			 * font1.setFontHeightInPoints((short) 10);
			...
			font_red.setColor(HSSFColor.RED.index);
			font_red.setBoldweight(org.apache.poi.ss.usermodel.Font.BOLDWEIGHT_BOLD);
			my_style_red.setFont(font_red);
			...
			HSSFCellStyle my_style_narration = workbook.createCellStyle();
			my_style_narration.setBorderLeft(XSSFCellStyle.BORDER_THIN);
			my_style_narration.setBorderRight(XSSFCellStyle.BORDER_THIN);
			my_style_narration.setBorderTop(XSSFCellStyle.BORDER_THIN);
			my_style_narration.setBorderBottom(XSSFCellStyle.BORDER_THIN);
			...
			// set Data
			setExcelRowsSecondary(workbook, excelSheet, lGeneralLegerList, my_style1, my_style2, my_style3,
					my_style_green, my_style_green_right_align, my_style_red, my_style_red_right_align,
					my_style_narration);
	...
	public void setExcelMainHeaderSecondary(HSSFSheet excelSheet, HSSFCellStyle my_style) {
		Row row = excelSheet.createRow(0);
		excelSheet.addMergedRegion(new CellRangeAddress(0, 1, 0, 23));
		Cell cell = row.createCell(0);
		cell.setCellValue("General Ledger");
		cell.setCellStyle(my_style);
	}

	public void setExcelHeaderSecondary(HSSFSheet excelSheet, HSSFCellStyle my_style1) {
		try {
	...
	public void setExcelRowsSecondary(HSSFWorkbook workbook, HSSFSheet excelSheet,
			List<GeneralLedgerBean> lGeneralLedgerList, HSSFCellStyle my_style1, HSSFCellStyle my_style2,
			HSSFCellStyle my_style3, HSSFCellStyle my_style_green, HSSFCellStyle my_style_green_right_align,
			HSSFCellStyle my_style_red, HSSFCellStyle my_style_red_right_align, HSSFCellStyle my_style_narration) {
		int record = 3, sno = 1;
		try {
			...
			for (GeneralLedgerBean objGeneralLedgerBean : lGeneralLedgerList) {
				...
				String sOpening_Balance = objGeneralLedgerBean.getAccountHeadCode() + "-"
						+ objGeneralLedgerBean.getAccountHeadName();
				...
				/*
				 * Cell cell1 = rowah.createCell(1);
				 * cell1.setCellStyle(my_style2);
				 * cell1.setCellValue(objGeneralLedgerBean
				 * .getAccountHeadCode());
				 * 
				 * Cell cell2 = rowah.createCell(2);
				 * cell2.setCellStyle(my_style2);
				 * cell2.setCellValue(objGeneralLedgerBean
				 * .getAccountHeadName());
				 * 
				 * Cell cell3 = rowah.createCell(3);
				 * cell3.setCellStyle(my_style2);
				 * cell3.setCellValue("Opening Bal");
				 * 
				 * Cell cell4 = rowah.createCell(4);
				 * cell4.setCellStyle(my_style2);
				 * cell4.setCellValue(objGeneralLedgerBean.getOpeningBalance());
				 */

				if (objGeneralLedgerBean.getlTransactionList().size() > 0) {
					for (GeneralLedgerBean objGeneralLedgerTransBean : objGeneralLedgerBean.getlTransactionList()) {
						Row rowsg = excelSheet.createRow(record++);
						rowsg.setHeight((short) 350);

						String sSubAccount = "";
						if (String.valueOf(objGeneralLedgerTransBean.getSubAccountCode()) == null
								|| String.valueOf(objGeneralLedgerTransBean.getSubAccountCode())
										.equalsIgnoreCase("null")
								|| String.valueOf(objGeneralLedgerTransBean.getSubAccountCode()).equalsIgnoreCase(""))
							sSubAccount = "";
						else
							sSubAccount = objGeneralLedgerTransBean.getSubAccountCode() + "-"
									+ objGeneralLedgerTransBean.getSubAccountName();
						...
						if (String.valueOf(objGeneralLedgerTransBean.getLedgerNo()) == null
								|| String.valueOf(objGeneralLedgerTransBean.getLedgerNo()).equalsIgnoreCase("null"))
						...
						if (String.valueOf(objGeneralLedgerTransBean.getLedgerSeq()) == null
								|| String.valueOf(objGeneralLedgerTransBean.getLedgerSeq()).equalsIgnoreCase("null"))
						...
						/*
						 * Cell cellah3 = rowsg.createCell(3);
						 * cellah3.setCellStyle(my_style2);
						 * cellah3.setCellValue(
						 * checkNullValue(objGeneralLedgerTransBean
						 * .getVoucherNo()));
						 */
				...
				String sClosing_Balance = objGeneralLedgerBean.getAccountHeadCode() + "-"
						+ objGeneralLedgerBean.getAccountHeadName();
				...
				rowah.createCell(23).setCellStyle(my_style2);
				/*
				 * Cell cellcb1 = rowcb.createCell(1);
				 * cellcb1.setCellStyle(my_style2);
				 * cellcb1.setCellValue(objGeneralLedgerBean
				 * .getAccountHeadCode());
				 * 
				 * Cell cellcb2 = rowcb.createCell(2);
				 * cellcb2.setCellStyle(my_style2);
				 * cellcb2.setCellValue(objGeneralLedgerBean
				 * .getAccountHeadName());
				 * 
				 * Cell cellcb3 = rowcb.createCell(3);
				 * cellcb3.setCellStyle(my_style2);
				 * cellcb3.setCellValue("Closing Bal");
				 * 
				 * Cell cellcb4 = rowcb.createCell(4);
				 * cellcb4.setCellStyle(my_style2);
				 * cellcb4.setCellValue(objGeneralLedgerBean
				 * .getClosingBalance());
				 */
	...
	private String writeExcelSubLedger(HSSFWorkbook workbook, String path) {
	...
	private String writeExcel(HSSFWorkbook workbook, String path) {

		String sOutFile = path + "/GeneralLedger.xls";
	...
	// through sub ledger
	@Override
	public GeneralLedgerResultBean exportSubLedgerExcel(String exportFilesPath, GeneralLedgerBean objGeneralLedgerBean)
		...
		try {
			...
			List<GeneralLedgerBean> objGeneralLedgerOPBean = new ArrayList<>();
			...
			try {
				 ...
				 * workbook.setCompressTempFiles(true);
				 * 
				 * XSSFCellStyle my_style = (XSSFCellStyle)
				 * workbook.createCellStyle();
				 * my_style.setBorderLeft(XSSFCellStyle.BORDER_MEDIUM);
				 * my_style.setBorderRight(XSSFCellStyle.BORDER_MEDIUM);
				 * my_style.setBorderTop(XSSFCellStyle.BORDER_MEDIUM);
				 ...
				 * font.setBoldweight(Font.BOLDWEIGHT_BOLD);
				 * font.setFontHeightInPoints((short) 15);
				 * my_style.setFont(font); XSSFCellStyle my_style1 =
				 * (XSSFCellStyle) workbook.createCellStyle();
				 * my_style1.setBorderLeft(XSSFCellStyle.BORDER_MEDIUM);
				 * my_style1.setBorderRight(XSSFCellStyle.BORDER_MEDIUM);
				 * my_style1.setBorderTop(XSSFCellStyle.BORDER_MEDIUM);
				 ...
				 * ()); my_style1.setAlignment(my_style.ALIGN_CENTER);
				 * my_style1.setFillForegroundColor(HSSFColor.YELLOW.index);
				 * my_style1.setFillPattern(my_style.SOLID_FOREGROUND); Font
				 * font1 = workbook.createFont(); font1.setFontHeight((short)
				 * 200); font1.setFontName("Arial");
				 * font1.setColor(HSSFColor.BLACK.index);
				 * font1.setBoldweight(Font.BOLDWEIGHT_BOLD);
				 * font1.setFontHeightInPoints((short) 10);
				 * my_style1.setFont(font1); XSSFCellStyle my_style2 =
				 ...
				 * my_style_green_right_align.setBorderRight(XSSFCellStyle.
				 * BORDER_THIN);
				 * my_style_green_right_align.setBorderTop(XSSFCellStyle.
				 * BORDER_THIN);
				 * my_style_green_right_align.setBorderBottom(XSSFCellStyle.
				 * BORDER_THIN);
				 * my_style_green_right_align.setAlignment(my_style.ALIGN_RIGHT)
				 ...
				 * XSSFCellStyle my_style_red_right_align = (XSSFCellStyle)
				 * workbook.createCellStyle();
				 * my_style_red_right_align.setBorderLeft(XSSFCellStyle.
				 * BORDER_THIN);
				 * my_style_red_right_align.setBorderRight(XSSFCellStyle.
				 * BORDER_THIN);
				 * my_style_red_right_align.setBorderTop(XSSFCellStyle.
				 * BORDER_THIN);
				 * my_style_red_right_align.setBorderBottom(XSSFCellStyle.
				 * BORDER_THIN);
				 * my_style_red_right_align.setAlignment(my_style.ALIGN_RIGHT);
				 ...
				 * 
				 * // Create a blank sheet SXSSFSheet excelSheet = (SXSSFSheet)
				 * workbook.createSheet("Sub Ledger");
				 * excelSheet.setRandomAccessWindowSize(100);// keep 100 rows in
				 */ // memory,
				...
				// set Data
				setExcelRowsSubLedgerWithMultiple(workbook, excelSheet, objGeneralLedgerOPBean, lGeneralLedgerList,
						objGeneralLedgerBean, my_style1, my_style2, my_style3, my_style_green,
						my_style_green_right_align, my_style_red, my_style_red_right_align);
	...
	public void setExcelHeaderSubLedger(HSSFSheet excelSheet, HSSFCellStyle my_style1,
			GeneralLedgerBean objGeneralLedgerBean) {
		try {
	...
	// sub ledger
	public void setExcelRowsSubLedgerWithMultiple(HSSFWorkbook workbook, HSSFSheet excelSheet,
			List<GeneralLedgerBean> objGeneralLedgerBeanOP, List<GeneralLedgerBean> lGeneralLedgerList,
			GeneralLedgerBean objGeneralLedgerBean, HSSFCellStyle my_style1, HSSFCellStyle my_style2,
			HSSFCellStyle my_style3, HSSFCellStyle my_style_green, HSSFCellStyle my_style_green_right_align,
			HSSFCellStyle my_style_red, HSSFCellStyle my_style_red_right_align) {
		int record = 3, sno = 1;
		try {
			...
			/*
			 * Row rowah = excelSheet.createRow( record++); rowah.setHeight(
			 * (short) 350);
			 */

			for (GeneralLedgerBean op : objGeneralLedgerBeanOP) {
				Row rowah = excelSheet.createRow(record++);
				rowah.setHeight((short) 350);
				...
				if (lGeneralLedgerList.size() > 0) {
					for (GeneralLedgerBean objGeneralLedgerTransBean : lGeneralLedgerList) {
						...
						cellah4.setCellValue(date);
						/*
						 * Cell cellah5 = rowsg.createCell(5);
						 * cellah5.setCellStyle(my_style2);
						 * cellah5.setCellValue(
						 * checkNullValue(objGeneralLedgerTransBean
						 * .getPartyInvoiceNo()));
						 * 
						 * Cell cellah6 = rowsg.createCell(6);
						 * cellah6.setCellStyle(my_style2);
						...
						/*
						 * Cell cellah8 = rowsg.createCell(8);
						 * cellah8.setCellStyle(my_style2);
						 * cellah8.setCellValue(
						 * checkNullValue(objGeneralLedgerTransBean
						 * .getCurrency()));
						 * 
						 * Cell cellah9 = rowsg.createCell(9);
						 * cellah9.setCellStyle(my_style3);
						 * cellah9.setCellValue(
						 * objGeneralLedgerTransBean.getExchangeRate());
						 */
						...
						/*
						 * Cell cellah18 = rowsg.createCell(18);
						 * cellah18.setCellStyle(my_style2);
						 * cellah18.setCellValue
						 * (checkNullValue(objGeneralLedgerTransBean
						 * .getVesselCode()));
						 * 
						 * Cell cellah19 = rowsg.createCell(19);
						 * cellah19.setCellStyle(my_style2);
						 * cellah19.setCellValue
						 * (checkNullValue(objGeneralLedgerTransBean
						 * .getVoyageCode()));
						 * 
						 * Cell cellah20 = rowsg.createCell(20);
						 * cellah20.setCellStyle(my_style2);
						 * cellah20.setCellValue
						 * (checkNullValue(objGeneralLedgerTransBean
						 * .getSectorCode()));
						 * 
						 * Cell cellah21 = rowsg.createCell(21);
						 * cellah21.setCellStyle(my_style2);
						 * if((objGeneralLedgerTransBean.getPol()) == null ||
						 * String.valueOf(objGeneralLedgerTransBean.getPol()).
						 * equalsIgnoreCase("null")) cellah21.setCellValue("");
						 * else cellah21.setCellValue(objGeneralLedgerTransBean.
						 * getPol ());
						 * 
						 * Cell cellah22 = rowsg.createCell(22);
						 * cellah22.setCellStyle(my_style2);
						 * if((objGeneralLedgerTransBean.getPod()) == null ||
						 * String.valueOf(objGeneralLedgerTransBean.getPod()).
						 * equalsIgnoreCase("null")) cellah22.setCellValue("");
						 * else cellah22.setCellValue(objGeneralLedgerTransBean.
						 * getPod ());
						 * 
						 * Cell cellah23 = rowsg.createCell(23);
						 * cellah23.setCellStyle(my_style2);
						 * cellah23.setCellValue
						 * (checkNullValue(objGeneralLedgerTransBean
						 * .getCreatedBy()));
						 * 
						 * Cell cellah24 = rowsg.createCell(24);
						 * cellah24.setCellStyle(my_style2);
						 * cellah24.setCellValue
						 * (checkNullValue(objGeneralLedgerTransBean
						 * .getAllocationStatus()));
						 * 
						 * Cell cellah25 = rowsg.createCell(25);
						 * cellah25.setCellStyle(my_style2);
						 * cellah25.setCellValue
						 * (checkNullValue(objGeneralLedgerTransBean
						 * .getAllocatedTo()));
						 * 
						 * Cell cellah26 = rowsg.createCell(26);
						 * cellah26.setCellStyle(my_style2);
						 * cellah26.setCellValue
						 * (checkNullValue(objGeneralLedgerTransBean
						 * .getAllocatedTo2()));
						 * 
						 * Cell cellah27 = rowsg.createCell(27);
						 * cellah27.setCellStyle(my_style2);
						 * if(objGeneralLedgerTransBean.getDueDate() != null &&
						 * objGeneralLedgerTransBean.getDueDate() != ""){
						 * cellah27
						 * .setCellValue(objGeneralLedgerTransBean.getDueDate
						 * ()); }else
	...
	public void setExcelRowsSubLedger(HSSFWorkbook workbook, HSSFSheet excelSheet,
			GeneralLedgerBean objGeneralLedgerBeanOP, List<GeneralLedgerBean> lGeneralLedgerList,
			HSSFCellStyle my_style1, HSSFCellStyle my_style2, HSSFCellStyle my_style3, HSSFCellStyle my_style_green,
			HSSFCellStyle my_style_green_right_align, HSSFCellStyle my_style_red,
			HSSFCellStyle my_style_red_right_align, GeneralLedgerBean objGeneralLedgerOPBean,
			GeneralLedgerBean inputbean) {
		int record = 5, sno = 1;
			...
			if (lGeneralLedgerList.size() > 0) {
				for (GeneralLedgerBean objGeneralLedgerTransBean : lGeneralLedgerList) {
					...
					if (objGeneralLedgerTransBean.getTransactionNo().length() >= 4) {
						if (objGeneralLedgerTransBean.getTransactionNo().substring(0, 4).equalsIgnoreCase("INBR")) {
						...
						} else if (objGeneralLedgerTransBean.getTransactionNo().substring(0, 4)
								.equalsIgnoreCase("INCR")) {
						...
						} else if (objGeneralLedgerTransBean.getTransactionNo().substring(0, 3)
							...
							cellah1.setCellValue(checkNullValue("Journal Voucher"));
								...
								.equalsIgnoreCase("INB")) {

							Cell cellah1 = rowsg.createCell(1);
							cellah1.setCellStyle(my_style2);
							cellah1.setCellValue(checkNullValue("Bank Payment"));

						} else if (objGeneralLedgerTransBean.getTransactionNo().substring(0, 3).equalsIgnoreCase("MUM")
								|| objGeneralLedgerTransBean.getTransactionNo().substring(0, 3).equalsIgnoreCase("AMD")
								|| objGeneralLedgerTransBean.getTransactionNo().substring(0, 3).equalsIgnoreCase("DEL")
								|| objGeneralLedgerTransBean.getTransactionNo().substring(0, 3)
										.equalsIgnoreCase("LUD")) {
	...
	// Excel Export
	@Override
	public boolean exportGeneralLedgerExcelOP(String exportFilesPath, GeneralLedgerBean objGeneralLedgerBean) {
		String acctHead = "";
		...
		if (true) {
			...
			try {
				...
				// .first
				if (objGeneralLedgerBean.getMainAccountCode() != null
				...
				try {
					 ...
					 * my_style.setBorderTop(XSSFCellStyle.BORDER_MEDIUM);
					 * my_style.setBorderBottom(XSSFCellStyle.BORDER_MEDIUM);
					 * my_style.setFillBackgroundColor(IndexedColors.BLACK.
					 * getIndex());
					 * my_style.setAlignment(my_style.ALIGN_CENTER);
					 * my_style.setFillForegroundColor(HSSFColor.BLUE_GREY.index
					 * ); my_style.setFillPattern(my_style.SOLID_FOREGROUND);
					 * my_style.setDataFormat(HSSFDataFormat.getBuiltinFormat(
					 * "#,##0.00")); Font font = workbook.createFont();
					 * font.setFontHeight((short) 200);
					 * font.setFontName("Arial");
					 * font.setColor(HSSFColor.YELLOW.index);
					 * font.setBoldweight(Font.BOLDWEIGHT_BOLD);
					 ...
					 * my_style1.setBorderTop(XSSFCellStyle.BORDER_MEDIUM);
					 * my_style1.setBorderBottom(XSSFCellStyle.BORDER_MEDIUM);
					 * my_style1.setFillBackgroundColor(IndexedColors.BLACK.
					 * getIndex());
					 * my_style1.setAlignment(my_style.ALIGN_CENTER);
					 * my_style1.setFillForegroundColor(HSSFColor.YELLOW.index);
					 * my_style1.setFillPattern(my_style.SOLID_FOREGROUND);
					 ...
					 * my_style_green.setBorderBottom(XSSFCellStyle.BORDER_THIN)
					 * ; my_style_green.setAlignment(my_style.ALIGN_LEFT);
					 * my_style_green.setDataFormat(HSSFDataFormat.
					 * getBuiltinFormat("#,##0.00"));
					 * 
					 * Font font_green = workbook.createFont();
					 * font_green.setColor(HSSFColor.GREEN.index);
					 ...
					 * my_style_green.setFont(font_green);
					 * 
					 * XSSFCellStyle my_style_green_right_align =
					 * (XSSFCellStyle) workbook.createCellStyle();
					 * my_style_green_right_align.setBorderLeft(XSSFCellStyle.
					 * BORDER_THIN);
					 * my_style_green_right_align.setBorderRight(XSSFCellStyle.
					 ...
					 * my_style_green_right_align.setBorderBottom(XSSFCellStyle.
					 * BORDER_THIN);
					 * my_style_green_right_align.setAlignment(my_style.
					 * ALIGN_RIGHT);
					 * my_style_green_right_align.setDataFormat(HSSFDataFormat.
					 * getBuiltinFormat("#,##0.00"));
					 * font_green.setColor(HSSFColor.GREEN.index);
					 ...
					 * my_style_red.setBorderBottom(XSSFCellStyle.BORDER_THIN);
					 * my_style_red.setAlignment(my_style.ALIGN_LEFT);
					 * my_style_red.setDataFormat(HSSFDataFormat.
					 * getBuiltinFormat("#,##0.00"));
					 * 
					 * Font font_red = workbook.createFont();
					 * font_red.setColor(HSSFColor.RED.index);
					 ...
					 * my_style_red_right_align.setBorderBottom(XSSFCellStyle.
					 * BORDER_THIN);
					 * my_style_red_right_align.setAlignment(my_style.
					 * ALIGN_RIGHT);
					 * my_style_red_right_align.setDataFormat(HSSFDataFormat.
					 * getBuiltinFormat("#,##0.00"));
					 * font_red.setColor(HSSFColor.RED.index);
					 ...
					 * my_style_red_right_align.setFont(font_red);
					 * 
					 * // Create a blank sheet // HSSFSheet excelSheet = //
					 * workbook.createSheet("General Ledger");
					 * 
					 * SXSSFSheet excelSheet = (SXSSFSheet)
					 * workbook.createSheet(objGeneralLedgerBean.getCompanyCode(
					 * )); excelSheet.setRandomAccessWindowSize(100);// keep 100
					 * rows
					 */ // in memory,
					...
					// set Data
					setExcelRowsSubLedger(workbook, excelSheet, objGeneralLedgerBean, lGeneralLedgerList, my_style1,
							my_style2, my_style3, my_style_green, my_style_green_right_align, my_style_red,
							my_style_red_right_align, objGeneralLedgerOPBean, objGeneralLedgerBean);
	...
	@Override
	public boolean exportTransactionLevelExcel(String exportFilesPath, GeneralLedgerBean objGeneralLedgerBean) {
		...
		try {
			 ...
			 * "#,##0.00"));
			 * 
			 * XSSFCellStyle my_style4 = (XSSFCellStyle)
			 * workbook.createCellStyle();
			 ...
			 * my_style4.setDataFormat(HSSFDataFormat.getBuiltinFormat(
			 * "#,##0.00")); // Create a blank sheet SXSSFSheet excelSheet =
			 * (SXSSFSheet) workbook.createSheet("General Ledger");
			 * excelSheet.setRandomAccessWindowSize(100);// keep 100 rows in
			 */ // memory,
			HSSFWorkbook workbook = new HSSFWorkbook();
			HSSFCellStyle my_style = workbook.createCellStyle();
	...
	public void setExcelMainHeaderTB(HSSFSheet excelSheet, HSSFCellStyle my_style) {
		Row row = excelSheet.createRow(0);
		excelSheet.addMergedRegion(new CellRangeAddress(0, 1, 0, 7));
		Cell cell = row.createCell(0);
		cell.setCellValue("General ledger");
	...
	public void setExcelHeaderTB(HSSFSheet excelSheet, HSSFCellStyle my_style1) {
		try {
	...
	public void setExcelRowsTB(HSSFSheet excelSheet, List<TrialBalanceBean> lTrialBalanceList, HSSFCellStyle my_style1,
			HSSFCellStyle my_style2, HSSFCellStyle my_style3, HSSFCellStyle my_style4) {
		int record = 3, sno = 1;
			...
			for (TrialBalanceBean objTrialBalanceBean : lTrialBalanceList) {
				...
				if (objTrialBalanceBean.getlTBTransactionList().size() > 0) {
					for (TrialBalanceBean objTrialBalanceSABean : objTrialBalanceBean.getlTBTransactionList()) {
						...
						String sSubAccountCode = checkNullValue(objTrialBalanceSABean.getSubAccountCode()) + "-"
								+ checkNullValue(objTrialBalanceSABean.getSubAccountName());
						...
						if (objTrialBalanceSABean.getlSATransactionLevelList().size() > 0) {
							for (TrialBalanceBean objTrialBalanceTransactionBean : objTrialBalanceSABean
									.getlSATransactionLevelList()) {
								Row rowah = excelSheet.createRow(record++);
								rowah.setHeight((short) 350);
	...
	public List<GeneralLedgerBean> getGeneralLedgerAHLevelAcct(GeneralLedgerBean objGeneralLedgerBean) {
		// TODO Auto-generated method stub
		return objGeneralLedgerDao.getGeneralLedgerAHLevelAcct(objGeneralLedgerBean);
	}
	...
	public GeneralLedgerBean pdfExportNew(GeneralLedgerBean glreport, String exportFilesPath) {
		...
		List<GeneralLedgerBean> Listbean = new ArrayList<>();
		try {
			JdbcTemplate jdbcTemplate = new JdbcTemplate(dataSource);
			List<Map<String, Object>> name = jdbcTemplate.queryForList("select acct_head_name from account_head_master where acct_head_code in ('"+glreport.getAcctHeadId()+"')");
			String mainAcctName = "";
			for (Map name1 : name) {
				if (name1.get("acct_head_name") != null) {
					mainAcctName = String.valueOf(name1.get("acct_head_name"));
				}
			}	
 
			String fromdate = glreport.getFromDate();
			String todate = glreport.getToDate(); 
			String header = mainAcctName+" as on period " +fromdate+ " to " +todate;
			...
			PdfWriter writer = PdfWriter.getInstance(document,
					new FileOutputStream(exportFilesPath + "/GeneralLedger.pdf"));
			document.addAuthor("DCI");
			document.addCreationDate();
			document.addProducer();
			document.addCreator("DCI");
			document.addTitle("GeneralLedger");
			document.setPageSize(PageSize.A4.rotate());
			document.setMargins(50, 50, 50, 50);

			document.open();

			Listbean = objGeneralLedgerDao.getConsolidatedGeneralLedgerList(glreport);
			Font bfBold123 = new Font(FontFamily.HELVETICA, 12, Font.BOLD, new BaseColor(0, 0, 0));
			 
			Image image = Image.getInstance("src\\main\\resources\\dci.png");
		...
		//	paragraphmain3 = new Paragraph("\n", bfBold123);
			paragraphmain = new Paragraph("General Ledger \n", bfBold123);			
			paragraphmain1 = new Paragraph( header, bfBold123);
			paragraphmain1.setAlignment(paragraphmain1.ALIGN_CENTER);
			...
			// float[] columnWidths = {8f, 6f, 5f, 5f,6f,6f,6f,5f,6f,5f};
			float[] columnWidths = { 5f, 8f, 6f, 8f, 4f, 4f };
			...
			/*
			 * insertCell(table1, "ORGANIZATION", Element.ALIGN_CENTER, 1,
			 * bfBold12); insertCell(table1, "ORGANIZATION NAME",
			 * Element.ALIGN_CENTER, 1, bfBold12); insertCell(table1,
			 * "FUND TYPE", Element.ALIGN_CENTER, 1, bfBold12);
			 * insertCell(table1, "MAIN ACCOUNT CODE", Element.ALIGN_CENTER, 1,
			 * bfBold12); insertCell(table1, "MAIN ACCOUNT NAME",
			 * Element.ALIGN_CENTER, 1, bfBold12); insertCell(table1,
			 * "TRANSACTION NO  ", Element.ALIGN_CENTER, 1, bfBold12);
			 * insertCell(table1, "TRANSACTION DATE", Element.ALIGN_CENTER, 1,
			 * bfBold12); insertCell(table1, "PARTY INV NO",
			 * Element.ALIGN_CENTER, 1, bfBold12); insertCell(table1,
			 * "NARRATION", Element.ALIGN_CENTER, 1, bfBold12);
			 * insertCell(table1, "AMOUNT", Element.ALIGN_CENTER, 1, bfBold12);
			 */

			insertCell(table1, " DATE", Element.ALIGN_LEFT, 1, bfBold12);
			insertCell(table1, "PARTICULARS", Element.ALIGN_LEFT, 1, bfBold12);
			insertCell(table1, "TRANSACTION NO  ", Element.ALIGN_LEFT, 1, bfBold12);
			insertCell(table1, "NARRATION", Element.ALIGN_LEFT, 1, bfBold12);
			insertCell(table1, "DEBIT", Element.ALIGN_RIGHT, 1, bfBold12);
			insertCell(table1, "CREDIT", Element.ALIGN_RIGHT, 1, bfBold12);

			table1.setHeaderRows(1);

			// insert an empty row
			/*
			 * insertCell(table1, "", Element.ALIGN_LEFT, 4, bfBold12); //create
			 * section heading by cell merging insertCell(table1,
			 * "New York Orders ...", Element.ALIGN_LEFT, 4, bfBold12);
			 */
			double dramt = 0, cramt = 0, total = 0, openingBalance = 0, closingBalance = 0, cr = 0, dr = 0;
			// OPENING OR CLOSING BALANCE
			
			String sDynamicQuery = "with A as ( select COALESCE(sum(BC_CREDIT),0) as credit  ,COALESCE(sum(BC_DEBIT),0) as debit,COALESCE(sum(BC_DEBIT)-sum(BC_CREDIT),0) as opening  from general_ledger  "
					+ "	where ledger_date::date < TO_DATE('" + glreport.getFromDate()
					+ "','DD-MM-YYYY') and company_id in ('C0002') and ACCOUNT_CODE = '" + glreport.getAcctHeadId()
					+ "'),"
					...
					+ "where   ACCOUNT_CODE = '" + glreport.getAcctHeadId() + "' and ledger_date::date >= TO_DATE('"
					+ glreport.getFromDate() + "','DD-MM-YYYY') and ledger_date::date <= " + "TO_DATE('"
					+ glreport.getToDate()
					+ "','DD-MM-YYYY')	 and company_id in ('C0002'))	select COALESCE(a.opening,0) as openingBalance,b.debit as debitamount,"
			...
			for (Map row : rows) {
				if (row.get("openingBalance") != null) {
					openingBalance = Double.valueOf(String.valueOf(row.get("openingBalance")));
				}
				if (row.get("closingBalance") != null) {
					closingBalance = Double.valueOf(String.valueOf(row.get("closingBalance")));
				}
			}

			

			insertCell(table1, "" + fromdate + "", Element.ALIGN_LEFT, 1, bfBold12);
			insertCell(table1, "Opening Balance", Element.ALIGN_LEFT, 1, bfBold12);
			if (openingBalance < 0) {
				insertCell(table1, df.format(0), Element.ALIGN_RIGHT, 3, bfBold12);
				insertCell(table1, df.format(-openingBalance), Element.ALIGN_RIGHT, 1, bfBold12);
			} else {
				insertCell(table1, df.format(openingBalance), Element.ALIGN_RIGHT, 3, bfBold12);
				insertCell(table1, df.format(0), Element.ALIGN_RIGHT, 1, bfBold12);
			}

			// just some random data to fill
			for (GeneralLedgerBean detail : Listbean) {
				String gldate = "";
				String ldate = detail.getLedgerDate();
				String[] arr = ldate.split("-", 0);
		        for (String w : arr) {  
		        	if(w.length()>2){
		        		gldate = w+gldate;
		        	}else{
				...
				if (detail.getCostCentername() == null)
					detail.setCostCentername("");
				if (detail.getAccountHeadCode() == null)
					detail.setAccountHeadCode("");
				if (detail.getCompanyCode() == null)
					detail.setCompanyCode("");
				if (detail.getCompanyName() == null)
					detail.setCompanyName("");
				if (detail.getAccountHeadName() == null)
					detail.setAccountHeadName("");
				if (detail.getTransactionNo() == null)
					detail.setTransactionNo("");
				if (detail.getTransactionDate() == null)
					detail.setTransactionDate("");
				if (detail.getPartyInvoiceNo() == null)
					detail.setPartyInvoiceNo("");
				if (detail.getNarration() == null)
					detail.setNarration("");
				if (detail.getLedgerDate() == null)
					detail.setLedgerDate("");

				if (detail.getBcCredit() < 0) {
					cr = -detail.getBcCredit();
				} else {
					cr = detail.getBcCredit();
				}

				if (detail.getBcDebit() < 0) {
					dr = -detail.getBcDebit();
				} else {
					dr = detail.getBcDebit();
				}

				/*
				 * insertCell(table1, "" +detail.getCompanyCode()+"" ,
				 * Element.ALIGN_CENTER,color, 1, bf12); insertCell(table1, ""
				 * +detail.getCompanyName()+"" , Element.ALIGN_CENTER,color, 1,
				 * bf12); insertCell(table1, "" +detail.getCostCentername()+"" ,
				 * Element.ALIGN_CENTER,color, 1, bf12); insertCell(table1, ""
				 * +detail.getAccountHeadCode()+"" , Element.ALIGN_CENTER,color,
				 * 1, bf12); insertCell(table1, ""
				 * +detail.getAccountHeadName()+"" , Element.ALIGN_CENTER,color,
				 * 1, bf12); insertCell(table1, "" +detail.getTransactionNo()+""
				 * , Element.ALIGN_CENTER,color, 1, bf12); insertCell(table1, ""
				 * +detail.getTransactionDate()+"" , Element.ALIGN_RIGHT,color,
				 * 1, bf12); insertCell(table1, ""
				 * +detail.getPartyInvoiceNo()+"" , Element.ALIGN_RIGHT,color,
				 * 1, bf12); insertCell(table1, "" +detail.getNarration()+"" ,
				 * Element.ALIGN_CENTER,color, 1, bf12); insertCell(table1, ""
				 * +df.format(detail.getBcCredit())+"" ,
				 * Element.ALIGN_RIGHT,color, 1, bf12);
				 */

				insertCell(table1, "" + gldate + "", Element.ALIGN_LEFT, color, 1, bf12);
				...
				insertCell(table1, "" + detail.getNarration() + "", Element.ALIGN_LEFT, color, 1, bf12);
				insertCell(table1, "" + df.format(cr) + "", Element.ALIGN_RIGHT, color, 1, bf12);
				insertCell(table1, "" + df.format(dr) + "", Element.ALIGN_RIGHT, color, 1, bf12);
				dramt = dramt + dr;
				cramt = cramt + cr;
			}

			// insertCell(table1, "TOTAL", Element.ALIGN_RIGHT, 9, bfBold12);
			// insertCell(table1, df.format(amt), Element.ALIGN_RIGHT, 1,
			// bfBold12);

			if (openingBalance <= 0) {
				openingBalance = -(openingBalance);
				insertCell(table1, "Current Total", Element.ALIGN_RIGHT, 4, bfBold12);
				insertCell(table1, df.format(cramt), Element.ALIGN_RIGHT, 1, bfBold12);
				insertCell(table1, df.format(dramt + openingBalance), Element.ALIGN_RIGHT, 1, bfBold12);
			} else {
				insertCell(table1, "Current Total", Element.ALIGN_RIGHT, 4, bfBold12);
				insertCell(table1, df.format(cramt+ openingBalance), Element.ALIGN_RIGHT, 1, bfBold12);
				insertCell(table1, df.format(dramt ), Element.ALIGN_RIGHT, 1, bfBold12);
			}

			if (cramt > dramt) {
				insertCell(table1, "Closing Balance", Element.ALIGN_RIGHT, 4, bfBold12);
				insertCell(table1, df.format(0), Element.ALIGN_RIGHT, 1, bfBold12);
				insertCell(table1, df.format(closingBalance), Element.ALIGN_RIGHT, 1, bfBold12);

				// total balance
				insertCell(table1, "Total", Element.ALIGN_RIGHT, 4, bfBold12);
				insertCell(table1, df.format(cramt), Element.ALIGN_RIGHT, 1, bfBold12);
				insertCell(table1, df.format(dramt + closingBalance + openingBalance), Element.ALIGN_RIGHT, 1,
						bfBold12);
			} else {
				insertCell(table1, "Closing Balance", Element.ALIGN_RIGHT, 4, bfBold12);
				insertCell(table1, df.format(-closingBalance), Element.ALIGN_RIGHT, 1, bfBold12);
				...
				// total balance
				insertCell(table1, "Total", Element.ALIGN_RIGHT, 4, bfBold12);				
				insertCell(table1, df.format(cramt + (-closingBalance) + openingBalance), Element.ALIGN_RIGHT, 1,
						bfBold12);
				insertCell(table1, df.format(dramt), Element.ALIGN_RIGHT, 1, bfBold12);
			}
