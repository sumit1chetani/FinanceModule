...
public class ManageStoresBean {
	...
	private List<ManageStoresBean> addressTable;
	private List<ManageStoresBean> mainTable;

	public List<ManageStoresBean> getAddressTable() {
		return addressTable;
	}

	public void setAddressTable(List<ManageStoresBean> addressTable) {
		this.addressTable = addressTable;
	}

	public List<ManageStoresBean> getMainTable() {
		return mainTable;
	}

	public void setMainTable(List<ManageStoresBean> mainTable) {
