...
public class EmployeeAdminNominationBean {
	...
	private List<EmployeeAdminNominationBean> nominatePhoneMultiple;
	private List<EmployeeAdminNominationBean> nominateMobileMultiple;
	...
	public List<EmployeeAdminNominationBean> getNominatePhoneMultiple() {
		return nominatePhoneMultiple;
	}

	public void setNominatePhoneMultiple(List<EmployeeAdminNominationBean> nominatePhoneMultiple) {
		this.nominatePhoneMultiple = nominatePhoneMultiple;
	}

	public List<EmployeeAdminNominationBean> getNominateMobileMultiple() {
		return nominateMobileMultiple;
	}

	public void setNominateMobileMultiple(List<EmployeeAdminNominationBean> nominateMobileMultiple) {
