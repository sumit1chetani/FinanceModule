...
public class UserMasterQueryUtil {
	...
	public static final String SELECT_EMPLOYEE_LIST2 = "select e.employee_id empId,e.reporting_to,e.first_name firstName, e.middle_name middleName, branch.brnch_nam branchName, e.surname lastName, e.gender gender, " + "to_char(e.dob,'dd/mm/yyyy') dob, to_char(e.doj,'dd/mm/yyyy') doj, e.access_card_number accessCardNo, e.phone mobileNo, e.email emailId, e.photo_url uploadPhoto, e.status status,e.emp_user_id empUserId, e.department_id departmentId, "
			+ "e.designation_id designation, e.grade_id grade, e.division_id division, e.password pwd, e.employee_type_id typeOfEmp, e.epf_no epfNo, e.esic_code esic, " + "e.relieving_date relieveDate, e.fixed_gross fixedGross, e.donor_code donorCode, department.department_name departmentCode, desig.designation_name designationName, " + "et.type empTypeName, g.name gradeName, div.division_name divisionName,cus.retailer_name cusName,company.company_name as companyName from employee e   "
			+ "left join designation desig on desig.designation_id = e.designation_id left join employment_type et on et.employment_type_id =e.employee_type_id " + "left join grade g on g.grade_id = e.grade_id left join division div on div.division_id = e.division_id inner join branch_department bd "
	...
	public static final String SELECT_EMPLOYEE_LIST3 = "select e.employee_id empId,e.reporting_to,e.first_name firstName, e.middle_name middleName, branch.brnch_nam branchName, e.surname lastName, e.gender gender, " + "to_char(e.dob,'dd/mm/yyyy') dob, to_char(e.doj,'dd/mm/yyyy') doj, e.access_card_number accessCardNo, e.phone mobileNo, e.email emailId, e.photo_url uploadPhoto, e.status status,e.emp_user_id empUserId, e.department_id departmentId, "
			+ "e.designation_id designation, e.grade_id grade, e.division_id division, e.password pwd, e.employee_type_id typeOfEmp, e.epf_no epfNo, e.esic_code esic, " + "e.relieving_date relieveDate, e.fixed_gross fixedGross, e.donor_code donorCode, department.department_name departmentCode, desig.designation_name designationName, " + "et.type empTypeName, g.name gradeName, div.division_name divisionName,cus.retailer_name cusName,company.company_name as companyName from employee e   "
			+ "left join designation desig on desig.designation_id = e.designation_id left join employment_type et on et.employment_type_id =e.employee_type_id " + "left join grade g on g.grade_id = e.grade_id left join division div on div.division_id = e.division_id inner join branch_department bd "
	...
	public static String SELECT_EMPLOYEE_BY_ID = "select e.uan_no uan,e.relieving_date relieveDate,e.employee_id empId, temp.branch_id reportBranch, e.reporting_to reportMangrId,e.emp_user_id empUserId, rep.designation_id reportDesigId, rep.department_id reportDeptId,  rep.first_name reportManagerName, depts.department_name reportToDept, desigs.designation_name reportToDesig,  e.first_name firstName, e.middle_name middleName, e.surname lastName, e.gender gender, e.dob dob, e.insurance_policy_no insuranceNo,e.doj doj, "
			...
			+ "desig.designation_name designationName, et.type empTypeName, g.name gradeName, div.division_name divisionName,  b.branch_id as branch,b.brnch_nam as branchName,c.company_id as companyCode,c.company_name as companyName,e.employee_type_date employmentDate from employee e  left join department dept on dept.department_id = e.department_id  left join designation desig on desig.designation_id = e.designation_id  left join employment_type et on et.employment_type_id = e.employee_type_id  left join grade g on g.grade_id = e.grade_id left join division div on div.division_id = e.division_id "
	...
	public static String SELECT_BRANCH_LIST = "select brnch_id as id,brnch_nam as text,brnch_id branch,brnch_nam branchName from branch where company_id = ?";
	...
	public static String SELECT_REPORT_BRANCH_LIST = "select brnch_id as id,brnch_name as text,brnch_id reportToBranch,brnch_nam reportToBranchName from branch order by brnch_nam ASC";

	public static String SELECT_REPORT_DEPT_LIST = "select d.department_id reportDeptId,department_name reportToDept FROM department d INNER JOIN branch_department bd ON bd.department_id=d.department_id AND bd.branch_id=? WHERE d.status=true order by department_name ASC";
