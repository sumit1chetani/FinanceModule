...
public class UserAdminEmergencyBean {
	private String empId;
	private Integer emergencyId;
	private String emergencyName;
	private String emergRelationship;
	private String emergEmail;
	private List<UserAdminEmergencyBean> phoneNoMultiple;
	private List<UserAdminEmergencyBean> mobileNoMultiple;
	...
	public List<UserAdminEmergencyBean> getPhoneNoMultiple() {
		return phoneNoMultiple;
	}

	public void setPhoneNoMultiple(List<UserAdminEmergencyBean> phoneNoMultiple) {
		this.phoneNoMultiple = phoneNoMultiple;
	}

	public List<UserAdminEmergencyBean> getMobileNoMultiple() {
		return mobileNoMultiple;
	}

	public void setMobileNoMultiple(List<UserAdminEmergencyBean> mobileNoMultiple) {
