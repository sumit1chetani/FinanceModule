...
//
public class UserAdminMasterPhoneNoDetailBean {
	private List<UserAdminMasterPhoneNoDetailBean> presentMobile;
	private List<UserAdminMasterPhoneNoDetailBean> presentPhone;
	...
	public List<UserAdminMasterPhoneNoDetailBean> getPresentMobile() {
		return presentMobile;
	}

	public void setPresentMobile(List<UserAdminMasterPhoneNoDetailBean> presentMobile) {
		this.presentMobile = presentMobile;
	}

	public List<UserAdminMasterPhoneNoDetailBean> getPresentPhone() {
		return presentPhone;
	}

	public void setPresentPhone(List<UserAdminMasterPhoneNoDetailBean> presentPhone) {
