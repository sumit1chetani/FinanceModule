...
public class ServicePartnerNewBean {
	private String id;
	private String bin;
	...
	private double mobileNo1;

	public double getMobileNo1() {
		return mobileNo1;
	}

	public void setMobileNo1(double mobileNo1) {
	...
	private List<ServicePartnerNewBean> commodity1;
	

	public List<ServicePartnerNewBean> getCommodity1() {
		return commodity1;
	}

	public void setCommodity1(List<ServicePartnerNewBean> commodity1) {
