...
@AuditLoggableType(tableName = "terms", formCode = "F5599")
public class TermsBean {
	...
	@AuditLoggable(fieldName = "trm_cd", displayName = "Code")
	...
	@AuditLoggable(fieldName = "trm_nam", displayName = "Name")
	...
	@AuditLoggable(fieldName = "dscrptn_vcr", displayName = "Description")
