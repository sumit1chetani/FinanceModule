...
public interface CommonUtilityDAO {
	...
	public String getserviceBasedLocation(String voyage);
	...
	boolean updateInventoryAndLedgerIn(String stockId, String date, int i, int sourceLoc, int destLoc, int parseInt, int quantity, String inTransistLocation, List<BatchAttributeBean> grnbatchBean);

	boolean updateInventoryAndLedgerOut(String stockId, String date, int i, int sourceLoc, int destLoc, int parseInt, int quantity, String inTransistLocation, List<BatchAttributeBean> grnbatchBean);

	boolean updateInventoryAndLedgerInCheckQc(String stockId, String date, int i, int sourceLoc, int destLoc, int parseInt, int quantity, String inTransistLocation, int qcStatus, List<BatchAttributeBean> attributeBeans);

	boolean updateInventoryAndLedgerOutCheckQc(String stockId, String date, int i, int sourceLoc, int destLoc, int parseInt, int quantity, String inTransistLocation, int qcStatus, List<BatchAttributeBean> attributeBeans);
	...
	public boolean updateInventoryAndLedgerIn(String stockId, String date, int i, int sourceLoc, int destLoc,
			int parseInt, double quantity, String inTransistLocation, List<BatchAttributeBean> attributeBeans);

	public boolean updateInventoryAndLedgerOut(String stockId, String date, int i, int destLoc, int sourceLoc,
			int parseInt, double quantity, String inTransistLocation, List<BatchAttributeBean> attributeBeans);

	boolean updateInventoryAndLedgerInCheckQc(String stockId, String date, int i, int sourceLoc, int destLoc, int parseInt, double quantity, String inTransistLocation, int qcStatus, List<BatchAttributeBean> attributeBeans);

	boolean updateInventoryAndLedgerOutCheckQc(String stockId, String date, int i, int sourceLoc, int destLoc, int parseInt, double quantity, String inTransistLocation, int qcStatus, List<BatchAttributeBean> attributeBeans);
	...
	TransferReceivedBean getTransferReceiveView(Integer receivedId);
