...
public interface IPurchaseQuotationService {
	...
	PurchaseQuotationResultBean uploadFile(MultipartFile file);

	PurchaseQuotationResultBean uploadFile1(MultipartFile file);

	PurchaseQuotationResultBean uploadFile2(MultipartFile file);
