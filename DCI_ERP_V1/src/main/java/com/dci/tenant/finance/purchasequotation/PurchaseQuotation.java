...
import com.dci.tenant.finance.purchaseorder.PurchaseOrder;
import com.dci.tenant.finance.purchaseorder.PurchaseOrderDetail;
import com.dci.tenant.finance.purchaseorder.PurchaseQuoteDetail;
import com.dci.tenant.finance.purchaseorder.RateContractDetail;
...
public class PurchaseQuotation {
	...
	private List<PurchaseQuotationDetail> quotationDetailList = new ArrayList<>();
	private List<PurchaseQuotationDetail> deletedIl = new ArrayList<>();
	...
	public List<PurchaseQuotationDetail> getDeletedIl() {
		return deletedIl;
	}

	public void setDeletedIl(List<PurchaseQuotationDetail> deletedIl) {
		this.deletedIl = deletedIl;
	}
