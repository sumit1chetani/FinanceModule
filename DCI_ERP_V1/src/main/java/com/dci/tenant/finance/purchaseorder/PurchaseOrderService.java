...
public interface PurchaseOrderService {
	...
	public List<PurchaseSelect> getCompanyNames(String string) throws Exception;
	...
	public List<PurchaseSelect> getPurchaseOrderDefList1(int purchasefromFormid) throws Exception;
