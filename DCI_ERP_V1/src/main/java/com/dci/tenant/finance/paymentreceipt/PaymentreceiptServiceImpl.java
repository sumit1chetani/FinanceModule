...
public class PaymentreceiptServiceImpl implements PaymentreceiptService {
	@Autowired
	PaymentreceiptDAO objAcctHeadMasterDAO;

	@Override
	public List<PaymentreceiptMasterBean> getAcctHeadMasterList(int limit, int offset) throws Exception {
	...
	@Override
	public void excellExport(PaymentreceiptResultBean ObjPendingapprovalResultBean, PaymentreceiptMasterBean ObjPendingapprovalBean, String pdfFile) {
		try {
			// Blank workbook
	...
	private void setExcelRows(XSSFWorkbook workbook, XSSFSheet excelSheet, PaymentreceiptResultBean ObjPendingapprovalResultBean, XSSFCellStyle my_style2, XSSFCellStyle my_style3, XSSFCellStyle my_style4, XSSFCellStyle my_style5, XSSFCellStyle my_style6, XSSFCellStyle my_style7, XSSFCellStyle my_style8) {
		int record = 4, sno = 1;
		try {

			for (PaymentreceiptMasterBean objPendingapprovalBean : ObjPendingapprovalResultBean.getSearchList()) {
	...
	private void setExcelMainHeader(XSSFSheet excelSheet, XSSFCellStyle my_style, PaymentreceiptMasterBean ObjPendingapprovalBean, XSSFCellStyle my_style4) {
