...
public class EmployeeMasterPhoneNoDetailBean {
	private List<EmployeeMasterPhoneNoDetailBean> presentMobile;
	private List<EmployeeMasterPhoneNoDetailBean> presentPhone;
	...
	public List<EmployeeMasterPhoneNoDetailBean> getPresentMobile() {
		return presentMobile;
	}

	public void setPresentMobile(List<EmployeeMasterPhoneNoDetailBean> presentMobile) {
		this.presentMobile = presentMobile;
	}

	public List<EmployeeMasterPhoneNoDetailBean> getPresentPhone() {
		return presentPhone;
	}

	public void setPresentPhone(List<EmployeeMasterPhoneNoDetailBean> presentPhone) {
