				...
				<div class="row">
					...
					<div class="form-group">
								...
								date-format="DD/MM/YYYY HH:mm" 			id="etd"  ng-model="trip.etd" validation="required"/></div>
									...
									<div class="form-group">
										<label class="col-md-4 control-label ">Road User(INR)<span
											style="color: red;"></span>
										</label>
										<div class="col-md-5">
...
<!-- 											</select> -->
								...
								<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="form-group">
										<label class="col-md-4 control-label ">Rate(INR)<span
											style="color: red;"></span>
										</label>
										<div class="col-md-5">
										<input type="text"
		...
		<div class="form-group">
										...
										<div class="form-group">
										<label class="col-md-4 control-label ">Income(INR)<span
											style="color: red;"></span>
										</label>
										<div class="col-md-5">
										<input type="text"
