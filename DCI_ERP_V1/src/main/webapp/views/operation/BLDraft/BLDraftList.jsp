  ...
  <div class="col-md-6 text-right padding-right-0">
   <div class="row">
    <div class="col-md-6 p-r-3">
     ...
     <button class="btn btn-sm btn-success"  style ="color: #ffffff;background-color: #4f9fc5fc;" ng-click="add()" >
...
<!--               <i class="fa  fa-print text-primary text" title="BL Print Draft" data-ng-click="printBLCopy(item.blNo)"></i> &nbsp;&nbsp;
 -->                <i class="fa  fa-print text-success text" style="color: #2039b1;" title="Print" data-ng-click="printBLCopy(item.blNo)"></i>
			  </span>
			  </td>
<%-- 			  	</security:authorize>
 --%>			  
<%-- 			  <security:authorize access="hasRole('${form_code}_${print}')">
 --%>			 <!--  <td>
			  <span>
			    ...
			    <i class="fa  fa-print text-success text" style="color: #fb00d1;" title="Print Proforma Invoice" data-ng-click="printBLInvoice(item.blNo)"></i>
			  </span>
			  </td> -->
<%-- 			  </security:authorize>
 --%>			   
