...
<!-- 						Shipping bill -->
			<div class="col-md-12" style="margin-top: 1%; margin-bottom: 1%;" >
				...
				<!-- 			<div class="col-md-4">
						...
						<!-- <div class="col-md-4">
							<label class="control-label"  ng-if="!isEdit">Country <span style="color: red;">*</span><span style="color: #23b7e5;padding-left: 95px;"></span></label> <input class="form-control"
					...
					<div class="col-md-4">
						...
						<div class="col-md-4" ng-if="isEdit">
							<label class="control-label">Shipper's Telephone No <span style="color: red;">*</span><span style="color: #23b7e5;padding-left: 95px;"></span></label> <input class="form-control"
								...
								friendly-name="Shipper Telephone No" ng-model="blNoData.shipperTel1" name="shipperTel"
								form-name="blForm" >
						</div>
					...
					<div class="col-md-4" ng-if="isEdit">
							<label class="control-label">Shipper's Email <span style="color: red;">*</span><span style="color: #23b7e5;padding-left: 95px;"></span></label>
							 <input class="form-control"
								...
								friendly-name="Shipper Email" ng-model="blNoData.shipperEmail1" name="shipperEmail"
								form-name="blForm" >
						</div>
					<div class="col-md-4" ng-if="!isEdit">
							<label class="control-label">Shipper's Email <span style="color: red;">*</span><span style="color: #23b7e5;padding-left: 95px;"></span></label>
					...
					<div class="col-md-4" ng-if="isEdit">
							<label class="control-label">Shipper's Country <span style="color: red;">*</span><span style="color: #23b7e5;padding-left: 95px;"></span></label> <input class="form-control"
								...
								friendly-name="Shipper Country" ng-model="blNoData.shipperCountry1" name="shipperCountry"
								form-name="blForm">
						</div>
						<div class="col-md-4" ng-if="!isEdit">
							<label class="control-label">Shipper's Country <span style="color: red;">*</span><span style="color: #23b7e5;padding-left: 95px;"></span></label> <input class="form-control"
								...
								<div class="row" id="items">
									...
									<table class="table table-striped b-t b-light">
										<thead>
											<tr>
												...
												<th colspan=1 class="width_4 text-center" >Cntr No <span
												...
												<th colspan=1 class="width_3 text-center">Seal No <span
													style="color: red;">*</span></th>
												<th colspan=1 class="width_3 text-center">NW (KG)<span
													style="color: red;"></span></th>
												<th colspan=1 class="width_3 text-center">GW (KG)<span
													style="color: red;">*</span></th>
									...
									<th colspan=1 class="width_6 text-center">SOC <span style="color: red;"></span></th> -->
												<th colspan=1 class="width_4 text-center">Package <span
													style="color: red;"></span></th>
												<th colspan=1 class="width_2 text-center">No of
...
<div class="col-md-12"
              ...
              <input class="form-control" type="text"  name="messers" id="messers" ng-model="blNoData.messers" placeholder="Messers">
					...
					<div class="col-md-12">
						<div class="table-responsive ">
							<div class="panel-body" style="width: 157%;">
								<div class="row" id="items">
									<table class="table table-striped b-t b-light">
										<thead>
											<tr>
												...
												<th colspan=1 class="width_3 text-center">NW (KG)<span
													style="color: red;"></span></th>
												<th colspan=1 class="width_3 text-center">GW ({{blNoData.gw_unit}})<span
													style="color: red;">*</span></th>
												<th colspan=1 class="width_3 text-center">VGM<span
													style="color: red;"></span></th>	
												<th colspan=1 class="width_3 text-center">CBM <span
									...
									<th colspan=1 class="width_6 text-center">POD Term <span style="color: red;">*</span></th> -->
										...
										<tbody
											...
											<tr>
												...
												<td class="width_3">
											<div class="row">
												<div class="col-xs-13"><selectivity
														list="containerList" property="blcntrDtl.cntrNo"
														id="cntrNo{{trIndex}}" ng-model="blcntrDtl.cntrNo"
														name="cntrNo{{trIndex}}" form-name="blForm"
														validation="required"
               ...
               name="cntrNo"  form-name="blForm" validation="required" friendly-name="Contaier No"></selectivity> -->
											...
											<div class="row">
												...
												<td class="width_4">
											<div class="row">
												<div class="col-xs-13"><input class="form-control"
													type="number" form-name="blForm" friendly-name="tw"
													name="tw{{trIndex}}" id="tw{{trIndex}}"
													ng-model="blcntrDtl.tw" data-ng-change="calcWeight(blcntrDtl,$index)"></div></div></td>
												<td class="width_4">
											<div class="row">
												<div class="col-xs-13"><input class="form-control"
													type="number" form-name="blForm" validation="required"
													friendly-name="{{ 'Row' + (trIndex+1) + '(GW)'}}"
													name="gw{{trIndex}}" id="gw{{trIndex}}"
													ng-model="blcntrDtl.gw" data-ng-change="calcWeight(blcntrDtl,$index)"></div></div></td>
													
												<td class="width_3">
											<div class="row">
												<div class="col-xs-12"><input class="form-control"
													type="text" form-name="blForm" 
													friendly-name="{{ 'Row' + (trIndex+1) + '(VGM)'}}"
													name="vgm{{trIndex}}" id="vgm{{trIndex}}"
													ng-model="blcntrDtl.vgm"></div></div></td>	
                ...
                friendly-name="SOC"></selectivity>
											...
											<div class="row">
												<div class="col-xs-12"><input class="form-control"
													...
													form-name="blForm"
													friendly-name="{{ 'Row' + (trIndex+1) + '(No Of Package)'}}"
													placeholder="NoO" data-ng-change="calcWeight(blcntrDtl,$index)"></div></div></td>
												<td class="width_5">
											<div class="row">
												<div class="col-xs-17"><input class="form-control"
													type="text" name="g{{trIndex}}" id="g{{trIndex}}"
													ng-model="blcntrDtl.goods" validation="required" friendly-name="{{ 'Row' + (trIndex+1) + '(goods)'}}"></div></div></td>
												<td class="text-center"><input type="checkbox"
													name="iso" id="iso{{trIndex}}" ng-model="blcntrDtl.iso" disabled="true"><i></i>
												</td>
												<td class="text-center"><input type="checkbox"
         ...
         form-name="blForm" validation="required" friendly-name="POD Term"      name="podTer"   ></selectivity>	</td> -->
											...
											<tr>
												...
												<td colspan="12">
													...
													">
														<tr>
															<th class="width_2 text-center subTable-brs" style="color: white;">Charge
																Code</th>
															<th class="width_2 text-center subTable-brs" style="color: white;">Currency</th>
															<th class="width_2 text-center subTable-brs" style="color: white;">Rate</th>
															<!-- 												<th class="width_6 text-center subTable-brs">MEA Rate</th>
 -->
															<!-- <th class="width_6 text-center subTable-brs">WG Rate</th>
												<th class="width_8 text-center subTable-brs">From Place</th>
												<th class="width_8 text-center subTable-brs">To Place</th>
												<th class="width_6 text-center subTable-brs">Min Rate</th> -->
															<th class="width_2 text-center subTable-brs" style="color: white;">Terms</th>
															<!-- 												<th class="width_6 text-center subTable-brs">Real Amount</th>
 -->
															<th class="width_2 text-center subTable-brs" style="color: white;">Action</th>
														</tr>
														<tr
															ng-repeat="(bTrIndex, blcntrinnerDtl) in blcntrDtl.chargeList track by bTrIndex">
															<td class="subTable-brs text-center"><selectivity
								...
								<div class="row" id="items">
									...
									<table class="table table-striped b-t b-light">
										<thead>
											<tr>
												<th colspan=1 class="width_1">select</th>
												<th colspan=1 class="width_4 text-center">Charge Heads <span
													style="color: red;">*</span></th>
												<th colspan=1 class="width_2 text-center">Unit <span
													style="color: red;">*</span></th>
													<th colspan=1 class="width_1 text-center">Container Type <span
													style="color: red;"></span></th>
												<th colspan=1 class="width_3 text-center">Qty <span
													style="color: red;">*</span></th>
												<th colspan=1 class="width_3 text-center">Rate<span
													style="color: red;"></span></th>
												<th colspan=1 class="width_3 text-center">Currency<span
													style="color: red;">*</span></th>
													<th colspan=1 class="width_2 text-center">Traxsnasaction Type <span style="color: red;">*</span>
												</th>
												<th colspan=1 class="width_4 text-center">Buy/Sell Party <span
													style="color: red;">*</span></th>
													<th colspan=1 class="width_5 text-center">Notes<span style="color: red;">*</span></th>
