...
<%--                  <security:authorize access="hasRole('${form_code}_${modify}')">
 ...
 --%>          <td class=" td-actions text-center"><span><i  class="fa fa-pencil text-success text" data-toggle="tooltip" title="Edit"
										data-ng-click="editRow(item.blNo)"></i>
									</span>
									<span > 
               <i class="fa  fa-print text-primary text"  title="Print" data-ng-click="printBLOriginal(item.blNo)"></i>
...
<%-- 				</security:authorize>
 --%>            
             <!-- <td>
  <span> 
               				 <i class="fa  fa-print text-primary text" title="Print" data-ng-click="printBLCopy(item.blNo)"></i>
			 					 </span>
