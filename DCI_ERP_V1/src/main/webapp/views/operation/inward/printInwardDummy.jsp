				...
				<thead>
					...
					<tr class="description" style="font-size:10px;height:265px">
								...
								style=" border-bottom: 1px solid white"
									valign="top"><span >${hdr.marks}</span></td>
								<td class="fntSiz12px" align="left"
								style=" border-bottom: 1px solid white"
									valign="top"><span style="padding-left:5px">${hdr.pkgs}</span></td>
								<td  class="fntSiz12px" align="left"
								style=" border-bottom: 1px solid white"
									valign="top"><span >${hdr.goods}</span><br>
									</td>
								...
								<td class="fntSiz12px" align="left"
								style=" border-bottom: 1px solid white"
									valign="top"><span style="padding-left:5px">${hdr.messers}</span></td>
					...
					<tr>
								...
								<table style="width: 100%;height: 58px;">
									<tr>
										...
										<p class="fntSiz13px" style="margin-right: 5%;margin-bottom: 2%;" align="right">Signed for the Carrier FSCS LLC</p> 
