...
<div class="breadcrumb-wrapper ng-scope">
	...
	<div class="panel panel-default panel-default-list" st-persist="outWardTable"
                ...
                <td ng-if='!item.typeOfBl'>Normal BL - OBL</td>
                 <td ng-if='item.typeOfBl'>{{item.typeOfBl}} - OBL</td>
                  <td>{{item.issueDate}}</td>
                    <td>{{item.surrenderDate}}</td><td>{{item.status}}</td>
               <td class=" td-actions text-center"  ng-show="item.blNo !='' && item.blNo !=null">
               <span ng-if="item.status!='Approved'"> <i class="fa fa-pencil text-success text"
