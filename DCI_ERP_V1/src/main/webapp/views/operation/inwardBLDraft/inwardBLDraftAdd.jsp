					...
					<div class="col-md-12" style="margin-top: 1%; margin-bottom: 1%;">
						...
						<div class="col-md-4">
							<label class="control-label"> Place of Issue <span
								style="color: red;">*</span><span style="color: #23b7e5;padding-left: 95px;">(29)</span></label>
								<input class="form-control"
                ...
                friendly-name="Issue Place"></selectivity> -->
						...
						<div class="col-md-4">
							<label class="control-label">Date of Issue <span
								style="color: red;">*</span><span style="color: #23b7e5;padding-left: 95px;">(30)</span></label>
                ...
                friendly-name="FPOD" disabled="true"></selectivity>     
					...
					<div class="col-md-4">
							<label class="control-label">Display Vessel <span
								style="color: red;"></span><span style="color: #23b7e5;padding-left: 95px;">(12)</span></label> <input class="form-control"
					...
					<div class="col-md-4">
							<label class="control-label">Display POL <span
								style="color: red;"></span><span style="color: #23b7e5;padding-left: 95px;">(8)</span></label> <input class="form-control"
						...
						<div class="col-md-4">
							...
							<span
								...
								<label class="control-label">Port Of Discharge<span style="color: red;">*</span> <span style="color: #23b7e5;padding-left: 95px;">(9)</span></label>
								 <input class="form-control"
						...
						<div class="col-md-4">
							<!-- <label class="control-label">Display F.P.O.D <span
								...
								<label class="control-label">place Of Delivery/ Final Destination <span style="color: red;">*</span><span style="color: #23b7e5;padding-left: 95px;">(10)</span> </label>
								 <input class="form-control"
 ...
 <br> -->
				...
				<div class="col-md-4" >
							<label class="control-label">Destination Agent <span
								style="color: red;"></span><span style="color: #23b7e5;padding-left: 95px;">(31)</span></label>
					...
					<div class="col-md-4">
						...
						<div class="col-md-4">
							<label class="control-label">Freight Payable by <span
								style="color: red;"></span><span style="color: #23b7e5;padding-left: 95px;">(22)</span></label> <input class="form-control"
