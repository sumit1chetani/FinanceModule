...
Date <span
                     ...
                     <div class="col-sm-4 col-md-4">
                      <div class="form-group">
                        ...
                        <div class="col-md-6">
                           <selectivity list="costList1" id="costCenter"
...
<%-- 		<%@include file="/views/templates/panel-header-form.jsp"%>		
 --%>		</div>
        ...
        <table id="dt_basic" class="table   table-hover dataTable no-footer" role="" aria-describedby="dt_basic_info">
         <thead class="dataTables-Main-Head">
	      <tr style="border-bottom:2.1px solid green;">
...
<!-- 	         <th class="sorting" st-sort="narration">SA Name</th>
         ...
         <tbody class="dataTables-Main-Body">
	      <tr data-ng-class="$index % 2 == 0? 'even' : 'odd'" ng-repeat="objTranslationItem in displayedCollection" style="border:none;">
		     <td ng-if="objTranslationItem.toadd== true" style ="color:blue; border:none;">{{objTranslationItem.ledgerDate}}</td>
		     <td ng-if="objTranslationItem.toadd!= true" class="tbltop" style="background-color: #c3e3ef69; border-top: 1px solid green; ">{{objTranslationItem.ledgerDate}}</td>
	       
	         <td ng-if="objTranslationItem.toadd== true"style ="color:blue; border:none;">{{objTranslationItem.transactionNo}}</td>
	       	 <td ng-if="objTranslationItem.toadd!= true" style="background-color: #c3e3ef69; border-top: 1px solid green; ">{{objTranslationItem.transactionNo}}</td>
	       	 
 	       	<td ng-if="objTranslationItem.toadd== true" style ="color:blue; border:none;">{{objTranslationItem.costCentername}}</td>
 	       	<td ng-if="objTranslationItem.toadd!= true" style="background-color: #c3e3ef69; border-top: 1px solid green; "><span class="text-capitalize"> {{objTranslationItem.costCentername}}</span></td>
 	       	
 	       	
 	       <td ng-if="objTranslationItem.toadd== true" style ="color:blue; border:none;">{{objTranslationItem.userBy}}</td>
 	       <td ng-if="objTranslationItem.toadd!= true"  style="background-color: #c3e3ef69; border-top: 1px solid green;"><span class="text-capitalize">{{objTranslationItem.userBy}}</span></td>
...
<!--   <td></td> -->
	        ...
	        <td ng-if="objTranslationItem.toadd == true" > &nbsp;  &nbsp;&nbsp; &nbsp; To {{objTranslationItem.accountHeadCode}}</td>
	        <td ng-if="objTranslationItem.toadd != true" style ="background-color: #c3e3ef69;  border-top: 1px solid green; "> {{objTranslationItem.accountHeadCode}} </td>
	       	      
	        <td ng-if="objTranslationItem.toadd == true" class="text-capitalize" > &nbsp;&nbsp;&nbsp;&nbsp;<span class="text-capitalize">To  {{objTranslationItem.subGroupAddress2 | lowercase}}</span></td>
	       	<td ng-if="objTranslationItem.toadd!= true" class="text-capitalize" style ="background-color: #c3e3ef69; border-top: 1px solid green;"><span class="text-capitalize">{{objTranslationItem.subGroupAddress2 | lowercase}}</span></td>
...
<!-- 	       <td>{{objTranslationItem.subGroupName}}</td>
 -->
	      ...
	      <!--  <td>
	        ...
	        <td ng-if="objTranslationItem.toadd == true" align ="right">{{objTranslationItem.bcDebit|number:2}}</td>
	        <td ng-if="objTranslationItem.toadd != true" align ="right" style ="background-color: #c3e3ef69; border-top: 1px solid green; ">{{objTranslationItem.bcDebit|number:2}}</td>
	        
	         <td ng-if="objTranslationItem.toadd == true" align ="right" >{{objTranslationItem.bcCredit|number:2}}</td>
	          <td ng-if="objTranslationItem.toadd != true" align ="right" style ="background-color: #c3e3ef69; border-top: 1px solid green; ">{{objTranslationItem.bcCredit|number:2}}</td>
	     	</tr>
	     </tbody>
        </table>
        </div>
...
<footer class="panel-footer panel-footer-list">
    ...
    <div style=" padding-left:52%;">
					<div class="col-sm-12 col-md-4 col-lg-4" class="pull-right"
						style="width: 51%; padding-right: -6%;left: 400px;">
						<fieldset>
							<div class="form-group">
								<label class="col-md-5 control-label"
									style="font-size: 14px; font-weight: 500;"> <b>Total</b>
									 </label>
								<div class="col-md-7"
									style="font-size: 14px; padding-top: 7px; font-weight: 500;"><b>{{generalLedger.totalAmount|number:2}}</b></div>
							</div>
						</fieldset>
					</div>
					</div>
