...
<body>
	...
	<c:set var="object1" value="${adminExpenses}" />
	<c:set var="object2" value="${otherExpenses}" />
	<c:set var="object3" value="${salesRevenue}" />
	<c:set var="object4" value="${otherIncome}" />
	<c:set var="object5" value="${plList}" />
...
<%-- 	<c:set var="object2" value="${shipperDetails}" /> --%>
	<div id="content" style="margin-bottom: 10px;">
			...
			<tr>
				<td><br> 
						...
						<tr>
							<td width="50%" style="text-align: center;">
								...
								<table border="0" width="100%" cellpadding="0" cellspacing="0"
                                   ...
                                   <%-- <c:if test="${user.tenantId.contains('athena')}">
										<td width="75%" style="font-size: 14px;"><span style="text-align: center;"><b>ATHENA
											...
											style="text-align: right;" style="font-size: 12px;">${object1.branchAddress3}</span> <br> </td></c:if>
									<c:if test="${user.tenantId.contains('ATHENA')}">
										<td width="75%"><span style="text-align: right;"><b>ATHENA
													GLOBAL LOGISTICS PVT LTD</b></span> <br> <span
											style="text-align: right;">1009, THE
												AVENUE,INTERNATIONAL AIRPORT ROAD,OPP. THE LEELA, ANDHERI
												(EAST),MUMBAI-400 059. INDIA </span> <br> <span
											style="text-align: right;">CIN NO.
												U62200MH2014PTC252664 </span> <br> <span
											style="text-align: right;">Tel : +91 22 40356200 Fax :
												+91 22 40356210 </span></td></c:if> --%>
									</tr>
								</table>
							</td>
					...
					<table width=100% align="center" border="1" cellPadding="0"
						...
						<tr>
							<td><center>
									<font size="2" face="arial"><b>PROFIT AND LOSS</b></font>
								</center></td>
						</tr>
					</table> 
					
					  <table width=100%  ng-if="view"  width=80% align="center" border="1" cellPadding="0"
						cellSpacing="0" >
						 
		     <tr><!-- <td class="width_10" align="center" style="font-size: 10px;"><b>Group Code</b></td> -->
		    <td class="width_40" align="left" height="40"  style="font-size: 10px;" ><font size="2" face="arial"><b>INCOME</b></font></td>
		     <td class="width_40" align="left" height="40"style="font-size: 10px;"><font size="2" face="arial"><b></b></font></td>
		     </tr>
		  
		 <!--  <tr ng-click="toggleBlock('sales-record')"><th class=" width_50">Sales (Revenue) - ( A )</th>
		        <td class="text-center width_50 text-right">{{profitLoss.dSalesRevenueTotal | number:2}}</td></tr> -->
		        ...
		        <c:forEach var="ob"
								...
								varStatus="theCount">
							<tr >
								<td align="left"><c:out value="${ob.accountHeadName}" /><!-- object1.accountHeadName -->
								</td>
								<td align="right"><c:out value="${ob.amount}" /><!-- object1.amount -->
								</td>
		...
		<!-- <tr ng-click="toggleBlock('oi-record')"><th class=" width_50">Other Income - ( D )</th>
		        <th class="text-center width_50 text-right">{{profitLoss.dOtherIncome | number:2}}</th></tr> -->
		        ...
		        <tbody >
		         <c:forEach var="ob1"
								...
								varStatus="theCount">
							<tr >
								<td align="left"><c:out value="${ob1.accountHeadName}" /> 
								</td>
								<td align="right"><c:out value="${ob1.amount}" /> 
								</td>
		  ...
		  <tr>
		         <td class="width_10" align="left" height="30" style="font-size: 10px;"><font size="2" face="arial"><b>SUBTOTAL FOR INCOME</b></font></td>
		         <td align="right"><c:out value="${object5.dSalesRevenueTotal + object5.dOtherIncome}" /> </td>
		         </tr>
		  
		  
		   
		     <!-- <table width="100%"  border="1" style="float:left; padding-top:10px; padding-bottom:15px;"> -->
		     <tr><!-- <td class="width_10" align="center" style="font-size: 10px;"><b>Group Code</b></td> -->
		     <td class="width_10" align="left" height="30" style="font-size: 10px;"><font size="2" face="arial"><b>EXPENSES</b></font></td>
		     <td class="width_10" align="left" height="30" style="font-size: 10px;"><font size="2" face="arial"><b></b></font></td>
		     </tr>
		      <!-- <tr ng-click="toggleBlock('ae-record')"><th class=" width_50">Administrative Expenses - ( E )</th>
		        <th class="text-center width_50 text-right">{{profitLoss.dAdminExpense | number:2}}</th></tr> -->
		        ...
		        <c:forEach var="ob2"
								...
								varStatus="theCount">
							<tr >
								<td align="left"><c:out value="${ob2.accountHeadName}" />  
								</td>
								<td align="right"><c:out value="${ob2.amount}" /> 
								</td>
								
							</tr>
							</c:forEach>
						</tbody>
						<!-- <tr ng-click="toggleBlock('oe-record')"><th class=" width_50">Other Expenses - ( F )</th>
		        <th class="text-center width_50 text-right">{{profitLoss.dOtherExpense | number:2}}</th></tr> -->
		        ...
		        <tbody >
		         <c:forEach var="ob3"
							...
							<!-- <tr  ng-repeat="(trIndex, row) in profitLoss.lOtherExpense"> -->
								<td align="left"><c:out value="${ob3.accountHeadName}" />
								</td>
								<td align="right"><c:out value="${ob3.amount}" /> 
								</td>
						...
						<tr>
		         <td class="width_10" align="left" height="40" style="font-size: 10px;"><font size="2" face="arial"><b>SUBTOTAL FOR EXPENSES</b></font></td>
		         <td align="right"><c:out value="${object5.dAdminExpense + object5.dOtherExpense}" /></td>
		         </tr>
		         
		         <tr>
		         <td class="width_10" align="right" height="40" style="font-size: 10px;"><font size="2" face="arial"><b>Grand Total</b></font></td>
		         <td align="right"><c:out value="${object5.dSalesRevenueTotal + object5.dOtherIncome + object5.dAdminExpense + object5.dOtherExpense}" /></td>
		         </tr>
					...
					<table width="50%" style="float:left; padding-top:10px; padding-bottom:15px;"><tr>
							...
							<tr><td class="width_40"  style="font-size: 10px;"><b>PURCHASE INVOICE NO</b></td><td style="font-size: 10px;">: ${object1.purchaseInvoiceNo}</td></tr>
							 <tr><td class="width_40"  style="font-size: 10px;"><b>JOB NO</b></td><td style="font-size: 10px;">: ${object1.jobNo}</td></tr>
							<tr><td class="width_40" style="font-size: 10px;"><b>HBL NO</b></td><td style="font-size: 10px;">: ${object1.hbl}</td></tr>
							<tr><td class="width_40"  style="font-size: 10px;"><b>MBL NO</b></td><td style="font-size: 10px;">: ${object1.mbl}</td></tr>
							...
							<tr><td class="width_40"  style="font-size: 10px;"><b>SAILED DATE</b></td><td style="font-size: 10px;">: ${object1.sailedDate}</td></tr>
							<tr><td class="width_40"  style="font-size: 10px;"><b>ARRIVAL DATE</b></td><td style="font-size: 10px;">: ${object1.arrivalDate}</td></tr>	
							<tr><td class="width_40" style="font-size: 10px;"><b>VESSEL/VOYAGE</b></td><td style="font-size: 10px;">: ${object1.vessel}</td></tr>
						...
						<tr>
							<td><center>
									<font size="2" face="arial">YOUR ACCOUNT HAS BEEN
										CREDITED TOWARDS THE FOLLOWING CHARGES.</font>
								</center></td>
						</tr>
					</table> <br>
					<table class="table table-striped b-t b-light padding-top-10"
						...
						<table style="font-size: 12px;">
						    ...
						    <tr>
						    <td>Please issue all payment in favour off"MBK"</td>
						    </tr>
						</table>
					</table></td>
			</tr>
	...
	<div >
		<table style="font-size: 10px;" >
						    <tr><td>BANK DETAILS&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:&nbsp&nbsp${object1.branchName}</td> </tr>
							<tr><td>ADDRESS&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:&nbsp&nbsp${object1.branchAddress1}${object1.branchAddress2}${object1.branchZip}</td></tr>
							<tr><td>ACCOUNT NO &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:&nbsp&nbsp${object1.branchAccountNo}</td></tr>
							<tr><td>SWIFT CODE&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:&nbsp&nbspN/A</td></tr>
							<tr> <td>IFSC CODE&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:&nbsp&nbsp${object1.branchifsc}</td></tr>
		...
		<br> <font size="1" face="arial"><b>FOR MBK (ADMIN)</b></font><br><font size="1" face="arial"> Remarks :</font>
		<br><br><br>
