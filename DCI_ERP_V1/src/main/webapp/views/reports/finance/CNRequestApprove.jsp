 ...
 -->
					...
					<div class="col-sm-12 col-md-12 col-lg-6">
						<fieldset>
							...
							<!-- <div class="form-group" ng-if="cnReq.cnType=='P' ">
								<label class="col-md-4 control-label">CN Amount</label>
								<div class="col-md-5">
									<input type="text" class="form-control input-sm"
										name="cnamount" ng-model="cnReq.cnamount">
								</div>
							</div>
							<div class="form-group" ng-if="cnReq.cnType=='F' ">
								<label class="col-md-4 control-label">CN Amount</label>
								<div class="col-md-5">
									<input type="text" class="form-control input-sm"
										name="cnamount" ng-model="cnReq.cnamount" disabled>
								</div>
							</div> -->
