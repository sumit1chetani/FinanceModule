	...
	<div class="panel panel-default panel-default-form ">
					...
					<div class="col-sm-12 col-md-4 col-lg-4">
						<fieldset>
							<div class="form-group">
								...
								<div class="col-md-8">
									<select form-name="profitLossForm" friendly-name="Mode"
										id="customerType" multiple="multiple" name="customerType"
										ng-model="joborder.lCustomerType" validation="required"
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<selectivity list="jobStatusList" property="joborder.jobStatus"
										ng-model="joborder.jobStatus" name="jobStatus" id="jobStatus"
										friendly-name="job Status" form-name="jobOrderForm"></selectivity>
								</div>
							</div>
							<div class="form-group"
								ng-if="empId == 'E0006' || empId == 'E0020' || empId == 'A0001'">
								<label class="col-md-4 control-label"> Sales Person <span
								...
								<div class="col-md-8">
									<selectivity list="employeeList"
										...
										form-name="profitLossForm"></selectivity>
								</div>
							</div>
					...
					<div class="col-sm-12 col-md-4 col-lg-4">
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<select id="service" multiple="multiple" name="service"
										ng-model="joborder.lservice"
										ng-options="option.text for option in servicePartnerTypelist"
										data-dropdownmultiselect>
										<option data-ng-repeat="option in servicePartnerTypelist"
											value="{{getserviceId(option)}}"
											data-ng-bind-template="{{option.text}}"></option>
									</select>
      ...
      ng-options="option.text for option in customerList" data-dropdownmultiselect>    
        <option data-ng-repeat="option in customerList" value="{{getcustomer(option)}}" data-ng-bind-template="{{option.text}}"></option>
							...
							<div class="form-group">
								</label> <label class="col-md-4 control-label">From Date <span
									style="color: red;">*</span></label>

								<div class="col-md-8">
									<ng-bs3-datepicker data-ng-model="joborder.fromDate"
										name="fromDate" id="fromDate" friendly-name="From Date"
										form-name="profitLossForm" validation="required" />
									<label class="control-label text-left" id="fromDate"
										name="fromDate" data-ng-model="joborder.fromDate">{{joborder.fromDate}}</label>
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-md-4 control-label">To Date <span
									style="color: red;">*</span></label>
								<div class="col-md-8">
									<ng-bs3-datepicker data-ng-model="joborder.toDate"
										friendly-name="To Date" name="toDate" id="toDate"
										validation="required" form-name="profitLossForm" />
									<label class="control-label text-left" id="toDate"
										name="toDate" data-ng-model="joborder.toDate">{{joborder.toDate}}</label>
								</div>
							</div>
        ...
        <option data-ng-repeat="option in podList" value="{{getpodId(option)}}" data-ng-bind-template="{{option.pod}}"></option>
				...
				<div>
					<header id="btntoggle" data-role="heading"
						...
						<div class="row">
							<a style="color: #0a4190;">Report Header</a>
						</div>
					</header>
					<div data-role="content" class="form-horizontal panel"
						...
						<ul class="dragList row list-unstyled">
							<li class="col-md-3 col-sm-3 col-lg-3">
								<div class="row">
									<label class="control-label col-md-8" style="width: 63%">SELECT
										ALL :</label>
				...
				<div class="form-actions">
					<div class="row">
						<div class="col-md-12 ">
							...
							<button type="button" class="btn btn-success" tooltip="Print"
								ng-click="printProfitAndLoss(joborder,profitLossForm)">
							...
							<a id="prfitLosExpId" href="" download=""></a>
				...
				<div class="panel panel-default panel-default-list"
					...
					<div class="panel-body float-left padding-0" style="width: 100%;">
						<div class="table-responsive ">
							<table
								class="table table-striped table-hover dataTable no-footer table-padding-cls">
								...
								<tbody class="dataTables-Main-Body">
									<tr data-ng-class="$index % 2 == 0? 'even' : 'odd'"
										ng-repeat="joborder in displayedCollection">
										<td class="width_6 padding-number-align text-left "
											data-ng-repeat="column in messageHeaderList"
											data-ng-class={hide:(!column.visible)}><span>{{joborder[column.id]}}</span>
				...
				<div id="printableTableId" class="col-md-12" style="display: none;">
					...
					<div class="col-md-12">
						...
						<div class="col-md-9"
							style="width: 55%; float: left; text-align: center;">
							<h4>Profit and Loss</h4>
						</div>
					</div>

					<div class="panel panel-default panel-default-list"
						style="width: 100%; float: left; padding-top: 10px;"
							...
							<div class="table-responsive ">
								<table
									...
									<thead class="dataTables-Main-Head">
										<tr>
											<th class="width_6"
												data-ng-repeat="column in printMessageHeaderList"
												data-ng-class={hide:(!column.visible)}>{{column.title}}</th>
										</tr>
									</thead>
									<tbody class="dataTables-Main-Body">
										<tr data-ng-class="$index % 2 == 0? 'even' : 'odd'"
											ng-repeat="joborder in displayedCollection1">
											<td class="width_6 padding-number-align text-left "
												style="padding: 0px 0px !important; border-top: 1px solid #000;"
												data-ng-repeat="column in printMessageHeaderList"
												data-ng-class={hide:(!column.visible)}><span>{{joborder[column.id]}}</span>
