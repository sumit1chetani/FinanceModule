...
<div class="wrapper-md">
			...
			<tr>
				<td>
					<table border="0" class="padding-top-2" width="100%"
						...
						align="center">
						<div style="text-align:right"><span><i class="fa fa-close" style="font-size: 20px;cursor: pointer;" ng-click="closedialog()"></i></span></div>
						<tr>
							<td width="50%" style="text-align: center;    padding-right: 200px;">
								...
								<table border="0" width="100%" cellpadding="0" cellspacing="0"
									...
									<tr>
										<td width="25%"><img
											src="/img/{{tenantId}}HelpVideos/logo.jpg"
											style="padding: 10 0 0 10; height: 60px;"></td>
										<td width="75%" style="font-size:12px;"><span
											style="text-align: center;     text-transform: uppercase;"><center><b>{{tenantId}}
													GLOBAL LOGISTICS PVT LTD</b></center></span> 
													<%-- 								<span style="text-align: right;" ng-if="${user.tenantId} == unicon"><b>UNICON GLOBAL LOGISTICS PVT LTD</b></span> --%>
											<br>
    ...
    padding-bottom: 0.5em; font-family: arial;"><span
							...
							ng-repeat="detailObj1 in detailList">
						...
						<tr>
							<td colspan=1
								style="border-top: none !important; line-height: 145%; text-decoration: underline; text-transform: uppercase;padding-left: 22px; font-size: 12px; font-family: arial;"><b>FOR
									{{tenantId}} GLOBAL LOGISTICS PVT LTD </b></td>
							<td colspan=1 style="border-top: none !important"></td>
						</tr>
			...
			<div class="row">
			     <div class="col-sm-12 col-md-12 col-lg-12">			     
			      	<div class="form-actions m-b-none">			       
			       		<button class="btn btn-success" type="button" ng-click="sendmail(hdr.quotationId)">Send Mail</button>
