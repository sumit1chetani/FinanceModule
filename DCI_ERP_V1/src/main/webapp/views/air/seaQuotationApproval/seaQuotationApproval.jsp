					...
					<div class="col-sm-12 col-md-4 col-lg-4">
						<fieldset>
							...
							<div class="form-group ">
								<label class="col-md-5 control-label">Quotation No <span
...
<div class="form-group ">
				...
				<label style="padding-left: 14px;">{{quotation.term1}}</label>
						...
						<div class="" ng-repeat="link in quotation.files"><!-- (tIndex, filelist) --> 
								
											<div>{{$index+1}} ) <a ng-click="downloadNewFile($Index)" href="filePath/{{link.filename}}" download="" style="color:green">{{link.filename}}</a> 
											</div>
 ...
 -->							<th colspan=1 class=" width_6 text-center">Transaction Type </th>
						...
						<tbody ng-repeat="(trIndex, row) in quotation.quotationDtl"
							...
							<tr>
								...
								<td class=" width_9"><!-- <selectivity list="chargeHeadList" disabled="true"
								...
								<td class=" width_9">
									<!-- 	<selectivity list="UnitList"
										...
										name="unit" ng-model="row.unit" disabled="true"
					...
					<!-- 	<input type="text" class="form-control input-sm text-right"
										name="qty" 
										property="row.qty" id="qty{{trIndex}}" ng-model="row.qty" disabled="true"
							...
							<!-- 	<input type="text" class="form-control input-sm text-right"
										name="Qty" 
										property="row.rate" id="rate{{trIndex}}" ng-model="row.rate" disabled="true"
							...
							<label class="col-md-7 control-label  text-right">{{row.rate}}</label>	
								...
								<!-- <selectivity list="currencylist"
									...
									<!-- 		<td class=" width_10">
											<selectivity list="PaymentMethodList" disabled="true"
										...
										form-name="quotationForm" ></selectivity>
													<label class="col-md-7 control-label  text-right">{{row.paymentMethod1}}</label>	
										
										</td> -->
														<td class=" width_10">
														
														<!-- <selectivity list="transactionTypeList" disabled="true"
										...
										<label class="col-md-7 control-label  text-right">{{row.transactionType1}}</label>	
													...
													<!-- <selectivity list="serviceParnrDropList" disabled="true"
...
<table class="table table-striped b-t b-light" ng-if="checking==true">
						...
						<tbody ng-repeat="(trIndex, row) in quotation.consolidated"
							...
							<tr>
								<td class=" width_15">
									<label class="col-md-10 control-label  text-center">{{row.tranType}}</label>	
									</td>
									<td class=" width_5">
<!-- 									<label class="col-md-6 control-label  text-right">{{row.credit}}</label>	
 ...
 <input type="text" class="form-control input-sm text-right"
										name="credit" 
										property="row.credit" id="credit{{trIndex}}" ng-model="row.credit"
										friendly-name="{{ 'Row' + ($index+1) + '(credit)'}}" readonly />	</td>
										<td class=" width_5">
<!-- 									<label class="col-md-6 control-label  text-right">{{row.credit}}</label>	
 -->								
 <input type="text" class="form-control input-sm text-right"
										name="creditDays" 
										property="row.creditDays" id="creditDays{{trIndex}}" ng-model="row.creditDays"
										friendly-name="{{ 'Row' + ($index+1) + '(creditDays)'}}" readonly/>	</td>
							</tr>
						</tbody>
					</table>
				<!-- 	<button ng-click="addRow()" class="btn btn-sm btn-info"
				...
				<div class="row">
					...
					<button class="btn btn-success" type="button"
											...
											ng-click="approve(quotation.quotationNo,quotation.consolidated)">
											<i class=""></i> Approve
										</button>
