						...
						<table class="table table-striped b-t b-light">
							<thead>
								<tr>
									...
									<th colspan="1" class="width_7 text-center">KG/QT	<span
										style="color: red;"></span></th>
									<th colspan="1" class="width_12 text-center">Commodity<span style="color: red;"></span>
									</th>
									...
									<th colspan="1" class="width_7 text-center">Gross Weight<span
										style="color: red;"></span></th>
									<th colspan="1" class="width_7 text-center">Chargebale
										Weight<span style="color: red;"></span>
									</th>
									<th colspan="1" class="width_7 text-center">Rate/Charge<span
										style="color: red;"></span></th>
									<th colspan="1" class="width_7 text-center">Amount<span
										style="color: red;"></span></th>
							...
							<tbody
								...
								<tr style="background-color: {{jobOrderDtl.color}};">
									...
									<td><!-- <selectivity list="commodityList"
									...
									<!-- 	<input type="text" class="form-control input-sm"
										...
										friendly-name="commodity" disabled=true/> -->
														...
														<label class="col-md-7 control-label view-content"> {{jobOrderTrackingDtl.commodity}}</label>							
									...
									<!-- <textarea  type="text" class="form-control input-sm"
											...
											<label class="col-md-7 control-label view-content"> {{jobOrderTrackingDtl.descriptionGoods}}</label>							
									...
									<!-- <selectivity list="uomList"
											...
											ng-model="jobOrderTrackingDtl.uom" name="uom" disabled=true></selectivity> -->
																		<label class="col-md-7 control-label view-content"> {{jobOrderTrackingDtl.uom}}</label>				
									</td>
									...
									<td><!-- <input type="text"
										...
										name="length{{trIndex1}}" disabled=true> -->
									<label class="col-md-7 control-label view-content"> {{jobOrderTrackingDtl.length}}</label>				
										</td>
									...
									<!-- <input type="text"
										...
										name="width{{trIndex1}}" disabled=true > -->
										
																	<label class="col-md-7 control-label view-content"> {{jobOrderTrackingDtl.width}}</label>			
										</td>
									...
									<!-- <input type="text"
										...
										name="height{{trIndex1}}" disabled=true> -->
							<label class="col-md-7 control-label view-content"> {{jobOrderTrackingDtl.height}}</label>				
										</td>
									...
									<!-- <input type="text"
										...
										name="noOfPcs{{trIndex1}}" disabled=true> -->
												<label class="col-md-7 control-label view-content"> {{jobOrderTrackingDtl.noOfPieces}}</label>						
										</td>
									...
									<label class="col-md-7 control-label view-content"> {{jobOrderTrackingDtl.netWeight}}</label>	
									...
									<!-- <input type="text"
										...
										name="length{{trIndex1}}" disabled=true> -->
													<label class="col-md-7 control-label view-content"> {{jobOrderTrackingDtl.grossWeight}}</label>						
									...
									<!-- <input type="text"
										...
										name="chargeableWeight{{trIndex1}}" disabled=true> -->
								<label class="col-md-7 control-label view-content"> {{jobOrderTrackingDtl.chargeableWeight}}</label>						
										
										</td>
									<td>
									<!-- <input type="text"
										class="form-control input-sm text-right" id="rate{{trIndex1}}"
										ng-model="jobOrderTrackingDtl.rate" name="rate{{trIndex1}}" disabled=true> -->
										
																	<label class="col-md-7 control-label view-content"> {{jobOrderTrackingDtl.rate}}</label>	
									...
									<!-- <input type="text"
										...
										name="amount{{trIndex1}}" disabled=true> -->
									<label class="col-md-7 control-label view-content"> {{jobOrderTrackingDtl.amount}}</label>	
										</td>
									<!-- <td><textarea  type="text" class="form-control input-sm"
                             ...
                             <div class="form-group col-md-3 col-lg-3">
									...
									<div class="col-md-7">
										<!-- <input
												...
												readonly> -->
							<label class="col-md-7 control-label view-content"> {{joborder.joborderTracking.totalPcs}}</label>							
								...
								<div class="form-group col-md-3 col-lg-3">
									...
									<div class="col-md-7">
										<!-- <input
												...
												readonly> -->
										<label class="col-md-7 control-label view-content"> {{joborder.joborderTracking.totalNetWeight}}</label>										
								...
								<label class="col-md-7 control-label view-content"> {{joborder.joborderTracking.totalGrosssWeight}}</label>				
								...
								<div class="form-group col-md-3 col-lg-3">
									...
									<div class="col-md-7">
										<!-- <input
												...
												readonly> -->
												<label class="col-md-7 control-label view-content"> {{joborder.joborderTracking.totalAmount}}</label>						
									...
									<div class="row">
										<div class="col-md-12">
											...
											<!-- <button class="btn btn-success"
												ng-click="updateJob(jobOrderForm)" ng-if="isEdit">
