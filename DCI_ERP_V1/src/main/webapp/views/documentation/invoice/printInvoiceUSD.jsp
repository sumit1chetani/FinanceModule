...
">
			...
			<th class="fntSiz10px"
				style="height: 18px; border-left: 1px dotted; text-align: center; font-weight: bold;width: 15%;">Amount(USD)</th>
		</tr>
 ...
 --%>
		...
		<tr>
         ...
         groupingUsed = "false" value = "${subTotal}" /> --%>
			...
			<c:if test="${hdr.currency != 'INR'}">
			<td class="fntSiz10px"
				style="height: 25px; border-left: 1px dotted; border-top: 1px dotted; font-weight: bold; text-align: right;">USD
		...
		<tr>
			...
			<!-- <td class="fntSiz10px"
				style="height: 40px; border-left: 1px dotted; width: 14%; border-top: 1px dotted;">
			</td>
			<td class="fntSiz10px"
				style="height: 40px; border-left: 1px dotted; border-top: 1px dotted;">
			</td>
			<td class="fntSiz10px"
				style="height: 40px; border-left: 1px dotted; border-top: 1px dotted;">
			</td> -->
		...
		<tr>
			<td class="fntSiz10px" colspan='3'
				...
				<c:if test="${hdr.currency == 'INR'}">  IFSC Code:</c:if> <c:if
					test="${hdr.currency != 'INR'}">  IBAN Code:</c:if>
