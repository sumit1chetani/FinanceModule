        ...
        <div class="row">
         <div class="col-sm-12 col-md-10 col-lg-10">
          ...
          <div class="form-group" >
			   <label class="col-md-4 control-label">Item Name<spring:message
				...
				<selectivity list="itemList" 
					...
					<div class="form-group"  >
			   <label class="col-md-4 control-label">UOM<spring:message
			   		code="label.asterisk.symbol"></spring:message></label>
			   	<div class="col-md-8">
          ...
          <%--  <div class="form-group">
			...
			<div class="form-group">
	           	<label class="col-md-4 control-label">Available Quantity<spring:message
			              			code="label.asterisk.symbol"></spring:message> </label>
	           	<div class="col-md-8">
			...
			<div class="form-group">
	           	<label class="col-md-4 control-label"> Quantity<spring:message
			              			code="label.asterisk.symbol"></spring:message> </label>
	           	<div class="col-md-8">
