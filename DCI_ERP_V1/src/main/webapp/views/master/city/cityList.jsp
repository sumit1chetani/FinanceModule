				...
				<table class="table table-striped table-hover dataTable no-footer">
					...
					<thead style="background-color: #e2e2e2;">
						<tr>
							...
							<!--        </label></th> -->
							<th class="sorting width_30" st-sort="code">City Code</th>
							<th class="sorting width_35" st-sort="name">City Name</th>
							<th class="sorting width_30" st-sort="pin">Zip/Postal Code</th>
							<th class="sorting width_30" st-sort="stateName">State Code</th>
							<th class="sorting width_30" st-sort="description">Description</th>
...
<th class="sorting width_30" >Action</th>						</tr>
					</thead>
...
<%-- 							 <security:authorize access="hasRole('${form_code}_${view}')"> 
 --%>							 <a ng-click="view(objGroupHeadItem.cityid)">
...
<%-- 		        </security:authorize>
 --%>		         </a>
							...
							<td class="sorting" data-toggle="tooltip"
												title="{{objGroupHeadItem.cityName}}">{{objGroupHeadItem.pin}}</td>
								<td class="sorting" data-toggle="tooltip"
												title="{{objGroupHeadItem.cityName}}">{{objGroupHeadItem.stateName}}</td>
													<td class="sorting" data-toggle="tooltip"
												title="{{objGroupHeadItem.cityName}}">{{objGroupHeadItem.description}}</td>
							<td class="sorting" data-toggle="tooltip"
...
<%-- 							 <security:authorize
 ...
 --%>									<span> <i class="fa fa-pencil text-success text" data-toggle="tooltip" title="Edit"
										data-ng-click="editRow(objGroupHeadItem.cityid)"></i>
									</span>
<%-- 								</security:authorize>  <security:authorize access="hasRole('${form_code}_${delete}')"> 
 --%>									<span> <i class="fa fa-trash-o text-danger-dker text" data-toggle="tooltip" title="Delete"
										data-ng-click="deleteRow(objGroupHeadItem.cityid)"></i>
									</span>
<%-- 								 </security:authorize>
 --%>								 </td> 
						</tr>
