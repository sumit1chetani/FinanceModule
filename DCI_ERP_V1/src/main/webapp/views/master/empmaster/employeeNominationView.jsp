				...
				<div class="panel panel-default panel-default-form">
												...
												<div class="form-group">
													...
													<div class="col-md-5 inputGroupContainer">
														<input type="text" class="form-control input-sm"
															...
															friendly-name="Name" name="Name" maxlength="20" disabled
												...
												<div class="form-group ">
													...
													<div class="col-md-5">
														<select class="form-control journalVoucher-textBox"
															...
															friendly-name="Gender" name="Gender" disabled
					...
					<!-- 							<div class="form-group">
												...
												<div class="form-group">
													...
													<div class="col-md-5 inputGroupContainer">
														<input type="text" class="form-control input-sm"
															name="nominateOccupation" maxlength="20" disabled
												...
												<div class="form-group">
													...
													<div class="col-md-5 inputGroupContainer">
														<input type="text" class="form-control input-sm"
															name="nominateRelationship" maxlength="20" disabled
												...
												<div class="form-group">
													...
													<div class="col-md-5 inputGroupContainer">
														<input type="text" class="form-control input-sm"
															name="nominateEmail" maxlength="50" disabled
											...
											<div class="col-sm-6 col-md-6 col-lg-6"">
												...
												<div class="form-group">
													...
													<div class="col-md-5 inputGroupContainer">
														<input type="text" class="form-control input-sm"
															data-message-id="aadharno2"  disabled
												...
												<div class="form-group">
													...
													<div class="col-md-5 inputGroupContainer">
														<input type="text" class="form-control input-sm"
															name="nominatePlace" maxlength="20" disabled
												...
												<div class="form-group">
													...
													<div class="col-md-5 inputGroupContainer">
														<input type="text" class="form-control input-sm"
															name="nominatePincode" maxlength="10" disabled
												...
												<div class="form-group">
													...
													<div class="col-md-5 inputGroupContainer">
														<input type="text" class="form-control input-sm"
															name="nominatePincode" maxlength="70" disabled
