									...
									<div class="col-sm-12 col-md-10 col-lg-10">
										<fieldset>
												...
												<label class="col-md-6 control-label">Qualification
													<div class="col-md-6">
														<input type="text"
															...
															name="qualification" validation="required"
															friendly-name="Qualification" disabled
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input type="text" ng-model="employeeEducation.institution" disabled
											...
											<div class="form-group">
												...
												<div class="col-md-5">
													...
													<select class="form-control journalVoucher-textBox w-sm" disabled
