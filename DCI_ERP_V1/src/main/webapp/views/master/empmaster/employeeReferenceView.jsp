								...
								<div class="row">
									<div class="col-sm-12 col-md-12 col-lg-12 padding-top-10">
										<div class="form-group">
											...
											<div class="col-md-5 inputGroupContainer">
												<input type="text" class="form-control input-sm"
													name="Name Ref" data-message-id="referenceName" disabled
										...
										<div class="form-group">
											...
											<div class="col-md-5 inputGroupContainer">
												<input type="text" class="form-control input-sm"
													name="occupationRef" maxlength="20" disabled
										...
										<div class="form-group">
											...
											<div class="col-md-5 inputGroupContainer">
												<input type="text" class="form-control input-sm"
													name="relationshipRef" maxlength="20" disabled
										...
										<div class="form-group">
											...
											<div class="col-md-5 inputGroupContainer">
												<textarea ng-model="EmployeeMasterDataRef.referenceAddress"
													name="referenceAddress" disabled
										...
										<div class="form-group">
											...
											<div class="col-md-5 inputGroupContainer">
												<input type="text" class="form-control input-sm"
													maxlength="10" name="pincodeRef" disabled
										...
										<div class="form-group">
											...
											<div class="col-md-5 inputGroupContainer">
												<input type="text" class="form-control input-sm"
													maxlength="20" name="emailRef" disabled
