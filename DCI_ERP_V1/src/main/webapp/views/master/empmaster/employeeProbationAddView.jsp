									...
									<div class="col-sm-12 col-md-12 col-lg-12">
											...
											<div class="form-group">
												...
												<div class="col-md-5">
													<ng-bs3-datepicker
														...
														id="Probation From" name=" Probation From " disabled
											...
											<div class="form-group">
												...
												<div class="col-md-5 inputGroupContainer">
													<input type="text" class="form-control input-sm"
														name="extend" data-message-id="extend" disabled
												...
												<div class="col-md-5">
													<div class="checkbox">
														<label> <input type="checkbox"
															class="checkbox style-0" disabled
										...
										<div class="col-sm-6 col-md-6 col-lg-6">
											...
											<div class="form-group">
												...
												<div class="col-md-5 inputGroupContainer">
													<input type="text" class="form-control input-sm"
														name="duration" data-message-id="duration" disabled
													...
													<div class='input-group date datetimepick'>
														<div class="dropdown" style="margin-top: -18px;">
															...
															<ul class="dropdown-menu" role="menu"
																...
																<datetimepicker 
																	data-ng-model="EmployeeMasterDataProbation.frmBreakPro" disabled
													...
													<div class='input-group date datetimepick'>
														<div class="dropdown" style="margin-top: -18px;">
															...
															<ul class="dropdown-menu" role="menu"
																aria-labelledby="dLabel">
																<datetimepicker
																	data-ng-model="EmployeeMasterDataProbation.toBreakPro" disabled
													...
													<div class='input-group date datetimepick'>
														<div class="dropdown" style="margin-top: -18px;">
															...
															<ul class="dropdown-menu" role="menu"
																aria-labelledby="dLabel">
																<datetimepicker
																	data-ng-model="EmployeeMasterDataProbation.completion" disabled
