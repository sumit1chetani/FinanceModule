				...
				<table class="table table-striped table-hover dataTable no-footer">
					...
					<thead style="background-color: #e2e2e2;">
						<tr>
							...
							<th class="sorting width_30" st-sort="groupName">Group Code</th>
														<th class="sorting width_30" st-sort="pName">Purchase Ledger Name</th>
														<th class="sorting width_30" st-sort="sName">Sales Ledger Name</th>
					...
					<tbody class="dataTables-Main-Body">
						<tr data-ng-class="$index % 2 == 0? 'even' : 'odd'"
							ng-repeat="objGroupHeadItem in displayedCollection">
							 ...
							 <a ng-click="view(objGroupHeadItem.id)">
		             <span tooltip="{{objGroupHeadItem.code}}" class="tool-tip-span font-blue">{{objGroupHeadItem.code}}</span>
							...
							<td class="sorting" data-toggle="tooltip"
												title="{{objGroupHeadItem.groupName}}">{{objGroupHeadItem.groupName}}</td>
												
																	<td class="sorting" data-toggle="tooltip"
												title="{{objGroupHeadItem.pName}}">{{objGroupHeadItem.pName}}</td>	
																			<td class="sorting" data-toggle="tooltip"
												title="{{objGroupHeadItem.sName}}">{{objGroupHeadItem.sName}}</td>	
												<td class="sorting" data-toggle="tooltip"
...
<td class="sorting" data-toggle="tooltip"
							...
							<td class=" td-actions text-center"> <security:authorize
									...
									<span> <i class="fa fa-pencil text-success text" data-toggle="tooltip" title="Edit"
										data-ng-click="editRow(objGroupHeadItem.id)"></i>
									</span>
									...
									<span> <i class="fa fa-trash-o text-danger-dker text" data-toggle="tooltip" title="Delete"
										data-ng-click="deleteRow(objGroupHeadItem.id)"></i>
									</span>
