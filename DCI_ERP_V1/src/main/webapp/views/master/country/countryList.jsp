				...
				<table class="table table-striped table-hover dataTable no-footer">
					...
					<thead style="background-color: #e2e2e2;">
						<tr>
							...
							<!--        </label></th> -->
							<th class="sorting width_30" st-sort="code">Country Code</th>
							<th class="sorting width_35" st-sort="name">Country Name</th>
							<th class="sorting width_30" st-sort="regionName">Region Code</th>
				 ...
				 <tbody class="dataTables-Main-Body">
						<tr data-ng-class="$index % 2 == 0? 'even' : 'odd'"
							ng-repeat="objGroupHeadItem in displayedCollection">
							 ...
							 <a ng-click="view(objGroupHeadItem.countryid)">
...
<%-- 		        </security:authorize>
 --%>		         </a>
							...
							<td class="sorting" data-toggle="tooltip"
												title="{{objGroupHeadItem.regionName}}">{{objGroupHeadItem.regionName}}</td>
							<td class="sorting" data-toggle="tooltip"
												title="{{objGroupHeadItem.regionName}}">{{objGroupHeadItem.description}}</td>
							...
							<td class=" td-actions text-center"> 
									...
									<span> <i class="fa fa-pencil text-success text" data-toggle="tooltip" title="Edit"
										data-ng-click="editRow(objGroupHeadItem.countryid)"></i>
									</span></button>
								<button><span> <i class="fa fa-trash-o text-danger-dker text" data-toggle="tooltip" title="Delete"
										data-ng-click="deleteRow(objGroupHeadItem.countryid)"></i>
									</span>
								 </button></td> 
						</tr>
					</tbody>
