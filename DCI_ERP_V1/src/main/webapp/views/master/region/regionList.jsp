					...
					<thead style="background-color: #e2e2e2;">
						<tr>
							...
							<th class="sorting width_35" st-sort="name"> Name</th>
														...
														<th class="sorting width_35" st-sort="mdyDate">  Modified Date</th>
																					<th class="sorting width_35" st-sort="isActive"> Active</th>
					...
					<tbody class="dataTables-Main-Body">
						<tr data-ng-class="$index % 2 == 0? 'even' : 'odd'"
							ng-repeat="objGroupHeadItem in displayedCollection">
							 ...
							 <a ng-click="view(objGroupHeadItem.regionid)">
...
<td class="sorting" data-toggle="tooltip"
												...
												<td class="sorting" data-toggle="tooltip"
												title="{{objGroupHeadItem.mdfyBy}}">{{objGroupHeadItem.mdyBy}}</td>
												<td class="sorting" data-toggle="tooltip"
												title="{{objGroupHeadItem.mdfyDate}}">{{objGroupHeadItem.mdyDate}}</td>
							<td class="sorting" data-toggle="tooltip"
							...
							<td class=" td-actions text-center"> <security:authorize
									...
									<span> <i class="fa fa-pencil text-success text" data-toggle="tooltip" title="Edit"
										data-ng-click="editRow(objGroupHeadItem.regionid)"></i>
									</span>
									...
									<span> <i class="fa fa-trash-o text-danger-dker text" data-toggle="tooltip" title="Delete"
										data-ng-click="deleteRow(objGroupHeadItem.regionid)"></i>
									</span>
