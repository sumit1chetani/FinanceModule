...
<!-- 									<button class="btn btn-primary" type="button"  
 ...
 -->           						
									<button class="btn btn-primary" type="button"  
										class="btn btn-primary" data-ng-click="fileUpload()">
										<i class="fa fa-file"></i>Upload Customer Details
									</button>
									<div class="excel"></div>
									 <a id="tbPdfExport" type="display:none" href="assets/docs/SampleCustomerMaster.xlsx" download="SampleCustomerMaster.xlsx"></a>
           						</div>
			...
			<div class="table-responsive" style=" border: 1px solid #CCC;">
				<table class="table table-striped table-hover dataTable no-footer">
					...
					<thead style="background-color: #e2e2e2;">
						<tr>
							<th class="sorting width_4" st-sort="id">Customer ID</th>
						
							<th class="sorting width_4" st-sort="servicePartnerCode">Code</th>
							<th class="sorting width_6" st-sort="servicePartnerName">Name</th>
							<!-- <th class="sorting width_5" st-sort="servicePartnerLedgerName">Ledger
								Name</th> -->
						<!-- 	<th class="sorting width_3" st-sort="region">Region</th> -->
							<th class="sorting width_5" st-sort="gSTNNo">GST NO</th>

							<th class="sorting width_3" st-sort="cityName">City Code</th>
							<th class="sorting width_5" st-sort="defaultTypeName">Type</th>
							<th class="sorting width_3" st-sort="branchName">Branch</th>
							<th class="sorting width_3" st-sort="salesPerson">Sales Person</th>
					<!-- 		<th class="sorting width_4" st-sort="modifiedBy">Modified By</th>
							<th class="sorting width_3" st-sort="modifiedDate">Modified Date</th> -->
							<th class="width_3">Active</th>

							<th class="width_3 text-center table-heading">Action</th>
						</tr>
					</thead>
					...
					<tbody class="dataTables-Main-Body">
						...
						<tr data-ng-class="$index % 2 == 0? 'even' : 'odd'"
							...
							<td class="sorting" > <a ng-click="view(objItem.servicePartnerId)"> 
