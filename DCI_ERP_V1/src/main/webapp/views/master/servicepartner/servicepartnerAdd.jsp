		...
		<form name="servicePartnerForm" method="post" class="form-horizontal"
			...
			<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-md-7">
								...
								<label class="i-checks m-b-none checkbox"> <input
									type="checkbox" data-bind="checked: servicePartner.active"  property="servicePartner.active" name="Active"
				...
				<div class="row pl2pc pr10pc">
					...
					<div class="col-md-4" ng-if="check==true">
						<div class="form-group">
							<label class="col-md-5 control-label">Email ID<span
								style="color: red;"></span></label>
							<div class="col-md-7">
								<input type="text" class="form-control input-sm"
									property="servicePartner.emailId" maxlength=50
									data-ng-model="servicePartner.emailId" name="Email" ng-blur="ValidateEmail(servicePartner.emailId)"
									friendly-name="Email" />
							</div>
						</div>
					</div>
						...
						<div class="form-group">
							...
							<div class="col-md-7">
								<input type="text" class="form-control input-sm"
									property="servicePartner.emailId" maxlength=50
									data-ng-model="servicePartner.emailId" name="Email" ng-blur="ValidateEmail(servicePartner.emailId)"
									validation="required" friendly-name="Email" />
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row pl2pc pr10pc">
					...
					<div class="col-md-4"  ng-if="servicePartner.sundryStatus!=20010003 && servicePartner.sundryStatus!=10080002">
						<div class="form-group">
							<label class="col-md-5 control-label">GSTN State Code<span
								style="color: red;">*</span></label>
							<div class="col-md-7">
								<selectivity list="gstnStateList"
									property="servicePartner.gSTNStateCode"
									data-ng-model="servicePartner.gSTNStateCode"
									name="GSTN State Code" form-name="servicePartnerForm" validation ="required"
				...
				<div class="row pl2pc pr10pc">
					...
					<div class="form-group" >
						...
						<!-- <div class="form-group" ng-if="servicePartner.defaultTypeCheck==false && servicePartner.defaultType==4">
							<label class="col-md-5 control-label">Sales Person<span
								style="color: red;">*</span></label>
							<div class="col-md-7">
								<selectivity list="employeeList"
									property="servicePartner.salesPerson"
									validation="required" data-ng-model="servicePartner.salesPerson"
									 name="Sales Person"
									form-name="servicePartnerForm" friendly-name="Sales Person">
								</selectivity>
					...
					<div class="col-md-4" ng-if="check==true && servicePartner.sundryStatus!=20010003">
						<div class="form-group">
					...
					<div class="col-md-4" ng-if="check!=true && servicePartner.sundryStatus!=20010003">
						<div class="form-group">
							<label class="col-md-5 control-label">GSTN No<span style="color:red;">*</span></label>
							<div class="col-md-7">
								<input type="text" class="form-control input-sm"
									property="servicePartner.gSTNNo" maxlength=15
									data-ng-model="servicePartner.gSTNNo" name="GSTN No"
									validation="required" friendly-name="GSTN No" />
							</div>
						</div>
					</div>
					<div class="col-md-4">
			...
			<div class="panel-body float-left padding-0" style="width: 100%;">
				<div class="table-responsive" style="overflow: hidden;">
					<header id="btntoggle" data-role="heading"
						...
						<div class="row">
							<a style="color: black;">Customer Type</a>
						</div>
					</header>
				</div>
			</div>
						...
						<div class="row">
							...
							<div class="col-md-4">
								<label class="i-checks m-b-none checkbox"> <input
									...
									data-ng-model="column.visible" ng-click="visi(column.id,column.visible)"/><i></i>
								</label>
							</div>
				...
				<table class="table table-striped b-t b-light">
					<thead>
						...
						<th class="sorting width_1">Select</th>
							<th class="sorting width_2 text-center table-heading">Contact Name</th>
							<th class="sorting width_3" text-center table-heading>Designation</th>
							<th class="sorting width_3 text-center table-heading">Email</th>

							<th class="sorting width_2 text-center table-heading">Landline
								No</th>

							<th class="sorting width_2 text-center table-heading">Mobile No
							</th>
