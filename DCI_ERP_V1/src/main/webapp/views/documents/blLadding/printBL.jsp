			...
			<tbody style="line-height: 5px;">
				<tr class="wid50pr" style="vertical-align: text-bottom;">
					...
					<span class="bold fntSiz10px" style="padding-left: 5px">
							consignor</span> <!-- <span class="fontsizeForNum"
					...
					<br>
					<span class="bold fntSiz10px" style="padding-left: 5px">
							Consignee (or order)</span> <!-- <span class="fontsizeForNum"
						style="float: right; margin-top: -5px;">3</span> -->
						<div class="" style="padding-left: 5px">
							<p class="fntSiz12px"
					...
					<br>
						...
						style="padding-left: 5px; padding-left: 5px"> Notify Address</span>
...
<td class="wid50pr" style="vertical-align: text-bottom;">
					...
					<p style ="padding-left:20px; font-size:13px; "><br><b>Multimodal Transport Document </b><br>
									<br><br><span style ="padding-right:10px; font-size:12px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;REG. No :${hdr.blNo}</span>
								</p>
						<hr class="hrLine">
						
					
					<p style ="padding-left:20px; font-size:13px; "><span style ="padding-right:10px; font-size:12px">MTD Number</span></p>
...
<td style="    border-top: 0px; border-right: 0px;  colspan="2"  border-left: 0px;">
							...
							<tr class="wid50pr" style="vertical-align: text-bottom;">
								<td style="    border-top: 0px; border-right: 0px; border-bottom: 0px;   border-left: 0px;">
									<div class="bold fntSiz10px table-body-cell"
										...
										<p class="fntSiz12px"
											style="font-weight: normal; padding-left: 5px;">${hdr.disPor}</p>
									</div>
								</td>
				...
				<tbody style="font-size: 10px;">
					<c:forEach var="detailObj1" items="${ConListOverFlow}">
						<tr style="height: 8px !important;">
							...
							<td class=" "
								style="border-bottom: 1px solid white; font-size: 8px; padding-left: 5px;"
							...
							<span style="padding: 0px; margin: 0px;">${contCount.contCount} X ${contCount.conType}</span> <br>
								...
								<span style="padding: 0px; margin: 0px;font-size: 7px;">${hdr.marks}</span>
								</td>
							<td class=" "
								style="border-bottom: 1px solid white; padding: 0px; margin: 0px; font-size: 8px; padding-left: 5px;"
								...
								<b>Particulars above furnished by consignor/consignee</b>
								</div>
								</div>
								</td>
							...
							<td class=" "
								style="border-bottom: 1px solid white; padding: 0px; margin: 0px; font-size: 8px; padding-left: 5px;"
								valign="top"><div class="main"><span>${detailObj1.g_wgt}</span></div> <c:set
									var="string3" value="Net Weight : ${detailObj1.nwgt}" /> <c:out
									value="${empty detailObj1.nwgt ? '' :  string3}" /></td>
							<td class=" "
								style="border-bottom: 1px solid white; padding: 0px; margin: 0px; font-size: 8px; padding-left: 5px;"
								valign="top"><div class="main"><span>${detailObj1.cbm}</span></div></td>
    ...
    word-break: break-all;"
						class="wid18pr"><span style="font-size: 9px;"><b>Freight Amount
								</b> </span><!-- <span class="fontsizeForNum" style="float: right;">31</span> -->
						<br>
					<span style="font-size: 8px;">${hdr.address}</span></td>
					...
					<!-- <span style="font-size: 13px;"><b>Cordelia Container
						...
						<p style="" class="signbehalf">
							<span style="font-size: 13px;">${hdr.polAgent}</span><br>
							<span style="font-size: 9px;">As Agent </span>
						</p></td>
						<td rowpan="3"
						style="vertical-align: text-top; border-bottom: 1px solid #333; font-size: 10px;width: 27% !important;
    word-break: break-all;"
						class="wid18pr"><span style="font-size: 9px;"><b>Number of Original MTD (s)
								</b> </span><!-- <span class="fontsizeForNum" style="float: right;">31</span> -->
						<br>
					<span style="font-size: 8px;">${hdr.address}</span></td>
					<td rowpan="3"
						style="vertical-align: text-top; border-bottom: 1px solid #333; font-size: 10px;width: 27% !important;
    word-break: break-all;"
						class="wid18pr"><span style="font-size: 9px;"><b>Place and date of issue
								</b> </span><!-- <span class="fontsizeForNum" style="float: right;">31</span> -->
						<br>
					<span style="font-size: 8px;">${hdr.address}</span></td>
</tr>
<tr>
					<td colspan="4"
						style="vertical-align: text-top; border-bottom: 1px solid #333; font-size: 10px;width: 27% !important;
    word-break: break-all;"
						class="wid18pr"><span style="font-size: 9px;"><b>Other Particulars (if any)
								Agent</b> </span><!-- <span class="fontsizeForNum" style="float: right;">31</span> -->
						<br>
					<span style="font-size: 8px;">${hdr.address}</span></td>
