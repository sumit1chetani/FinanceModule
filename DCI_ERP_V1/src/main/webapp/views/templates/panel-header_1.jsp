...
<security:authorize access="hasRole('${form_code}_${assetcost}')" var="isAssetCost" />
<security:authorize access="hasRole('${form_code}_${assetcontract}')" var="isAssetContract" />
