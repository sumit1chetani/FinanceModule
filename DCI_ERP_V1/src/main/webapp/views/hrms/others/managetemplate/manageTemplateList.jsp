 ...
 --%>								</div>
								<table id="dt_basic"
									...
									<thead class="dataTables-Main-Head">
										<tr>
											<th class="sorting width_12" data-st-sort="companyId">Template ID</th>
											<th class="sorting width_12" data-st-sort="branch">Template Name
												</th>
											<th class="sorting width_15" data-st-sort="holiday">Valid From
											</th>
											<th class="sorting width_15" data-st-sort="holiday">Valid Till
											</th>
											<th class="sorting width_15" data-st-sort="holiday">Designation
											</th>
									...
									<tbody class="dataTables-Main-Body">
										<tr data-ng-class="$index % 2 == 0? 'even' : 'odd'"
											...
											<td>{{disciplinaryCollection.template_id}}</td>
											<td>{{disciplinaryCollection.template_name}}</td>
											<td>{{disciplinaryCollection.valid_from}}</td>
											<td>{{disciplinaryCollection.valid_to}}</td>
											...
											<td><%-- <security:authorize
													...
													<span> <i class="fa  fa-pencil text-success text"
														data-ng-click="editRow(disciplinaryCollection.tempid)"></i>
													</span>
												</security:authorize> --%> <security:authorize
													access="hasRole('${form_code}_${delete}')">
													<span data-ng-if="!row.status"> <i
														class="fa fa-trash-o text-danger-dker text"
														data-ng-click="deleteRow(disciplinaryCollection.tempid,$index)"></i>
													</span>
