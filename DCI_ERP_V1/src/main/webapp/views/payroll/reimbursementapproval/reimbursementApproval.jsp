				...
				<div jarvis-widget id="standard-datatable-widget"
					...
					<div role="content">
						<div class="widget-body">
							...
							<form class="form-horizontal" name="payslipReportForm"
								role="form">
								<div class="row">
											...
											<div class="form-group">
												...
												<div class="col-md-5">
													<select class="form-control"
														ng-model="reimbursementApproval.status">
										...
										<div class="col-sm-6 col-md-6 col-lg-4">
											<div class="col-md-5">
												<button class="btn btn-success" type="button"
													data-ng-click="showList(reimbursementApproval.status)">
													Submit</button>
											</div>
											<div class="col-md-5">
												<security:authorize
		...
		<%@include file="/views/templates/panel-header.jsp"%>
									...
									<table id="dt_basic"
										...
										<thead class="dataTables-Main-Head">
											<tr>
												<!-- <th class="width_1"></th> -->
												<th class="sorting width_10" st-sort="employeeNo">Employee
													No</th>
												<th class="sorting width_10" st-sort="employeeName">Employee
													Name</th>
												<th class="sorting width_15" st-sort="reimbursementType">Reimbursement
													Type</th>
												<th class="sorting width_10" st-sort="description">Description</th>
												<th class="sorting width_10" st-sort="payMode">Payment
													Mode</th>
