		...
		<div role="content">
						<div class="widget-body">
							<form class="form-horizontal" name="disciplinaryActionForm"
										...
										<fieldset>
											<div class="col-md-6">
												...
												<!-- 		<selectivity list="hospitalList"
															...
															ng-model="disciplinaryData.hospitalId" validation="required" 
															readonly> </selectivity> -->
															
															 <selectivity list="companyList"
															property="disciplinaryData.hospitalId" id="hospitalId"
															ng-model="disciplinaryData.hospitalId"  name="hospitalId" ng-disabled="checked"
												...
												<!-- 	<input type="text" class="form-control input-sm"
													ng-model="disciplinaryData.hospitalId1" friendly-name="hospitalId1" form-name="disciplinaryActionForm"
													property="disciplinaryData.hospitalId1"
													name="hospitalId1" id="hospitalId1" validation="required"/>
													 -->
													<!-- <selectivity list="branchlist"
															property="disciplinaryData.hospitalId1" id="hospitalId1" name="hospitalId1"
															friendly-name="Employee Name" form-name="disciplinaryActionForm"
															ng-model="disciplinaryData.hospitalId1" validation="required"> </selectivity> -->
														<selectivity list="branchList"
								...
								<div class="col-md-2">
									<ng-bs3-datepicker data-ng-model="disciplinaryData.suspendFrom"
										id="suspendFrom" name="suspendFrom" form-name="suspendFrom" friendly-name="suspendFrom"
										validation="required" />
						</div>	
											<label class="col-md-2 control-label">Suspended To<span
														style="color: red;">*</span><span style="color: red;"></span></label>
															...
															<div class="col-md-2">
									<ng-bs3-datepicker data-ng-model="disciplinaryData.suspendTo"
										id="suspendTo" name="suspendTo" form-name="suspendTo" friendly-name="suspendTo"
										validation="required" />
						</div>	
										<!-- 	<div class="col-md-2">
												<div class='input-group date datetimepick'>
