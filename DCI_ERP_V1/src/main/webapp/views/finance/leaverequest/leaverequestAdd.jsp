							...
							<div class="col-sm-12 col-md-12 col-lg-12">
								...
								<!-- <fieldset>
											<div class="form-group padding-right-0">
													<div class="form-group">
														<label class="col-md-3 control-label">Form<span
												...
												<div class="col-md-3">
															...
															<ng-bs3-datepicker
															 ...
															 data-ng-model="leaveRequestObj.fromDate"
										id="fromDate" name="fromDate" form-name="leaveReqAddForm" friendly-name="fromDate" 
										ng-change="selectDate(leaveRequestObj.fromDate)"
									 ...
									 />
													...
													<div class="form-group padding-left-0">
														<label class="col-md-8 control-label">To<span
															style="color: red;">*</span> </label>
														<div class="col-md-3">
															<select class="form-control"
																ng-model="leaveRequestObj.halfTo"
												...
												<div class="col-md-3">
															...
															<ng-bs3-datepicker
															 ...
															 data-ng-model="leaveRequestObj.toDate"
										id="toDate" name="toDate" form-name="leaveReqAddForm" friendly-name="toDate"	
										ng-disabled="editRequest"	
								...
								<fieldset>
									<div class="col-sm-6 col-md-6 col-lg-6">
										...
										<div class="form-group" ng-if="leaveRequestObj.leaveRadio==3">
											...
											<div class="col-md-6">
												<!-- <div class="dropdown">
																<a class="dropdown-toggle" id="cplFromDate"
																	role="button" data-toggle="dropdown" data-target="#"
																	href="#">
																	<div class="input-group">
																		<input type="text" class="form-control"
																			placeholder="dd/mm/yyyy" name="cplFromDate"
																			data-ng-model="leaveRequestObj.cplFromDate"
																			ng-disabled="!cplLeave"><span
																			class="input-group-addon"><i
																			class="glyphicon glyphicon-calendar"></i></span>
																	</div>
																</a>
																<ul class="dropdown-menu" role="menu"
																	aria-labelledby="dLabel" ng-if="cplLeave">
																	<datetimepicker
																		data-ng-model="leaveRequestObj.cplFromDate"
																		data-on-set-time="leaveRequestObj.cplFromDate = onDateSet(newDate)"
																		data-datetimepicker-config="{ dropdownSelector: '#cplFromDate',startView:'day', minView:'day'}" />
																</ul>
															</div> -->
												<ng-bs3-datepicker
													data-ng-model="leaveRequestObj.cplFromDate"
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												<textarea class="form-control input-sm" name="leaveAddress"
													...
													form-name="leaveReqAddForm"></textarea>
											</div>
										</div>
										<div class="form-group">
										...
										<!-- <div class="form-group">
											<label class="col-md-5 control-label"> Pay Type </label>
											<div class="col-md-7 radio radio-inline"
												ng-if="!leaveRequestObj.isEdit">
												<div class="radio radio-inline"
													ng-init="leaveRequestObj.payType='H'">
													<label class="i-checks"> <input type="radio"
														name="Pay" ng-model="leaveRequestObj.payType" id="halfPay"
														value="H"> <i></i> Half Pay
													</label> <label class="i-checks col-md-offset-1"> <input
														type="radio" name="Pay" ng-model="leaveRequestObj.payType"
														id="fullPay" value="F"> <i></i> Full Pay
													</label>
												</div>
											</div>
											<div class="col-md-7 radio radio-inline"
									...
									<div class="col-sm-6 col-md-6 col-lg-6 ">
											...
											<div class="col-md-6">
												<!-- <div class="dropdown">
																<a class="dropdown-toggle" id="toDate" role="button"
																	...
																	<div class="input-group">
																		<input type="text" class="form-control"
																			placeholder="dd/mm/yyyy" name="cplToDate"
																			data-ng-model="leaveRequestObj.cplToDate"
																			ng-disabled="!cplLeave"><span
																			class="input-group-addon"><i
																			class="glyphicon glyphicon-calendar"></i></span>
																	</div>
																...
																<ul class="dropdown-menu" role="menu"
																	...
																	<datetimepicker
																		data-ng-model="leaveRequestObj.cplToDate"
																		data-on-set-time="leaveRequestObj.cplToDate = onDateSet(newDate)"
																		data-datetimepicker-config="{ dropdownSelector: '#toDate',startView:'day', minView:'day'}" />
																</ul>
															</div> -->
										...
										<!-- <div class="form-group" ng-if="mlLeave">
														<label class="col-md-4 control-label"> Support
															Document <span style="color: red;">*</span>
														</label>
														<div class="col-md-6">
															<input type="text" class="form-control input-sm"
																id="attachment" ng-model="leaveRequestObj.supportDoc"
																name="Support Document" validation="required"
																friendly-name="Support Document"
																form-name="leaveReqAddForm"
																onchange="angular.element(this).scope().uploadDocFile(this)"
																readonly>
														</div>
														<button class="btn btn-success"
															ng-click="uploadMLDoc($index)" type="button"
															class="btn btn-success">
															<i class="fa fa-upload"></i> Upload <a id="fileExport"
																class="link"
																data-ng-repeat="link in leaveRequestObj.supportDoc"
																href="{{link}}" ng-click="fileDownload()" download>
																<button class="btn btn" type="button">
																	FILE{{$index+1}}</button>
															</a>
														</button>
													</div> -->
										<!--  <div class="form-group" ng-if="mlLeave || splLeave">
														<label class="col-md-4 control-label">Doc Upload <span
															style="color: red;">*</span> </label>
														<div class="col-md-6">
															<input type="file" class="form-control"
																name="joinDocUpload" multiple
																ng-model="leaveRequestObj.supportDoc" id="fileUpload"
																validation="required" friendly-name="Document Upload" 
																onchange="angular.element(this).scope().uploadDocFile(this)" />
															<br>
															<button class="btn btn" type="button"
																ng-click="uploadDocument($index)">Upload</button>
															<div style="margin-top: 5%">
																<a id="fileExport" class="link"
																	data-ng-repeat="link in leaveRequestObj.supportDoc track by $index"
																	href="{{link}}" ng-click="fileDownload()" download>
																	<button class="btn btn" type="button">
																		FILE{{$index+1}}</button>
																</a>
							...
							<div class="row">
								<div class="col-md-12">
									<button class="btn btn-success" class="btn btn-success"
										...
										data-ng-if="!leaveRequestObj.isEdit"
										ng-click="submit(leaveReqAddForm)">
										<i class="fa fa-save"></i> Save
									</button>
									<button class="btn btn-success" type="button"
										data-ng-click="update(leaveReqAddForm)"
										data-ng-if="leaveRequestObj.isEdit">
