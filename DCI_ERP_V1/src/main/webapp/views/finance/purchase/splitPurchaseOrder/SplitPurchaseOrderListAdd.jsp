   ...
   <article class="col-sm-12">
    <div data-jarvis-widget id="standard-datatable-widget"
     ...
     <header class="ngdialog-header">
      ...
      <h2>
       Add Merge Purchase Order List
      </h2>
     </header>
     <div role="content">
      <div class="widget-body">
       <form class="form-horizontal" name="splitPurchaseOrderListForm">
        <div class="row">
         <div class="col-md-12">
          <fieldset>
