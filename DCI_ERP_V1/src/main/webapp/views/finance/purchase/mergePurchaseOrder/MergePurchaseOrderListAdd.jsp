    ...
    <div data-jarvis-widget id="standard-datatable-widget"
     ...
     <div role="content">
      <div class="widget-body">
       <form class="form-horizontal" name="mergePurchaseOrderListForm">
        <div class="row">
         <div class="col-md-12">
          <fieldset>
