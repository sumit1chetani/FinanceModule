...
<%-- <security:authorize access="hasRole('F0026_D')" var="isDelete" />
<security:authorize access="hasRole('F0026_A')" var="isAdd" />
<security:authorize access="hasRole('F0026_UP')" var="isUpload" /> --%>
<div id="content">
 <!-- widget grid -->
