...
<div class="form-group">
            ...
            <div class="col-md-3" style="margin-top: 1%;" data-ng-if="letterrequest.hrStatus == 'Pending'">
								...
								<div class="col-md-3" style="margin-top: 1%;" data-ng-if="letterrequest.hrStatus == 'Approved'">
						...
						<div class="row">
							<div class="col-md-12">
								<button class="btn btn-success" class="btn btn-success"
									type="button" 
									data-ng-if="letterrequest.hrStatus == 'Pending'"
									data-ng-click="Approve(letterRequestForm)"
									>
