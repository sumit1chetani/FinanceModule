						...
						<div class="row page">				     
							<div class="col-sm-12 col-md-12 col-lg-12 width_100" st-table="displayedCollection" st-safe-src="rowCollection">
						      	<fieldset style="border:0px">
						      		<legend class="width_50 text-center b-a bg-header m-n text-font-size-20p">${object1.vesselName}</legend>
						      	</fieldset>
						      </div>
						    ...
						    <div class="col-sm-12 col-md-12 col-lg-12 width_100"  st-table="displayedCollection" st-safe-src="rowCollection">
								<table class="" align=center border=1 width="100%">
									...
									<tbody>
											...
											<td class="width_20" align="right">
												<c:forEach var="ob2"  items="${charterReportList.rowData}"> 
													<div class="padding-top-20 row">														
														<div class="col-xs-12">		
															<div class="col-xs-4">													
																<div class="form-group height_20p padding-top-55 text-right">
																	<span>$5,76,700.00</span>																
																</div>
															</div>
														</div>
													</div>
										...
										<tr>
											...
											<td class="width_20 text-right"><c:out value="${object1.totalChargesWithCommission}" />
											</td>
												...
												<div class="padding-top-20 row">
													<div class="col-xs-12">
														<div class="col-xs-4">
															...
															<div class="form-group height_20p text-right padding-top-20 text-right">
															$1,26,000.00						
															</div>
															<div class="form-group">
															</div>
												...
												<div class="padding-top-20 row">
													<div class="col-xs-12">		
														<div class="col-xs-4">									
															...
															<div class="form-group height_20p padding-top-30 text-right">
															$66,834.00													
															</div>
										...
										<tr>
											...
											<td class="width_20"  align="right">
												...
												<div class="padding-top-20 row">
													<div class="col-xs-12">	
														<div class="col-xs-4">
															<div class="form-group height_20p padding-top-10 text-right">
																$5,750.51																																										
															</div>
															<div class="form-group height_20p padding-top-10 text-right">
																$10,000.00
										...
										<tr>
											...
											<td class="width_20"></td>
											<td class="width_20"  align="right">																					
												<div class="form-group height_20p padding-top-20 text-right">
													$1,853.33																																								
												</div>
												<div class="form-group height_20p padding-top-20 text-right">
													$1,544.45
												...
												<div class="padding-top-20 row">
													<div class="col-xs-12">
														<div class="col-xs-4">
															...
															<div class="form-group text-right height_20p padding-top-10">
																$3,984.58
															</div>
															<div class="form-group text-right height_20p padding-top-20">
																$1,757.37
															</div>
														</div>
													</div>
