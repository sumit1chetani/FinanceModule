					...
					<table id="dt_basic"
						...
						<thead class="dataTables-Main-Head"
							...
							<tr role="row">
								...
								<th class="sorting width_15" st-sort="invoiceDt">Invoice
									Date</th>
								<th class="sorting width_29" st-sort="partyInvNo">Party
									Invoice No</th>
								<th class="sorting width_29" st-sort="CustomerName">Supplier</th>
									<th class="sorting width_29" st-sort="CustomerName">Amount</th>
								<th class="sorting width_29" st-sort="createdBy">Created By</th>
								<th class="sorting width_29" st-sort="createdOn">Created On</th>
								<th class="sorting width_29" st-sort="createdOn">Action</th>
							</tr>
						</thead>
						<tbody class="dataTables-Main-Body">
							<tr data-ng-class="$index % 2 == 0? 'even' : 'odd'"
								...
								<td><span tooltip="{{objTranslationItem.invoiceDt}}"
									class="tool-tip-span" ng-bind="objTranslationItem.invoiceDt"></span>
								</td>
								<td><span tooltip="{{objTranslationItem.partyInvNo}}"
									class="tool-tip-span" ng-bind="objTranslationItem.partyInvNo"></span>
								</td>
								<td><span tooltip="{{objTranslationItem.CustomerName}}"
									class="tool-tip-span" ng-bind="objTranslationItem.CustomerName"></span>
								</td>
									<td><span tooltip="{{objTranslationItem.totalAmount}}"
									class="tool-tip-span" ng-bind="objTranslationItem.totalAmount"></span>
								</td>
								<td><span tooltip="{{objTranslationItem.createdBy}}"
									class="tool-tip-span" ng-bind="objTranslationItem.createdBy"></span>
								</td>
								<td><span tooltip="{{objTranslationItem.createdOn}}"
									class="tool-tip-span" ng-bind="objTranslationItem.createdOn"></span>
								</td>
								<td class="td-actions text-center"><security:authorize
										...
										<span class="edit-button  padding-right-5"
											...
											data-ng-click="editRow(objTranslationItem.invoiceNo)"
											tooltip="Edit Row"> <i
											class="fa  fa-pencil text-success text"></i>
										</span>
									</security:authorize> <%-- <security:authorize access="hasRole('${form_code}_${delete}')">
										<span class="delete-button" data-toggle="tooltip"
											title="Delete"
											data-ng-click="deleteRow1(objTranslationItem.invoiceNo)"
