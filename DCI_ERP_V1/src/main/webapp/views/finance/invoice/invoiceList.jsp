    ...
    <table class="table table-striped b-t b-light table-hover dataTable no-footer">
     <thead class="dataTables-Main-Head">
      <tr>
       ...
       <th colspan="4">{{invoiceGenerateData.vesselCode}}</th>
        <th colspan="3">Voyage</th>	
         <th colspan="4	">{{invoiceGenerateData.voyageId}}</th>
      </tr>
     ...
     <tbody>
      ...
      <td class="width_1">Transhipment</td>
      <td class="width_1">Remark</td>
     ...
     <!--  <td class="width_4">Print</td> -->
      ...
      <tr data-ng-class="$index % 2 == 0? 'even' : 'odd'" ng-repeat="objItem in displayCollection" >
       ...
       <td class="width_1"><a ng-click="gotosummay(objItem)">{{objItem[0].submitShortSlot}}</a></td>
       ...
       <td class="width_1">{{objItem[0].submitTranshipment}}</td>
       <td class="width_1">{{objItem[0].flsRemarks}}</td>
