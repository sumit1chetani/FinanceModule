     ...
     <div class="col-sm-12">
      <div class="col-sm-4">
			...
			<div class="form-group ">
		        ...
		        <div class="col-md-8">
				     <input type="text" class="form-control input-sm"  data-ng-model="customerinvoice.invDate" id="invDate" name="invDate" form-name="cashbankpaymentForm"
             friendly-name="Invoice Date" validation="required"  disabled="disabled"/>
		...
		<div class="form-group ">
		        ...
		        <div class="col-md-8">
			         <input type="text" class="form-control input-sm"  data-ng-model="customerinvoice.customerName" id="customerCode" name="customerCode"
			          friendly-name="Customer" form-name = "creditNoteForm" validation="required"  disabled="disabled" />
		        </div>
	       	</div> 
	       	...
	       	<div class="form-group ">
		        ...
		        <div class="col-md-8">
			        <input type="text" class="form-control input-sm"  id="tripCode"  name="tripCode"
			        ng-model="customerinvoice.tripNo"  friendly-name="Customer" form-name = "creditNoteForm" validation="required" disabled="disabled" />
		        </div>
	       	</div> 
	...
	<div class="form-group ">
		        ...
		        <div class="col-md-8">
		        	<input type="text"  name="Currency"  class="form-control input-sm" 
											id="currency" validation="required" friendly-name="Currency" form-name = ""
											ng-model="customerinvoice.currency" disabled="disabled" />
		        </div>
	       	</div>
	    ...
	    <div class="form-group">
		        ...
		        <div class="col-md-8">
		         	...
		         	ng-model="customerinvoice.exchangeRate" ng-change="calculateTotalAmount(customerinvoice.GIDtl)" disabled="disabled"  />
		        </div>
	       </div>
	       ...
	       <div class="form-group ">
		        ...
		        <div class="col-md-8">
		       	 	<textarea ng-model="customerinvoice.remarks" id="remarks" rows="2" class="form-control" disabled="disabled" ></textarea>
		        </div>
	       </div>
        ...
        <tbody ng-repeat="(trIndex, row) in customerinvoice.GIDtl">
        	<tr>
              ...
              <td class="width_10">
	          		<div class="row" >
	            		<div class="col-xs-12">
	            			<input type="text" class="form-control input-sm text-right" ng-model="row.quotAmount" name ="quotAmount{{$index}}" id="quotAmount{{$index}}"  disabled="disabled" />
	              		</div>
	              	</div>
	            </td>
      ...
      <div class="content">
        ...
        <div class="row">
         ...
         <!--  <button id = "saveInvoice" class="btn btn-success" type="button" ng-if="!edit" ng-click="submit(customerinvoiceForm,customerinvoice)" >
           ...
           <button class="btn btn-success" type="button" ng-click="printCustInvoiceLocal(customerinvoice.invoiceNo)">
           <i class="fa fa-save"></i>
           Print Local
          </button>
          <button class="btn btn-success" type="button" ng-click="printCustInvoiceUSD(customerinvoice.invoiceNo)">
           <i class="fa fa-save"></i>
           Print USD
          </button>
          <button class="btn btn-success" type="button" ng-click="printCustInvoiceDiv(customerinvoice.invoiceNo)">
           <i class="fa fa-save"></i>
           Print Both
          </button>
