				...
				<div class="col-md-12">
					<div class="panel panel-default">
						...
						<div class="panel-body float-left padding-10" style="width: 100%">
							<div class="panel panel-default panel-default-list"
								st-table="purchaseInvoiceList"
								st-safe-src="displayedCollection1">
									...
									<table
										...
										<tbody class="dataTables-Main-Body">
											<tr data-ng-class="$index % 2 == 0? 'even' : 'odd'"
												...
												<%-- <td>
										<a ng-click="view(purchaseInvoiceList.purchaseSNo)"><security:authorize access="hasRole('${form_code}_${view}')">
											<span tooltip="{{purchaseInvoiceList.puchaseInvoiceNo}}"
											class="tool-tip-span font-blue">{{purchaseInvoiceList.puchaseInvoiceNo}}</span></security:authorize>
												...
												<td class="sorting ">{{purchase.polName}}</td>
												<td class="sorting ">{{purchase.podName}}</td>
						...
						<table class="table table-striped table-hover dataTable no-footer">
							...
							<tbody class="dataTables-Main-Body">
								<tr data-ng-class="$index % 2 == 0? 'even' : 'odd'"
									...
									<td><a ng-click="view(purchaseInvoiceList.purchaseSNo)"><access="hasRole('${form_code}_${view}')">
												<span tooltip="{{purchaseInvoiceList.puchaseInvoiceNo}}"
