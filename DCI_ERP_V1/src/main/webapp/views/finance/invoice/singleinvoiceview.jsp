	...
	<!-- <div class="panel panel-default panel-default-form"> -->
		...
		<%@include file="/views/templates/panel-header-form.jsp"%>
			<!-- <ol class="breadcrumb inline-block padding-left-10">
				<li><a>Finance</a></li>
				<li><a>Invoice </a></li>
				<li><a x-ui-sref="">Invoice View </a></li>
			...
			<div class="panel-body">
				<form class="form-horizontal" name="billAddForm" role="form">
					<div class="row book-widget-row">
							...
							<fieldset>
								...
								<div class="form-group">
									<label class="col-md-6 control-label">Quot. Valid from </label>  <label
										class="col-md-6 text-left control-label" 
										ng-bind="viewInvoiceHeader.quotValidFrom">
						...
						<div class="col-sm-12 col-md-4 col-lg-4">
							<fieldset>
								...
								<div class="form-group">
									<label class="col-md-6 control-label">Quot. No </label>
									
									<!-- <a href="#/quotation/view/{{viewInvoiceHeader.quotNo}}"><label
										class="col-md-6 text-left control-label"
										ng-bind="viewInvoiceHeader.quotNo"> </label></a> -->
										<a href="#/quotation/view/{{viewInvoiceHeader.quotNo}}" target="_blank"
										 ng-bind="viewInvoiceHeader.quotNo" class="col-md-6 text-left control-label"
										ng-if="viewInvoiceHeader.quotNo.indexOf('QT') == -1" >{{viewInvoiceHeader.quotNo}}</a>
										 <a href="#/transhQuotList/view/{{viewInvoiceHeader.quotNo}}" target="_blank"
										 ng-bind="viewInvoiceHeader.quotNo" class="col-md-6 text-left control-label"
										 ng-if="viewInvoiceHeader.quotNo.indexOf('QO') == -1">{{viewInvoiceHeader.quotNo}}</a>
								...
								<div class="form-group">
									<label class="col-md-6 control-label">Quot. Valid To  </label>  <label
										class="col-md-6 text-left control-label" 
										ng-bind="viewInvoiceHeader.quotValidTo">
							...
							<fieldset>
								...
								<div class="form-group">
									<label class="col-md-6 control-label">Ex. Rate </label>  <label
										class="col-md-6 text-left control-label" 
										ng-bind="viewInvoiceHeader.exchangeRate">
								...
								<fieldset>	
									<div class="form-group">
										<label class="col-md-2 control-label">Quot. Remarks </label>  <label
											...
											ng-bind="viewInvoiceHeader.remarks">
						...
						<table class="table table-striped b-t b-light">
							<thead>
								<tr>
									...
									<th colspan="2" class="text-center" valign="top">OOG SLOT LOSS</th>
					...
					<div class="form-actions">
						<div class="row">
							<div class="col-md-12">
							<button class="btn btn-danger" ng-if="invoiceTable==true" ng-click="cancel1()" type="button">
									<i class="fa fa-close"></i> Cancel
								</button>
								<button class="btn btn-danger" ng-if="invoiceTable==false" ng-click="cancel()" type="button">
									<i class="fa fa-close"></i> Cancel
								</button>
								<button class="btn btn-success" type="button" ng-if="invoiceTable==false" ng-click="clickInvoiceFunction(viewInvoiceHeader.invoiceno,'both')">
									<i class="fa fa-print"></i> Print Both
								</button>
								<button class="btn btn-success" type="button" ng-if="invoiceTable==false" ng-click="clickInvoiceFunction(viewInvoiceHeader.invoiceno,'usd')">
									<i class="fa fa-print"></i> Print USD
								</button>
								<button class="btn btn-success" type="button" ng-if="invoiceTable==false" ng-click="clickInvoiceFunction(viewInvoiceHeader.invoiceno,'local')">
