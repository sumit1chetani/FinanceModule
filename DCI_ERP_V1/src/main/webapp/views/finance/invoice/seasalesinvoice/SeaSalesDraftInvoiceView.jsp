								...
								<fieldset>
									<div class="form-group">
										...
										<input type="text" class="form-control" name="jobName"
												ng-model="purchaseInvoiceData.jobName" disabled> </>
										</div>
							...
							<div class="col-sm-12 col-md-4 col-lg-4">
								...
								<div class="form-group">
									...
									<selectivity list="statusList"
												property="purchaseInvoiceData.status"
												ng-model="purchaseInvoiceData.status" id="status_id" validation="required"
												friendly-name="Status"
												name="status_id" object="status"  form-name="purchaseInvoiceForm"></selectivity>
							...
							<table class="table table-striped b-t b-light">
								<thead>
									<tr>
										...
										<th colspan=1 class="width_8 text-center">Commodity</th>
										...
										<div class="form-actions">
											<div class="row">
												<div class="col-md-12">
													...
													<button  class="btn btn-success" 
														 type="button" class="btn btn-success"
														ng-click="onSubmitDraft1(purchaseInvoiceForm,purchaseInvoiceData)">
