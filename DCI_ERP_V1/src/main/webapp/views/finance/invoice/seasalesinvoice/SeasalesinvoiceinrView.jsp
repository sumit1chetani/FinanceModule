		...
		<table  width=100% align="center" border="1" cellPadding="0"
			...
			<tbody>
				<tr ng-repeat="x in listdata">
					...
					<td align="right"  valign="right" type="number" minFractionDigits="2" maxFractionDigits="2" style="font-size: 10px;">{{ x.cgstAmt }}</td>
					<td align="right" valign="right" style="font-size: 10px;">{{ x.sgstPrct }}</td>
					<td align="right" valign="right" type="number" minFractionDigits="2" maxFractionDigits="2" style="font-size: 10px;">{{ x.sgstAmt }}</td>
					<td align="right" valign="right" style="font-size: 10px;">{{ x.igstPrct}}</td>
					<td align="right" valign="right" style="font-size: 10px;" type="number" minFractionDigits="2" maxFractionDigits="2">{{ x.igstAmt }}</td>
				...
				<tr>
					...
					<td align="right" valign="right" style="font-size: 10px;" colspan="2">{{header.totalAmount | number : 2}}</td>
				</tr>
			</tbody>
