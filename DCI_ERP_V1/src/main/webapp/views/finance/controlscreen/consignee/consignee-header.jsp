   ...
   <div class="col-sm-12 col-md-4 col-lg-4">
          <fieldset>
           <div class="form-group">
            <label class="col-md-5 control-label  vessel-text">Customer Name</label>
            <div class="col-md-7">
          ...
          <fieldset>
 <div class="form-group">
            <label class="col-md-5 control-label">Customer Area</label>
            <div class="col-md-7">
         ...
         <div class="col-sm-12 col-md-4 col-lg-4">
          <fieldset>
            <div class="form-group">
            <label class="col-md-5 control-label">Customer ShortName</label>
            <div class="col-md-7">
   ...
   <div class="col-sm-12 col-sm-offset-4 m-b-sm">
	   ...
	   <button type="button" class="btn btn-info btn-sm" data-ng-click="resetAll()">Reset</button>

	   <button id="button1" type="button" class="btn btn-primary btn-sm" ng-click="">Customer Consolidated</button>
	   <button type="button" class="btn btn-primary btn-sm" ng-click="updateMlo()">Export To Excel Sun</button>

	   <button type="button" class="btn btn-primary btn-sm">Export  Customer Code To Excel </button>
