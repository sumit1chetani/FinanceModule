						...
						<div class="form-group">
							...
							<div class="col-md-7">
								<input type="text" class="form-control input-sm"
									...
									friendly-name="ServicePartnerCode" readonly/>
						...
						<div class="form-group">
							...
							<div class="col-md-7">
								<input type="text" class="form-control input-sm"
									...
									friendly-name="ServicePartnerName" readonly/>
							</div>
						</div>
					</div>
					<div class="col-md-4">
						...
						<div class="form-group">
							...
							<div class="col-md-7">
								<input type="text" class="form-control input-sm"
									...
									friendly-name="Service Partner Ledger Name" readonly/>
							</div>
						</div>
					</div>
                     <div class="col-md-4">
						...
						<div class="form-group">
							...
							<div class="col-md-7">
								<input type="text" class="form-control input-sm"
									...
									name="credit Days Offered" friendly-name="Credit Days Offered" readonly/>
							</div>
						</div>
					</div>
						...
						<div class="form-group">
							...
							<div class="col-md-7">
								...
								<label class="i-checks m-b-none checkbox"> <input
									...
									data-ng-model="servicePartner.active" friendly-name="Active" readonly/><i></i>
								</label>
						...
						<div class="form-group">
							...
							<div class="col-md-7">
								<textarea class="form-control input-sm"
									...
									friendly-name="Address" rows="2" readonly></textarea>
						...
						<div class="form-group">
							...
							<div class="col-md-7">
								<input type="text" class="form-control input-sm"
									...
									friendly-name="ZipCode" readonly/>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="form-group">
							...
							<div class="col-md-7">
								<input type="text" class="form-control input-sm"
									...
									name="Person To Contact" friendly-name="Person To Contact" readonly/>
							</div>
						</div>
					</div>
						...
						<div class="form-group">
							...
							<div class="col-md-7">
								...
								<input type="text" class="form-control input-sm"
									...
									friendly-name="Designation" readonly/>
							</div>
						</div>
					</div>
						...
						<div class="form-group">
							...
							<div class="col-md-7">
								<input type="text" class="form-control input-sm"
									...
									friendly-name="LandLine No" readonly/>
							</div>
						</div>
					</div>
						...
						<div class="form-group">
							...
							<div class="col-md-7">
								<input type="text" class="form-control input-sm"
									...
									friendly-name="Mobile No" readonly/>
							</div>
						</div>
					</div>
						...
						<div class="form-group">
							...
							<div class="col-md-7">
								<input type="text" class="form-control input-sm"
									...
									friendly-name="Skype ID" readonly/>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="form-group">
							...
							<div class="col-md-7">
								<input type="text" class="form-control input-sm"
									...
									friendly-name="WebSite" readonly/>
							</div>
						</div>
					</div>
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<div class="col-md-7">
								...
								Description" rows="2" readonly></textarea>
						...
						<div class="form-group">
							...
							<div class="col-md-7">
								<selectivity list="classificationList"
									...
									name="partnerClassification" form-name="servicePartnerForm" disabled="true"
									"> </selectivity>
							</div>
						</div>
					</div>
						...
						<div class="form-group">
							...
							<div class="col-md-7">
								<input type="text" class="form-control input-sm"
									...
									name="Exemption Under" friendly-name="Exemption Under" readonly/>
							</div>
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							...
							<div class="col-md-7">
								<input type="text" class="form-control input-sm"
									...
									friendly-name="GSTN No" readonly/>
							</div>
						</div>
					</div>
				</div>
								...
								<div class="row">
									<div class="col-xs-12">
										<input type="text" class="form-control input-sm"maxlength=50
											...
											friendly-name="{{ 'Row' + $index + '(LandLineNo)'}}" readonly/>
									</div>
								</div>
							</td>
							<td class="width_10">
								...
								<div class="row">
									<div class="col-xs-12">
										<input type="text" class="form-control input-sm"maxlength=500
											...
											friendly-name="{{ 'Row' + $index + '(remarks)'}}" readonly/>
									</div>
								</div>
							</td>
