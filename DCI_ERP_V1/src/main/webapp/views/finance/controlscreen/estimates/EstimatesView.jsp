      ...
      <div class="panel-body">
       <form class="form-horizontal" name="estimatesForm" novalidate>
        ...
        <div class="row">
          ...
          <table class="table table-striped b-t b-light toggleBlock-currsor">
           <thead>
            <tr>
             ...
             <th colspan=4 class="text-center" ng-click="toggleBlock('charterBlock')">Charter Hire Cost Total ({{charterHireCost | number:2}})</th>
          ...
          <table class="table table-striped b-t b-light toggleBlock-currsor">
           <thead>
            <tr>
             ...
             <th colspan=4 class="text-center" ng-click="toggleBlock('bunkerBlock')">Bunker Cost Total ({{bunkerCostTotal | number:2}})</th>
             <th class="width_15">Approved Date</th>
            </tr>
           </thead>
          </table>
          ...
          <table class="table table-striped b-t b-light toggleBlock-currsor">
           <thead>
            <tr>
             ...
             <th colspan=1 class=" text-center" ng-click="toggleBlock('portBlock')">Port</th>
             <th colspan=1 class=" text-center" ng-click="toggleBlock('portBlock')">Port Tariff Cost Total ({{portCostTotal | number:2}})</th>
             <th colspan=1 class=" text-center" ng-click="toggleBlock('portBlock')">Remarks</th>
             <th class="width_15">Approved Date</th>
            </tr>
           </thead>
          </table>
          ...
          <table class="table table-striped b-t b-light toggleBlock-currsor">
           <thead>
            <tr>
             ...
             <th colspan=1 class=" text-center" ng-click="toggleBlock('agencyBlock')">Port</th>
             <th colspan=1 class=" text-center" ng-click="toggleBlock('agencyBlock')">Agency Tariff Cost Total ({{agentCostTotal | number:2}})</th>
             <th colspan=1 class=" text-center" ng-click="toggleBlock('agencyBlock')">Remarks</th>
             <th class="width_15">Approved Date</th>
            </tr>
           </thead>
          </table>
          ...
          <table class="table table-striped b-t b-light toggleBlock-currsor">
           <thead>
            <tr>
             ...
             <th colspan=1 class=" text-center" ng-click="toggleBlock('insuranceBlock')">Insurance</th>
             <th colspan=1 class=" text-center" ng-click="toggleBlock('insuranceBlock')">Insurance Cost Total ({{insuranceCostTotal | number:2}})</th>
             <th colspan=1 class=" text-center" ng-click="toggleBlock('insuranceBlock')">Remarks</th>
             <th class="width_15">Approved Date</th>
            </tr>
           </thead>
          </table>
         ...
         <div class="col-lg-11 div-center">
          <table class="table table-striped b-t b-light toggleBlock-currsor">
           <thead>
            <tr>
             ...
             <th class="width_10 text-center" ng-click="toggleBlock('otherBlock')">Dr.Account <span style="color: red;">*</span></th>
             <th class="width_10 text-center" ng-click="toggleBlock('otherBlock')">Dr.Sub Account</th>
             <th class="width_10 text-center" ng-click="toggleBlock('otherBlock')">Cr.Account<span style="color: red;">*</span></th>
             <th class="width_13 text-center" ng-click="toggleBlock('otherBlock')">Cr.Sub Account</th>
             <th class="width_8 text-center" ng-click="toggleBlock('otherBlock')">Port<span style="color: red;">*</span></th>
             <th class="width_10 text-center" ng-click="toggleBlock('otherBlock')">Other Cost Total ({{otherCostTotal | number:2}})</th>
             <th class="width_10 text-center" ng-click="toggleBlock('otherBlock')">Other Remarks</th>
             <th class="width_15">Approved Date</th>
            </tr>
           </thead>
          </table>
           ...
           <table class="table table-striped b-t b-light">
            <tbody ng-repeat="(trIndex, row) in estimates.otherCostList" ng-controller="tableCtrl">
             <tr>
              ...
              <td classs="width_5" style="padding-right: 7% !important;" ng-if="estimates.activity!='OWN OPERATING SHIPS'"><input type="checkbox" ng-model="row.otheraccountcheck"></td>
              <td classs="width_10"><label class="col-md-1 control-label ">{{row.accountHeadName}}</label></td>
              <td class="width_10"><label class="col-md-1 control-label ">{{row.drSubAccountCode}}</label></td>
              <td classs="width_10"><label class="col-md-1 control-label ">{{row.crAccountHeadName}}</label></td>
              <td class="width_10"><label class="col-md-1 control-label ">{{row.crSubAccountCode}}</label></td>
              <td classs="width_8"><label class="col-md-1 control-label text-nowrap">{{row.port}}</label></td>
              <!-- <td>
                    <div class="row">
                       <div class="col-xs-12">
        ...
        <div class="form-actions">
         <div class="row">
          <div class="col-md-12 text-center">
           ...
           <button ng-model="approve" class="btn btn-success" ng-if="(estimates.status=='PA' || estimates.status=='A') && estimates.activity!='OWN OPERATING SHIPS'" class="btn btn-success" ng-click="openDatePopup('Approve','jvpost')">
