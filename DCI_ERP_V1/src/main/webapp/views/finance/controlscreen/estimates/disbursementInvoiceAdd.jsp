  ...
  <div class="wrapper-md">
    <div class="panel panel-default panel-default-form">
      ...
      <div class="table-responsive clear">
           <table class="table table-striped b-t b-light">
             <thead>
               <tr>
                 ...
                 <th colspan=1  class="width_15 text-center">Voyage</th>
         ...
         <td>
         <div class="col-md-9" style="padding:0px;margine:0px;">
         	<selectivity list="voyageList" property="row.voyageCode" id="voyageCode{{trIndex}}" ></selectivity>
         </div>
         <div class="col-md-2" style="padding:5px;">
         	<button ng-click="showEstAmt(row.accountHeadCode,row.voyageCode,row.companyCode)" class="btn btn-xs btn-primary" type="button" data-toggle="tooltip" title="" ng-disabled="disabled">
        ...
        <!--   <selectivity list="approveList" property="row.status" id="status{{trIndex}}" name ="status{{trIndex}}" validation="required" ng-model="row.status"
          ...
          <label class="i-checks m-b-none"> <input type="checkbox" ng-click="setStatus(row)" ng-model="row.allocType" id="allocType{{trIndex}}"><i></i></label>
         </td>
               <td>
                 <div class="row">
                    <div class="col-xs-12">
           ...
           <div class="row">
            <div class="col-md-12">
             <button ng-model="add" class="btn btn-success" ng-if="!edit"
               class="btn btn-success" ng-click="onSubmit(purchaseInvoiceForm,purchaseInvoiceData)">
