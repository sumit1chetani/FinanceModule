        					...
        					<table id="dt_basic"
         						...
         						<thead class="dataTables-Main-Head">
									 ...
									 <th class="width_1 table-heading text-center">
							           ...
							           <th class="sorting text-center padding-both-side-2 width_8" >Transfer Qty</th>
							            <th class="sorting text-center padding-both-side-2 width_2" >Receive Qty</th>
         					...
         					<tbody class="dataTables-Main-Body">
              					<tr data-ng-class="$index % 2 == 0? 'even' : 'odd'" ng-repeat="batchData in displayedCollectionBatch">
					               ...
					               <td><input type="text" ng-pattern-restrict="^[0-9]*$"  ng-model="batchData.receiveQty" ng-blur="checkQty(batchData)"></td>
