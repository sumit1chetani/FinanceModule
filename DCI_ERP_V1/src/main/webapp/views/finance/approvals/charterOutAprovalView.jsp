		...
		<div class="panel-body">
			<form name="invoiceForOwnerForm" class="form-horizontal" novalidate>
				<div class="row book-widget-row">
						<input type="hidden" ng-model="invoiceForOwner.ExchangeRateFrom" id="ExchangeRateFrom" /> 
						<input type="hidden" ng-model="invoiceForOwner.ExchangeRateTo" id="ExchangeRateTo" /> 
						<input type="hidden" ng-model="invoiceForOwner.currencyValue" id="currencyValue" /> 
						<input type="hidden" ng-model="invoiceForOwner.fraction" id="fraction" />
						...
						<fieldset ng-disabled="viewDisable">
							<div class="col-md-4">
								<div class="form-group">
									...
									<div class="col-md-7">
										<input type="hidden" ng-model="invoiceForOwner.companyCode" id="txtCompany" ng-disabled="true" />
								 		<label class="form-label-control" ng-bind="invoiceForOwner.companyName"></label>
									</div>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
	    							...
	    							<div class="col-md-7">
								          ...
								          <label class="form-label-control" ng-bind="invoiceForOwner.invoiceDate"></label>
								        </div>   									
	    							</div>
			       				</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									...
									<div class="col-md-5">
										<input type="text" class="form-control input-sm" ng-if="invoiceForOwner.blRelated=='Y'" value="Yes" ng-disabled="true" />
										<input type="text" class="form-control input-sm" ng-if="invoiceForOwner.blRelated=='N'" value="No" ng-disabled="true" />
						...
						<fieldset ng-disabled="viewDisable">
							<div class="col-md-4">
								<div class="form-group">
									...
									<div class="col-md-7">
								 		<label class="form-label-control" ng-bind="invoiceForOwner.customerName"></label>
									</div>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									...
									<div class="col-md-7">
										<label class="form-label-control" ng-bind="invoiceForOwner.mloName"></label>
									</div>
								</div>
							</div>
							<div class="col-md-4" id="blcheck">
								<div class="form-group">
									...
									<div class="col-md-7">
										<label class="form-label-control" ng-bind="invoiceForOwner.bl"></label>
									</div>
								</div>
							</div>
						</fieldset>
						...
						<fieldset ng-disabled="viewDisable">
							<div class="col-md-4">
								<div class="form-group">
									...
									<div class="col-md-7">
										<label class="form-label-control" ng-bind="invoiceForOwner.currencyName"></label>
									</div>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									...
									<div class="col-md-7">
										<label class="form-label-control" ng-bind="invoiceForOwner.exchangeRate"></label>
									</div>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									...
									<div class="col-md-7">
										<label class="form-label-control" ng-bind="invoiceForOwner.subject"></label>
									</div>
								</div>
							</div>
						</fieldset>
						...
						<fieldset ng-disabled="viewDisable">
							<div class="col-md-4">
								<div class="form-group">
									...
									<div class="col-md-7">
							 			<label class="form-label-control" ng-bind="invoiceForOwner.vesselName"></label>
									</div>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									...
									<div class="col-md-7">
								 		<label class="form-label-control" ng-bind="invoiceForOwner.voyage"></label>
									</div>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									...
									<div class="col-md-7">
										<label class="form-label-control" ng-bind="invoiceForOwner.serviceName"></label>
									</div>
								</div>
							</div>
						</fieldset>
						...
						<fieldset ng-disabled="viewDisable">
									...
									<div class="col-md-7">
										<div class="row">
											<div class="col-md-6 custom-col-md-6 pull-left ">
												...
												<label class="form-label-control" ng-bind="invoiceForOwner.unit20"></label>
											</div>
											<div class="col-md-6 custom-col-md-6 pull-left">
												<label class="col-md-3 custom-col-md-3 control-label">40'</label>
												<label class="form-label-control" ng-bind="invoiceForOwner.unit40"></label>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<div class="col-md-7">
								 		<label class="form-label-control" ng-bind="invoiceForOwner.pol"></label>
									</div>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									...
									<div class="col-md-7">
								 		<label class="form-label-control" ng-bind="invoiceForOwner.pod"></label>
									</div>
								</div>
							</div>
						</fieldset>
				...
				<div class="table-responsive">
					<table class="table table-striped b-t b-light">
						...
						<tbody ng-repeat="(trIndex, row) in invoiceForOwner.detailList" ng-controller="detailViewCtrl">
							<tr>
				...
				<div class="form-actions">
					<div class="row">
						<div class="col-md-12">
							<button class="btn btn-danger" ng-if="invoiceForOwnerTable!=true" ng-click="cancel()" type="button">
								<i class="fa fa-close"></i> Cancel
							</button>
							<button class="btn btn-success" ng-if="invoiceForOwnerTable!=true" ng-click="printinvoiceForOwner(invoiceForOwner.invoiceNo)"  type="button">
				        	  Print
				          	</button> 
             			  <button class="btn btn-success" ng-if="invoiceForOwnerTable!=true" ng-click="ApproveVoucher(invoiceForOwner.invoiceNo)"  type="button">
				        	  Approve
				          	</button> 
				          	<button class="btn btn-danger" ng-if="invoiceForOwnerTable!=true" ng-click="RejectVoucher(invoiceForOwner.invoiceNo)"  type="button">
				        	  Reject
				          	</button> 
						</div>
					</div>
