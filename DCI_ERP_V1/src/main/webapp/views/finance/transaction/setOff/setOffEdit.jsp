		...
		<div class="form-body form-horizontal">
			<div class="row m-t-sm">
				...
				<div class="col-sm-12 col-md-6 col-lg-6 ">
					...
					<fieldset>
						<div class="form-group">
							<label class="col-md-4 control-label  bold">SetOffDate</label>
							<div class="col-md-8">
									<ng-bs3-datepicker data-ng-model="setOffDate"
											name="setOffDate" 
   ...
   <div class="form-actions">
			...
			<div class="col-md-12">
				<button class="btn btn-success"
					ng-click="updatesetOff(displayedCollection)" type="button">Update
					</button>
