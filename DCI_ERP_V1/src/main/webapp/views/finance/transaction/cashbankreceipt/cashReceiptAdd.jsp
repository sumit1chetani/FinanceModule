					...
					<div class="col-sm-12 col-md-12 col-lg-12">
						<div class="col-sm-4 col-md-4 col-lg-4">
							<fieldset ng-disabled="isView">
								...
								<!-- <div class="form-group" ng-if="show">
									<label class="col-md-5 control-label">Bank A/c <span style="color: red;">*</span></label>
									<div class="col-md-7 inputGroupContainer">
								...
								<div class="form-group">
									<label class="col-md-5 control-label">Cash Account <span
										style="color: red;">*</span></label>
									<div class="col-md-7 inputGroupContainer">
										<selectivity list="cashList" property="objCBReceipt.cashAcc"
											id="cashAcc_id" name="cashAcc_id"
						...
						<div class="col-sm-4 col-md-4 col-lg-4">
							<fieldset ng-disabled="isView">
								...
								<div class="form-group">
									<label class="col-md-5 control-label"> BC Amount<span
										style="color: red;">*</span></label>
									<div class="col-md-7">
										<input type="text" class="form-control input-sm text-right"
						...
						<thead>
							<tr>
								...
								<th colspan=1 class="width_8 text-center">TC Amount<span
									style="color: red;">*</span></th>
								<th colspan=1 class="width_8 text-center">BC Amount<span
									style="color: red;">*</span></th>
								<th colspan=1 class="width_1"></th>
							</tr>
						</thead>
									...
									<div class="row">
										<div class="col-xs-12">
											...
											<input type="hidden" class="form-control input-sm"
												...
												name="invoice{{trIndex}}" readonly /> <input type="hidden"
					...
					<div class="row">
						<div class="col-sm-12 col-md-12 col-lg-12">
							<div class="form-group pull-right">
								...
								<div class="col-md-3">
									<input type="text" class="form-control input-sm text-right"
										ng-model="cbRcptDtlTotalAmt.balTCAmount" placeholder="0.0"
										readonly name="TC Total">
								</div>

								<label class="col-md-3 control-label"> Balance BC Amt</label>
								<div class="col-md-3">
									<input type="text" class="form-control input-sm text-right"
										ng-model="cbRcptDtlTotalAmt.balBCAmount" placeholder="0.0"
										readonly name="BC Total">
								</div>
						...
						<div class="col-sm-12 col-md-12 col-lg-12">
							<div class="form-group pull-right">
								...
								<label class="col-md-3 control-label"
									style="padding-left: 44px;"> Total TC Amt</label>
								<div class="col-md-3">
									<input type="text" class="form-control input-sm text-right"
						...
						<div class="col-sm-12 col-md-12 col-lg-12">
							<div class="content">
								<div class="form-actions">
									<div class="row">
										<div class="col-md-12">
											<button id="addBtn" class="btn btn-success" ng-hide="isView"
												type="button" ng-if="!edit"
