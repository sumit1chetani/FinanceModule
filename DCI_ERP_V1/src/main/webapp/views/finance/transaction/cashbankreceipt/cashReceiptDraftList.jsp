    ...
    <table id="dt_basic" class="table table-striped table-bordered table-hover dataTable no-footer" width="100%" role="grid" aria-describedby="dt_basic_info">
     <thead class="dataTables-Main-Head">
      <tr role="row">
       ...
       <th class="sorting width_30" st-sort="objCashBankRCptListItem.accountName">Cash</th>
      <th class="sorting width_10" st-sort="objCashBankRCptListItem.bcAmountHdr">BC Amount</th> 
       <th class="sorting width_10" st-sort="objCashBankRCptListItem.tcAmountHdr">TC Amount</th> 
       <th>Action</th>
      </tr>
     </thead>
 ...
 <!--       <td class="width_20" >
       ...
       <td class="width_15">
        <span tooltip="{{objCashBankRCptListItem.accountName}}" class="tool-tip-span text-wrap" ng-bind="objCashBankRCptListItem.accountName"></span>
         ...
         <td class="width_15" ng-bind="objCashBankRCptListItem.bcAmountHdr"></td>
          <td class="width_15" ng-bind="objCashBankRCptListItem.tcAmountHdr"></td> 
