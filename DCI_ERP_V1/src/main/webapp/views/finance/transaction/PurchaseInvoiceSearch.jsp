     ...
     <div class="col-sm-12 col-md-4 col-lg-4">
      <fieldset>
       <div class="form-group">
        ...
        <div class="col-md-8">
                      <select id="customerType" multiple="multiple"  name="customerType" ng-model="purchase.lCustomerType" validatin="required"
      ng-options="option.text for option in customerTypelist" data-dropdownmultiselect>    
        <option data-ng-repeat="option in customerTypelist" value="{{getCustomerTypeId(option)}}" data-ng-bind-template="{{option.customerType}}"></option>
         ...
         <div class="form-group">
        <label class="col-md-4 control-label">Charge Heads <span style="color: red;"></span></label>
        <div class="col-md-8">
                      <div class="checkbox">
											<label class="i-checks"> <input type="checkbox"checked="checked" 
											ng-false-value = "'N'" ng-true-value = "'Y'"
												id="isActive" class="checkbox style-0" name="Active"
												ng-model="purchase.charge" /> <i></i>
											</label>
        ...
        <div class="col-md-7">
                  ...
                  <select id="pol" multiple="multiple"  name="pol" ng-model="purchase.lpol"
      ng-options="option.text for option in polList" data-dropdownmultiselect>    
        ...
        <div class="col-md-7">
            ...
            <select id="pod" multiple="multiple"  name="pod" ng-model="purchase.lpod"
       ...
       <!-- <div class="form-group">
        <label class="col-md-4 control-label">Party</label>
         <div class="col-md-8">
                  ...
                  <select id="party" multiple="multiple"  name="party" ng-model="purchase.lparty"
      ng-options="option.text for option in partyList" data-dropdownmultiselect>    
        <option data-ng-repeat="option in partyList" value="{{getpartyId(option)}}" data-ng-bind-template="{{option.text}}"></option>
     </select> 
			...
			<div class="table-responsive ">
				<table class="table table-striped table-hover dataTable no-footer">
					<thead class="dataTables-Main-Head">
						<tr>
							 <th class=" width_6 padding-number-align text-center "  data-ng-repeat ="column in messageHeaderList" 
