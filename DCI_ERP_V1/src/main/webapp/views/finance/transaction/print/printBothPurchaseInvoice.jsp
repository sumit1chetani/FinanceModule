		...
		<table class="width_100" align="center" border="0" cellPadding="0"
			...
			<tr>
				<td><br> 
					...
					<table width=100% align="center" border="1" cellPadding="0" style="border-left: none;border-right: none;"
						cellSpacing="0">
						<tr>
							<td><center>
					...
					<table width="50%" style="float:left; padding-top:10px; padding-bottom:15px;"><tr>
							...
							<tr><td class="width_40"  style="font-size: 10px;"><b>PURCHASE INVOICE NO</b></td><td style="font-size: 10px;">: ${object1.purchaseInvoiceNo}</td></tr>
							 ...
							 <tr><td class="width_40" style="font-size: 10px;"><b>HAWB NO</b></td><td style="font-size: 10px;">: ${object1.hawbNo}</td></tr>
							<tr><td class="width_40"  style="font-size: 10px;"><b>MAWB NO</b></td><td style="font-size: 10px;">: ${object1.mawbNo}</td></tr>
							...
							<tr><td class="width_40"  style="font-size: 10px;"><b>REFERENCE NO</b></td><td style="font-size: 10px;">: ${object1.reference}</td></tr>
					...
					<table class="table table-striped b-t b-light " style="border-left: none;border-right: none;"
						...
						<thead>
							<tr>
								...
								<th class="width_12" align="center" style="font-size: 10px;">TOTAL(INR)</th>
								<th class="width_12" align="center" style="font-size: 10px;">TOTAL(${object1.hdrCurrency})</th>
							</tr>
						</thead>
						<tbody>
							<c:forEach var="ob"
                              ...
                              <td align="right" valign="right" style="font-size: 10px;"><fmt:formatNumber type="number"
												...
												<td align="right" valign="right" style="font-size: 10px;"><fmt:formatNumber type="number"
												minFractionDigits="2" maxFractionDigits="2"
												value="${object1.totalTcAmount}" /></td>
                              </tr>     
						</tbody>
