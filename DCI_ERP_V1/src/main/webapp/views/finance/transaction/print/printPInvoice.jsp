		...
		<table class="width_100" align="center" border="0" cellPadding="0" cellSpacing="0">
			<tr>
				...
				<table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="FFFFFF" bordercolor="" align="center">		
					<tr>
						<td><!-- <img class="width_22" src='/img/interafrica_new.png'/>' --></td>
					</tr>
				</table><br>
				<font size="5" face="arial"><b>PURCHASE INVOICE</b></font>
					<table width=100% align="center" border="1" cellPadding="0" cellSpacing="0">
						<tr>						
							...
							<td valign="top" colspan="3" class="width_5 line-height-23p padding-left-5 border-bottom-1p border-right-none"><span class="normal">
					...
					<table class="table table-striped b-t b-light padding-top-10" align="left" border="1"  bordercolor="" cellPadding="0" cellSpacing="0" width=100%>
						<thead>					
							<tr>
								<th class="width_7" align="center"><span class="thead-bold">Company</span></th>
					            ...
					            <th class="width_5" align="center"><span class="thead-bold">VAT Percentage (%)</span></th>							
							    <th class="width_5" align="center"><span class="thead-bold">VAT Tc Amount</span></th>	
							    <th class="width_5" align="center"><span class="thead-bold">VAT Bc Amount</span></th>							
							    						
								
														
								<th class="width_7" align="center"><span class="thead-bold">TC Amount</span></th>
						...
						<tbody>									
								<c:forEach var="ob" items="${purchaseInvoiceList.purchaseInvoiceDetail}" varStatus="theCount"> 
									<tr>
										<td class="subcolor width_7 detail-table-cell" align="left" valign="top">
										...
										<td class="subcolor width_45 detail-table-cell" align="left" valign="top">																			
											...
											<c:choose>
											    <c:when test="${empty ob.voyageName}">
											    	<span class="detail-table-font"></span>
													<!-- <font face="arial" size="2"></font> -->												        
											    </c:when>
											    <c:otherwise>
											    	<span class="detail-table-font">
											        	 <b>Trip:</b> ${ob.voyageName}<br>
											        </span>
											    </c:otherwise>
											</c:choose>	
											...
											<c:choose>
											    ...
											    <c:otherwise>
											    	<span class="detail-table-font">
											    		<b>Truck:</b> ${ob.vesselCode} -  ${ob.vesselName}
											    	</span><br>
										...
										<span class="detail-table-font"> 
										${ob.vatPercentage} 
										</span></td><td class="subcolor width_5 detail-table-cell" align="right">
										<span class="detail-table-font"> 
										${ob.vatAmount} 
										</span></td>
								...
								<tr>
									<td class="width_7" border="0" align="right" valign="top">
									</td>									
									...
									<td class="width_5" align="right" valign="top">
									${object1.totalVatAmount}
									</td>
									
									<td class="width_5" align="right" valign="top">
									${object1.totalVatBcAmount}
									</td>
									<td class="width_7" align="right">
