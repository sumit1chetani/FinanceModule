...
<body style="border:1px solid black"> 
			...
			<tr>
				<td><br> 
							...
							<td width="50%" style="text-align: center;">
								...
								<table border="0" width="100%" cellpadding="0" cellspacing="0"
									...
									<tr>
										...
										<td width="75%" style="font-size: 14px;"><span style="text-align: center;"><b>MBK
													 LOGISTICS PVT LTD</b></span> <br> <span
					...
					<table width="50%" style="float:left; padding-top:10px; padding-bottom:15px;"><tr>
							<td class="width_40"  style="font-size: 10px;"><b>DATE</b></td><td style="font-size: 10px;">: ${object1.invoiceDate}</td></tr>
							<tr><td class="width_40"  style="font-size: 10px;"><b>INVOICE NO</b></td><td style="font-size: 10px;">: ${object1.invoiceNo}</td></tr>
							<tr><td class="width_40"  style="font-size: 10px;"><b>PARTY INVOICE NO</b></td><td style="font-size: 10px;">: ${object1.partyInvNo}</td></tr>
					...
					<table class="table table-striped b-t b-light "
						...
						<thead>
							<tr>
								<th class="width_10" align="center" style="font-size: 10px;">Company</th>
								<th class="width_10" align="center" style="font-size: 10px;">Charge Heads</th>
								<th class="width_8" align="center" style="font-size: 10px;">SAC No</th>
						...
						<tbody>
							<c:forEach var="ob"
								items="${generalInvoiceList.GIDtl}"
								varStatus="theCount">
								<tr>
								<td  align="left" style="font-size: 10px;">${ob.company}</td>
									<td  align="left" style="font-size: 10px;">${ob.chargeHeadName}</td>
						...
						<table style="font-size: 12px;">
						    ...
						    <tr>
						    <td>Please issue all payment in favour of &nbsp;"MBK"</td>
						    </tr>
						</table>
					</table></td>
			</tr>
	...
	<div>
		...
		<br> <font size="1" face="arial"><b>FOR MBK (ADMIN)</b></font><br><font size="1" face="arial"> Remarks :${object1.remarks}</font>
		<br><br><br>
