...
<style type="text/css" media="print">
	...
	<body>
	<c:forEach var="object1" items="${purchaseInvoiceList.lBulkPIBean}" varStatus="loopCounter">			
		<%-- <c:set var="object1" value="${purchaseInvoiceList}" /> --%>
		<div class="break_page">
		<div id="content"  style="margin-bottom: 0px;">
		<table class="width_100" height="90%" align="center" valign="top" border="0" cellPadding="0" cellSpacing="0">
			<tr>
				<td> <br>
				<table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="FFFFFF" bordercolor="" align="center"  valign="top">		
					<tr>
						<td  valign="top"><!-- <img class="width_22" src='/img/sfpl_logo_202x48.jpg'/>' --></td>
					</tr>
				</table><br>
				<font size="5" face="arial"><b>PURCHASE INVOICE</b></font>
					...
					<table class="table table-striped b-t b-light padding-top-10" align="left" border="1"  bordercolor="" cellPadding="0" cellSpacing="0" width=100%>
						...
						<tbody>									
								<c:forEach var="ob" items="${object1.purchaseInvoiceDetail}" varStatus="theCount">
									<tr>
