...
<body>
								...
								<table border="0" width="100%" cellpadding="0" cellspacing="0"
									...
									<tr>
										...
										<td width="60%" style="word-wrap: break-word;padding-left: 2%;padding-right: 2%;">
											...
											<p style="text-align: right; padding-right:0px !important; "><span style="text-align: left;font-size: 15px;">${object1.branchAddress1}</span> <br> 
    ...
    border-right: none;"
					...
					<tr><td class="width_30" align="left" style="font-size: 10px;"><b>To</b></td></tr><tr><td style="font-size: 10px;"><b>Customer Id:${object1.customerName}</b></td></tr><tr><td style="font-size: 10px;"><b>${object1.cutName}</b></td></tr><tr><td style="font-size: 10px;">${object1.custAddress1}${object1.custAddress2}${object1.custAddress3}
