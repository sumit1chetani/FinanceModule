...
<body style="border:1px solid black;width: 94%;margin-left: 25px;">
    ...
    border-right: none;"
						...
						<tbody>
						<c:if test="${containerDetails.conlist !=null}"><td>Containers:</td></c:if>
							<c:forEach var="ob"
								items="${containerDetails.conlist}"
								varStatus="theCount">
							
								<td style="font-family:'Courier New'">${ob.containerNo}&nbsp;</td>
						   </c:forEach>
						 </tbody>   
						</table>
						<table style="font-size: 12px;">
						    ...
						    <tr>
						    <td>Please issue all payment in favour of &nbsp"MBK"</td>
						    </tr>
						</table>
					</table></td>
			</tr>
