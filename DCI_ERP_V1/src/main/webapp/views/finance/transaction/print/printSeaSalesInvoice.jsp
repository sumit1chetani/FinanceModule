...
<body style="width: 94%;margin-left: 25px;">
								...
								<table border="0" width="100%" cellpadding="0" cellspacing="0"
									...
									<tr>
										...
										<td width="75%" style="font-size: 14px;"><span style="text-align: center;"><b>MBK
											...
											style="text-align: right;" style="font-size: 12px;">${object1.branchAddress1},${object1.branchAddress2},${object1.branchZip} </span> <br> 
											<span
    ...
    border-right: none;"
						...
						<tr>
							<td><center>
									<font size="2" face="arial"><b>${object1.invoiceType}</b></font>
								</center></td>
						</tr>
					</table> 
    ...
    border-right: none;"
						...
						<tbody>
							<c:forEach var="ob"
								...
								varStatus="theCount">
								<tr>
									<td  align="left" style="font-size: 9px;">${ob.accountHeadCode}</td>
                             ...
                             <!--  <td align="right" valign="right" style="font-size: 10px;"></td> -->
                              ...
                              <td colspan="3" class="width_10" align="right" style="font-size: 12px;" >ROUND OFF</td>                      
                            
                              
                              <td align="right" valign="right" style="font-size: 10px;"><fmt:formatNumber type="number"
												minFractionDigits="2" maxFractionDigits="2"
												value="${object1.roundOff}" /></td>
												<td colspan="2" class="width_10" align="right" style="font-size: 12px;" >GRAND TOTAL</td>  
                              <td align="right" valign="right" style="font-size: 10px;"><fmt:formatNumber type="number"
												minFractionDigits="2" maxFractionDigits="2"
						...
						<table style="font-size: 12px;">
						    ...
						    <tr>
							<td>
							If any discrepancy revert us with in 10 Days.
							</td>
							</tr>
						</table>
					</table></td>
	...
	<div >
		...
		<br> <font size="1" face="arial"><b>FOR MBK (${object1.branchName})</b></font><br><font size="1" face="arial"> Remarks :${object1.remarks}</font>
		<br><br><br>
