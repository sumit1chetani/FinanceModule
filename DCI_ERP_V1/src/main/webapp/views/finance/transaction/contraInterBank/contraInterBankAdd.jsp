 ...
 <div class="panel panel-default panel-default-form">
  <div class="panel-heading panel-heading-form font-bold">
   <ol class="breadcrumb padding-left-0">
    ...
    <li>
     <a1 x-ui-sref="app.finance.transaction.journalvoucher.list">Contra Inter Bank</a1>
    </li>
   ...
   <form class="form-horizontal" name="journalVoucherForm" >
    <div class="row book-widget-row">
     <div class="col-sm-12 col-md-12 col-lg-12">
     	<div class="col-sm-4 col-md-4 col-lg-4" ng-if="journalVoucher.isEdit">
       ...
       data-ng-change="checkDatesCL(journalVoucher.dataOfIssue)" friendly-name="From Date" validation="required"/>
       ...
       data-ng-change="checkDatesCL(journalVoucher.dataOfIssue)" 
        friendly-name="JV Date" validation="required"/>
	             <!--  </div> -->
		        </div>
	       	</div>
	    </div>
	    <div class="col-sm-4 col-msd-4 col-lg-4">
	     ...
	     <!-- <div class="col-sm-4 col-msd-4 col-lg-4">
	    	<div class="form-group">
		       	<label for="inputPassword" class="control-label col-md-6 col-lg-6">isOpeningBalance<span style="color: red;">*</span></label>
		       	<div class="col-md-6">
			        <textarea id="txtNarration" ng-model="journalVoucher.narration" name="Narration" friendly-name="Narration" validation="required" 
			        class="custom-scroll width_100" rows="1"></textarea>
			        
		<label class="i-checks m-b`-none"> <input type="checkbox" ng-model="journalVoucher.openingBalance" id="openingBalance" /><i></i></label>
       ...
       <div class="table-responsive clear">
          <table class="table table-striped b-t b-light">
	          <thead>
		          <tr>
			          ...
			          <th class="width_6 text-center padding-both-side-2">Ex-Rate<span style="color: red;">*</span></th>
	          ...
	          <tbody ng-repeat="(trIndex, row) in journalVoucher.tables" ng-controller="tableCtrlJV">	          
		          ...
		          <!--   <td class="padding-both-side-2">
		             	...
		             	<div class="row">
				            <div class="col-xs-12" ng-if="row.isCurrencyBlocked">
		           			...
		           			<div class="col-xs-12" ng-if="!row.isCurrencyBlocked">
				            	  <selectivity list="currencyList" property="row.currency" id="currency{{trIndex}}" object="currency" 
				            	  name="currency{{trIndex}}" validation="required" friendly-name="{{ 'Row' + $index + '(Currency)'}}" 
				            	  ng-model="row.currency" property="row.currency" form-name="journalVoucherForm"></selectivity>
		           			</div>
		            ...
		            <input type="hidden" class="form-control input-sm text-right" id="txtFromCurrency{{trIndex}}" ng-model="row.fromCurrency"  
		              ...
		              validation="required" friendly-name="{{ 'Row' + $index + '(Exchange rate)'}}" ng-pattern-restrict="^\d+(?:\.\d{0,3})?$">
		            </td>
		            <td class="padding-both-side-2">
	    ...
	    <!--        	ng-if = "draft == false" -->
	        		...
	        		ng-click="saveDraft(journalVoucherForm,journalVoucher)">
