...
<%-- <security:authorize access="hasRole('F0358_D')" var="isDelete" />
<security:authorize access="hasRole('F0358_A')" var="isAdd" />
<security:authorize access="hasRole('F0358_UP')" var="isUpload" /> --%>
<div id="content">
 <!-- widget grid -->
        ...
        <table id="dt_basic" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dt_basic_info">
         <thead class="dataTables-Main-Head">
          <tr>
           ...
           <th class="sorting width_5" st-sort="assetMaintenanceContractNo">AMC No </th>
         ...
         <tbody class="dataTables-Main-Body">
          ...
          <td cs-select="amcObject" class="text-center"></td>        
