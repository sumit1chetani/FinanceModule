...
<div class="form-group " ng-if="screenNames=='receipt'">
								<label class="col-md-5 control-label">Voucher Date <span
									style="color: red">*</span></label>
								<div class="col-md-7 ">
									<ng-bs3-datepicker
										ng-disabled="createQuote" data-ng-model="objCBReceipt.cbReceiptDate"
										id="cbReceiptDate" name="Receipt Date"
...
<label class="col-md-4 control-label line-height-30">Voucher
Date<span style="color: red;"> *</span>
</label>
<div class="col-md-6">
<div class="dropdown">
<a class="dropdown-toggle" id="cashbankPmtDate" role="button"
data-toggle="dropdown" data-target="#" href="#">
<div class="input-group">
<input type="text" class="form-control" placeholder="dd/mm/yyyy" name="Receipt Date"
...
<div class="form-group " ng-if="screenNames=='payment'">
								...
								<div class="col-md-7 ">
									<ng-bs3-datepicker
										...
										id="cashbankPmtDate" name="Payment Date"
