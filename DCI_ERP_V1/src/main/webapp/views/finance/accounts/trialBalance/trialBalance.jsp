...
<!-- <div class="form-group" data-ng-if="trialBalance.isGenerate">
	...
	<div class="form-group" data-ng-if="trialBalance.isGenerate">
					             		<label class="col-md-5 control-label"> Closing Balance</label>
					             			<div class="col-md-6">
							              		<div class="checkbox">
							               			<label> 
  							               				<input type="checkbox" name = "currentBalance"  data-ng-model="trialBalance.opnbal" data-ng-true-value="'Y'" data-ng-false-value="'N'"   ng-click = "Showbalance()"/>
									...
									<div class="row">
										<div class="col-xs-12">
										    <div collapse="isThingsCollapsed" >
											 <div id="trialhead"></div>
											<div id="jqgrid" style="margin-top: 10px;">  
												<table id="trialBalanceGrid" class="table text-capitalize"></table> 
