       ...
       <table id="dt_basic"
         ...
         <thead class="dataTables-Main-Head">
          <tr>
           ...
           <th class="sorting width_10" data-st-sort="">Sub Tax Code</th>
           <th class="sorting width_10" data-st-sort="">Sub Tax Name</th>
          ...
          <!-- <td class="width_1 text-center">
            <label class="i-checks m-b-none">
             ...
             <i></i>
              ...
              <td>{{collection.subTaxCode}}</td>
                 <td>{{collection.subTaxName}}</td>
            <td>
        ...
        <span>
         <i class="fa  fa-pencil text-success text" data-ng-click="editRow(collection.subTaxId)"></i>
        </span>
        </security:authorize>
