<div class="wrapper-md">
	<div class="panel panel-default panel-default-form">
		...
		<div class="panel-body">
						<form id="purchaseInvoiceForm" name="purchaseInvoiceForm"
							class="form-horizontal" novalidate method="post">
							<div class="row">
															...
															<a class="dropdown-toggle" id="purchaseInvoiceDate"
																...
																<div class="input-group">
																	<input type="text" class="form-control"
																		...
																		friendly-name="Pur Invoice Date" disabled="edit"/><span
...
data-datetimepicker-config="{ dropdownSelector: '#dueDate',startView:'day', minView:'day'}"  />
														...
														<!-- <div class="input-group" ng-if="edit">
																	<input type="text" class="form-control"
																		...
																		class="input-group-addon"><i
																		class="glyphicon glyphicon-calendar" disabled="true"></i></span>
																</div> -->
											...
											<div class="form-group">
												...
												<div class="col-md-7">
													<input type="text" class="form-control input-sm"
														...
														ng-model="purchaseInvoiceData.bcamount" friendly-name=" Amount" />
												</div>
											</div>
									...
									<thead class="dataTables-Main-Head">
										<tr>
											...
											<th colspan="1" class="sorting width_10 text-center">Unit
												price</th>
												<th colspan="1" class="sorting width_10 text-center">Cost 
												Center</th>
												...
												<div class="row">
													<div class="col-xs-12"> 
														<input type="text" class="form-control input-sm" 
															...
															ng-model="row.discountAmount" name="discountAmount"
															ng-keyup="calculateProductAmount(purchaseInvoiceData.purchaseInvoiceProdDetail)"
															ng-disabled="isGRNNo" />
				        	...
				        	<div class="col-sm-12">							        	
								...
								<div class="col-md-4" ng-if="row.isCostCenter "  style="padding-top: 10px;">
									...
									<div class="col-md-9">
										...
										ng-model="row.costCenter"
										 property="row.costCenter" 
										 id="costCenterId{{trIndex}}"   ></selectivity>
								    </div>
								</div>
								<div class="col-md-4" ng-if="row.isCompany"  style="padding-top: 10px;">
