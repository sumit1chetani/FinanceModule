 ...
 --%>		</div>
        <table id="dt_basic"
         ...
         <thead class="dataTables-Main-Head">
          <tr>
           ...
           <th class="sorting width_15" data-st-sort="subGroupName">Sub Group Name</th>
           <!-- <th class="sorting width_10" data-st-sort="grpHeadCode">Group Head Code</th> -->
           <!-- <th class="sorting width_10" data-st-sort="grpHeadCode">Sub Group Head</th> -->
            <th class="sorting width_10" data-st-sort="grpHeadCode">Group Head</th>
           <th class="sorting width_10" data-st-sort="grpHeadCode">Group Master</th>
      ...
      <tr data-ng-class="$index % 2 == 0? 'even' : 'odd'" ng-repeat="objSubGrpAcctBean in displayedCollection">
       ...
       <!-- <td class="sorting ">{{objSubGrpAcctBean.grpHeadCode}}</td> -->
              <td class="sorting ">{{objSubGrpAcctBean.subHeadCode}}</td>
