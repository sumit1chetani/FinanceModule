...
<div class="breadcrumb-wrapper ng-scope">
	<div class="panel panel-default panel-default-form">
		<div class="panel-heading panel-heading-form font-bold">
			<ol class="breadcrumb padding-left-0">
				...
				<li><a x-ui-sref="app.finance.transaction.journalvoucher.list">Journal
						Voucher</a></li>
				<li ng-if="journalVoucher.isEdit"><a
					x-ui-sref="app.finance.transaction.journalvoucher.edit">View</a></li>
			</ol>
		</div>
					...
					<div class="col-sm-12 col-md-12 col-lg-12">
						...
						<div class="col-md-3" ng-if="!edit">
							<div class="form-group">
								<label class="col-md-5 control-label"> JV No<span
									style="color: red">*</span></label>
								<div class="col-md-7">
									<input type="text" class="form-control input-sm text-left"
										name="Journal voucherNo" property="journalVoucher.jvNumber"
										id="journalvoucherNo" ng-model="journalVoucher.jvNumber"
										friendly-name="Journal Voucher No" disabled="true" />
								</div>
							</div>
						</div>
								...
								<div class="form-group">
									...
									<div class="col-md-7">
										...
										<selectivity list="companyList" ng-if="!edit" id="company_id"
											...
											ng-model="journalVoucher.company" validation="required"
											friendly-name="Hospital" object="hospitalObj"
											disabled="isGRNNo"></selectivity>

										<selectivity list="companyList" ng-if="edit" id="company_id"
											name="Hospital" form-name="purchaseInvoiceForm"
											property="journalVoucher.company"
											ng-model="journalVoucher.company" validation="required"
											friendly-name="Hospital" object="hospitalObj" disabled="true"></selectivity>
									</div>
								</div>
						</div>
						...
						<div class="col-sm-3 col-md-3 col-lg-3">
							<fieldset>
								...
								<div class="form-group">
									<label class="col-md-3 control-label"> JV Date <span
										style="color: red";>*</span>
									</label>
									<div class="col-md-8">
										<div class='input-group date datetimepick col-md-12'>
											<div class="dropdown">
												<a class="dropdown-toggle" id="dataOfIssue" role="button"
												...
												<ul class="dropdown-menu" role="menu"
													...
													<datetimepicker data-ng-model="journalVoucher.dataOfIssue"
						...
						<div class="col-md-3">
							...
							<!-- <div class="form-group">
												<label class="col-md-6 control-label"> JV Type </label>
												<div class="col-md-6">
						...
						<div
							...
							<table
								...
								<thead class="dataTables-Main-Head">
									<tr>
										<th class="width_3 sorting text-center padding-both-side-2"></th>
										<!-- <th class="text-center padding-both-side-2">Sub Group</th> -->
										<th class="width_15 sorting text-center padding-both-side-2"><!-- Account Head --> Ledger <span style="color: red";>*</span>
										</th>
										<th class="width_15 sorting text-center padding-both-side-2"><!-- Sub Account -->Ledger Code</th>
										<!-- <th
 ...
 -->
										<th class="width_10 sorting text-center padding-both-side-2">
											Debit</th>
 ...
 -->
									...
									<tr>
										<td class="padding-both-side-2"><label
											class="i-checks m-b-none"> <input type="checkbox"
												ng-model="row.select" id="section{{trIndex}}"
												disabled="true" /><i></i></label></td>
										<td class="padding-both-side-2"><selectivity class=""
												list="accountHeadList" ng-model="row.accountCode"
												property="row.accountCode" id="txtAccountCode{{trIndex}}"
												name="{{ 'accountCode' + $index }}" validation="required"
										...
										<td>
											<!-- 	<selectivity
																...
																form-name="journalVoucherForm" disabled="true"></selectivity> -->
											<input type="text"
										...
										<!-- <td class="padding-both-side-2"><input type="text"
															class="form-control input-sm journalVoucher-textBox"
															ng-model="row.narration" disabled="true"></td>
														<td class="padding-both-side-2"><selectivity
																...
																form-name="journalVoucherForm" disabled="true"></selectivity></td> -->
			              ...
			              <input type="text" class="form-control input-sm journalVoucher-textBox" ng-model="row.exchangeRate" />
			            	...
			            	<input type="text" class="form-control input-sm journalVoucher-textBox" ng-model="row.tcDebitAmount" ng-keyup="numberCheck(row)" ng-change="onChangeTcDebit(row,journalVoucher.tables)" />
										...
										<td class="padding-both-side-2"><input type="text"
											class="form-control input-sm journalVoucher-textBox text-right"
											ng-model="row.bcDebitAmount|number:2"
											ng-keyup="numberCheck(row)"
			            	...
			            	<input type="text" class="form-control input-sm  journalVoucher-textBox" ng-model="row.tcCreditAmount" ng-keyup="numberCheck(row)" ng-change="onChangeTcCredit(row,journalVoucher.tables)" />
										...
										<td class="padding-both-side-2"><input type="text"
											class="form-control input-sm journalVoucher-textBox text-right"
											ng-model="row.bcCreditAmount|number:2"
											ng-keyup="numberCheck(row)"
										...
										<td colspan="12">
											<div class="col-sm-12">
												<div class="col-sm-4" ng-if="row.isEmployee">
													...
													<div class="col-md-9">
														<selectivity list="employeeList"
															property="row.employeeCode" id="employeeCode{{trIndex}}"></selectivity>
													</div>
												</div>
												...
												<div class="col-sm-4" ng-if="row.isLocation">
													...
													<div class="col-md-9">
														<selectivity list="studentList" property="row.countryCode"
												...
												<div class="col-sm-4" class="col-sm-4"
													...
													<div class="col-md-9">
														<selectivity list="customerList"
															property="row.customerCode" id="customerCode{{trIndex}}"></selectivity>
													</div>
												</div>
												<div class="col-sm-4" style="padding-top: 10px;"
													...
													<div class="col-md-9">
														<selectivity list="supplierList"
															property="row.supplierCode" id="supplierCode{{trIndex}}"></selectivity>
													</div>
												</div>
												<div class="col-sm-4" style="padding-top: 10px;"
												...
												<div class="col-sm-4" style="padding-top: 10px;"
													...
													<div class="col-md-9">
														<selectivity list="patientList" property="row.patientCode"
				        	...
				        	<input type="text" class="form-control input-sm" id="totaltcCredit" ng-model="totaltcCredit" readonly>
								...
								<div class="col-md-12">
									<div class="form-group">
										<label class="col-md-1 control-label"> Narration </label>
										<div class="col-md-11">
											<textarea type="text" class="form-control input-sm"
												id="txtNarration" name="Narration"
												data-ng-model="journalVoucher.narration"
												friendly-name="Narration"></textarea>
										</div>
									</div>
								</div>
							</div>
