								...
								<div class="form-group ">
									...
									<div class="col-md-7 ">
										<ng-bs3-datepicker ng-disabled="createQuote"
											...
											data-ng-change="checkjvno(todate)" friendly-name="todate"
											validation="required" />
									</div>
								</div>
							</div>
								...
								<table
									...
									<thead class="dataTables-Main-Head">
										<tr>
											...
											<th class="width_15 sorting text-center padding-both-side-2">Ledger
			              ...
			              <input type="text" class="form-control input-sm journalVoucher-textBox" ng-model="row.exchangeRate" />
			            	...
			            	<input type="text" class="form-control input-sm journalVoucher-textBox" ng-model="row.tcDebitAmount" ng-keyup="numberCheck(row)" ng-change="onChangeTcDebit(row,journalVoucher.tables)" />
											...
											<td class="padding-both-side-2"><input type="text"
												...
												ng-change="onChangeBcDebit(row,journalVoucher.tables)" /></td>
											<!--  <td class="padding-both-side-2">
													...
													<div class="col-sm-4" ng-if="row.isLocation">
														...
														<div class="col-md-9">
															<selectivity list="studentList"
																property="row.countryCode" id="countryCode{{trIndex}}"></selectivity>
														</div>
													</div>
													...
													<div class="col-sm-4" style="padding-top: 15px;"
														...
														<div class="col-md-9">
															...
															<selectivity list="companyList"
																property="row.companyCode" id="companyCode{{trIndex}}"></selectivity>
														</div>
													</div>
													<div class="col-sm-4" style="padding-top: 10px;"
														ng-if="row.isPatient">
