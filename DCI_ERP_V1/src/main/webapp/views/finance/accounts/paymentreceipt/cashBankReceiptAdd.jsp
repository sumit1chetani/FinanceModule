					...
					<div class="col-sm-12 col-md-12 col-lg-12">
						<div class="col-sm-4 col-md-4 col-lg-4">
							<fieldset>
								...
								<div class="form-group" ng-if="!edit">
									...
									<label class="col-md-5 control-label">Receipt Voucher
									...
									<div class="col-md-7">
										...
										<input type="text" class="form-control input-sm text-left"
											name="voucherNo" property="objCBReceipt.voucherNo"
											id="voucherNo" ng-model="objCBReceipt.voucherNo"
								...
								<div class="form-group" style="display: none;">
									<label class="col-md-5 control-label">Organization Name<span
									...
									<div class="col-md-7">
										...
										<selectivity list="companyList"
											property="objCBReceipt.companyCode"
											ng-model="objCBReceipt.companyCode" id="cmbCompanyName"
											name="organizationName" object="company"
											validation="required"
								...
								<div class="form-group">
									<label class="col-md-5 control-label">Type of Receipt<span
										style="color: red;"> *</span></label>
									<div class="col-md-7 inputGroupContainer">
										<selectivity list="typeList"
											property="objCBReceipt.paymentMode"
											ng-model="objCBReceipt.paymentMode" validation="required"
											friendly-name="Type Of Payment" id="pmt_id"
											name="Payment Type" form-name="cashBankReceiptForm"></selectivity>
									</div>
								</div>
								<div class="form-group" ng-if="pmtTypeShow">
									<label class="col-md-5 control-label">Bank Acct<span
										style="color: red;"> *</span></label>
									<div class="col-md-7 inputGroupContainer">
										<selectivity list="bankAccountNewList" id="bankAcc_id"
											name="Bank Acct" property="objCBReceipt.bankAcc"
											ng-model="objCBReceipt.bankAcc" object="bankacctobj"
											validation="required" friendly-name="Bank Acct"
											form-name="cashBankReceiptForm"></selectivity>
								...
								<div class="form-group" ng-if="!(pmtTypeShow)">
									...
									<div class="col-md-7 inputGroupContainer">
										<selectivity list="cashList" id="cashAcc_id" name="Cash Acct"
											property="objCBReceipt.cashAcc"
											ng-model="objCBReceipt.cashAcc" object="cashacctobj"
											validation="required" friendly-name="Cash Acct"
											form-name="cashBankReceiptForm"></selectivity>
									</div>
								</div>
						...
						<div class="col-sm-4 col-md-4 col-lg-4">
							<fieldset>
								...
								<div class="form-group ">
									...
									<div class="col-md-7 ">
										<ng-bs3-datepicker ng-disabled="createQuote"
											data-ng-model="objCBReceipt.cbReceiptDate" id="receipt_date"
											name="Receipt Date"
								...
								<div class="form-group">
									...
									<div class="col-md-7">
										<input type="text" class="form-control input-sm"
											ng-model="objCBReceipt.bcAmountHdr" name="Amount USD"
											ng-keyup="bcToTcHdrAmtCalculation(objCBReceipt.bcAmountHdr)"
											ng-pattern-restrict="^[0-9.]*$" />
									</div>
								</div>
								...
								<div class="form-group">
									<label class="col-md-5 control-label">Receipt From<span
										style="color: red;"> *</span></label>
									<div class="col-md-7">
										<!-- <input type="hidden" class="form-control input-sm" data-ng-model="objCBReceipt.companyCode" value="" /> 
					             				<label class="form-control input-sm" ng-bind="objCBReceipt.compLocationName"></label> -->
										<selectivity list=receiptList
											property="objCBReceipt.receiptfrom"
											ng-model="objCBReceipt.receiptfrom" id="receiptfrom"
											name="Receipt From" object="receiptfrom"
											validation="required" friendly-name="receiptfrom"
											form-name="cashBankReceiptForm"></selectivity>
									</div>
								</div>
						...
						<div class="col-sm-4 col-md-4 col-lg-4">
							...
							<div class="form-group">
								...
								<div class="col-md-7">
									<selectivity list="costList" id="costCenter" name="costCenter"
										...
										ng-model="objCBReceipt.costCenter" friendly-name="Costcenter"></selectivity>
								</div>
							</div>

							<div class="form-group" ng-if="pmtTypeShow">
								<label class="col-md-5 control-label">Cheque/DD/UTR Ref
									No</label>
								<div class="col-md-7">
									<input type="text" class="form-control input-sm"
							...
							<div class="form-group " ng-if="pmtTypeShow">
								<label class="col-md-5 control-label">Cheque/DD/UTR Date
								</label>
								<div class="col-md-7 ">
									<ng-bs3-datepicker ng-disabled="createQuote"
										data-ng-model="objCBReceipt.chequeDate" id="receipt_date"
										name="Cheque Date"
					...
					<table
						...
						<thead>
							<tr>
								...
								<th colspan=1 class="width_10 text-center">Nature of
									Receipt</th>
								<!-- <th colspan=1 class="width_10 text-center">Ledger<span style="color: red;"> *</span></th> -->
 ...
 -->
						...
						<tbody ng-repeat="(trIndex, row) in objCBReceipt.cshBankDetail"
							...
							<tr>
									...
									<div class="row">
										<div class="col-xs-9">
											...
											<selectivity list="receiptList" ng-model="row.receipt"
												property="row.receipt" id="receipt{{trIndex}}"
												name="{{ 'receipt' + $index }}"
									...
									<div class="row">
										<div class="col-xs-9">
											...
											<selectivity list="accountList" ng-model="row.acctName"
												property="row.acctName" id="acctName{{trIndex}}"
												name="{{ 'acctName' + $index }}" validation="required"
												friendly-name="{{ 'Row ' + $index + ' (Account Name on Detail table)'}}"
												form-name="cashBankReceiptForm"></selectivity>
										</div>
									</div>
								</td> -->
										...
										<div class="col-xs-12">
											<div class="col-xs-9 pull-left">
												<selectivity list="subAccountCodeList"
													ng-model="row.subAccountCode" property="row.subAccountCode"
													id="txtSubAccountCode{{trIndex}}"
													name="{{ 'subAccountCode' + $index }}"></selectivity>
											</div>
									...
									<div class="row">
										<div class="col-xs-12">
											<input type="text" class="form-control input-sm"
												...
												name="tcamount"
												validation="pattern=/^[0-9-]+(\.[0-9-]{1,2})?$/:alt= Amount Should be 2 digit|required"
												step="0.01"
								...
								<td class="visible-left"><input type="hidden"
									ng-model="row.invoiceReceiptList" /></td>
							</tr>
							<tr>
								<td colspan="12">
									<div class="col-sm-12">
										...
										<div class="col-sm-4" ng-if="row.isDepartment">
											...
											<div class="col-md-9">
												<selectivity class="selectivity-results-container1"
													list="studentList" property="row.departmentCode"
										...
										<div class="col-sm-4" ng-if="row.isLocation">
											...
											<div class="col-md-9">
												<selectivity class="selectivity-results-container1"
													list="countryList" property="row.countryCode"
													id="countryCode{{trIndex}}"></selectivity>
											</div>
										</div>
										<div class="col-sm-4" style="padding-top: 10px;"
											ng-if="row.isCustomer">
											<label class="col-md-3 control-label"> Customer</label>
											<div class="col-md-9">
												<selectivity class="selectivity-results-container1"
													list="customerList" property="row.customerCode"
										...
										<div class="col-sm-4" style="padding-top: 10px;"
											...
											<div class="col-md-9">
												<selectivity class="selectivity-results-container1"
													list="supplierList" property="row.supplierCode"
										...
										<div class="col-sm-4" style="padding-top: 10px;"
											...
											<div class="col-md-9">
												<selectivity class="selectivity-results-container1"
													list="designationList" property="row.designationCode"
										...
										<div class="col-sm-4" style="padding-top: 10px;"
											...
											<div class="col-md-9">
												<selectivity class="selectivity-results-container1"
													list="patientList" property="row.patientCode"
													id="patientId{{trIndex}}"></selectivity>
											</div>
										</div>
									</div>
								</td>
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="form-group">
								<label for="inputPassword" class="col-md-1 control-label">Narration</label>
								<div class="col-md-11">
						...
						<div class="col col-md-12">
							<div class="form-group">
								<label for="inputPassword" class="col-md-1 control-label">Approval
									Note</label>
								<div class="col-md-11">
									<textarea rows="2" cols="45" class="form-control"
										name="Approval Note" ng-model="objCBReceipt.approvenote"
										friendly-name="Approval Note">
			 									</textarea>
