      ...
      <div class="widget-body">
       <form class="form-horizontal" name="cashBankReceiptPricePopupForm"  novalidate  method="post">
			        ...
			        <table id="dt_basic"
			         ...
			         <thead class="dataTables-Main-Head">
			          <tr>
			           ...
			           <th class="sorting width_13" data-st-sort="receiptCollections.bcBalanceAmt">BC Balance Amt</th>
			           <th class="sorting width_10" data-st-sort="receiptCollections.tcInvAmt">TC Inv Amt</th>
			           <th class="sorting width_13" data-st-sort="receiptCollections.tcBalanceAmt">TC Balance Amt</th>
			         ...
			         <tbody class="dataTables-Main-Body">
			          <tr data-ng-class="$index % 2 == 0? 'even' : 'odd'" ng-repeat="receiptCollections in displayedCollection">
			           ...
			           <td class="width_10" ng-bind="receiptCollections.bcInvAmt"></td>
			            <td class="width_13" ng-bind="receiptCollections.bcBalanceAmt"></td>
			           <td class="width_10" ng-bind="receiptCollections.tcInvAmt"></td>
			           <td class="width_13" ng-bind="receiptCollections.tcBalanceAmt"></td>
			           <td class="width_8" ng-bind="receiptCollections.currency"></td>
			           <td class="width_8" ng-bind="receiptCollections.exchangeRate"></td>
			           <td class="width_10">
				           	<div class="row">
					           	<div class="col-xs-8">
					           		<input type="text" class=" width_100" ng-model="receiptCollections.bcPaidAmt" 
					           		id="txtBcPaidAmt" ng-keyup="calculateBcPaidToTcPaidAmount(receiptCollections.bcPaidAmt,receiptCollections)" />	
					           	</div>
				       		</div>			           	
			           </td>
			           <td class="width_10">
			           		<div class="row">
					           	<div class="col-xs-8">
					           		<input type="text" class=" width_100" ng-model="receiptCollections.tcPaidAmt" id="txtTcPaidAmt"
					           		ng-keyup="calculateTcPaidToBcPaidAmount(receiptCollections.tcPaidAmt,receiptCollections)"  ng-disabled="true" />	
					           	</div>
				           </div>			           	
			           </td>
			          </tr>
        ...
        <div class="form-actions">
         <div class="row">
          <div class="col-md-12" ng-if="isValid">           
           <button class="btn btn-success" type="button"
            class="btn btn-success"
            ng-click="getSelectedList(displayedCollection)" ng-disabled="true">
            <i class="fa fa-save"></i> Add to Selected List
           </button>
          ...
          <div class="col-md-12" ng-if="!isValid">
          	<button class="btn btn-success" type="button"
            class="btn btn-success"
            ng-click="getSelectedList(displayedCollection)">
            <i class="fa fa-save"></i> Add to Selected List
           </button>
          	<button class="btn btn-danger" type="reset"
            class="btn btn-success" ng-click="cancelInvoicePriceDialog()">
