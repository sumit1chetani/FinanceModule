			...
			<tr>
				<td><br> <!-- <table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="FFFFFF" bordercolor="" align="center">		
						...
						<tr>
							...
							<tr>
								...
								<td width="75%"> <span style="text-align: right;text-transform: uppercase;"><b>${user.tenantId} GLOBAL LOGISTICS PVT LTD</b></span>
								 <br><span style="text-align: right;"> ${object1[0].address1}</span>
								 <br><span style="text-align: right;">${object1[0].address2} </span>
								 <br><span style="text-align: right;">${object1[0].address3}</span>
							 </tr>
							 </table>
							</td>
					...
					<table width="100%" border="1"
						...
						<tr>
							<td class="width_40" style="font-size: 12px;"><b>FINAL
