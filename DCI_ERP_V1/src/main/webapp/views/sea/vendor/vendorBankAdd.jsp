...
.tooltip .tooltiptext {
	...
	text-align: center;
	border-radius: 6px;
	padding: 5px 0; / Position the tooltip / position : absolute;
	z-index: 1;
	top: -5px;
	left: 105%;
}
				...
				<div class="widget-body">
					<form class="form-horizontal" name="bankAddForm">
						<div class="row">
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<select class="form-control"
												data-ng-model="customerBankobj.accountTypeId"
							...
							<!-- jgkj kdg jk -->
							<div class="row col-md-12 no-padding" style="margin-left: 1px;">
								...
								<div class="col-md-10">
									...
									<textarea type="text" cols="100" class="form-control input-sm"
										id="address" name="Address"
										ng-model="customerBankobj.bankDetAddress"
										friendly-name="Address"></textarea>
								</div>
							</div>

							<div class="col-md-10 col-md-offset-2 no-padding">
								<div class="col-md-5 no-padding padding-top-5">
									<selectivity list="billingCityList"
										property="customerBankobj.bankCityId" id="txtCitybillingId"></selectivity>
								</div>
								<div class="col-md-4 no-padding padding-left-5 padding-top-5">
									<input type="hidden" class="form-control input-sm"
										placeholder="state" ng-model="customerBankobj.desStateCode" />
									<input type="text" class="form-control input-sm"
										placeholder="state" ng-model="customerBankobj.desState" />
								</div>
								<div class="col-md-3 no-padding padding-left-5 padding-top-5">
									<input type="text" class="form-control input-sm"
										placeholder="zip" ng-model="customerBankobj.desZipcode" />
								</div>
								
								<div class="row col-md-12 no-padding padding-top-5" style="margin-left: 1px;">
								<input type="hidden" class="form-control input-sm"
									placeholder="country" ng-model="customerBankobj.desCountryCode" />
								<input type="text" class="form-control input-sm"
									placeholder="country" ng-model="customerBankobj.desCountry" />
							</div>
							</div>
