		...
		<div style="margin-top:0px">
				...
				<div>
					...
					<span></span>			
						<span class="bold fntSiz15px" style="padding-left: 60%;">BILL
							...
							style="padding-left: 40%;">FOR COMBINED TRANSPORT OR PORT TO
							PORT SHIPMENT </span>
					</div>
				</div>
				<table width="100%">
					...
					<tbody>
						...
						<tr>
							...
							<td class="wid50pr" style="line-height:16px">
									...
									<span class="fntSiz8px" style="height: 200%;font-size:9px; padding-left:5px">. For
				...
				<table style="width: 100%;height: 160px;">
					<tr>
						...
						<td  class="fntSiz8px" align="left" style="border:hidden;border-top:1px solid black"
									valign="top"><span >${detailObj2.containerNo}</span></td>
									<td class="fntSiz8px"" style="text-align:center;border:hidden;border-top:1px solid black"
					...
					<tr>
					<td class="fntSiz11px wid30pr"colspan="2" style="padding-left:5px;height:10%;">ABOVE PARTICULARS AS DECLARED BY SHIPPING</td>
					<td class="wid40pr" style="border-left:white;border-top: white;"></td> 
					<td class="wid10pr"  style="border-left:white;border-top: white;"></td> 
					<td class="wid20pr"  style="border-right:white;border-left:white;border-top: white;"></td>
					</tr>
				</table>
				</div>
				<table style="width: 100%;">
					<tr>
						<td  width="100%"
							style="border-top: 1px solid #fff; border-bottom: 1px solid #fff;font-size:10px"><span class="fntSiz8px"style="padding-left:5px">Note : The Merchant's attention
			...
			<!-- 						<td width="10%" style="border-right:hidden">
								...
								<tr style="font-size: 9px;"> 
									...
									<td width="30%" height=20 style="height: 74px;border-left: 1px solid white;border-bottom: 1px solid white;"><div><span class="bold fntSiz11px"></span></div></td>
									<td width="30%"  height=20 style="border-left:white;"><div>  <c:if test="${footerobj.paymentMode==1}"><span class="bold fntSiz11px" style="padding-left:30px"></span></c:if></div></td>
									<td width="30%" height=20 style="border-right: 1px solid white;"><div> <c:if test="${footerobj.paymentMode==2}"><span class="bold fntSiz11px" style="padding-left:30px"></span></c:if></div></td>
