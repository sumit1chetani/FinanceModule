...
<body style="border:1px solid  black">
	...
	<table class="table" width=100% border=0 bordercolor=""
			...
			<tr>
			<td colspan=1 style="border-top: none !important;width:40% line-height: 200%;padding-left: 19px;"><b>Name Of The Shipping Line</b>:${hdr.shipperName}</td>
				<td colspan=1 style="border-top: none !important;width:40% line-height: 200%;padding-right: 383px;"><b>Name Of The Agent:</b>${hdr.agentName}</td>
				<td colspan=1 style="border-top: none !important;width:30% line-height: 200%;"></td>
			<%-- 
			...
			cellspacing="0" cellpadding="2" align="center">
			<tr>
				<td colspan=1 style="border-top: none !important;width:40% line-height: 200%;padding-left: 19px;"><b>1. Name of the Ship </b>:${hdr.shipperName}</td>
				<td colspan=1 style="border-top: none !important;width:40% line-height: 200%;"><b>2. Port where report is made  </b>:${hdr.originCode}</td>
				<td colspan=1 style="border-top: none !important;width:30% line-height: 200%;"></td>
				
			<tr>
				<td colspan=1 style="border-top: none !important;width:40% line-height: 200%;padding-left: 19px;"><b>3. Nationality of Ship</b>:<%-- ${hdr.serviceType} --%></td>
				<td colspan=1 style="border-top: none !important;width:40% line-height: 200%;"><b>4. Name of the Master</b>:</td>
				<td colspan=1 style="border-top: none !important;width:30% line-height: 200%;"><b>5. Port of Loading</b>:${hdr.podCode}</td>
		...
		<%-- <table class="table" width=100% border=0 bordercolor=""
			...
			<tr>
				<td colspan=1
					style="border-top: none !important; line-height: 200%;"><b>Name
						Of The Shipping Line </b></td>
				<td colspan=1 style="border-top: none !important">${hdr.shipperName}</td>
				<td colspan=1
					style="border-top: none !important; line-height: 200%;"><b>Name Of The Agent </b></td>
				<td colspan=1 style="border-top: none !important">${hdr.consigneeName}</td>
			</tr>

			<tr>
				<td
				 colspan=1
					style="border-top: none !important; line-height: 200%;"><b>1.
						Name of the Ship </b></td>
				<td colspan=1 style="border-top: none !important">${hdr.shipperName}</td>
				<td colspan=1
					style="border-top: none !important; line-height: 200%;"><b>2.
						Port where report is made : </b></td>
				<td colspan=1 style="border-top: none !important">${hdr.originCode}</td>
			<tr>
				<td colspan=1
					style="border-top: none !important; line-height: 200%;"><b>3.
						Nationality of Ship : </b></td>
				<td colspan=1 style="border-top: none !important">
					${hdr.serviceType}
				</td>
				<td colspan=2
					style="border-top: none !important; line-height: 200%;"><b>4.
						Name of the Master : </b></td>
				<td colspan=2 style="border-top: none !important"></td>

				<td colspan=2
					style="border-top: none !important; line-height: 200%;"><b>4.
						Port of Loading : </b></td>
		...
		<table class="table" align="left" border="0" cellPadding="0"
				...
				<tbody>
					...
					<tr class="description">
						<td class="width_10 " align="left" valign="top"
							style="border: 1px dashed !important"><span>${detailObj1.containerNo}</span></td>
						<td class="width_10 " align="left" valign="top"
							style="border: 1px dashed !important"><span>${detailObj1.noOfOriginalBl}</span></td>
						<td class="width_10 " align="left" valign="top"
							style="border: 1px dashed !important"><span>${detailObj1.noofPackage}</span></td>
						<td class="width_10 " align="left" valign="top"
							style="border: 1px dashed !important"><span>${detailObj1.marksAndNos}</span></td>
						<td class="width_10 " align="left" valign="top"
							style="border: 1px dashed !important"><span>${detailObj1.netWeight}</span></td>
						<td class="width_15 " align="right" valign="top"
							...
							<td class="width_10 " align="left" valign="top"
							style="border: 1px dashed !important"><span>${detailObj1.cargoDescription}</span></td>
						<td class="width_10 " align="left" valign="top"
							style="border: 1px dashed !important"><span>${hdr.shipperName}${hdr.consigneeName}${hdr.customerName}</span></td>
						<td class="width_10 " align="left" valign="top"
							style="border: 1px dashed !important"><span>${hdr.etd}</span></td>
						<td class="width_10 " align="left" valign="top"
							style="border: 1px dashed !important"><span>${detailObj1.notifyAddress}</span></td>
						<td class="width_10 " align="left" valign="top"
							style="border: 1px dashed !important"><span>${detailObj1.pol}</span></td>
						<td class="width_10 " align="left" valign="top"
							style="border: 1px dashed !important"><span>${detailObj1.pol}</span></td>
						<td class="width_15 " align="right" valign="top"
						...
						<td class="width_10 " align="left" valign="top"
							style="border: 1px dashed !important"><span>${detailObj1.remarks}</span></td>
		...
		<table class="table" width=100% border=0 bordercolor=""
			...
			<tr>
				<td colspan=1 align="center"
					style="border-top: none !important;padding-left: 19px; line-height: 200%; text-decoration: underline;"><b>TRANSHIPMENT
			...
			<tr>
				<td colspan=1 align="center"
					style="border-top: none !important;padding-left: 19px;line-height: 200%; text-decoration: underline;"><b>Ex
						Vessel: </b></td>
			</tr>
		...
		<table class="table" width=100% border=0 bordercolor="" style="padding-top: 60px;"
			cellspacing="0" cellpadding="2" align="center">
			<tr>
				<td colspan=1
					style="border-top: none !important;padding-left: 19px; line-height: 200%;">We
			...
			<tr>
				<td colspan=1
					style="border-top: none !important;padding-left: 19px; line-height: 200%;">
		...
		<table class="table" width=100% border=0 bordercolor=""
			...
			<tr>
				<td colspan=1
					style="border-top: none !important;padding-left: 19px; line-height: 200%; text-transform: uppercase;"><b>FOR
			...
			<tr>
				<td colspan=1
					style="border-top: none !important;padding-left: 19px; line-height: 200%;"><b>(ADMIN)</b></td>
				<td colspan=1 style="border-top: none !important"></td>
			</tr>
