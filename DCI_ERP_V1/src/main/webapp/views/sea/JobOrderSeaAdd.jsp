					...
					<table class="table table-striped b-t b-light">
						...
						<tbody
							...
							<tr>
								...
								<td>Select All&nbsp;&nbsp;<input
										type="checkbox" ng-model="jobOrderTrackingDtl.cargoSelect" 
										data-ng-click="selectAll1(jobOrderTrackingDtl.cargoSelect,jobOrderTrackingDtl.cargoDescription,trIndex1) ">
...
<td class="">Select All&nbsp;&nbsp;<input
										type="checkbox" ng-model="jobOrderTrackingDtl.uomSelect" 
										data-ng-click="selectAll(jobOrderTrackingDtl.uomSelect,jobOrderTrackingDtl.uom,trIndex1) ">
								...
								<div class="row">
									<div class="col-md-12">
										...
										<button class="btn btn-success" type="button" ng-if="edit"
											ng-click="submitupdate(jobOrderForm,joborder)">
