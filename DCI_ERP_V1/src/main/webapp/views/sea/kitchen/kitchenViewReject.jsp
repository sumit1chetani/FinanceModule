...
<div class="wrapper-md">
	...
	<div class="input-group date datetimepick col-md-12">
												...
												<label class="col-md-4 control-label"> Source Location <span style="color: red;">*</span>
											 	...
											 	<div class="col-md-7">
													<selectivity list="parentLocationList" ng-model="local.sourceLocation" disabled="true"  property="local.sourceLocation" id="sourceLocation" object="sourceLocation"  name="sourceLocation" validation="required" friendly-name="Source Store" form-name = "consignmentRequestForm"></selectivity>
												</div>
												</div>
 -->
												<div class="form-group">
											...
											<div class="col-md-7">
												 ...
												 <selectivity list="parentLocationList" ng-model="local.destinationLocation" disabled="true"  property="local.destinationLocation" id="destinationLocation" object="destinationLocation"  name="destinationLocation" validation="required" friendly-name="Destination Store" form-name = "consignmentRequestForm"></selectivity>
										...
										<div class="form-group">
											...
											<div class="col-md-7">
												 ...
												 <selectivity list="costList" ng-model="local.costcenter" property="local.costcenter" disabled="true"  id="costcenter" object="costcenter"  name="costcenter" validation="required" friendly-name="Cost Center" form-name = "consignmentRequestForm"></selectivity>
							...
							<div class="form-group">
			              			...
			              			code="label.company.name"></spring:message> --%>Organization Name <spring:message
					        				...
					        				<div class="col-md-7">
						        				...
						        				ng-model="local.companyId" name="companyId" form-name = "consignmentRequestForm" disabled="true" 
					...
					<div class="row">
						<div class="col-md-12">
							...
							<button class="btn btn-success" type="button" ng-if="isEdit"
								class="btn btn-success" ng-click="Reject(localForm,local)">
