							...
							<form class="form-horizontal" name="storeToStoreAddForm">
								<div class="row">
									...
									<div class="col-sm-10 col-md-5">
										...
										<div class="form-group" ng-show="isEdit">
											<label class="col-md-6 control-label">PR Request Number</label> <label
												class="col-md-1 control-label">{{storeApprovalData.prReqNo}}</label>
											<div class="col-md-6">
												<textarea type="text" class="form-control input-sm" rows="2"
													cols="25"
													name="PR Request Number"
													ng-show="!isEdit" ng-model="storeApprovalData.remarks"
													style="resize: none"></textarea>
											</div>
										</div>
										...
										<div class="form-group" ng-show="isEdit">
											<label class="col-md-6 control-label">PR Request Date</label> <label
												class="col-md-1 control-label">{{storeApprovalData.prReqDate}}</label>
											<div class="col-md-6">
												<textarea type="text" class="form-control input-sm" rows="2"
													cols="25"
													name="PR Request Date"
													ng-show="!isEdit" ng-model="storeApprovalData.remarks"
													style="resize: none"></textarea>
											</div>
										</div>
																...
																<td class="width_10" ng-show="isEdit">
																	<div class="row">
																		<div class="col-xs-12">
																			...
																			<label class="col-md-8 control-label">{{storeTableRow.quantity1}}</label>
																		</div>
																	</div>
																</td>
