...
<span style = "color:red">*</span>													</label>
											...
											<div class="col-md-6">
												...
												<div class="form-group">
													<label class="col-md-3 control-label">PR Request Number</label>
													<div class="col-md-7">
														<input type="text" class="form-control input-sm"
															name="prReqNo" id="prReqNo"
															ng-model="storeApprovalData.prReqNo"
															readonly="readonly">
													</div>
												</div>
												
												<div class="form-group">
													<label class="col-md-3 control-label">PR Request Date</label>
													<div class="col-md-7">
													<div class='input-group date datetimepick col-md-12'>
															<div class="dropdown">
																<a data-toggle="dropdown" class="dropdown-toggle"
																	id="requestDate" role="button" data-target="#"
																	href="#">
																	<div class="input-group">
																		<input type="text" class="form-control"
																			placeholder="dd/mm/yyyy"
																			data-ng-model="storeApprovalData.prReqDate" disabled>
																		<span class="input-group-addon"> <i
																			class="glyphicon glyphicon-calendar"></i>
																		</span>
																	</div>
