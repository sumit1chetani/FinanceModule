   ...
   <article class="col-sm-12">
    <div data-jarvis-widget id="standard-datatable-widget" data-widget-color="sttropaz">
     <header class="ngdialog-header">
      ...
      <h2>Add Store To Store Request</h2>
     </header>
     <div role="content">
      <div class="widget-body">
       <form class="form-horizontal" name="stkReqReqForm">
        <div class="row">
         <div class="col-sm-12 col-md-10 col-lg-10">
          <fieldset>
           <div class="form-group">
            ...
            <div class="col-md-6">
             <select class="form-control input-sm" ng-model="stockRequisitionRequestData.itemCode">
           ...
           <div class="form-group">
            ...
            <div class="col-md-6">
             <select class="form-control input-sm" ng-model="stockRequisitionRequestData.itemCategory">
              <option value="">Select</option>
           ...
           <div class="form-group">
            ...
            <div class="col-lg-6">
             <input type="number" ng-model="stockRequisitionRequestData.quantity"
             ...
             <div class='input-group date datetimepick'>
              <div class="dropdown">
               <a class="dropdown-toggle" id="Edd" role="button" data-toggle="dropdown" data-target="#" href="#">
                <div class="input-group">
                 <input type="text" class="form-control" placeholder="dd/mm/yyyy" name="requestDate"
                  ...
                  data-ng-model="stockRequisitionRequestData.edd">
               ...
               <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                <datetimepicker data-ng-model="stockRequisitionRequestData.edd"
                 data-on-set-time="stockRequisitionRequestData.edd = onDateSet(newDate)"
