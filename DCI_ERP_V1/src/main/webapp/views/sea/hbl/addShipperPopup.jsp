				...
				<div class="col-sm-12 col-md-12 col-lg-12">
						...
						<div class="form-group">
							...
							<div class="col-md-7">
								<input type="text" class="form-control input-sm"
									property="servicePartner.shipCode" maxlength=6
									data-ng-model="servicePartner.shipCode"
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<div class="col-md-7">
								<input type="text" class="form-control input-sm"
									property="servicePartner.shipName" maxlength=250
									data-ng-model="servicePartner.shipName"
				...
				<div class="row">
					<div class="col-md-12">
						...
						<button class="btn btn-success"
							ng-click=allowSaveShip(servicePartner)
							type="button">
