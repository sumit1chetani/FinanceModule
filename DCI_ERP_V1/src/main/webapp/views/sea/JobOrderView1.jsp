		...
		<div>
			...
			<div class="panel-body">
				...
				<div class="form-group col-md-12 col-lg-12" ng-if="edit" align="center">
								<label class="col-md-5 control-label" style="padding-top: 0px;">Job No </label>
					...
					<div class="row book-widget-row">
								...
								<div class="form-group col-md-3 col-lg-3">
									...
									<div class="col-md-7">
										<ng-bs3-datepicker data-ng-model="joborder.jobDate"
											...
											friendly-name="Job Date" validation="required"  disabled/>
									</div>
								</div>
								<div class="form-group col-md-3 col-lg-3">
						...
						<fieldset>
								...
								<div class="form-group col-md-3 col-lg-3">
									<label class="col-md-5 control-label"> Term 
									</label>
									<div class="col-md-7">
										<selectivity list="TermList" property="joborder.term"
											ng-model="joborder.term" name="term" validation="required"
											friendly-name="Term" form-name="jobOrderForm"  disabled="true" disabled="true"></selectivity>
									</div>
								</div>
								</fieldset>
								</div>
					...
					<div class="row book-widget-row">
							...
							<div class="form-group col-md-3 col-lg-3">
									...
									<div class="col-md-7">
										<selectivity list="portList" property="joborder.aol"
											...
											friendly-name="Aol" form-name="jobOrderForm"  disabled="true" disabled="true"></selectivity>
									</div>
								</div>
								
								<div class="form-group col-md-3 col-lg-3">
									<label class="col-md-5 control-label"> POD
									</label>
									<div class="col-md-7">
										<selectivity list="portList" property="joborder.aod"
											ng-model="joborder.aod" name="aod" validation="required"
											friendly-name="AOD" form-name="jobOrderForm"  disabled="true" disabled="true"></selectivity>
									</div>
								</div>
								
								<div class="form-group col-md-3 col-lg-3">
									<label class="col-md-5 control-label"> ORIGIN 
									</label>
									<div class="col-md-7">
						...
						<div class="col-sm-12 ">
							<fieldset>
								...
								<div class="form-group col-md-3 col-lg-3">
									<label class="col-md-5 control-label"> Commodity 
									</label>
									<div class="col-md-7">
										<input type="text" class="form-control input-sm text-right"
											ng-model="joborder.commodity" name="commodity"
											form-name='jobOrderForm' friendly-name="Commodity"  disabled>
									</div>
								</div>
						...
						<div class="col-sm-12 ">
							<fieldset>
								...
								<div class="form-group col-md-3 col-lg-3">
									<label class="col-md-5 control-label"> Sales Type 
									</label>
									<div class="col-md-7">
							...
							<div class="form-group col-md-3 col-lg-3">
									...
									<div class="col-md-7">
										<selectivity list="employeeList" property="joborder.salesPerson"
											...
											friendly-name="Sales Person" form-name="jobOrderForm"  disabled="true"></selectivity>
									</div>
								</div>
								
								<div class="form-group col-md-3 col-lg-3">
									<label class="col-md-5 control-label"> Nominated By
									</label>
									<div class="col-md-7">
							...
							<div class="form-group col-md-3 col-lg-3">
									<label class="col-md-5 control-label"> Vendor 
									</label>
									<div class="col-md-7">
					...
					<div class="row book-widget-row">
						<div class="col-sm-12 ">
							<fieldset>
								...
								<div class="form-group col-md-3 col-lg-3">
									<label class="col-md-5 control-label"> Carrier 
									</label>
									<div class="col-md-7">
										<input type="text" class="form-control input-sm text-right"
											ng-model="joborder.carrier" name="carrier"
											form-name='jobOrderForm' friendly-name="Carrier"  disabled>
									</div>
								</div>
							...
							<div class="form-group col-md-3 col-lg-3">
									...
									<div class="col-md-7">
										<input type="text" class="form-control input-sm text-right"
											...
											form-name='jobOrderForm' friendly-name="Flight No"  disabled>
									</div>
								</div>
							...
							<div class="form-group col-md-3 col-lg-3">
									<label class="col-md-5 control-label"> Ex rate(USD) 
									</label>
									<div class="col-md-7">
									<input type="text" class="form-control input-sm text-right"
											ng-model="joborder.exRate" name="exRate" 	validation="required|integer"
											form-name='jobOrderForm' friendly-name="Ex Rate"  disabled>
									</div>
								</div>
									<div class="form-group col-md-3 col-lg-3">
									<label class="col-md-5 control-label"> Customer Broker 
									</label>
									<div class="col-md-7">
										<selectivity list="customerList" property="joborder.customsBroker"
											...
											friendly-name="Customs Broker" form-name="jobOrderForm"  disabled="true"></selectivity>
									</div>
								</div>
						...
						<table class="table table-striped b-t b-light">
							<thead>
								<tr>
									...
									<th colspan=1 class="width_13 text-center">Units</th>
									...
									<th colspan=1 class="width_10 text-center">Payment Mode</th>
									<th colspan=1 class="width_10 text-center">Buy/Sell Party</th>
								...
								<tr>
									...
									<td class="text-center">
										...
										<selectivity list="chargeHeadList" property="jobOrderDtl.chargeHead" id="chargeHeads{{trIndex}}" 
											...
											friendly-name="{{ 'Row-' + (trIndex+1) + '(ChargeHead)'}}" form-name="jobOrderDtlForm"  disabled="true"></selectivity>
									</td>
									...
									<td class="text-center">
										...
										<selectivity list="UnitList" property="jobOrderDtl.unit" id="unit"
											...
											friendly-name="{{ 'Row-' + (trIndex+1) + '(unit)'}}" form-name="jobOrderForm"  disabled="true"></selectivity>
									</td>
									 ...
									 <td class="text-center">
										...
										<selectivity list="transactionTypeList" property="jobOrderDtl.transactionType"   id="transactionType{{trIndex}}" 
											...
											friendly-name="{{ 'Row-' + (trIndex+1) + '(transactionType)'}}" form-name="jobOrderForm"  disabled="true"></selectivity>
									</td>
									...
									<td class="text-center"><input type="text" id="qty{{trIndex}}"
										...
										maxlength="3"
										friendly-name="{{ 'Row-' + (trIndex+1) + '(Quantity)'}}"  disabled>
									</td>
									...
									<td class="text-center"><input type="text"
										...
										validation="required|integer" form-name='jobOrderForm'
										maxlength="3"
										friendly-name="{{ 'Row-' + (trIndex+1) + '(rate)'}}"  disabled>
									</td>
									 ...
									 <td class="text-center">
										...
										<selectivity list="currencylist" property="jobOrderDtl.currency" id="currency{{trIndex}}"
											...
											friendly-name="{{ 'Row-' + (trIndex+1) + '(currency)'}}" form-name="jobOrderForm"  disabled="true"></selectivity>
									</td>
										...
										validation="required|integer" form-name='jobOrderForm'
										maxlength="3"
										friendly-name="{{ 'Row-' + (trIndex+1) + '(exRate)'}}"  disabled>
									</td>
										...
										friendly-name="{{ 'Row-' + (trIndex+1) + '(amount)'}}"  disabled>
									</td>
										...
										<selectivity list="PaymentMethodList" property="jobOrderDtl.paymentMode" id="paymentMethod{{trIndex}}"
											...
											friendly-name="{{ 'Row-' + (trIndex+1) + '(paymentMode)'}}" form-name="jobOrderForm"  disabled="true"></selectivity>
									</td>
										...
										<selectivity list="customerList" property="jobOrderDtl.buySellParty" id="buySell{{trIndex}}"
											...
											friendly-name="{{ 'Row-' + (trIndex+1) + '(buySellParty)'}}" form-name="jobOrderForm"  disabled="true"></selectivity>
									</td>
									 <td class="text-center">
										...
										<selectivity list="jobStatusList1" property="jobOrderDtl.jobStatus1" id="jobStatus1{{trIndex}}"
											...
											friendly-name="{{ 'Row-' + (trIndex+1) + '(jobStatus1)'}}" form-name="jobOrderForm"  disabled="true"></selectivity>
									</td>
