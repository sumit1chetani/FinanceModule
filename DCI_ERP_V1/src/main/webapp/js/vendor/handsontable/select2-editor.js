(function(Handsontable) {
    ...
    var onBeforeKeyDown = function(event) {
        ...
        var ctrlDown = (event.ctrlKey || event.metaKey) && !event.altKey; // catch
                                                                            // CTRL
                                                                            // but
                                                                            // not
                                                                            // right
        ...
        case keyCodes.V:
            if (ctrlDown) {
                event.stopImmediatePropagation(); // CTRL+A, CTRL+C, CTRL+V,
                                                    // CTRL+X should only work
                                                    // locally when cell is
                                                    // edited (not in table
                                                    // context)
            }
            break;
    ...
    Select2Editor.prototype.focus = function() {
        ...
        // DO NOT CALL THE BASE TEXTEDITOR FOCUS METHOD HERE, IT CAN MAKE THIS
        // EDITOR BEHAVE POORLY AND HAS NO PURPOSE WITHIN THE CONTEXT OF THIS
        // EDITOR
        // Handsontable.editors.TextEditor.prototype.focus.apply(this,
        // arguments);
    };
