...
(function($, undefined) {
     ...
     * $.support.cssUserSelect = (function(){ var t = false, e =
     * document.createElement('div');
     * 
     * $.each('Moz|Webkit|Khtml|O|ms|Icab|'.split('|'), function(i, prefix) {
     * var propCC = prefix + (prefix ? 'U' : 'u') + 'serSelect', prop = (prefix ?
     * ('-' + prefix.toLowerCase() + '-') : '') + 'user-select';
     * 
     * e.style.cssText = prop + ': text;'; if (e.style[propCC] == 'text') { t =
     * true; return false; }
     * 
     * return true; });
     * 
    ...
    defaults = {
        ...
        // as long as the trigger happened on one of the trigger-element's child
        // nodes
        reposition : true,
    ...
    handle = {
        ...
        contextmenu : function(e) {
            ...
            // abort native-triggered events unless we're triggering on right
            // click
            ...
            if (!$this.hasClass('context-menu-disabled')) {
                ...
                // var evt = jQuery.Event("show", { data: data, pageX: e.pageX,
                // pageY: e.pageY, relatedTarget: this });
                ...
                if (e.data.build) {
                    ...
                    if (!e.data.items || $.isEmptyObject(e.data.items)) {
                        // Note: jQuery captures and ignores errors from event
                        // handlers
                        if (window.console) {
        ...
        layerClick : function(e) {
            ...
            setTimeout(function() {
                ...
                // find the element that would've been clicked, wasn't the layer
                // in the way
                ...
                if (root.reposition && triggerAction) {
                    if (document.elementFromPoint) {
                        ...
                        $window = $(window);
                        // while this looks kinda awful, it's the best way to
                        // avoid
        ...
        key : function(e) {
            ...
            default: // 0-9, a-z
                ...
                if (opt.accesskeys[k]) {
                    // according to the specs accesskeys must be invoked
                    // immediately
        ...
        focusItem : function(e) {
            ...
            // position sub-menu - do after show so dumb $.ui.position can keep
            // up
            if (opt.$node) {
    ...
    op = {
        ...
        hide : function(opt, force) {
            ...
            if (opt.$layer) {
                // keep layer for a bit so the contextmenu event can be aborted
                // properly by opera
            ...
            // $(document).off('.contextMenuAutoHide keydown.contextMenu'); //
            // http://bugs.jquery.com/ticket/10705
        ...
        create : function(opt, root) {
            ...
            $.each(opt.items, function(key, item) {
                ...
                // register accesskey
                // NOTE: the accesskey attribute should be applicable to any
                // element, but Safari5 and Chrome13 still can't do that
                if (item.accesskey) {
    ...
    $.contextMenu = function(operation, options) {
        ...
        case 'create':
            ...
            case 'left':
                ...
                break;
            /*
             * default: // http://www.quirksmode.org/dom/events/contextmenu.html
             * $document .on('mousedown' + o.ns, o.selector, o,
             * handle.mousedown) .on('mouseup' + o.ns, o.selector, o,
             * handle.mouseup); break;
             */
            }
    ...
    function menuChildren(items, $children, counter) {
        ...
        $children.each(function() {
             ...
             * <canvas> and such are valid menu items. Not being the sadistic
             * kind, $.contextMenu only accepts: <command>, <menuitem>, <hr>,
             * <span>, <p> <input [text, radio, checkbox]>, <textarea>, <select>
             * and of course <menu>. Everything else will be imported as an html
