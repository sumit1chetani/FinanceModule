...
app.controller('doissuedreportListCtrl', function($scope, $timeout, $stateParams,sharedProperties,toaster,
    ...
    $scope.getList = function() {
        $http.post($stateParams.tenantid+'/api/blissuedreport/doList',$scope.doissuedreport).success(function(datas) {
        	/*var l=1;
      ...
      //Search
	      $scope.getSearch = function(){
	        	 ...
	        	 $http.post($stateParams.tenantid+'/api/blissuedreport/SearchDOList', $scope.doissuedreport).success(function(response) {
		   ...
		   $scope.reset = function(blissuedreportForm) {
		    ...
		    //Excel Export	
		  	 $scope.exportExcel = function(){
		  	   	 $http.post($stateParams.tenantid+'/api/blissuedreport/DOExportExcel', $scope.doissuedreport).success(function(response) {
