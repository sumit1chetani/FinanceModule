...
app.controller('stockReportCtrl', function($scope, $timeout, $stateParams,sharedProperties,toaster,
    ...
    $scope.getList = function() {
        $http.post($stateParams.tenantid+'/api/stockReport/list',$scope.stockReport).success(function(datas) {
      ...
      //Search
	      $scope.getSearch = function(){
	        	 ...
	        	 $http.post($stateParams.tenantid+'/api/stockReport/searchstockeDtl', $scope.stockReport).success(function(response) {
		  ...
		  //Conatiner list
		   ...
		   $scope.reset = function(containerstockReportForm) {
			   $scope. stockReport = {
						vessel : '',
						voyage : '',
						pol : '',
		    ...
		    //Excel Export	
		  	 $scope.exportExcel = function(){
		  	   	 $http.post($stateParams.tenantid+'/api/stockReport/ExportExcel', $scope.stockReport).success(function(response) {

		  	                if(response){
		  	                    debugger;
		  	                    $("#stockExport").bind('click', function() {
		  	                    });
		  	                    $('#stockExport').simulateClick('click');
