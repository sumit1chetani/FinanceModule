...
'use strict';
app.controller('dayBookCtrl', function($templateCache, $scope, $rootScope, $http, logger, $log, ngDialog, 
     ...
     $scope.test=true;
        ...
        $http.get('app/dayBook/getGroupHeadList').success(function(datas) {
            $scope.GroupList = datas;
        }).error(function(datas) {
        });
        
        
        $http.get('app/dayBook/mainaccountList').success(function(datas) {
        ...
        if($scope.testing!=undefined ){
            ...
            $scope.Report = function(){
                ...
                if($scope.testing!=undefined ){
                   ...
                   $http.post('app/dayBook/getGeneralLedgerReport', $scope.testing).success(function(data) {
                        if(data.success){
...
/*
        ...
        */
     /*   $http.get('app/dayBook/getGroupHeadList').success(function(data) {
    ...
    $scope.viewGeneralLedgerReport = function(){
       ...
       // $scope.generalLedger.toDate = $('#toDate').val();
        ...
        if($scope.generalLedger.companyCode !='' ){
           ...
           $http.post('app/dayBook/getGLTransactionLevel', $scope.generalLedger).success(function(data) {

                if(data.success){
                    if(data.lGeneralLedgerTransactionList.length >0){

                    $scope.rowCollection =data.lGeneralLedgerTransactionList;
                    $scope.generalLedger.totalAmount= data.lGeneralLedgerTransactionList[0].totalAmount;
                   var vochuerno='';
                    for(var i=0;i<=data.lGeneralLedgerTransactionList.length;i++){
                    	
                    	if(vochuerno==data.lGeneralLedgerTransactionList[i].transactionNo){
                    		data.lGeneralLedgerTransactionList[i].transactionNo ='';
                    		data.lGeneralLedgerTransactionList[i].ledgerDate ='';
                    		data.lGeneralLedgerTransactionList[i].userBy ='';
                    		data.lGeneralLedgerTransactionList[i].costCentername ='';
                    		data.lGeneralLedgerTransactionList[i].toadd = true;

                    		
                    	}
                    	else{
                    	vochuerno =data.lGeneralLedgerTransactionList[i].transactionNo;
                    	}
    ...
    $scope.exportGeneralLedgerExcel = function(){
      ...
      ////  $scope.generalLedger.fromDate = $('#fromDate').val();
       // $scope.generalLedger.toDate = $('#toDate').val();
        if( $scope.generalLedger.companyCode !=''){
            $http.post('app/dayBook/exportGeneralLedgerExcel', $scope.generalLedger).success(function(data) {
                if(data){
                    debugger;
    ...
    //Excel PDF	
  	 $scope.exportPDF = function(){
          ...
          if( $scope.generalLedger.companyCode !=''){
	     	   	 ...
	     	   	 $http.post('app/dayBook/ExportPDF',$scope.generalLedger).success(function(response) {
        ...
        if(($scope.generalLedger.toDate =='' || $scope.generalLedger.fromDate == '') && $scope.generalLedger.companyCode =='')
    	  ...
    	  /*}else{
    		 logger.logError("Please Choose Port ! ");
    	  }*/
  	    }
    ...
    $scope.printgeneralLedger = function(generalLedger){
        ...
        $http.post('app/dayBook/print',$scope.generalLedger).success(function(response) {
    ...
    $scope.exportGeneralLedgerExcelOP = function(){
        ...
        console.log($scope.generalLedger);
        if($scope.generalLedger.toDate !='' && $scope.generalLedger.fromDate != '' && $scope.generalLedger.companyCode !=''){
            $http.post('app/dayBook/exportGeneralLedgerExcelOP', $scope.generalLedger).success(function(data) {
                if(data){
                    debugger;
                    $("#GLExport").bind('click', function() {
                    });
    ...
    $scope.exportTransactionLevelExcel = function(){
        ...
        $scope.generalLedger.toDate = $('#toDate').val();
        if($scope.generalLedger.toDate !='' && $scope.generalLedger.fromDate != '' && $scope.generalLedger.companyCode !=''){
            $http.post('app/dayBook/exportTransactionLevelExcel', $scope.generalLedger).success(function(data) {
                if(data){
                    debugger;
                    $("#GLExport").bind('click', function() {
                    });
    ...
    $scope.populateGeneralLedgerGrid1 = function(sgListData){
     ...
     $scope.geneSubgroupData=[];
        $http.post('app/dayBook/getGeneralLedgerALLLevel',$scope.testing).success(function(data) {
        ...
        $("#generalLedgerGrid").jqGrid({
            ...
            subGridRowExpanded: function(subgrid_id, row_id) {
                ...
                $http.post('app/dayBook/getGeneralLedgerAHLevel',$scope.testing).success(function(data) {
                 if(data.success){
                     debugger;
                    ...
                    gridComplete: function(){
                     ...
                     subGridRowExpanded: function(subgrid_child_id, row_id) {
                         ...
                         $http.post('app/dayBook/getGLTransactionLevel',$scope.testing).success(function(data) {
                          if(data.success){
                              debugger;
    ...
    $scope.exportGeneralLedgerExcelOP1 = function(){
        ...
        if($scope.testing.toDate !='' && $scope.testing.fromDate != '' && $scope.testing.companyCode !=''){
            $http.post('app/dayBook/exportGeneralLedgerExcelOP', $scope.testing).success(function(data) {
                if(data){
                    debugger;
                    $("#GLExport").bind('click', function() {
                    });
    ...
    $scope.exportGeneralLedgerExcel1 = function(){
        ...
        $scope.testing.accountHeadCode=acct;
        if($scope.testing.toDate !='' && $scope.testing.fromDate != '' && $scope.testing.companyCode !=''){
            $http.post('app/dayBook/exportGeneralLedgerExcel', $scope.testing).success(function(data) {
                if(data){
                    debugger;
                    $("#GLExport").bind('click', function() {
                    });
    ...
    $scope.exportTransactionLevelExcel1 = function(){
        ...
        $scope.testing.accountHeadCode=acct;
        if($scope.testing.toDate !='' && $scope.testing.fromDate != '' && $scope.testing.companyCode !=''){
            $http.post('app/dayBook/exportTransactionLevelExcel', $scope.testing).success(function(data) {
                if(data){
                    debugger;
                    $("#GLExport").bind('click', function() {
                    });
    ...
    $scope.populateGeneralLedgerGrid = function(sgListData){
        ...
        $("#generalLedgerGrid").jqGrid({
            ...
            subGridRowExpanded: function(subgrid_id, row_id) {
                ...
                $scope.generalLedger.subGroupCode =rowData.subGroupCode;
                $("#"+subgrid_id).html("<table id='"+subgrid_table_id+"' class='scroll'></table><div id='"+pager_id+"' class='scroll'></div>");
                $http.post('app/dayBook/getGeneralLedgerAHLevel',$scope.generalLedger).success(function(data) {
                 if(data.success){
                     debugger;
                     var glAHlevelDataList =data.lGeneralLedgerAHList;
                     $("#"+subgrid_table_id).jqGrid({
...
/*   
         $scope.$watch('generalLedger.objGroupCodes', function(newValue, oldValue) {
                ...
                if (newValue != '' && newValue != undefined) {
                     ...
                     $http.get('app/dayBook/getsubgroupList?subgroup='+ $scope.test).success(function(datas) {
                         if(datas != null){
                              $scope.subGroupList = datas;
                              $scope.sub = false;
                         }
   ...
   /* $scope.$watch('generalLedger.subGroupCode', function(newValue, oldValue) {
        if (newValue != '' && newValue != undefined) {
             ...
             $http.get('app/dayBook/getmaingroupList?maingroup='+  newValue).success(function(datas) {
                 if(datas != null){
                      $scope.accountHeadList = datas;
                      $scope.main = false;
                 }
