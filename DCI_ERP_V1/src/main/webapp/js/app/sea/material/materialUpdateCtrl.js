//define([ 'hospital/purchase/purchase' ], function(module) {
    ...
    app.controller('materialUpdateCtrl', function($scope, $state, $http, ngDialog, logger, $location, $controller, $injector, sharedProperties, toaster, $rootScope, $stateParams, $filter, validationService) {
...
//                            });
        ...
        $scope.save = function(consignmentRequestData) {
            ...
            if (!$scope.isEdit) {
                    ...
                    if (flag == true && flag2 == true) {
                        ...
                        $http({
                            ...
                            if (data.success == false) {
                                ...
                                $location.path('hospital/purchase/consignmentRequest/list');
                            }
                ...
                if (flag == true && flag2 == true) {
                    var myURL = 'app/hospital/purchase/consignmentRequest/updateApproveMR';
                    $http({
                        url : myURL,
                        data : objWholeData,
                        method : 'post',
