...
app.controller('pendingAddCtrl', function($scope, $rootScope, $http, $location, logger, ngDialog,
        ...
        $scope.callDialog = function($scope, requestCode, $http, ngDialog, logger, $injector, sharedProperties, toaster, $rootScope) {
            ngDialog.open({
                scope : $scope,
                template : 'views/master/pending/ManagePendingPOListAdd',
