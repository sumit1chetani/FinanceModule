//define([ 'hospital/purchase/purchase' ], function(module) {
    ...
    app.controller('quotListCtrl', function($scope, $state, $http, ngDialog, logger, $location, $controller, $injector, sharedProperties, toaster, $rootScope, $stateParams, $filter, validationService) {
