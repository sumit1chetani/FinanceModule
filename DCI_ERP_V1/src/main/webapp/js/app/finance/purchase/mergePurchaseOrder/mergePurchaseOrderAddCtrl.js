define([ 'hospital/purchase/purchase' ], function(module) {
    ...
    'use strict';
    module.registerController('mergePurchaseOrderAddCtrl', function($scope, $state, $http, ngDialog, logger, $location, $controller, $injector, sharedProperties, toaster, $rootScope) {
        ...
        $scope.cancel = function(){
            $state.go("app.hospital.purchase.mergePurchaseOrder.list");
        }
        ...
        $scope.callDialog = function($scope, requestCode, $http, ngDialog, logger, $injector, sharedProperties, toaster, $rootScope) {
            ngDialog.open({
                scope : $scope,
                template : 'views/hospital/purchase/mergePurchaseOrder/MergePurchaseOrderListAdd',
                controller : $controller('mergePurchaseOrderListAddCtrl', {
                    $scope : $scope,
    ...
    module.registerController('mergePurchaseOrderListAddCtrl', function($scope, $http, ngDialog, logger, requestCode, $injector, sharedProperties, toaster, $rootScope) {
