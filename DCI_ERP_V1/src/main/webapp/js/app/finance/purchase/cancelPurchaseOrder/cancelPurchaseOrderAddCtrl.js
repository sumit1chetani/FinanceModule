define([ 'hospital/purchase/purchase' ], function(module) {
    ...
    'use strict';
    module.registerController('cancelPurchaseOrderAddCtrl', function($scope, $state, $http, ngDialog, logger, $location,
        ...
        $scope.cancel = function(){
            $state.go("app.hospital.purchase.cancelPurchaseOrder.list");
        };
        ...
        $scope.save = function(){
            var url = 'app/purchaseOrder/updatePurchaseOrderStatus?statusId='+ $scope.purchaseOrder.statusId+
