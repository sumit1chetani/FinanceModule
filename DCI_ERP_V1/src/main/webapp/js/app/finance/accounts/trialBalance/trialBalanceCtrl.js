    ...
    $scope.viewTrialBalanceReport = function(){
        ...
        if($scope.trialBalance.toDate !='' && $scope.trialBalance.fromDate != '' /*&& $scope.trialBalance.companyCode !=''*/){
            $http.post('app/trialBalance/getTrialBalanceReport', $scope.trialBalance).success(function(data) {
                if(data.success){
                    debugger;
                    $("#trialhead").append("<table id='jqhead' class='text-center'><tr style='font-weight: bold;'><td></td><td> &emsp;&emsp;&emsp;&emsp;&emsp;Code</td><td> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Particulars</td><td id='ob'> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; &emsp;&emsp;&emsp; &emsp;&emsp;Opening Balance</td><td id='dr'> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; &emsp;&emsp;&emsp;&emsp;&emsp;Debit</td><td id='cr'> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; Credit</td><td id='cb' >&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; Closing Balance</td></tr></table>");
...
/*	 self.dealers=  jqGrid('setGridParam', { data : sgListData }).trigger("reloadGrid"); 
    ...
    $scope.populateTrialBalanceGrid = function(sgListData,trialBalance){
        ...
        $("#trialBalanceGrid").jqGrid({
           ...
           // colNames : [ 'Code', 'Particulars','Opening Balance'+$scope.currencCode,'Debit'+$scope.currencCode, 'Credit'+$scope.currencCode, 'Closing Balance'+$scope.currencCode,'Related Party' ],
            colModel:[
                {name:'subGroupCode',index:'subGroupCode', width:81,'color':'red', align:"left",searchoptions:{sopt:['cn']},classes: 'level_class1'},
                ...
                {name:'openingBalance',index:'openingBalance', width:81,align:"right", searchoptions:{sopt:['cn']},hidden:false,classes: 'level_class1',formatter:'currency',formatoptions: { thousandsSeparator:','}},
                {name:'debitAmount',index:'debitAmount', width:84,align:"right", searchoptions:{sopt:['cn']},hidden:false,classes: 'level_class1',formatter:'currency',formatoptions: { thousandsSeparator:','}},
                ...
                {name:'relatedParty',index:'relatedParty', align:"right", searchoptions:{sopt:['cn']},hidden:true,classes: 'level_class1'},
                ],
//                onCellSelect: function(rowid, iCol){  
//                //	alert(rowid);
//                //	$("#modal-fullscreen").modal("panel-fixed-page1");
//                },
        ...
        //    ignoreCase: true,
          ...
          loadComplete: function () {
                ...
                if(celValue != undefined){
                    ...
                    for ( var i = 0; i < celValue.length; i++) {                            
                        ...
                        if (highlightvalue=="RELATED PARTY") {
                            $("#trialBalanceGrid").jqGrid('setCell',highlightid,"subGroupCode","",{'background-color':'#FFFF00', 'font-weight': 'bold','color':'#000000','background-image':'none','opacity':'0.75'});
                            $("#trialBalanceGrid").jqGrid('setCell',highlightid,"subGroupName","",{'background-color':'#FFFF00','font-weight': 'bold','color':'#FFFF00','background-image':'none','opacity':'0.75'});
                            $("#trialBalanceGrid").jqGrid('setCell',highlightid,"debitAmount","",{'background-color':'#FFFF00','font-weight': 'bold','color':'#FFFF00','background-image':'none','opacity':'0.75'});
                            $("#trialBalanceGrid").jqGrid('setCell',highlightid,"creditAmount","",{'background-color':'#FFFF00','font-weight': 'bold','color':'#FFFF00','background-image':'none','opacity':'0.75'});
                            $("#trialBalanceGrid").jqGrid('setCell',highlightid,"currentBalance","",{'background-color':'#FFFF00','font-weight': 'bold','color':'#FFFF00','background-image':'none','opacity':'0.75'});
            ...
            subGridRowExpanded: function(subgrid_id, row_id) {
               ...
               // $('.ui-grid_id-hdiv').hide();
              //  $('div.ui-jqgrid-hdiv').hide();
                ...
                $("#"+subgrid_id).html("<div class='text-lowercase'><table id='"+subgrid_table_id+"' style='text-transform: lowercase;display: inline-block;'></table></div><div id='"+pager_id+"' class='scroll'></div>");
                $http.post(Ahurl,$scope.trialBalance).success(function(data) {
                 if(data.success){
                  ...
                  //    colNames: none,
                     colModel:[
                            {name:'acctHeadCode',index:'acctHeadCode', width:'161', align:"left",searchoptions:{sopt:['cn']},classes: 'level_class2'},
                            {name:'acctHeadName',index:'acctHeadName',  width:'175',  align:"left",searchoptions:{sopt:['cn']},hidden:false,classes: 'level_class2'},
                            {name:'openingBalance',index:'openingBalance', width:'175', align:"right", searchoptions:{sopt:['cn']},hidden:false,classes: 'level_class2'},
                            {name:'debitAmount',index:'debitAmount', width:'180',  align:"right", searchoptions:{sopt:['cn']},hidden:false,classes: 'level_class2'},
                            {name:'creditAmount',index:'creditAmount', width:'175',  align:"right", searchoptions:{sopt:['cn']},hidden:false,classes: 'level_class2'},
                            {name:'currentBalance',index:'currentBalance', width:'159', border:'none' ,align:"right", searchoptions:{sopt:['cn']},hidden:false,classes: 'level_class2'},
                            {name:'relatedParty',index:'relatedParty',  align:"right", searchoptions:{sopt:['cn']},hidden:true,classes: 'level_class2'},
                        ],
                     autowidth: true,
                     height: '100%',
                    // pager: pager_id,
                  //   sortname: 'num',
                   //  sortorder: "asc",
                     ...
                     subGridRowExpanded: function(subgrid_child_id, row_id) {
                    	 $subgrid.parents("div.ui-jqgrid-view").children("div.ui-jqgrid-hdiv").hide();
                         debugger;
                         ...
                         $http.post(transactionURL,$scope.trialBalance).success(function(data) {
                          if(data.success){
                              ...
                              colModel:[
                                 ...
                                 {name:'subAccountCode',index:'subAccountCode', width:200, align:"left",searchoptions:{sopt:['cn']},classes: 'level_class3 cursor-pointer'},
                          ...
                          //    sortname: 'num',
                          //    sortorder: "asc",
                              }).jqGrid('setGridParam', { data : tbTransactionlevelDataList }).trigger("reloadGrid");
                          }
