...
toaster, $timeout, $injector, logger, $stateParams, validationService) {
       ...
       /* $scope.checkjvno = function(newValue) {        	
        	 if (newValue != '' && newValue != undefined) {        		
                  $http.get('app/journalVoucher/getjvNumber?issuedate=' + newValue).success(function(data) {
                 // $scope.receivedFromList = datas;
               		console.log(data);
       		   $scope.journalVoucher.jvNumber=data;     
              }).error(function(data) {
            //	  console.log(data)
              });         
             }	
        ...
        $http.get('app/journalVoucher/getjvNumber').success(function(data) {                
      		   $scope.journalVoucher.jvNumber=data;     
             }).error(function(data) {
            	 console.log(data)
             });         
