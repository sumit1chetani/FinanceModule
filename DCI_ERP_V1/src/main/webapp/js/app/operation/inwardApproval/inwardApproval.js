...
app.controller('bladdingCtrl1Approval', function($scope, $rootScope,ngDialog, $http, $location, logger,
    ...
    $scope.add = function() {
    	 ...
    	 $state.go('app.documentation.inwardbladdingApproval.inwardApprovaladd',{tenantid:$stateParams.tenantid});
    };
...
$scope.getBlList();
    ...
    $scope.editRow = function(item,rowid) { 
    	 ...
    	 $rootScope.values=item;
    	$location.url($stateParams.tenantid+'/documentation/inwardBlApproval/Approval?blNo='+rowid);       
     }
