					...
					<table class="table table-striped b-t b-light">
						...
						<tbody
							...
							<tr>
								...
								<td><label class="col-md-7 control-label view-content"> {{jobOrderTrackingDtl.containerNo}}</label>	<!-- <input type="text" id="containerNo{{trIndex1}}"
                                ...
                                <td class="text-center"><label class="col-md-7 control-label view-content"> {{jobOrderTrackingDtl.sizeTypeName}}</label><!-- <input type="text" class="form-control input-sm text-right"
                               ...
                               <td><label class="col-md-7 control-label view-content"> {{jobOrderTrackingDtl.noOfPackage}}</label><!-- <input type="text"
								...
								<td class="text-center"><label class="col-md-7 control-label view-content"> {{jobOrderTrackingDtl.uom}}</label><!-- <selectivity list="uomList"
