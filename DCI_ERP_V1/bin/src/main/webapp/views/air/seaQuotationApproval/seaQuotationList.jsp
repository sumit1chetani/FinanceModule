				...
				<table class="table table-striped table-hover dataTable no-footer">
					...
					<thead style="background-color: #e2e2e2;">
						...
						<th class="sorting" st-sort="mode">Mode</th>
							...
							<th class="sorting" st-sort="createdOn">Created
								Date</th>
								<th class="sorting" st-sort="modifiedBy">Approved
								By</th>
							<th class="sorting" st-sort="modifiedOn">Approved
								Date</th>
					...
					<tbody class="dataTables-Main-Body">
						<tr data-ng-class="$index % 2 == 0? 'even' : 'odd'"
							...
							<td class="sorting">{{row.approvedBy}}</td>
							<td class="sorting">{{row.approvedDt}}</td>
