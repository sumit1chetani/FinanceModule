...
<body>
	<div class="new" style="border: 1px solid black">
		<c:set var="print" value="${payerIndia}" />
			...
			<tr>
				<td><br> <br>
										...
										<td width="75%" style="font-size: 11px;"><span
											style="text-align: center;">
												<h4
													...
													${print.companyTitle}<br>No:79,Omega
					...
					<table width="50%"
						...
						<td class="width_40" style="font-size: 13px;"><b>GATE PASS NO </b></td>
						<td style="font-size: 13px;">: <b>${print.gatePassNo}</b></td>
						</tr>
						<tr>
							<td class="width_40" style="font-size: 13px;"><b>ORGANISATION NAME</b></td>
							<td style="font-size: 13px;">: <b>${print.companyName}</b></td>
						</tr>
						<tr>
							<td class="width_40" style="font-size: 13px;"><b>LOCATION</b></td>
							<td style="font-size: 13px;">: <b> ${print.location} </b></td>
						</tr>
						<tr>
							<td class="width_40" style="font-size: 13px;"><b>DELIVERY ORDER NO</b></td>
							<td style="font-size: 13px;">:<b> ${print.deliveryorderNo} </b>
							</td>
						</tr>
					...
					<table width="50%"
						style="float: left; padding-top: 10px; padding-bottom: 15px;">
						<tr>
							<td class="width_40" style="font-size: 13px;"><b>GATE PASS DATE</b></td>
							<td style="font-size: 13px;">:<b> ${print.date} </b>
							</td>
						</tr>
						<tr>
							<td class="width_40" style="font-size: 13px;"><b>INVOICE NO</b></td>
							<td style="font-size: 13px;">:<b> ${print.invoiceNo}
							</b></td>
						</tr>
						<tr>
							<td class="width_40" style="font-size: 13px;"><b>RETURN DATE</b></td>
							<td style="font-size: 13px;">:<b> ${print.return_date} </b>
							</td>
						</tr>
						<tr>
							<td class="width_40" style="font-size: 13px;"><b>TYPE</b></td>
						...
						style="float: left; padding-top: 10px; padding-bottom: 15px;">
						<tr>
							<td class="width_40" style="font-size: 13px;"><b>PARTY</b></td>
							<td style="font-size: 13px;">:<b> ${print.party}
							</b></td>
						</tr>
						<tr>
							<td class="width_40" style="font-size: 13px;"><b>MODE OF DELIVERY</b></td>
							<td style="font-size: 13px;">:<b> ${print.modeofdelivery} </b>
							</td>
						</tr>
						<tr>
							<td class="width_40" style="font-size: 13px;"><b>PERSON NAME</b></td>
							<td style="font-size: 13px;">:<b> ${print.personname} </b>
							</td>
						</tr>
						<tr>
...
<br>
					...
					<table class="table table-striped b-t b-light "
						...
						<tr>
							<td><center>
									<font size="4" face="arial"><b>ITEM DETAILS</b></font>
								</center></td>
						</tr>
					</table> <br>
...
<th class="width_1" align="center" style="font-size: 13px;">QUANTITY</th>
<th class="width_2" align="center" style="font-size: 13px;">APPROXIMATE VALUE</th>

							</tr>
						</thead>
						<tbody>
							<c:forEach var="ob" items="${payerIndia.gatepassTables}"
								varStatus="theCount">
								<tr>
									<td align="left" style="font-size: 13px;"><b>${ob.itemname}</b></td>
									<td align="left" style="font-size: 13px;"><b>
											${ob.description1}</b></td>
 ...
 -->
							<td class="no-border" align="center">________________________<br>
							<font face="arial" size="2">Approved By</font></td>
							<td class="no-border" align="center">________________________<br>
							<font face="arial" size="2">Received By</font></td>
						</tr>
					</table></td>
			</tr>
		</table>
