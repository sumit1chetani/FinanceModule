			...
			<form name="gateInForm" class="form-horizontal" novalidate>
                  ...
                  <div class="col-md-7">
                    ...
                    form-name="gateInForm" value="true"></selectivity>
						...
						<div class="form-group">
									...
									<div class="col-md-7">
										<!-- <selectivity list="gateInnoList" ng-model="gateIn.gateInno" disabled="isEdit"
											validation="required" friendly-name="gateInno"
											property="gateIn.gateInno" id="gateInno" name="gateInno" 
											form-name="bookingForm"></selectivity> -->
											<selectivity list="modeList"
										property="gateIn.mode" id="mode"
										name="mode" ng-model="gateIn.mode"
										 friendly-name="Mode" 
										validation="required" form-name="gateInForm"
										></selectivity>
									</div>
								</div>
							<div class="form-group">
									<label class="col-md-5 control-label" >Carrier<span ng-if="gateIn.mode==4"
										style="color: red;">*</span> </label>
								<div class="col-md-7">
									<selectivity list="carrierList" ng-model="gateIn.carrier"
										 property="gateIn.carrier"
					...
					<div class="col-sm-12 col-md-4 col-lg-4">
						<fieldset>
						<div class="form-group"  ng-if="gateIn.type=='Export' && !isEdit">
					...
					<div class="col-sm-12 col-md-4 col-lg-4">
						 ...
						 <div class="form-group">
							...
							<!-- 	<div class="input-group  input-append date">
                             ...
                             <div class="form-group" >
								<label class="col-md-5 control-label">Trip No<span
									style="color: red"></span></label>
								<div class="col-md-7">
									<selectivity list="tripNoList"
										property="gateIn.tripNo" id="tripNo{{trIndex}}"
										ng-model="gateIn.tripNo" 
										name="tripNo{{trIndex}}"
										friendly-name="{{ 'Row' + ($index+1) + '(tripNo)'}}"
										form-name="gateInForm" ></selectivity>
								</div>
							</div> 
							</fieldset>
			   ...
			   <br><br><br><br><br><br><br><br><br><br><br><br><br>
				<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="col-md-7">
									<div class="input-group  input-append date">
									<ng-bs3-datepicker  	property="gateIn.detailDate" id="detailDate"
									name="detailDate"  ng-model="gateIn.detailDate"  friendly-name="Gate In Date" 
									form-name="gateInForm"  />
									</div>
									</div>
								</div>
						...
						<div class="col-md-3">
							<button class="btn btn-info ng-scope"  type="button" 
								ng-click="apply(gateIn.detailDate)">
					...
					<table class="table table-striped b-t b-light">
						<thead>
							<tr>
								...
								<th colspan=1 class="width_17 text-center">Gate Out Date</th>
						...
						<tbody>
							...
							<td class="width_15">
								...
								<td class="width_15">
									...
									<div class="input-group  input-append date">
											<input type="text" class="form-control input-sm"
											     property="row.gateOutDate" id="gateOutDate{{trIndex}}"
												data-ng-model="row.gateOutDate" name="gateOutDate{{trIndex}}"
												friendly-name="{{ 'Row' + $index + '(gateOutDate)'}}" disabled ="true"/>										
										</div>
									</div>
								</td>
								...
								<!-- 
												...
												<div class="input-group  input-append date">
										<ng-bs3-datepicker  	property="row.returnDate" ng-model="row.returnDate" id="returnDate{{trIndex}}" 
				...
				<div class="form-actions">
					<div class="row">
						<div class="col-md-12">
							<button class="btn btn-success" type="button" ng-if="!isEdit" ng-disabled ="saveButtonDisble"
							...
							<!-- <button class="btn btn-success" type="button" ng-if="isEdit"
								class="btn btn-success"
								ng-click="update(gateInForm,gateIn)">
							...
							<button class="btn btn-info" type="button"
							 ...
							 <div class="btn btn-primary" ng-if="isEdit"  data-ng-click="excelexport(gateIn.gateInNo)">
