          ...
          <label class="control-label">B/L No  <span style="color: red;">*</span></label>
             <div>
                ...
                ng-model="blNoData.blNo" name="blNo" form-name="blForm" validation="required"  friendly-name="B/L No" > </div>
						...
						<label class="control-label">Carrier<span
					...
					<div class="col-md-4"  style="margin-bottom: 10px;">
						<label class="control-label">Shipment Order No.<span
							style="color: red;"></span></label>
						<div>
						<label class="control-label" style="margin-top: 5px;">{{blNoData.jobNo}}</label>
          ...
          <label class="control-label">B/L No  <span style="color: red;">*</span></label>
             <div>
                ...
                ng-model="blNoData.blNo" name="blNo" form-name="blForm" validation="required"  friendly-name="B/L No" > </div>
					...
					<div class="col-md-4">
							<label class="control-label">BL Number <span
								style="color: red;"></span><span style="color: #23b7e5;padding-left: 95px;"></span></label> 
							 	<input class="form-control"
								type="text" placeholder="" class="form-control" id="blNo"
								friendly-name="blNo" ng-model="blNoData.blNo" name="blNo"
								form-name="blForm"> 
						<!-- 		
								<selectivity list="voyageList" ng-model="blNoData.disvoyage"
											property="booking.voyage" id="disvoyage" name="disvoyage"
										form-name="blForm" friendly-name="disvoyage"></selectivity>
								  -->
 ...
 -->							<selectivity list="polList" property="blNoData.issuePlace"
              ...
              <ng-bs3-datepicker data-ng-model="blNoData.onBoard"
               ...
               name="receiptAt"  form-name="blForm" validation="required" 
                friendly-name="Receipt at"></selectivity> -->
						...
						<div class="col-md-4">
							<label class="control-label">POL <span
								style="color: red;">*</span></label>
						...
						<div class="col-md-4">
							<label class="control-label">POD / POT<span
								style="color: red;">*</span></label>
              ...
              <selectivity list="portlist" property="blNoData.fpod" id="fpod" ng-model="blNoData.fpod"
               name="fpod" form-name="blForm"  
                friendly-name="FPOD" disabled="false"></selectivity>     
              </div> 
						<div class="col-md-4">
						...
						<div class="col-md-4">
							<label class="control-label">No. of BLs <span
					...
					<div class="col-md-4">
						...
						<div class="col-md-4">
							<label class="control-label">Display Place of Receipt <span
								style="color: red;"></span></label> 
								<!-- <selectivity list="polList" property="blNoData.disPor"
								id="disPor" ng-model="blNoData.disPor" name="disPor"
								form-name="blForm" validation="required"
								friendly-name="Receipt at "></selectivity> -->
								<!-- <input class="form-control"
								...
								<selectivity list="portList1" ng-model="blNoData.disPor"
											property="blNoData.disPor" id="disPor" name="disPor"
											form-name="blForm" friendly-name="disPor"></selectivity>
						</div>
						</div><br>
					<div class="col-md-12" style="margin-top: 1%; margin-bottom: 1%;">
					<div class="col-md-4">
							<label class="control-label">Display POL <span
								style="color: red;"></span><span style="color: #23b7e5;padding-left: 95px;"></span></label> 
								<!-- <input class="form-control"
								...
								form-name="blForm"> -->
											...
											<selectivity list="portList1" ng-model="blNoData.disPor"
											property="blNoData.disPol" id="disPol" name="disPol"
											form-name="blForm" friendly-name="disPol"></selectivity>
						</div>
						<div class="col-md-4">
							<!-- <label class="control-label">Display P.O.D 
							<span
								...
								form-name="blForm"> -->
									...
									<selectivity list="portList1" ng-model="blNoData.disPor"
											property="blNoData.disPod" id="disPod" name="disPod"
											form-name="blForm" friendly-name="disPod"></selectivity>
						</div>
						<div class="col-md-4">
							<!-- <label class="control-label">Display F.P.O.D <span
								style="color: red;"></span><span style="color: #23b7e5;padding-left: 95px;">(10)</span></label> -->
								...
								<selectivity list="portList1" ng-model="blNoData.disFpod"
											property="blNoData.disFpod" id="disFpod" name="disFpod"
											form-name="blForm" friendly-name="disFpod"></selectivity>
						</div>
						</div>
					<br>
					<div class="col-md-12" style="margin-top: 1%; margin-bottom: 1%;">
 ...
 <br> -->
				...
				<div class="col-md-4" >
							...
							<selectivity list="agentList" property="blNoData.deliveryAgent"
								...
								friendly-name="deliveryAgent" form-name="blForm" disabled="true"></selectivity>
						</div>
						 <div class="col-md-4">
				 ...
				 <div class="col-md-4">
						...
						<div class="col-md-4">
							<label class="control-label">Notify Telephone No <span style="color: #23b7e5;padding-left: 95px;"></span></label> <input class="form-control"
								...
								form-name="blForm" >
									...
									<div class="col-md-4">
							<label class="control-label">Notify Email<span style="color: #23b7e5;padding-left: 95px;"></span></label>
							 <input class="form-control"
						...
						<div class="col-md-4">
							<label class="control-label">Consignee Name <span style="color: red;">*</span><span style="color: #23b7e5;padding-left: 95px;"></span></label>
							 <!-- <input class="form-control" type="text" placeholder="" class="form-control input-sm" id="consigName"
								...
								validation="required" > -->
								<selectivity list="customerList" property="blNoData.consigName"
								id="consigName" ng-model="blNoData.consigName" name="consigName"
								friendly-name="consigName" form-name="blForm" validation="required"></selectivity>
						 ...
						 <div class="col-md-4">
							<label class="control-label">Shipper's Address <span style="color: red;">*</span><span style="color: #23b7e5;padding-left: 95px;"></span></label>
								...
								<textarea class="form-control" type="text" name="shipperAddress"
											id="shipperAddress" ng-model="blNoData.shipperAddress" validation="required"
											placeholder="Shipper Address">
                            </textarea>
						</div>
						
						<div class="col-md-4">
							<label class="control-label">Shipper's Telephone No <span style="color: red;"></span><span style="color: #23b7e5;padding-left: 95px;"></span></label>
							 <input class="form-control"
					...
					<div class="col-md-4">
							<label class="control-label">Shipper's Country <span style="color: red;"></span></label> <input class="form-control"
              ...
              <input class="form-control" type="text"  name="messers" id="messers" ng-model="blNoData.messers" placeholder="Messers">
							...
							style="color: red;">*</span></label>
									...
									<div class="col-md-6">
										<label class="control-label">Shipper's Details <span style="color: #23b7e5;padding-left: 95px;"></span></label>
									...
									<div class="col-md-6">
										<label class="control-label">Consignee Details <span style="color: #23b7e5;padding-left: 95px;"></span></label>
									...
									<div class="col-md-6">
										<label class="control-label">Notify 1 Details <span style="color: #23b7e5;padding-left: 95px;"></span></label>
									...
									<div class="col-md-6">
										<label class="control-label">Notify 2 Details <span style="color: #23b7e5;padding-left: 95px;"></span></label>
              ...
              <input class="form-control" type="text" name="t_wgt" id="t_wgt" ng-model="blNoData.t_wgt"  placeholder="T.WGT" validation="numeric">
							...
							<div class="col-md-2">
								<label class="control-label">No. of Packages <span style="color: #23b7e5;padding-left: 95px;"></span></label> <input
							...
							<label
								  class="i-checks m-b-none">Print Net Weight  
							...
							<div class="col-md-2">
								<label class="control-label">Gross Weight <span style="color: #23b7e5;padding-left: 95px;"></span></label> <input
							...
							<div class="panel-body" style="width: 150%;">
								...
								<div class="row" id="items">
									...
									<table class="table table-striped b-t b-light">
										<thead>
											<tr>
												...
												<th colspan=1 class="width_5 text-center">Container No. <span
													style="color: red;">*</span></th>
												<th colspan=1 class="width_3 text-center">Type <span
													style="color: red;">*</span></th>
													<th colspan=1 class="width_1 text-center">SOC <span
													style="color: red;"></span></th>
												<th colspan=1 class="width_4 text-center">Seal No. <span
													style="color: red;">*</span></th>
												<th colspan=1 class="width_3 text-center">Net Weight (Kg)<span
													style="color: red;"></span></th>
												<th colspan=1 class="width_3 text-center">Gross Weight (Kg)<span
													style="color: red;">*</span></th>
												<th colspan=1 class="width_3 text-center">VGM<span
													style="color: red;"></span></th>	
												...
												<th colspan=1 class="width_2 text-center">Celsius / Fahrenheit<span
													style="color: red;"></span></th>
												<th colspan=1 class="width_2 text-center">Check Digit <span
													style="color: red;"></span></th>
									...
									<th colspan=1 class="width_6 text-center">SOC <span style="color: red;"></span></th> -->
												<th colspan=1 class="width_4 text-center">Package <span
													style="color: red;"></span></th>
												<th colspan=1 class="width_2 text-center">No. of Packages <span style="color: red;">*</span>
												</th>
												<th colspan=1 class="width_5 text-center">Commodity<span style="color: red;">*</span></th>
												...
												<th colspan=1 class="width_3 text-center">IMCO Charge</th>
										...
										<table class="table table-striped b-t b-light">
											<thead>
												<tr>
													...
													<th colspan=1 class="width_4">Sequence<span
														style="color: red;">*</span></th>
													...
													<th colspan=1 class="width_6 text-center">Currency <span
														style="color: red;">*</span></th>
													<th colspan=1 class="width_6 text-center">Quantity <span
														style="color: red;">*</span></th>
													...
													<th colspan=1 class="width_6 text-center">Pay At  <span
														style="color: red;"></span></th>
										    ...
										    <table class="table table-striped b-t b-light table-hover dataTable no-footer" style="border: 0px solid Red">
										     ...
										     <tbody class="dataTables-Main-Body">
										      <tr data-ng-class="$index % 2 == 0? 'even' : 'odd'" ng-repeat="blLogHistoryItem in displayedCollection">
											   ...
											   <td>{{blLogHistoryItem.form_name}}</td>
										       <td> {{blLogHistoryItem.user_name}}</td>
										       <td>{{blLogHistoryItem.action_type}}</td>
...
<div class="col-md-12"
              ...
              <input class="form-control" type="text"  name="messers" id="messers" ng-model="blNoData.messers" placeholder="Messers">
							...
							style="color: red;">*</span></label>
									...
									<div class="col-md-6">
										<label class="control-label">Shipper's Details <span style="color: #23b7e5;padding-left: 95px;">(1)</span></label>
										<textarea class="form-control" type="text" name="shipper"
											id="shipper" ng-model="blNoData.shipper"
											placeholder="Shippers">
                            </textarea>
									...
									<div class="col-md-6">
										<label class="control-label">Consignee Details <span style="color: #23b7e5;padding-left: 95px;">(3)</span></label>
										<textarea class="form-control" type="text" name="cnee"
											id="cnee" ng-model="blNoData.cnee" placeholder="Cnee">
                            </textarea>
...
<div class="form-group col-md-3 col-lg-3">
									<label class="col-md-5 control-label"> Same as Consignee 
									</label>
									<div class="col-md-7">
										<input
									type="checkbox" 
									data-ng-model="blNoData.add" />
									</div>
								</div>
									<div class="col-md-6">
										<label class="control-label">Notify 1 Details <span style="color: #23b7e5;padding-left: 95px;">(5)</span></label>
										<textarea class="form-control" type="text" name="notify1"
											id="notify1" ng-model="blNoData.notify1"
											placeholder="Notify1">
                            </textarea>
									...
									<div class="col-md-6">
										<label class="control-label">Notify 2 Details <span style="color: #23b7e5;padding-left: 95px;">(6)</span></label>
										<textarea class="form-control" type="text" name="notify2"
											id="notify2" ng-model="blNoData.notify2"
											placeholder="Notify2">
                            </textarea>
										...
										<thead>
											<tr>
												...
												<th colspan=1 class="width_2 text-center">Type <span
													...
													<th colspan=1 class="width_1 text-center">SOC <span
													style="color: red;"></span></th>
												<th colspan=1 class="width_3 text-center">Seal No. <span
													style="color: red;">*</span></th>
												<th colspan=1 class="width_3 text-center">Net Weight (Kg)<span
													style="color: red;"></span></th>
												<th colspan=1 class="width_3 text-center">Gross Weight ({{blNoData.gw_unit}})<span
													style="color: red;">*</span></th>
													<th colspan=1 class="width_2 text-center">No. of Packages <span style="color: red;">*</span>
												</th>
												<th colspan=1 class="width_4 text-center">Package <span
               ...
               name="cntrNo"  form-name="blForm" validation="required" friendly-name="Contaier No"></selectivity> -->
												...
												<td class="text-center"><selectivity list="packageList"
														property="blcntrDtl.packageType"
														id="packageType{{trIndex}}"
														ng-model="blcntrDtl.packageType" name="packageType" validation="required"
														form-name="blForm" friendly-name="Package Type"
														friendly-name="Package Type"></selectivity></td>
														<!-- <td class="text-center"><input class="form-control"
													type="text" name="g{{trIndex}}" id="g{{trIndex}}"
 ...
 -->
              ...
              <input class="form-control" type="text" name="t_wgt" id="t_wgt" ng-model="blNoData.t_wgt"  placeholder="T.WGT" validation="numeric">
							...
							<div class="col-md-2">
								<label class="control-label">No. of Packages <span style="color: #23b7e5;padding-left: 95px;">(15)</span></label> <input
									class="form-control" type="number" name="pkgs" id="pkgs"
									ng-model="blNoData.pkgs" placeholder="PKGS"
									validation="numeric" disabled="true">
							...
							<div class="col-md-2">
								<label class="control-label">Gross Weight <span style="color: #23b7e5;padding-left: 95px;">(17)</span></label> <input
									class="form-control" type="number" name="g_wgt" id="g_wgt"
									ng-model="blNoData.g_wgt" placeholder="G.WGT"
									validation="numeric" disabled="true">
							...
							<div class="panel-body">
								...
								<div class="row" id="items">
									...
									<th colspan=1 class="width_6 text-center"> Real Amount<span style="color: red;">*</span></th>
											...
											<tbody ng-repeat="(trIndex, blCharge) in blNoData.blCharges">
												<tr>
													<td><label class="i-checks m-b-none"> <input
															type="checkbox" ng-model="blCharge.select"><i></i></label></td>
<td class="width_1" style="">{{trIndex+1}}</td> 
													<td><input class="form-control" type="text" name="seq"
														id="seq" ng-model="blCharge.seq" form-name="blForm"
														form-name="blForm" validation="required"
														friendly-name="Sequence"><span></span> {{(trIndex1+1}} </td>
													<td class="text-center"><selectivity
															list="BlsurchargeList" property="blCharge.chargeCode"
															id="chargeCode" ng-model="blCharge.chargeCode"
															name="chargeCode" form-name="blForm"
													...
													<td class="text-center"><input class="form-control"
														type="text" name="qty" id="qty" ng-model="blCharge.qty"
														form-name="blForm" validation="required" ng-blur = "totalAmtcalculation(blCharge.qty,blCharge.rate,trIndex)"
														friendly-name="Qty"></td>
													<td class="text-center"><input class="form-control"
														type="text" name="rate" id="rate" ng-model="blCharge.rate"
														form-name="blForm" validation="required"  ng-blur = "totalAmtcalculation(blCharge.qty,blCharge.rate,trIndex)"
...
<!-- 								<th colspan=1 class=" width_10 text-center">Payment Method </th>
 -->							<th colspan=1 class=" width_6 text-center">Transaction Type </th>
								...
								<th colspan=1 class=" width_16 text-center">Notes </th>
										...
										<tbody ng-repeat="(trIndex, row) in blNoData.quotationDtl"
						...
						<td class=" width_6" ><input type="text" class="form-control input-sm text-right"
								...
								<td class=" width_10" ><selectivity list="currencylist" 
										...
										<textarea  type="text" class="form-control input-sm"
										                   ...
										                   friendly-name="{{ 'Row' + ($index+1) + '(note)'}}" disabled="true">
															</textarea>
							</tr>
						</tbody>
									</table>
									...
									<button type="button" class="btn btn-sm btn-danger"
										ng-click="removeqtnDtl(blNoData.quotationDtl)">
										<i class="fa fa-minus"></i>
									</button>
...
style="color: red;"></span></th>
										...
										<tbody ng-repeat="(trIndex, row) in blNoData.addchargeData track by trIndex">
<tr>
<td><label class="i-checks m-b-none"> <input
...
friendly-name="{{ 'Row' + $index + '(bookremarks)'}}" />
									...
									<button ng-click="addAdditionalRow()" class="btn btn-sm btn-success"
 type="button">
<i class="fa fa-plus"></i>
</button>
