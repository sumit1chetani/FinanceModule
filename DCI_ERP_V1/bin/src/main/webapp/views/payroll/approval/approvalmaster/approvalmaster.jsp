        ...
        <table id="dt_basic" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dt_basic_info">
         <thead class="dataTables-Main-Head">
          <tr>
           ...
           <th class="sorting width_15" st-sort="">Approver Name</th>
           <th class="sorting width_15" st-sort="">Employee No</th>
           <th class="sorting width_15" st-sort="">Employee Name</th>
           <th class="sorting width_15" st-sort="">Created By</th>
           <th class="sorting width_15" st-sort="">Created Date</th>
