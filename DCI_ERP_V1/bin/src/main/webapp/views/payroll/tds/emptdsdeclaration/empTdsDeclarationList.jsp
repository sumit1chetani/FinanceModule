     ...
     <header>
      ...
      <form class="form-horizontal" name="empTdsDeclarationForm" role="form" > 
     	...
     	<div class="col-sm-12 col-md-12 col-lg-12 ">
				<div class="col-sm-6 col-md-6 col-lg-6">
					<div class="form-group">
						...
						<div class="col-md-5">
						 <selectivity  list=companyList property="tdsDeclarationList.companyId" ng-model="tdsDeclarationList.companyId"
								 	id="companyId"  name="companyId" form-name = "empTdsDeclarationForm" validation="required" friendly-name="Hospital Name" ng-if="companyList.length > 1"></selectivity>
					...
					<div class="form-group">
						...
						<div class="col-md-5">
							<selectivity  list=branchList property="tdsDeclarationList.branchId" ng-model="tdsDeclarationList.branchId" id="branchId"  name="branchId" form-name = "empTdsDeclarationForm" validation="required" friendly-name="Branch Name" ng-if="branchList.length > 1"></selectivity>
			...
			<div class="col-sm-6 col-md-6 col-lg-6">
					...
					<div class="col-md-5">
						 <selectivity  list=departmentList property="tdsDeclarationList.departmentId" ng-model="tdsDeclarationList.departmentId" id="departmentId"  name="departmentId" form-name = "empTdsDeclarationForm" validation="required" friendly-name="Department Name"></selectivity>
					...
					<div class="form-group">
						...
						<div class="col-md-5">
							...
							<selectivity  list=employeeList  property="tdsDeclarationList.employeeId" ng-model="tdsDeclarationList.employeeId" id="employeeId"  name="employeeId" form-name = "empTdsDeclarationForm" validation="required" friendly-name="Employee Name"></selectivity> 										        
						...
						<div class="col-md-5">
							...
							<selectivity  list=taxsectionList  property="tdsDeclarationList.taxSectionCode" ng-model="tdsDeclarationList.taxSectionCode" id="taxSectionCode"  name="taxSectionCode" form-name = "empTdsDeclarationForm" validation="required" friendly-name="Tax Section Code">></selectivity> 										      												        
						</div>
						</div>
					</div>
			</div>
		...
		<%@include file="/views/templates/panel-header.jsp"%>
		        ...
		        <table id="dt_basic" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dt_basic_info">
		          ...
		          <tr>
		           ...
		           <th class="sorting width_15" st-sort="taxSubSectionDescription">Tax SubSection Description</th>
		            <th class="sorting width_10" st-sort="declaredAmount
		            ">Declared Amount</th>
          ...
          <tr data-ng-class="$index % 2 == 0? 'even' : 'odd'" ng-repeat="tdsDeclarationList in displayedCollection">
			...
			<td><input type="number" min="0" ng-model="tdsDeclarationList.declaredAmount"></td>
		 ...
		 <input type="file" name="filePathUrl" ng-model="tdsDeclarationList.filePathUrl" class="form-control" onchange="angular.element(this).scope().uploadDocFile(this)"
		 	...
		 	<button class="btn btn-success" type="button" ng-click="uploadDocument(tdsDeclarationList.taxSubSectionCode,tdsDeclarationList.taxSectionCode)" style=" margin-left:31%; margin-top:-17%; ">
											  <i ></i>
											     Upload
						  </button>
		     ...
		     <br>
		        <div class="form-actions">
					<div class="row">
							<div class="col-md-12">
								<button class="btn btn-success" class="btn btn-success" type="button"  data-ng-model="add" data-ng-if="tdsDeclarationList.isEdit" ng-click="updateTdsList()">
