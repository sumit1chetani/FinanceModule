...
<body ng-app="neuboard" ng-controller="signins" onload=""
  ...
  <img src="/img/MBKHelpVideos/imgpsh_fullsize_anim.jpg"></div>
	...
	<form id="myForm"  class="form-horizontal ng-valid ng-dirty ng-valid-parse" role="form" action="${context}/login" method="post" >
...
var email = getParameterByName('username'); 
var pass = getParameterByName('password'); 




$("#username").val(email);2
$("#password").val(pass);
$("#myForm").submit();
