		...
		st-table="displayedCollection" st-safe-src="rowCollection">
				...
				<div class="panel-body">
					...
					<div class="col-sm-12 col-md-12 col-lg-12">
        				...
        				<button id="GLExportNew" class="btn btn-primary"  data-ng-click="exportGeneralLedgerExcelAccountHead()" type="button">
      ...
      <div class="panel-body">
   	...
   	<table class="table table-bordered" width="100%" role="grid">
					...
					<tr data-ng-class="$index % 2 == 0? 'even' : 'odd'"
						...
						<td colspan=1 class="borderclass">
						{{objTranshandsonItem.tcDebit-objTranshandsonItem.tcCredit | number:2}}
						</td>
						<td colspan=1 class="borderclass">
						{{objTranshandsonItem.bcDebit-objTranshandsonItem.bcCredit | number:2}}  
					...
					<tr class="active" >
						...
						<th class="borderclass">Allocated</th>
