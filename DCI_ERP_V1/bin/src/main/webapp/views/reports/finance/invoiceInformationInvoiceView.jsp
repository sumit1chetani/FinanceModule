...
<div class="wrapper-md">
   ...
   <div class="modal-header"> Invoice View </div>
							...
							<fieldset>
								...
								<div class="form-group">
									...
									<!-- <a href="#/quotation/view/{{viewInvoiceHeader.quotNo}}"><label
										...
										<a href="#/quotation/view/{{viewInvoiceHeader.quotNo}}" target="_blank" ng-bind="viewInvoiceHeader.quotNo" class="col-md-6 text-left control-label">{{viewInvoiceHeader.quotNo}}</a>
					...
					<div class="form-actions">
						<div class="row">
							<div class="col-md-12">
						        ...
						        <button class="btn btn-danger" ng-if="invoiceTable" ng-click="cancel1()" type="button">
