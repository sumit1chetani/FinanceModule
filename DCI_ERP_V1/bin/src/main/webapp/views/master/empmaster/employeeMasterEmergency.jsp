									...
									<div class="col-sm-12 col-md-12 col-lg-12 padding-top-10">
										<div class="col-sm-6 col-md-6 col-lg-6">
											<div class="form-group">
												...
												<div class="col-md-5 inputGroupContainer">
													<input type="text" class="form-control input-sm"
														name="Name Emer" data-message-id="emergencyName"
											...
											<div class="form-group">
												...
												<div class="col-md-5 inputGroupContainer">
													<input type="text" class="form-control input-sm"
														name="emergRelationship" maxlength="50"
											...
											<div class="form-group">
												...
												<div class="col-md-5 inputGroupContainer">
													<input type="text" class="form-control input-sm"
														name="emergencyOccu" maxlength="50"
										...
										<div class="col-sm-6 col-md-6 col-lg-6"">
											...
											<div class="form-group">
												...
												<div class="col-md-5 inputGroupContainer">
													<input type="text" class="form-control input-sm"
														name="emergencyPincode" maxlength="10"
									...
									<div class="row">
										<div class="form-group">
											<div class="col-md-12" style="padding-top: 15px;"
												align="center">
												<button class="btn btn-success" data-ng-if="!ispop5Edit" type="button"
													ng-click="validateEmergency(frmEmergency,EmployeeMasterDataEme)">
													<i class="fa fa-save"></i> Save
												</button>
												<button class="btn btn-success" type="button"
													data-ng-click="validateEmergency(frmEmergency,EmployeeMasterDataEme);"
													data-ng-if="ispop5Edit==true">
