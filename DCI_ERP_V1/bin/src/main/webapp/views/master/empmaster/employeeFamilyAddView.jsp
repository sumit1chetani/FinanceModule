											...
											<fieldset class="field_set setBorder"
													...
													<div class="form-group">
														...
														<div class="col-md-5">
															<select class="form-control journalVoucher-textBox"
																...
																validation="required" friendly-name="Gender" disabled> 
													...
													<div class="form-group">
														...
														<div class="col-md-5 inputGroupContainer">
															...
															<div class="input-group input-append date">
																<input type="text" class="form-control input-sm"
																	id="dependentDob" name="dependentDob" disabled
														...
														<div class="col-md-5 inputGroupContainer">
															<div class="input-group">
																...
																<input type="file" class="form-control"
																	name="uploadDependentPhoto" disabled
												...
												<div class="col-sm-6 col-md-6 col-lg-6">
													...
													<div class="form-group">
														...
														<div class="col-md-5 inputGroupContainer">
															<input type="text" class="form-control input-sm"
																name="Relationship With Employee" disabled
													...
													<div class="form-group">
														...
														<div class="col-md-5">
															<textarea class="form-control"
																name="dependentMedicalEntitlement" disabled
													...
													<div class="form-group">
														...
														<div class="radio radio-inline">
															<label class="i-checks"> <input type="radio" disabled
											...
											<fieldset class="field_set setBorder"
																...
																<div class="dropdown" style="margin-top: -15px;">
																	...
																	<ul class="dropdown-menu" role="menu"
																		...
																		<datetimepicker 
																			...
																			data-on-set-time="employeeFamilyList.dependentPassportIssuedDate = onDateSet(newDate)" disabled
												...
												<div class="col-sm-12 col-md-6">
													...
													<div class="form-group">
														...
														<div class="col-md-5 inputGroupContainer">
															<input type="text" class="form-control input-sm"
																name="dependentPassportIssuedPlace" disabled
											...
											<fieldset class="field_set setBorder"
												...
												<div class="col-sm-12 col-md-6">
													<div class="form-group">
														...
														<div class="col-md-5 inputGroupContainer">
															<input type="text" class="form-control input-sm"
																name="dependentVisaReferenceNumber" disabled
													...
													<div class="form-group">
														...
														<div class="col-md-5 inputGroupContainer">
															<input type="text" class="form-control input-sm"
																name="dependentVisaType" disabled
															...
															<div class='input-group date datetimepick'>
																<div class="dropdown" style="margin-top: -15px;"
																	...
																	<ul class="top-pad" role="menu"
																		aria-labelledby="dLabel">
																		<datetimepicker
																			data-ng-model="employeeFamilyList.dependentVisaIssuedDate" disabled
															...
															<div class='input-group date datetimepick'>
																<div class="dropdown" style="margin-top: -15px;">
																	<a class="dropdown-toggle"
																		...
																		<div class="input-group">
																			<input type="text" class="form-control"
																				...
																				name="dependentVisaExpirationDate" disabled
																	...
																	<ul class="dropdown-menu" role="menu"
																		aria-labelledby="dLabel">
																		<datetimepicker
																			data-ng-model="employeeFamilyList.dependentVisaExpirationDate" disabled
