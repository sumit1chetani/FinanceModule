					...
					<div class="col-sm-12 col-md-12 col-lg-12">
							...
							<fieldset>					
								...
								<div class="form-group">
									<label class="col-md-4 control-label">Charge Type Code<span
								...
								<div class="form-group">
									<label class="col-md-4 control-label">Charge  Type Name<span
										style="color: red;">*</span></label> 
									<div class="col-md-5">			
					...
					<div class="row">
						<div class="col-md-12">
							<button class="btn btn-success" ng-if="edit"
								ng-click="validate(chargetypeForm)">
							...
							<button class="btn btn-info" ng-if="edit"
