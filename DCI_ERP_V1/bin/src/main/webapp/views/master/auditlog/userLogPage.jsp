...
<%--  <div class="panel panel-default panel-default-form ">
  ...
  <div class="panel-body">
   ...
   <div class="panel panel-default panel-default-list" st-table="displayedCollection" st-safe-src="rowCollection">
	  <div class="panel-heading panel-heading-list  font-bold">
  ...
  <div class="table-responsive ">
    <table class="table table-striped b-t b-light table-hover dataTable no-footer" style="border: 0px solid Red">
     <thead class="dataTables-Main-Head">
      <tr>
       <th class="sorting width_10" st-sort="employeeName">Employee</th>
       <th class="sorting width_10" st-sort="formName">Form Name</th>
       <th class="sorting width_10" st-sort="actionType">Action</th>
       <th class="sorting width_10" st-sort="primaryDataId">Identifier</th>
       <th class="sorting width_40" st-sort="logDescription">Description</th>
