  ...
  <tab heading="{{tabs[0].title}}"> 
									<div class="panel-body">
										...
										<div class="form-group">
													<label class="col-md-6 control-label">Trailer No <span style="color: red;">*</span>
													</label>
													<div class="col-md-6">
														<input type="text" class="form-control input-sm"
															name="trailerNo" validation="required" friendly-name="Trailer No" form-name="trailerForm"
															ng-model="trailer.trailerNo">
													</div>
												</div>		
											

<div class="form-group">
							<label class="col-md-6 control-label">Trailer Type<span
							...
							<div class="col-md-6">
								<select class="form-control input-sm"
									...
									friendly-name="trailerType" id="trailerType">
									<option value="">--Select--</option>
																	...
																	<div class="form-group">
							<label class="col-md-6 control-label">Number of Axles<span
								style="color: red;">*</span> 
							</label>
							...
							<div class="col-md-6">
								<select class="form-control input-sm"
									...
									form-name="trailerForm" validation="required"
									friendly-name="numberofAxles" id="numberofAxles"	>
									<option value="">--Select--</option>
								</select>
							</div>
						</div>
												...
												<div class="form-group">
													<label class="col-md-6 control-label">Capacity (Tonnes)<span style="color: red;">*</span>
													</label>
													<div class="col-md-6">
														<input type="text" class="form-control input-sm"
															name="capacity" validation="required" friendly-name="Capacity" form-name="trailerForm"
															ng-model="trailer.capacity">
													</div>
												</div>
												<div class="form-group">
	...
	<button class="btn btn-info" type="reset" ng-click="reset()"
							...
							<button class="btn btn-info" ng-click="reset1()" ng-if="edit">
								<i class="fa fa-undo"></i> Reset
							</button>
