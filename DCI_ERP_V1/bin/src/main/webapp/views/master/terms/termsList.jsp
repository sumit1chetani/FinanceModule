				...
				<table class="table table-striped table-hover dataTable no-footer">
					...
					<thead style="background-color: #e2e2e2;">
						<tr>
							...
							<!--        </label></th> -->
							<th class="sorting width_25" st-sort="code">Code</th>
							<th class="sorting width_30" st-sort="name">Name</th>
...
<th class="sorting width_25" >Action</th>						</tr>
					</thead>
					<tbody class="dataTables-Main-Body">
						...
						<security:authorize access="hasRole('${form_code}_${view}')"> 
							 <a ng-click="view(objGroupHeadItem.termid)"> 
...
<td class="sorting" data-toggle="tooltip"
							...
							<td class=" td-actions text-center">
									...
									<span> <i class="fa fa-pencil text-success text" data-toggle="tooltip" title="Edit"
										data-ng-click="editRow(objGroupHeadItem.termid)"></i>
									</span>
									...
									<span> <i class="fa fa-trash-o text-danger-dker text" data-toggle="tooltip" title="Delete"
										data-ng-click="deleteRow(objGroupHeadItem.termid)"></i>
									</span>
