							...
							<div class="form-group">
								...
								<div class="col-md-5">
									<input type="text" class="form-control input-sm" maxlength=6
										...
										friendly-name="ContainerSequence Code">
								</div>
							</div>
							...
							<!-- <div class="form-group">
								...
								<div class="col-md-5">
									<input type="text" class="form-control input-sm"
										...
										ng-model="containerSequenceMaster.containerSequenceShortName" name="containerSequenceShortName" />
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-5">
									<selectivity list="statelist" property="containerSequenceMaster.state"
										...
										form-name="containerSequenceMasterForm" validation="required"
										friendly-name="State"></selectivity>
							...
							<div class="form-group">
								...
								<div class="col-md-5">
									<selectivity list="countryList" property="containerSequenceMaster.country"
										...
										form-name="containerSequenceMasterForm" friendly-name="country"></selectivity>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-5">
									<input type="text" class="form-control input-sm" maxlength=250
										...
										name="containerSequenceLocation" />
								</div>
							</div>
							<!-- <div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-md-5">
									<input type="text" class="form-control input-sm" maxlength=250
										...
										ng-model="containerSequenceMaster.address" name="address" />
							...
							<div class="form-group">
								...
								<div class="col-md-5">
									<input type="text" class="form-control input-sm" maxlength=100
										...
										ng-model="containerSequenceMaster.personIncharge" name="personIncharge" />
					...
					<div class="row">
						<div class="col-md-12">
							<button class="btn btn-success" type="button" ng-if="!isEdit"
								...
								ng-click="save(containerSequenceMasterForm,containerSequenceMaster)">
								<i class="fa fa-save"></i> Save

							</button>
							<button class="btn btn-success" type="button" ng-if="isEdit"
								class="btn btn-success"
								ng-click="update(containerSequenceMasterForm,containerSequenceMaster)">
								<i class="fa fa-save"></i> Update
							</button>
							<button class="btn btn-info" type="button"
								data-ng-click="reset(containerSequenceMasterForm)">
