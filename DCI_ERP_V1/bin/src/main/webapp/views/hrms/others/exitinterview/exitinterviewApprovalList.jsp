					...
					<div role="content">
						...
						<div class="widget-body no-padding">
							<div
								...
								st-table="displayedCollection" st-safe-src="rowCollectionApproval">
								...
								<table id="dt_basic"
									...
									<thead class="dataTables-Main-Head">
										<tr>
											...
											<th class="sorting width_1" data-st-sort="date">Action
											</th>
										</tr>
									</thead>
										...
										<tr data-ng-class="$index % 2 == 0? 'even' : 'odd'"
											...
											<td><security:authorize
													...
													<span> <i class="fa  fa-pencil text-success text"
														data-ng-click="viewToApprove(disciplinaryCollection.exitid)"></i>
													</span>
												</security:authorize>
												</td>
										</tr>
