       ...
       <div class="form-actions">
        <div class="row">
         <div class="col-lg-12 col-md-12">
          <button class="btn btn-primary" type="save" data-ng-click="saveRfq('N')" data-ng-disabled="saveDisabled" ng-show="rfqStatusName=='Draft'">
           <i class="fa fa-save"></i>
           <spring:message code="label.save"></spring:message>
          </button>
          <button class="btn btn-primary" type="button" data-ng-click="saveRfq('Y')" data-ng-disabled="saveDisabled" ng-show="rfqStatusName=='Draft'">Save and Send Mail</button>
