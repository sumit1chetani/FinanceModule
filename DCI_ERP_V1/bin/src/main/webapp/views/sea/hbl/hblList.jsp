...
<div class="row" style="margin-top: 15px;">
           						...
           						<button class="btn btn-primary" data-ng-click="exportExcel()">
										<span class="fa fa-file-excel-o"> </span> Export to Excel <a
											...
											href="filePath/Bill of Coastal Goods.xlsx"
											download="Bill of Coastal Goods.xlsx"></a>
									</button>
			...
			<div class="table-responsive" style=" border: 1px solid #CCC;">
				<table class="table table-striped table-hover dataTable no-footer">
					...
					<thead style="background-color: #e2e2e2;">
						<tr>
							<th class="sorting width_5" st-sort="hblNo">BCG No</th>
							<th class="sorting width_4" st-sort="hblDocNo">BCG Doc No</th>
							<th class="sorting width_3" st-sort="hblDocDate">BCG Doc
								Date</th>

							<th class="sorting width_2" st-sort="jobCode">Job No</th>
							<!-- <th class="sorting width_3" st-sort="customerCode">MBL No</th> -->
							<th class="sorting width_3" st-sort="customerCode">Customer</th>
							<th class="sorting width_3" st-sort="vessel">Vessel</th>
							<th class="sorting width_3" st-sort="voyage">Voyage</th>
					...
					<tbody class="dataTables-Main-Body">
						...
						<tr data-ng-class="$index % 2 == 0? 'even' : 'odd'"
							...
							<td class="" data-toggle="tooltip" title="{{objItem.vessel}}">{{objItem.vessel}}</td>
							<td class="" data-toggle="tooltip" title="{{objItem.voyage}}">{{objItem.voyage}}</td>							
