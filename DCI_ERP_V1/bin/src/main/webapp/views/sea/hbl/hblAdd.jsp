		...
		<form name="hblForm" method="post" class="form-horizontal" novalidate>
			<div class="panel-body" style="border-bottom:none;">
				<div class="row pl2pc pr10pc">
					<div class="col-md-3" ng-if="isEdit">
						<div class="form-group" >
							<label class="col-md-5 control-label" style="text-align:left">BCG No <span
				...
				<div class="row pl2pc pr10pc">
						...
						<div class="form-group">
							...
							<div class="col-md-7" ng-if="isEdit">
								<input type="text" class="form-control input-sm"
									property="hbl.jobCode" data-ng-model="hbl.jobCode"
									name="Job No" friendly-name="Job No" disabled/>
					...
					<div class="col-md-3">
						<div class="form-group">
							<label class="col-md-5 control-label"style="text-align:left">BCG Date <span
								style="color: red;">*</span>
							</label>
							<div class="col-md-7">
...
<div class="col-md-3">
				...
				<div class="row pl2pc pr10pc">
					...
					<div class="col-md-3">
						<div class="form-group">
							<label class="col-md-5 control-label"style="text-align:left">Add Shipper</label>
							<div class="col-md-7" style="padding-top: 5.25px;">
								<input
									type="checkbox" 
									data-ng-model="hbl.addShipper" />
							</div>
						</div>
					</div><div class="col-md-3">
						<div class="form-group">
							<label class="col-md-5 control-label"style="text-align:left">Add Consignee </label>
							<div class="col-md-7" style="padding-top: 5.25px;">
								<input
									type="checkbox" 
									data-ng-model="hbl.addConsignee" />
							</div>
						</div>
					</div>
...
">Document Details</legend>
				...
				<div class="row pl2pc pr10pc">
					...
					<div class="col-md-3">
						<div class="form-group">
							<label class="col-md-5 control-label">BCG Doc No</label>
							<div class="col-md-7">
								<input type="text" class="form-control input-sm"
					...
					<div class="col-md-3">
						<div class="form-group">
							<label class="col-md-5 control-label">BCG Doc Date </label>
							<div class="col-md-7">
						...
						<div class="form-group">
							...
							<div class="col-md-7">
								<input type="text" class="form-control input-sm"
									...
									name="Vessel Voyage" friendly-name="Vessel Voyage" disabled/>
							</div>
						</div>
					</div>
...
">Container Details</legend>
			...
			<div >
				<table class="table table-striped b-t b-light" style="width:100%">
					<thead>
						<tr>
							<th class="sorting width_2">Select<label
								  class="i-checks m-b-none">
									<input type="checkbox" ng-model="selection"
									data-ng-click="selectAllRec(lHablContainerBean,selection)"><i style="margin-left: -15px;"></i>
							</label></th>
			...
			<div class="panel-body" style="border-top:none;">
				...
				<div class="row pl2pc pr10pc" ng-if = "specialEmployeeFlag">
					<div class="col-md-3">
						<div class="form-group">
				...
				<div class="table-responsive">
					<table class="table table-striped b-t b-light"  ng-if = "specialEmployeeFlag">
						<thead>
							<tr>
									...
									<th colspan=1 class="width_14 text-center">Units<span
										style="color: red;">*</span></th>
								...
								<!-- 	<th colspan=1 class="width_9 text-center">Payment Mode<span
									...
									<th colspan=1 class="width_12 text-center">Status<span
										style="color: red;">*</span></th>
									<th class="sorting width_10">Payment Mode </th>
						...
						<tbody ng-repeat="($index,row) in lHablFreightBean">
							<tr>
									<td ng-if="row.jobStatus1==1"><label class="i-checks m-b-none"> <input
											type="checkbox" ng-model="row.select"><i></i></label></td>
											
											<td ng-if="row.jobStatus1!=1"><label class="i-checks m-b-none"> <input
											type="checkbox" ng-model="row.select" disabled=ture><i></i></label></td>
											
									<!-- <td class="text-center">{{trIndex+1}}</td> -->
									<td class="" ng-if="row.jobStatus1==1"><selectivity list="chargeHeadList"
											property="row.chargeName" id="chargeHeads{{trIndex}}"
											ng-model="row.chargeName"
											name="chargeName{{trIndex}}" validation="required"
											friendly-name="{{ 'Row-' + (trIndex+1) + '(chargeName)'}}"
											form-name="hblForm" disabled=false></selectivity></td>
											...
											name="chargeName{{trIndex}}" validation="required"
											friendly-name="{{ 'Row-' + (trIndex+1) + '(chargeName)'}}"
											form-name="hblForm" disabled=true></selectivity></td>

									<td class="" ng-if="row.jobStatus1==1"><selectivity list="UnitList"
											property="row.unit" id="unit"
											ng-model="row.unit" name="unit{{trIndex}}"
											validation="required"
									...
									<td class="text-center" ng-if="row.jobStatus1==1"><selectivity
											list="transactionTypeList"
											property="row.transactionType"
											id="transactionType{{trIndex}}"
											ng-model="row.transactionType"
									...
									<td class="text-center" ng-if="row.jobStatus1==1"><input type="text"
										id="qty{{trIndex}}" class="form-control input-sm text-right"
										ng-model="row.quantity" name="quantity{{trIndex}}"
										validation="required" form-name='hblForm'
										...
										id="qty{{trIndex}}" class="form-control input-sm text-right"
										ng-model="row.quantity" name="quantity{{trIndex}}"
										validation="required|integer" form-name='hblForm'
										maxlength="9" ng-change="ratevalues()"
										friendly-name="{{ 'Row-' + (trIndex+1) + '(Quantity)'}}"
									...
									<td class="text-center" ng-if="row.jobStatus1==1"><input type="text"
										...
										ng-model="row.rate" name="rate{{trIndex}}"
										validation="required|integer" form-name='hblForm'
										maxlength="10"
									...
									<td class="" ng-if="row.jobStatus1==1"><selectivity list="currencylist"
											property="row.currency" id="currency{{trIndex}}"
											ng-model="row.currency" name="currency{{trIndex}}"
											validation="required"
									...
									<td class="text-center" ng-if="row.jobStatus1==1"><input type="text"
										...
										id="exRate{{trIndex}}" ng-model="row.exRate" 
										name="exRate{{trIndex}}" validation="required|integer"
										form-name='hblForm' ng-blur="CheckExRateDtl(row.currency,trIndex)"
										maxlength="9"
									...
									<td class="text-center" ng-if="row.jobStatus1==1"><input type="text"
										class="form-control input-sm text-right"
										ng-model="row.amount" name="amount{{trIndex}}"
										validation="required|integer" form-name='hblForm'
									...
									<td class="" ng-if="row.transactionType==1 && row.jobStatus1==1"><selectivity list="customerBuyList"
											property="row.buySellParty" id="buySell{{trIndex}}"
											ng-model="row.buySellParty"
									...
									<td class="" ng-if="row.transactionType==2 && row.jobStatus1==1"><selectivity list="customerSellList"
											property="row.buySellParty" id="buySell{{trIndex}}"
											ng-model="row.buySellParty"
											name="buySellParty{{trIndex}}" validation="required"
											friendly-name="{{ 'Row-' + (trIndex+1) + '(buySellParty)'}}"
									...
									<!-- <td class="" ng-if="row.jobStatus1==1"><selectivity list="customerBuyList"
											property="row.buySellParty" id="buySell{{trIndex}}"
											ng-model="row.buySellParty"
											name="buySellParty{{trIndex}}" validation="required"
											friendly-name="{{ 'Row-' + (trIndex+1) + '(buySellParty)'}}"
									...
									<td class="text-center" ng-if="row.jobStatus1==1"><selectivity list="jobStatusListDtl"
											property="row.jobStatus1" id="jobStatus1{{trIndex}}"
											ng-model="row.jobStatus1" name="jobStatus1{{trIndex}}"
											validation="required"
											friendly-name="{{ 'Row-' + (trIndex+1) + '(jobStatus1)'}}"
											form-name="hblForm" disabled=true></selectivity></td>
											<td class="text-center" ng-if="row.jobStatus1!=1"><selectivity list="jobStatusListDtl"
											property="row.jobStatus1" id="jobStatus1{{trIndex}}"
											ng-model="row.jobStatus1" name="jobStatus1{{trIndex}}"
							...
							<!-- <tr>
								...
								<td class="">
									<selectivity list="chargeHeadList"
											property="row.chargeName" id="chargeName{{trIndex}}"
											ng-model="row.chargeName"
											name="chargeName{{trIndex}}" validation="required"
											friendly-name="{{ 'Row-' + (trIndex+1) + '(Charger Name)'}}"
											form-name="hblForm"></selectivity>
								</td>
								<td>
									<div class="row">
					...
					<div class="padding-right-5" id="AddOrRmvebtn" ng-if = "specialEmployeeFlag">
