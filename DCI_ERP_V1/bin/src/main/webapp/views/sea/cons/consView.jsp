			        ...
			        <table id="dt_basic"
			         ...
			         <tbody class="dataTables-Main-Body">
			          ...
			          ng-hide="departmentCollections.edit == '2'">
			           ...
			           <td>{{departmentCollections.unitPrice}}</td>
			           <td>{{departmentCollections.oldUnitPrice}}</td>
			           <td>{{departmentCollections.price}}</td>
			           <td>{{departmentCollections.discount}}</td>
			           <td>{{departmentCollections.total}}</td>
			           <td>{{departmentCollections.tax}}</td>
			           <td>{{departmentCollections.finalTotal}}</td>
...
<!-- 			         data-smart-include="views/layout/toolbar-footer.tpl"></div> -->
				...
				<div class="col-md-12">
        			<div class="form-group">
						...
						<span class="span-class">{{purchaseOrder.freight}}</span>
