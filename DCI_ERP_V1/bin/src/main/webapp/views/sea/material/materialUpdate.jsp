			              		...
			              		Organization Name <span style = "color:red";>*</span></label>
					        				<div class="col-md-7">
						        				...
						        				<selectivity list="companyList" 
													  ng-model="consignmentRequestData.companyId" property="consignmentRequestData.companyId" id="companyId" 
													    name="Company Id" validation="required" 
													  friendly-name="Company Id" form-name = "consignmentRequestForm">
													  </selectivity>
						        				<!-- <selectivity list="companyList" 
