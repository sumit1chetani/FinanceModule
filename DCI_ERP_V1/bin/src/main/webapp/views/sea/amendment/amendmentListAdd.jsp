         ...
         <div class="col-md-12">
          <fieldset>
        		   ...
        		   <div class="col-md-3">
					 <!-- <div class='input-group date datetimepick'>
					    <div class="dropdown">
					      ...
					      <ng-bs3-datepicker
										ng-disabled="createQuote" data-ng-model="purchaseData.requestFromDate"
										id="Purchase Order Date" name="Purchase Order Date"
										data-ng-change="checkDatesCL(purchaseData.requestFromDate)"
			...
			<div class="form-group">	
	            ...
	            <div class="col-md-3">
	            <select class="form-control input-sm" id="status" name="status" data-ng-model="addQuoteStatus"
