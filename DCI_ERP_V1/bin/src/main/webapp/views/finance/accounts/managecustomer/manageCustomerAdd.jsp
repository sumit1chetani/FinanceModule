          					...
          					<div class="col-sm-6 col-md-6 col-lg-6">
           						<fieldset>
						            <div class="form-group">
						             	<label class="col-md-4 control-label">Name of Customer
						             	...
						             	<div class="col-md-7">
						              		<input type="text" class="form-control input-sm" 
						               			...
						               			data-ng-model="manageCustomerObj.entityName"
						               			 validation="required"  friendly-name="companyName"  form-name ="manageCustomerAddForm" ng-blur="checkCustomerName(manageCustomerObj.entityName,manageCustomerObj.entityId)"/>
						             	</div>
						            </div>
						            <div class="form-group">
							            ...
							            <div class="col-md-7">
								            <div class="col-md-12 no-padding">
								             	<textarea class="text-left form-control input-sm" ng-model="manageCustomerObj.locationAddress" rows="2" cols="15" placeholder="Street" style="resize: none" maxlength="200"> </textarea>
								            </div>
								             <div class="col-md-12 no-padding padding-top-5"">
								             <selectivity list="mainCityList" property="manageCustomerObj.cityId" id=cityId"></selectivity>
								            </div>
									        <div class="col-md-12 no-padding">
										        
										        <div class="col-md-6 no-padding padding-top-5">
										        	<input type="hidden" class="form-control input-sm" placeholder="State" ng-model="manageCustomerObj.desStateCode" />
							             			<input type="text" class="form-control input-sm" placeholder="State" ng-model="manageCustomerObj.desState" />
										        </div>
										        <div class="col-md-6 no-padding  padding-top-5">
										        	<input type="text" class="form-control input-sm" placeholder="Zip" ng-model="manageCustomerObj.desZipcode" />
										        </div>
									        </div>
									        <div class="col-md-12 no-padding padding-top-5">
								             	<input type="hidden" class="form-control input-sm" placeholder="Country" ng-model="manageCustomerObj.desCountryCode" />
							             		<input type="text" class="form-control input-sm" placeholder="Country" ng-model="manageCustomerObj.desCountry" />
								            </div>
							            </div>
						            </div>
						            <!-- <div class="form-group">
 ...
 -->							      	<div class="form-group">
					             		<label class="col-md-4 control-label"> Active</label>
					             			<div class="col-md-7">
							              		<div class="checkbox">
							               			<label> 
							               				<input type="checkbox" class="checkbox style-0" data-ng-model="manageCustomerObj.isActive" data-ng-true-value="'Y'" data-ng-false-value="'N'" />
							                			<span></span>
							               			</label>
							              		</div>
							             	</div>
					            	...
					            	<div class="form-group visible-left">
					             		<label class="col-md-4 control-label"> Is Customer</label>
					             			<div class="col-md-7">
							              		<div class="checkbox">
							               			<label> 
							               				<input type="checkbox" class="checkbox style-0" data-ng-model="manageCustomerObj.isCustomer" data-ng-true-value="'Y'" data-ng-false-value="'N'" />
							                			<span></span>
							               			</label>
							              		</div>
							             	</div>
			           			...
			           			<fieldset>
						            ...
						            <div class="form-group">
						             	...
						             	<div class="col-md-7">
						              		<input type="text" class="form-control input-sm" 
						               			...
						               			data-ng-model="manageCustomerObj.mobile" 
						            ...
						            <div class="form-group">
						             	...
						             	<div class="col-md-7">
						              		<input type="text" class="form-control input-sm" 
						               			name="phone" id="phone"
						               			data-ng-model="manageCustomerObj.phoneNo"					               			
						               			 phonenumbers-only maxlength="10"/>
						            ...
						            <div class="form-group">
						             	...
						             	<div class="col-md-7">
						              		<input type="text" class="form-control input-sm" 
						               			name="fax" id="fax"
						               			data-ng-model="manageCustomerObj.fax" 
						            ...
						            <div class="form-group">
						             	...
						             	<div class="col-md-7">
						              		<input type="text" class="form-control input-sm" 
						               			...
						               			data-ng-model="manageCustomerObj.website" placeholder='www.yourwebsite.com'
						               			data-validator="required" data-valid-method="submit" />
						             	</div>
						            </div>
						            <div class="form-group">
						             	...
						             	<div class="col-md-7">
						              		<input type="email" class="form-control input-sm" 
						               			name="email" id="email"
						               			data-ng-model="manageCustomerObj.email"  placeholder='your@email.com' 
						               			ng-change="$scope.emailValidation(manageCustomerObj.email)"  maxlength="50"/>		
						            ...
						            <div class="form-group">
					             		<label class="col-md-4 control-label"> Is Others</label>
					             			<div class="col-md-7">
							              		<div class="checkbox">
							               			<label> 
							               				<input type="checkbox" class="checkbox style-0" data-ng-model="manageCustomerObj.isOthers" ng-disabled="edit" data-ng-true-value="'Y'" data-ng-false-value="'N'" />
							                			<span></span>
							               			</label>
							              		</div>
							             	</div>
					            	...
					            	<div class="form-group ">
					             		<label class="col-md-4 control-label"> College</label>
					             			<div class="col-md-7">
							              		<div class="checkbox">
							               			<label> 
							               				<input type="checkbox" class="checkbox style-0" data-ng-model="manageCustomerObj.isCollege" data-ng-true-value="'Y'" data-ng-false-value="'N'" />
							                			<span></span>
							               			</label>
							              		</div>
							             	</div>
