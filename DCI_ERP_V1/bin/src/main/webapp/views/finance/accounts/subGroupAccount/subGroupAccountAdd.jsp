				    ...
				    <div role="content">
				      <div class="widget-body">
				       <form class="form-horizontal" name="subGroupAccountForm">
				         ...
				         <div class="col-sm-12 col-md-10 col-lg-10">
				          <div class="col-sm-6 col-md-6 col-lg-6">
							...
							<div class="form-group">
						   	...
						   	<div class="form-group">
							   <label class="col-md-4 control-label">Sub Group Head<span style="color: red;">*</span> </label>
						       <div class="col-md-7 inputGroupContainer">
								 <selectivity list="subHeadGrpTypeList" property="subGroupData.subHeadCode" id="subHeadCode"
									 ng-model="subGroupData.subHeadCode" name="subHeadCode" form-name ="subGroupAccountForm"
				   							validation="required" friendly-name="Sub Head Code"></selectivity>
							   </div>
						   	</div>
						  	<!-- <div class="form-group">
						...
						<div class="col-sm-6 col-md-6 col-lg-6">
							<div class="form-group">
								<label class="col-md-4 control-label"> Sub Group Name
							...
							<div class="form-group">
								<label class="col-md-4 control-label"> Sub Group Desc
								</label>
								<div class="col-md-7">
									<textarea rows="2" cols="60" name="Description" id="subGroupDesc" friendly-name="Sub Group Desc"
