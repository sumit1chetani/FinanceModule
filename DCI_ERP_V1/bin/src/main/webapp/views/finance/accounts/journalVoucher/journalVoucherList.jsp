                    ...
                    <div class="col-sm-4 col-md-4">
                      <!--  <div class="form-group">
                        ...
                        <div class="form-group ">
								...
								<div class="col-md-7 ">
									<ng-bs3-datepicker
										ng-disabled="createQuote" data-ng-model="fromdate"
	       ...
	       <td class="td-actions text-center">
	        ...
	        <span class="fa  fa-pencil text-success text" data-ng-click="editJVRow(objTranslationItem.jvNumber)">
	         ...
	         <security:authorize access="hasRole('${form_code}_${view}')">
				       	<span>
				       		<i class="fa  fa-list-alt text-dark text" data-ng-click="view(objTranslationItem.jvNumber)" tooltip="Edit"></i>
				       	</span>
			       	</security:authorize>
	        <security:authorize access="hasRole('${form_code}_${delete}')">
	        <span class="fa fa-trash-o text-danger-dker text" data-ng-click="deleteJVRow(objTranslationItem.jvNumber,$index)" >
	        </span>
			</security:authorize>
			
			 <span>
			        <i class="fa fa-print text-dark text" title="Print" ng-click="printJournalVoucherDiv(objTranslationItem.jvNumber)" ></i>
			        </span>
		<!-- 	<button class="btn btn-success"  ng-click="printJournalVoucherDiv(objTranslationItem.jvNumber)"  type="button">
	        	  Print
	          	</button> -->
	       </td>
	      </tr>
