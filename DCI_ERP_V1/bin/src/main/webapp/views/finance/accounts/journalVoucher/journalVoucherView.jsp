							...
							<div class="col-sm-12 col-md-12 col-lg-12">
								<div class="col-sm-4 col-md-4 col-lg-4">
									<fieldset>
												...
												<div class="form-group">
													<label class="col-md-4 control-label"> JV Date <span style = "color:red";>*</span>
													</label>
													<div class="col-md-8">
...
<div class="form-group">
													...
													<div class="col-md-7">
														<selectivity list="costList" id="costCenter"
															name="costCenter" form-name="journalVoucherForm"
								...
								<div class="col-md-3">
											<div class="form-group">
												<label class="col-md-6 control-label"> Narration </label>
												<div class="col-md-6">
											...
											<table
												...
												<thead class="dataTables-Main-Head">
													<tr>
														...
														<th
															class="width_15 sorting text-center padding-both-side-2">Sub
															Account Code</th>
														<!-- <th
													...
													<tr>
														<td class="padding-both-side-2"><label
															class="i-checks m-b-none"> <input type="checkbox"
																ng-model="row.select" id="section{{trIndex}}" disabled="true"/><i></i></label>
														</td>
			              ...
			              <input type="text" class="form-control input-sm journalVoucher-textBox" ng-model="row.exchangeRate" />
			            	...
			            	<input type="text" class="form-control input-sm journalVoucher-textBox" ng-model="row.tcDebitAmount" ng-keyup="numberCheck(row)" ng-change="onChangeTcDebit(row,journalVoucher.tables)" />
														...
														<td class="padding-both-side-2"><input type="text"
															...
															ng-model="row.bcDebitAmount|number:2" ng-keyup="numberCheck(row)"
															ng-change="onChangeBcDebit(row,journalVoucher.tables)" disabled="true"/>
														</td>
														<!--  <td class="padding-both-side-2">
			            	<input type="text" class="form-control input-sm  journalVoucher-textBox" ng-model="row.tcCreditAmount" ng-keyup="numberCheck(row)" ng-change="onChangeTcCredit(row,journalVoucher.tables)" />
														...
														<td class="padding-both-side-2"><input type="text"
															class="form-control input-sm journalVoucher-textBox text-right"
															ng-model="row.bcCreditAmount|number:2" ng-keyup="numberCheck(row)"
															ng-change="onChangeBcCredit(row,journalVoucher.tables)" disabled="true"/>
														</td>
													</tr>
