							...
							<div class="col-sm-12 col-md-4 col-lg-4">
								<fieldset ng-disabled="viewDisable">
									...
									<div class="form-group">
										...
										<div class="col-md-7">
										<label class="form-label-control" ng-bind="purchaseInvoiceData.companyName"></label>
										</div>
									</div>
           							...
           							<div class="form-group">
										...
										<div class="col-md-7">
										<label class="control-label" ng-bind="purchaseInvoiceData.partyInvoiceNo"></label>
										</div>
									</div>
								   ...
								   <div class="form-group">
										...
										<div class="col-md-7">
											<label class="control-label" ng-bind="purchaseInvoiceData.currency"></label>
										</div>
									</div>
           							...
           							<div class="form-group">
             							...
             							<div class="col-md-7">
            							<label class="control-label" ng-bind="purchaseInvoiceData.description"></label>
            							</div>
           							</div>
					     	...
					     	<div class="col-sm-12 col-md-4 col-lg-4">
								<fieldset ng-disabled="viewDisable">
									...
									<div class="form-group">
             							...
             							<label class="col-md-7 control-label" ng-bind="purchaseInvoiceData.puchaseInvoiceDate"></label>
           							</div>
           							
									
									<div class="form-group">
             							<label for="inputPassword" class="control-label col-md-5 bold">Party Invoice Date</label>
             							<label class="col-md-7 control-label" ng-bind="purchaseInvoiceData.partyInvoiceDate"></label>
           							</div>

									<div class="form-group">
											<label class="col-md-5 control-label bold"> Exchange Rate </label>
											<label class="col-md-7 control-label" ng-bind="purchaseInvoiceData.exchangeRate"></label>
									</div>

									<div class="form-group">
										<label class="col-md-5 control-label bold"> TC Amount</label>
										<label class="col-md-7 control-label" ng-bind="purchaseInvoiceData.tcAmount"></label>
									</div>
							    ...
							    <div class="col-sm-12 col-md-4 col-lg-4">
								 <fieldset ng-disabled="viewDisable">
									<div class="form-group">
										...
										<label class="col-md-7 control-label" ng-bind="purchaseInvoiceData.supplierName"></label>
									</div>
									
							 		 <div class="form-group">
										<label class="col-md-5 control-label bold"> Purchase Order No </label>
										<label class="col-md-7 control-label" ng-bind="purchaseInvoiceData.purchaseOrderNo"></label>
									</div>

							    	<div class="form-group">
             							<label for="inputPassword" class="control-label col-md-5 bold">Due Date</label>
             							<label class="col-md-7 control-label" ng-bind="purchaseInvoiceData.dueDate"></label>
           							</div>

									<div class="form-group">
										<label class="col-md-5 control-label bold"> BC Amount</label>
										<label class="col-md-7 control-label" ng-bind="purchaseInvoiceData.bcAmount"></label>
									</div>
						...
						<div class="table-responsive clear">
					      <table class="table table-striped b-t b-light">
					        ...
					        <tbody ng-repeat="(trIndex, row) in purchaseInvoiceData.purchaseInvoiceDetail">
						        <tr>
									...
									<td>
										<label class="col-md-7 " ng-bind="row.companyCode"></label>
									</td>
					      ...
					      <div class="col-sm-12 col-md-12 col-lg-12">
					          	...
					          	<fieldset ng-disabled="viewDisable">
										...
										<div class="col-md-2">
											<input type="text" class="form-control input-sm" ng-model="purchaseInvoiceData.tcAmount" readonly
											name="TC Total" placeholder="0.0">
										</div>
										
										<div class="col-md-2">
											<input type="text" class="form-control input-sm" ng-model="purchaseInvoiceData.bcAmount" readonly
