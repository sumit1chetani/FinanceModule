		...
		<form name="servicePartnerForm" method="post" class="form-horizontal"
			...
			<div class="panel-body">
				<div class="row pl2pc pr10pc">
					<div class="col-md-4">
						<div class="form-group">
							<label class="col-md-5 control-label">Vendor Code <span
					...
					<div class="col-md-4">
						<div class="form-group">
							<label class="col-md-5 control-label">Vendor Name <span
								style="color: red;">*</span>
							</label>
							<div class="col-md-7">
								<input type="text" class="form-control input-sm"
					...
					<div class="col-md-4">
						<div class="form-group">
							<label class="col-md-5 control-label">Vendor Ledger Name
								<span style="color: red;">*</span>
							</label>
							<div class="col-md-7">
								<input type="text" class="form-control input-sm"
									property="servicePartner.servicePartnerLedgerName"
									maxlength=255
				...
				<div class="row pl2pc pr10pc">
					...
					<!-- <div class="col-md-4">
									<label class="col-md-5 constrol-label"> Sales Person 
									</label>
									<div class="col-md-7">
				...
				<div class="row pl2pc pr10pc">
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<div class="col-md-7">
								<input type="text" class="form-control input-sm"
									property="servicePartner.region"
									data-ng-model="servicePartner.region" name="region"
									friendly-name="Region" />
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<div class="col-md-7">
								<input type="text" class="form-control input-sm"
									property="servicePartner.country" maxlength=6
				...
				<div class="row pl2pc pr10pc">
					...
					<div class="form-group" ng-if="!isEdit">
							<label class="col-md-5 control-label">Sundry Type<span
								style="color: red;">*</span></label>
							<div class="col-md-7">
								<selectivity list="sundryList"
									...
									form-name="servicePartnerForm" friendly-name="Sundry Status">
								</selectivity>

							</div>
						</div>
						<div class="form-group" ng-if="isEdit">
							<label class="col-md-5 control-label">Account Type<span
								style="color: red;">*</span></label>
							<div class="col-md-7">
								<selectivity list="sundryList"
									property="servicePartner.sundryStatus"
						...
						<div class="form-group" ng-if="isEdit && !unique">
							<label class="col-md-5 control-label">Sundry Type<span
								style="color: red;">*</span></label>
							<div class="col-md-7">
								<selectivity list="sundryList"
						...
						<div class="form-group">
							...
							<div class="col-md-7">
								<input type="text" class="form-control input-sm"
									...
									ng-blur="ValidateEmail(servicePartner.emailId)"
									friendly-name="Email" />
							</div>
						</div>
					</div>
				...
				<div class="row pl2pc pr10pc">
					...
					<div class="col-md-4">
						<div class="form-group">
							<label class="col-md-5 control-label">Vendor Description</label>
							<div class="col-md-7">
								<textarea class="form-control input-sm"
						...
						<div class="form-group">
							...
							<div class="col-md-7">
								<selectivity list="gstnStateList"
									...
									data-ng-model="servicePartner.gSTNStateCode"
				...
				<div class="row pl2pc pr10pc">
					...
					<div class="col-md-4">
						<div class="form-group"
							ng-if="servicePartner.defaultTypeCheck==true">
							...
							<div class="col-md-7">
								<selectivity list="employeeList"
									...
									form-name="servicePartnerForm" friendly-name="Sales Person">
								</selectivity>

							</div>
						</div>
						<div class="form-group"
							ng-if="servicePartner.defaultTypeCheck==false">
							<label class="col-md-5 control-label">Sales Person<span
								style="color: red;">*</span></label>
							<div class="col-md-7">
								<selectivity list="employeeList"
									property="servicePartner.salesPerson" validation="required"
									data-ng-model="servicePartner.salesPerson" name="Sales Person"
									form-name="servicePartnerForm" friendly-name="Sales Person">
								</selectivity>
			...
			<div class="panel-body float-left padding-0" style="display: none"
				style="width: 100%;">
				<div class="table-responsive" style="overflow: hidden;">
					<header id="btntoggle" data-role="heading"
						...
						<div class="row">
							<a style="color: black;">Vendor Type</a>
						</div>
					</header>
				</div>
			</div>
						...
						<div class="row">
							...
							<div class="col-md-4">
								<label class="i-checks m-b-none checkbox"> <input
									...
									ng-click="visible(column.id,column.visible)" /><i></i>
								</label>
							</div>
							<!-- <div class="col-md-4" ng-if="flag==false">
								<label class="i-checks m-b-none checkbox"> <input
									type="checkbox" hidden="column.id"
									data-ng-model="column.visible" ng-click="visible(column.id)"  disable/><i></i>
								</label>
							</div> -->
			...
			<div class="table-responsive">
				<table class="table table-striped b-t b-light" style="display: none">
					<thead>
						<tr>
							<th class="sorting width_1">Select</th>
							<th class="sorting width_3 text-center table-heading">Contact
								Name</th>

							<th class="sorting width_2 text-center table-heading">Designation</th>
							<th class="sorting width_2" text-center table-heading>Email</th>

							<th class="sorting width_2 text-center table-heading">Landline
								No</th>

							<th class="sorting width_2 text-center table-heading">Mobile
								No</th>
					...
					<tbody ng-repeat="(trIndex,row) in servicePartnerTable">
						<tr>
							...
							<td class="width_10">
								<div class="row">
									<div class="col-xs-12">
										<input type="text" class="form-control input-sm" maxlength=250
											data-ng-model="row.keyDesignation"
								...
								<div class="row">
									<div class="col-xs-12">
										<input type="text" class="form-control input-sm" maxlength=50
											data-ng-model="row.keyLandLineNo"
											name="LandLineNo{{trIndex}}"
				...
				<div class="padding-right-5" id="AddOrRmvebtn" style="display: none">
				...
				<div class="table-responsive" ng-if="checkBox=='3'">

					<table class="table table-striped b-t b-light">
						<thead>
							<tr>
								<th class="sorting width_1">Select</th>
								<th class="sorting width_3 text-center table-heading">Charge
									Head</th>

								<th class="sorting width_2 text-center table-heading">Unit</th>
								<th class="sorting width_2 text-center table-heading">Container
									Type</th>

								<th class="sorting width_2 text-center table-heading">Currency</th>
								<th class="sorting width_2 text-center table-heading">Commodity
								</th>
								<th class="sorting width_2 text-center table-heading">Pol</th>
								<th class="sorting width_2 text-center table-heading">Pod</th>
								<!-- 														<th class="sorting width_2 text-center table-heading">Qty</th>
 -->
								<th class="sorting width_2 text-center table-heading">Buy
									Rate</th>
								<th class="sorting width_2 text-center table-heading">Validity
									Date</th>
								<th class="sorting width_3 text-center table-heading">Upload
									Document</th>
								<th class="sorting width_3 text-center table-heading">File
									Download</th>
						...
						<tbody tbody ng-repeat="(trIndex, row) in servicePartnerCharge"
							...
							<tr>
								...
								<td class="width_10">
									<div class="row">
										<div class="col-xs-12">
											<selectivity list="chargeHeadList" property="row.charge"
												data-ng-model="row.charge" name="charge{{trIndex}}"
												friendly-name="{{ 'Row' + $index + '(charge)'}}" />
										</div>
									</div>
								</td>
								...
								<td class="width_10">
									<div class="row">
										<div class="col-xs-12">
											<selectivity list="UnitList" property="row.unit"
												data-ng-model="row.unit" name="unit{{trIndex}}"
												friendly-name="{{ 'Row' + $index + '(unit)'}}" />
										</div>
									</div>
								</td>
								<td class="width_10">
									<div class="row">
										<div class="col-xs-12">
											<selectivity list="conTypeList" property="row.cntrType"
												data-ng-model="row.cntrType" name="cntrType{{trIndex}}"
												friendly-name="{{ 'Row' + $index + 'cntrType'}}" />
										</div>
									</div>
								</td>
								<td class="width_10">
									<div class="row">
										<div class="col-xs-12">
											<selectivity list="currencylist" property="row.currency"
												data-ng-model="row.currency" name="currency{{trIndex}}"
								...
								<td class="width_10">
									<div class="row">
										<div class="col-xs-15 datetimepicker_port">
											<select id="commodity1{{trIndex}}" multiple="multiple"
												name="commodity1{{trIndex}}" data-ng-model="row.commodity1"
												ng-options="option.text for option in commodityList"
												friendly-name="{{ 'Row' + $index + '(commodity1)'}}"
									...
									<select id="commodity1" multiple="multiple" name="commodity1"
									friendly-name="commodity1"  form-name="servicePartnerForsm"
										ng-model="row.commodity1" validation="required"
										ng-options="option.text for option in commodityList"
										data-dropdownmultiselect>
										<option data-ng-repeat="option in commodityList" 
											value="{{getOptionId(option)}}"
											data-ng-bind-template="{{option.commodity1}}"></option>
									</select>										
								...
								<td class="width_10">
									<div class="row">
										<div class="col-xs-12">
											<selectivity list="portList" property="row.pol"
												data-ng-model="row.pol" name="pol{{trIndex}}"
												form-name="servicePartnerForsm"
												friendly-name="{{ 'Row' + $index + '(pol)'}}">
											</selectivity>
										</div>
									</div>
								</td>
								<td class="width_10">
									<div class="row">
										<div class="col-xs-12">
											<selectivity list="portList" property="row.pod"
												data-ng-model="row.pod" name="pod{{trIndex}}"
												form-name="servicePartnerForsm"
												friendly-name="{{ 'Row' + $index + '(pod)'}}">
											</selectivity>
								...
								<div class="row">
									<div class="col-xs-12">
										<input type="text" class="form-control input-sm text-right" maxlength=500
											data-ng-model="row.qty" name="qty{{trIndex}}"
									...
									<div class="row">
										<div class="col-xs-12">
											<input type="text" class="form-control input-sm text-right"
												maxlength=500 data-ng-model="row.amt" name="amt{{trIndex}}"
												friendly-name="{{ 'Row' + $index + '(amt)'}}" />
										</div>
									</div>
								</td>
								<td class="width_10">
									<div class="row">
										<div class="col-xs-12">
											<ng-bs3-datepicker ng-disabled="createQuote"
												data-ng-model="row.date" id="date" name="ValidityDate"
												friendly-name="row.date" validation="required" />
											<!-- <input type="text" class="form-control input-sm" maxlength=500
											data-ng-model="row.date" name="date{{trIndex}}"
											friendly-name="{{ 'Row' + $index + '(date)'}}" /> -->
										</div>
									</div>
								</td>
								<td class="width_25" class="col-md-20"
									style="border: 0px solid red"><input type="checkbox"
									ng-model="row.select1" id="section{{trIndex}}"
									ng-click="watch(trIndex)"> <input
									ng-if="row.select1==true" type="file" class="form-control"
									name="uploadRef" id="uploadRef"
								...
								<td class="width_5"
									ng-if="row.uploadRef!='' && row.uploadRef!=null"><a
									ng-click="downloadNewFile(row.uploadRef)" style="color: green">Download</a>
									<a id="tbnewExport" href="" download=""></a></td>
								<td ng-if="row.uploadRef=='' || row.uploadRef==null"><a
									style="color: red">No file uploaded</a></td>
							</tr>
						</tbody>
					</table>
					<br>
					...
					<br>
					<br>
					<div class="padding-right-5" id="AddOrRmvebtn11">
						<button ng-click="addCredRow11()" class="btn btn-sm btn-info"
							tooltip="Add Row" ng-disabled="" type="button">
							<i class="fa fa-plus"></i>
						</button>
						<button ng-click="removeCredRow11()" class="btn btn-sm btn-danger"
							type="button" tooltip="Delete">
							<i class="fa  fa-trash-o"></i>
						</button>
					</div>
				...
				<div class="table-responsive" ng-if="checkBox=='4'">
					...
					<table class="table table-striped b-t b-light">
						<thead>
							<tr>
								...
								<th class="sorting width_2 text-center table-heading">Currency</th>
								<th class="sorting width_2 text-center table-heading">Commodity</th>

								<th class="sorting width_2 text-center table-heading">Origin/Destination
								</th>
								<th class="sorting width_2 text-center table-heading">Pol/Pod</th>
								<!-- 														<th class="sorting width_2 text-center table-heading">Qty</th>
 -->
								<th class="sorting width_2 text-center table-heading">Buy
									Rate</th>
								...
								<td class="width_10">
									<div class="row">
										<div class="col-xs-15 datetimepicker_port">
											...
											<!-- <select id="commodity1{{trIndex}}" multiple="multiple" name="commodity1{{trIndex}}"
											data-ng-model="row.commodity1"
				...
				<!-- <table class="table table-striped b-t b-light" ng-if="isEdit">
					<thead>
						<tr>
							...
							<th class="sorting width_6">Vendor Id </th>
								...
								<div class="row">
									<div class="col-xs-12">
										<input type="text"  class="form-control input-sm"
											...
											friendly-name="{{ 'Row' + $index + '(VendorID)'}}" disabled/>
									</div>
								</div>
							</td>
		...
		</tab> <!-- kyc --> <tab heading="{{tabs[1].title}}" active="tabs[1].active">
					...
					<div class="col-sm-12 col-md-12 col-lg-6">
						<div class="row">
							<fieldset ng-disabled="customComm.isLead == 'true'">
								...
								<div class="form-group">
									<label class="col-md-4 control-label"> Managing
										Director </label>
									<div class="col-md-5">
										<input type="text" class="form-control input-sm"
											name="subject" id="subject" ng-model="customComm.subject"
											maxlength="50">
									</div>
								</div>
								<!--  <div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-md-5">
										<input type="text" class="form-control input-sm"
											...
											maxlength="500" id="operationsCntctPrsnEmail">
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-4 control-label"> Finance Contact
				...
				<div class="row">
					<div class="col-md-12">
						...
						<button class="btn btn-danger" type="reset"
							class="btn btn-success" ng-click="cancelCustomDetail()">
							<i class="fa fa-close"></i> Cancel
						</button>
					</div>
				</div>
