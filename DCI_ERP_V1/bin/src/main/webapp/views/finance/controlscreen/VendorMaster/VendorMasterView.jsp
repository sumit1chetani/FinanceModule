...
<div class="table-responsive" ng-if="checkBox=='3'" >
				...
				<table class="table table-striped b-t b-light" >
					<thead>
						<tr>
						<th class="sorting width_1">Select</th>
 							<th class="sorting width_3 text-center table-heading">Charge Head</th>
							
							<th class="sorting width_2 text-center table-heading">Unit</th>
							<th class="sorting width_2 text-center table-heading">Container Type</th>
...
<th class="sorting width_2 text-center table-heading">Commodity
							...
							<th class="sorting width_2 text-center table-heading">Pol
							</th>
							<th class="sorting width_2 text-center table-heading">Pod</th>
<!-- 														<th class="sorting width_2 text-center table-heading">Qty</th>
 -->							
							<th class="sorting width_2 text-center table-heading">Buy Rate
							</th>
							<th class="sorting width_2 text-center table-heading">Validity Date
							</th>
<th class="sorting width_3 text-center table-heading">Upload Document
							</th>
							<th class="sorting width_3 text-center table-heading">File Download
							</th>

						</tr>
					</thead>

					<tbody ng-repeat="($index,row) in servicePartnerCharge">
						<tr>
							<td><label class="i-checks m-b-none"> <input
							...
							<td class="width_10">
								...
								<label style="padding-top: 9px;padding-left: 10px;">{{row.charge}}</label>
							...
							<td class="width_10">
								<div class="row">
									<div class="col-xs-12">
							<label style="padding-top: 9px;padding-left: 10px;">{{row.unit}}</label>
							...
							<label style="padding-top: 9px;padding-left: 10px;">{{row.cntrType}}</label>
						...
						<label style="padding-top: 9px;padding-left: 10px;">{{row.currency}}</label>			</div>
								</div>
							</td>
							<td class="width_10">
								<div class="row">
								<div class="col-xs-15 datetimepicker_port">
											...
											friendly-name="{{ 'Row' + $index + '(commodity1)'}}"  data-dropdownmultiselect>
										...
										<!-- <select id="commodity1{{trIndex}}" multiple="multiple" name="commodity1{{trIndex}}"
											...
											<label style="padding-top: 9px;padding-left: 10px;">{{row.commodity}}</label>
								...
								<div class="row">
									<div class="col-xs-12">
										<!-- <selectivity list="portList" property="row.pol"
											data-ng-model="row.pol" name="pol{{trIndex}}" form-name="servicePartnerForsm"
											friendly-name="{{ 'Row' + $index + '(pol)'}}"> </selectivity> -->
											<label style="padding-top: 9px;padding-left: 10px;">{{row.pol}}</label>
									</div>
								</div>
							</td>
							<td class="width_10">
								<div class="row">
									...
									friendly-name="{{ 'Row' + $index + '(pod)'}}" > </selectivity> -->
									<label style="padding-top: 9px;padding-left: 10px;">{{row.pod}}</label>
							...
							<td class="width_10">
								<div class="row">
									<div class="col-xs-12">
										<input type="text" class="form-control input-sm text-right" maxlength=500
											data-ng-model="row.amt" name="amt{{trIndex}}"
							...
							<td class="width_10">
								<div class="row">
									<div class="col-xs-12">
									<ng-bs3-datepicker
										ng-disabled="createQuote" data-ng-model="row.date"
										id="date" name="ValidityDate"
...
<td>											<label style="padding-top: 9px;padding-left: 10px;">{{row.uploadRef}}</label>
</td>
						<td class="width_5"
												ng-if="row.uploadRef!='' && row.uploadRef!=null">
												<a
													ng-click="downloadNewFile(row.uploadRef)"
													style="color: green">Download</a> <a id="tbnewExport"
													href="" download=""></a>
											</td>
											<td ng-if="row.uploadRef=='' || row.uploadRef==null">
