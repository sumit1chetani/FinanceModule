...
<div class="panel panel-default panel-default-form ">
  ...
  <div class="panel-body">
    ...
    <div class="form-actions">
     <div class="row">
      <div class="col-md-12">
        <button ng-model="add" class="btn btn-success" type="button" ng-if="!CustomerMasterData.edit" class="btn btn-success">
       ...
       <button class="btn btn-success" ng-if="CustomerMasterData.edit"  type="button"">
