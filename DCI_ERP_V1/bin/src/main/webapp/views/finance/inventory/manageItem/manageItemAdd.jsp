									...
									<div class="col-sm-12 col-md-12 col-lg-12">
											...
											<fieldset>
												<div class="form-group">
													<label class="col-md-3 control-label"> <spring:message
															code="label.manageitem.itemType"></spring:message> <spring:message
													...
													<div class="col-md-7">
														<select class="form-control"
															...
															data-ng-options="obj.defTableId as obj.value for obj in itemTypeList" validation="required" friendly-name="Item Type">
												...
												<div class="form-group">
													<label class="col-md-3 control-label"><spring:message
															code="label.manageitem.itemName"></spring:message> <spring:message
															code="label.asterisk.symbol"></spring:message></label>
													<div class="col-md-7">
														<input type="text" class="form-control input-sm"
															name="<spring:message code="label.itemName"></spring:message>"
															id="itemName" data-ng-model="manageItemObj.itemName"
										...
										<div class="col-sm-6 col-md-3 col-lg-6">
											<fieldset>
												<div class="form-group">
													<label class="col-md-3 control-label"><spring:message
															code="label.manageitem.partNo"></spring:message><spring:message
															code="label.asterisk.symbol"></spring:message></label>
													<div class="col-md-7">
														<input type="text" class="form-control input-sm"
												...
												<div class="form-group">
													<label class="col-md-3 control-label"> <spring:message
															code="label.manageitem.itemCategory"></spring:message> 
															<spring:message
													...
													<div class="col-md-7">
														<selectivity list="categoryList"
	        												...
	        												validation="required" friendly-name="Item Category"
															></selectivity>
													</div>
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<div class="col-md-7">
														<input type="text"
															...
															placeholder=0 validation="numeric"
															friendly-name="Warranty">
													</div>
												</div>
											</div>
											<div class="col-sm-6 col-md-6 col-lg-6">
												<div class="form-group">
													...
													<div class="col-md-7">
														<input type="text"
															...
															placeholder=0.00 validation="numeric"
															friendly-name="Cost Price">
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label"> <spring:message
									...
									<div data-ng-show="manageItemObj.purchaseable">
										...
										<div class="col-sm-12 col-md-12 col-lg-12">
												...
												<div class="form-group">
													...
													<div class="col-md-7">
														<input type="text"
															...
															name="minQuantity" id="minQuantity" placeholder=0.00
															validation="numeric" friendly-name="Minimum Quantity"
											...
											<div class="col-sm-6 col-md-6 col-lg-6">
												...
												<div class="form-group">
													<label class="col-md-3 control-label"> <spring:message
															code="label.manageitem.purchaseLevel">
															</spring:message>
															<spring:message
															code="label.asterisk.symbol"></spring:message>
															</label>
													<div class="col-md-7" data-ng-if="manageItemObj.purchaseable">
														<input type="text"
															...
															validation="numeric|required" friendly-name="Reorder Level"
												...
												<div class="form-group">
													...
													<div class="col-md-7">
														<input type="text"
															...
															validation="numeric" friendly-name="Maximum Quantity">
													</div>
												</div>
											</div>
										</div>
													...
													<div class="form-group">
														<div class="col-md-8">
															<input type="text"
																...
																validation="numeric" friendly-name="Reorder Level"
																data-ng-model="row.vendorLeadTime">
														</div>
								...
								<div class="row">
									<div class="col-sm-12 col-md-12 col-lg-12">
										<div class="col-sm-6 col-md-6 col-lg-6">
											<div class="form-group">
												<label class="col-md-3 control-label"><spring:message
														code="label.manageitem.inventoryValuation">
												...
												<div class="col-md-7" data-ng-show="InventoryNone">
													...
													validation="required" friendly-name="Inventory Valuvation">
														<option value="" selected="selected">Select</option>
												...
												<div class="col-md-7">
													<select class="form-control"
														...
														data-ng-options="obj.defTableId as obj.value for obj in issueList"
														 validation="required" friendly-name="Issue Method">
														<option value="" selected="selected">Select</option>
									...
									<div class="row">
										<div class="col-md-12">
											...
											<button class="btn btn-info ng-scope" type="submit"
												data-ng-click="reset(manageItemAddForm)"
