	...
	<section data-widget-grid id="widget-grid">
     ...
     <div role="content">
      <div class="widget-body">
       <form class="form-horizontal" name="splitPurchaseOrderForm">
        <div class="row">
        	...
        	<fieldset >
        		<div class="form-group">
						...
						<div class="form-group">
			      				...
			      				<div class="col-md-7">
			      				<select class="form-control input-sm deselect" id="Status" name="Status" data-ng-model="purchaseOrder.statusId"
			         ...
			         <tbody class="dataTables-Main-Body">
			          ...
			          ng-hide="departmentCollections.edit == '2'">
			           ...
			           <label class="i-checks m-b-none" >
			             ...
			             ng-change="splitPurchaseOrder(departmentCollections)"
			           ...
			           <input type="text" style="text-align: right;" ng-model="departmentCollections.quantity" 
			           		ng-blur="calculateTaxDiscount(departmentCollections,false)" 
			           		placeholder="0" style="width:40px;" ng-init="calculateTaxDiscount(departmentCollections,false)" 
			           		name="{{ 'quantity' + $index }}"
			           		validation="required" friendly-name="{{ 'Row' + $index + '(Quantity)'}}" 
			           		ng-disabled="departmentCollections.pendingQnty == '0'">
			           		</td>
			           <td style="text-align: right;">{{departmentCollections.unitPrice}}</td>
			           <td>{{departmentCollections.price}}
			           </td>
...
<!-- 			         data-smart-include="views/layout/toolbar-footer.tpl"></div> -->
				...
				<div class="col-md-12" ng-if="purchaseOrder.purchaseTypeName != 'Rate Contract'">
        			<div class="form-group">
        				...
        				<div class="col-md-1">
							<input type="text" class="form-control input-sm"  ng-model="purchaseOrder.freight"  style="text-align: right;padding-right: 0;padding-left: 0;">
						</div>
							...
							<table class="table table-striped table-bordered table-hover dataTable no-footer">
								 <thead class="dataTables-Main-Head">
							          <tr>
							           ...
							           <th class="sorting width_10" >Delivery Date Status</th>
         ...
         <div class="row">
          <div class="col-md-12">
           <button class="btn btn-success" type="button"
            ...
            data-ng-click="save(splitPurchaseOrderForm,purchaseOrder)"
            >
