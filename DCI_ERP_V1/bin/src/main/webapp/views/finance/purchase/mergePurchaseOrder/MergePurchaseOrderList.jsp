...
<%-- <security:authorize access="hasRole('F0028_D')" var="isDelete" />
<security:authorize access="hasRole('F0028_A')" var="isAdd" />
<security:authorize access="hasRole('F0028_UP')" var="isUpload" /> --%>
<!-- #MAIN CONTENT -->
<div id="content">
 <!-- widget grid -->
    ...
    <div data-jarvis-widget id="standard-datatable-widget">
     ...
     <div role="content">
      <div class="widget-body no-padding">
        ...
        <table id="dt_basic"
         ...
         <thead class="dataTables-Main-Head">
          <tr>
           ...
           <th class="sorting width_7" data-st-sort="purchaseStatus">Location</th>
             <th class="sorting width_7" data-st-sort="purchaseStatus">Company Name</th>
         ...
         <tbody class="dataTables-Main-Body">
          <tr data-ng-class="$index % 2 == 0? 'even' : 'odd'"
           ng-repeat="collections in displayedCollection">
           <td>
           <label class="i-checks m-b-none">
             <input type="checkbox" ng-model="collections.isSelected"> <i></i>
           </label>
           </td>
            ...
            <td>{{collections.locationName}}</td>
            <td>{{collections.companyName}}</td>
            <td>{{collections.purchaseStatus}}</td>
            <%-- <td class=" td-actions text-center">
            <security:authorize access="hasRole('F0028_M')">
           <span> <i
             class="fa  fa-pencil text-success text" data-ng-click="editRow(collections)"></i>
           </span> 
           </security:authorize>
            <security:authorize access="hasRole('F0028_D')">
           <span> <i class="fa fa-trash-o text-danger-dker text"
             data-ng-click="deleteRow(collections)"></i>
           </span>
           </security:authorize>
           </td> --%>
          </tr>
       ...
       <button type="button" class="btn btn-success btn-sm margin-bottom-10 margin-left-2" ng-click="mergePurchaseOrder(displayedCollection)">Merge Purchase Order</button>
       </div>
      </div>
      <!-- end widget content -->
     </div>
