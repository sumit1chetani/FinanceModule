			...
			<form novalidate name="revenuecompForm" method="POST"
				...
				<div style="overflow: scroll; max-height: 700px;">
					<table class="table table-bordered table-striped">
						<tr>
							...
							<th rowspan=2 class=" text-center"><input type="checkbox"
								id="selectall" ng-model="selectAll" ng-click="checkAll(selectAll)" /></th>
						...
						<tbody ng-repeat="(trIndex, row) in rowCollection">
							...
							<tr>
								...
								<td colspan=1 class="text-center"><textarea
										ng-model="row.bilRemarks" class="form-group "></textarea></td>
								<td colspan=1 class="text-center"><input type="checkbox"
									id="selectall" ng-model="row.select" ng-click="check()" /></td>

							</tr>
							<tr
								ng-if="rowCollection[$index].pod != rowCollection[$index+1].pod ">
								<td colspan=8 class=" text-center"><b>TOTAL FOR
				...
				<div class="col-sm-12 col-md-6 col-lg-6">
					<div class="form-group">
						<label class="col-md-5 control-label">Select Invoice Status</label>
						<div class="col-md-7">
							<selectivity list="invoiceTypeList" property="invoiceType" id="invoiceType_id"></selectivity>
						</div>
					</div>
					</div>
					<div class="col-sm-12 col-md-3 col-lg-3">
					<button class="btn btn-primary" type="button" tooltip="Close"
								ng-click="close()">
								Close
							</button>
