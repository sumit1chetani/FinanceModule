...
<body marginheight=0 marginwidth=0 topmargin=0 leftmargin=0 style="background-color: white">
	<c:forEach var="object1" items="${printBulkPhcInvoiceList.lBulkInvBean}" varStatus="loopCounter">	
	<div class="break_page">
		 <%-- <c:set var="object1" value="${phcInvoiceList}" /> --%>
		 <c:set var="payerForIndia" value="${object1.payerForIndiaBankDetails}" />
		  ...
		  <tr>
		   <td><br>
		    ...
		    <table class="width_100" align="center" border="0" cellPadding="0" cellSpacing="0">
		     <tr>
		      <td><font face="arial" size="4"><b>INVOICE</b></font></td>
		     </tr>
		     <tr>
		      <td width="24%">
		       <TABLE align=left border="1" cellPadding="2" cellSpacing="0" width=100%
		        ...
		        <TR>
		         ...
		         <TD align=left><span class="normal"><b>${object1.accountName}<br>
		     ...
		     <tr>
		      <td  class="padding-top-5" colspan="3"> 
		       <table align="left" border="1" cellPadding="2" cellSpacing="0" class="width_100">
		        <thead>
		         <tr>
		          ...
		          <th class="width_15" align="center" class="" height="10" valign="top" style="border-bottom-width: 1px; border-left-width: 0px; border-top-width: 1px; border-right-width: 0px;"><span
		           class=normal><b>BC Amount (${object1.companyCurrency})</b></span></th>
		        ...
		        <tbody>
		        <!-- phcInvQtyDescList -->
		         <c:forEach var="ob" items="${object1.phcInvQtyDescList}" varStatus="theCount">
		          <c:if test="${ ob.bcamount > 0 }">
		           <tr class="description">
		            ...
		            <td  class="width_15 normal" width=15% height="10"  style="border-right: 0pt;" align="right" valign="top">
		             <c:out value="${ob.bcamount}" /></td>
		            <td  class="width_15 normal" height="10" align="right" valign="top"><c:out
		              value="${ob.tcamount}" /></td>
		           </tr> 
		          </c:if>
		         </c:forEach>
		         <tr class="description">
		...
		<br> <br>
		 ...
		 <div class="content2 width_100" style="height:90%">
			 <table border="1" width="90%" cellpadding="0" cellspacing="0" bgcolor="FFFFFF" bordercolor="#cccccc" align="center">
			  ...
			  <tr>
			   <th class="gridheadercell">S.No</th>
			   <!-- <td class="gridheadercell">Ex-Voyage</td> -->
			   <th class="gridheadercell">Voyage</th>
			   <th class="gridheadercell">MLO</th>
			   <th class="gridheadercell">POL</th>
			   <th class="gridheadercell">POD</th>
			   <th class="gridheadercell">TYPE</th>
			   <th class="gridheadercell">CONTAINER_NO</th>
			   <th class="gridheadercell">SLOT_SIZE</th>
			   <th class="gridheadercell">WEIGHT</th>
			   <th class="gridheadercell">IMCO</th>
			   <th class="gridheadercell">REFER</th>
			   <th class="gridheadercell">Remarks</th>
			  </tr>
			  <c:set var="index" value="0"></c:set>  
			  <c:forEach var="slotmessageList" items="${object1.slotMsgList}" varStatus="theCount">
			   <tr>
			    <td class="tablespace"><span class=normal>${theCount.count}</span></td>
			    <%-- <td class="tablespace"><span class="normal text-nowrap" >${slotmessageList.voyageCode}</span></td> --%>
			    <td class="tablespace "><span class="normal text-nowrap">${object1.voyage}</span></td>
