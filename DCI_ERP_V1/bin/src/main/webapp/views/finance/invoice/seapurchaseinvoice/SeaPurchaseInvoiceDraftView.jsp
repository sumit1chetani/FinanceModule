					...
					<form name="purchaseInvoiceForm" class="form-horizontal" novalidate>
						<div class="row book-widget-row">
								...
								<fieldset>
									<div class="form-group">
										...
										<div class="col-md-7">
											<selectivity list="jobNoList"
												...
												friendly-name="jobNo" form-name="purchaseInvoiceForm" disabled="true"></selectivity>
										</div>
									...
									<div class="col-md-7">
											<input type="text" class="form-control" name="Customer"
												ng-model="purchaseInvoiceData.invoiceNo" form-name="purchaseInvoiceForm" disabled> </>
										</div>
								</div>
									...
									<div class="form-group">
										...
										<div class="col-md-7">
											...
											<selectivity list="customerDropList" property="purchaseInvoiceData.customerId"
									...
									<div class="form-group">
										<label class="col-md-5 control-label">Salied Date</label>
									...
									<div class="col-md-7">
										<div class="checkbox">
											<label class="i-checks"> <input type="checkbox"
												...
												ng-model="purchaseInvoiceData.container" ng-true-value="true"
												ng-false-value="false"> <i></i>
											</label>
										</div>
									</div>
								</div>
									...
									<div class="form-group">
										...
										<div class="col-md-7">
											 <selectivity list="partyList"
												...
												name="party_id" object="party"  form-name="purchaseInvoiceForm" validation="required" friendly-name="Party" disabled="true"></selectivity> 
									...
									<div class="form-group">
										...
										<div class="col-md-7">
											<textarea rows="2" cols="4"
												...
												ng-model="purchaseInvoiceData.narration">
           									</textarea>
										</div>
									</div>
									<!-- <div class="form-group">
							...
							<div class="col-sm-12 col-md-4 col-lg-4">
								...
								<div class="form-group" style="padding-bottom: 44px">
                                ...
                                <div class="form-group" >
									...
									<div class="form-group">
										...
										<div class="col-md-7">
											<ng-bs3-datepicker
												data-ng-model="purchaseInvoiceData.vendorInvoiceDate" id="arrival"
												name="vendorInvoiceDate" form-name="purchaseInvoiceForm"
												 />
										</div>
									</div>
							</div>
								...
								<thead>
									<tr>
										...
										<th colspan=1 class="width_8 text-center">Unit</th>		
																												<th colspan=1 class="width_8 text-center">Container Type</th>
										...
										<td>
											<div class="row">
												<div class="col-xs-12" align="center">
													<button  type="button" ng-click="showTax(row.chargeHeadId,purchaseInvoiceData.jobNo,purchaseInvoiceData.partyNo)">View
												    </button>
												</div>
											</div>
										</td>
											...
											<div class="row">
												<div class="col-xs-12">
													<input type="text" class="form-control input-sm text-right"
														...
														friendly-name="{{ 'Row' + $index + '(Tax Percentage'}}" >
												</div>
											</div>
										</td>
								<!-- <td>
											<div class="row">
												<div class="col-xs-12">
													<input type="text" class="form-control input-sm text-right"
														id="taxPrct{{trIndex}}" ng-model="row.taxPrct"
														name="taxPrct" ng-change="calTaxAmount()"
										...
										<div class="form-actions">
											<div class="row">
												<div class="col-md-12">
													...
													<button class="btn btn-success" 
														 class="btn btn-success" type="button" ng-click="onSubmitDraft1(purchaseInvoiceForm,purchaseInvoiceData)">
														<i class="fa fa-save"></i> Save as Draft
													</button>
													<button class="btn btn-success"  type="button"
														ng-click="printUsdFormDraft(purchaseInvoiceForm,purchaseInvoiceData)">
														<i class="fa fa-print"></i> Print Preview USD
													</button>
													<!-- <button class="btn btn-success"  type="button"
														ng-click="printSgdFormDraft(purchaseInvoiceForm,purchaseInvoiceData)">
														<i class="fa fa-print"></i> Print Preview SGD
													</button> -->
													<button class="btn btn-success"  type="button"
														ng-click="printInrFormDraft(purchaseInvoiceForm,purchaseInvoiceData)">
