					...
					<div class="row book-widget-row">
						...
						<div class="col-sm-12 col-md-4 col-lg-4">
							<fieldset>
								...
								<div class="form-group">
									<label class="col-md-6 control-label">Quot. No </label> <label
										class="col-md-6 text-left control-label"
										ng-bind="viewInvoiceHeader.quotNo"> </label>
      ...
      <table class="table table-striped b-t b-light">
       <thead>
        <tr>
         ...
         <th colspan="2" class="text-center" valign="top">Charges</th>
         <!--  <th colspan="2" ng-repeat="objCont in containersList" class="text-center">{{objCont.containerType}} </th>  -->
         <th  class="text-center" valign="top">M20</th>
         <th  class="text-center" valign="top">M40</th>
         <th  class="text-center" valign="top">M45</th>

         <th  class="text-center" valign="top">D20</th>
         <th  class="text-center" valign="top">D40</th>
         <th  class="text-center" valign="top">D45</th>

         <th  class="text-center" valign="top">R20</th>
         <th  class="text-center" valign="top">R40</th>

         <th  class="text-center" valign="top">OOG20</th>
         <th  class="text-center" valign="top">OOG40</th>
         <th  class="text-center" valign="top">RI20</th>
         <th  class="text-center" valign="top">RI40</th>
         <th  class="text-center" valign="top">FLEXI_20</th>
         <th  class="text-center" valign="top">FLEXI_40</th>
         <th  class="text-center" valign="top">IM51-20</th>
         <th  class="text-center" valign="top">IM51-40</th>
       <th  class="text-center" valign="top">OOG Slot Loss</th>
         
        </tr>
                
       </thead>
       <tbody>
        <tr ng-repeat="objItem in offInvoiceDtl">
