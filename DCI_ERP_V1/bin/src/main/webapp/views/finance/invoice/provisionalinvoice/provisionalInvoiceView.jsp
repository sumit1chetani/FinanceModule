		...
		<div class="panel-body">
			<form name="provisionalInvoiceForm" class="form-horizontal" novalidate>
				<div class="row book-widget-row">
						<input type="hidden" ng-model="provisionalinvoice.ExchangeRateFrom" id="ExchangeRateFrom" /> 
						<input type="hidden" ng-model="provisionalinvoice.ExchangeRateTo" id="ExchangeRateTo" /> 
						<input type="hidden" ng-model="provisionalinvoice.currencyValue" id="currencyValue" /> 
						<input type="hidden" ng-model="provisionalinvoice.fraction" id="fraction" />
						...
						<fieldset ng-disabled="viewDisable">
							<div class="col-md-4">
								<div class="form-group">
									...
									<div class="col-md-7">
										<input type="hidden" ng-model="provisionalinvoice.companyCode" id="txtCompany" ng-disabled="true" />
								 		<label class="form-label-control" ng-bind="provisionalinvoice.companyName"></label>
									</div>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
	    							...
	    							<div class="col-md-7">
								          ...
								          <label class="form-label-control" ng-bind="provisionalinvoice.invoiceDate"></label>
								        </div>   									
	    							</div>
			       				</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									...
									<div class="col-md-5">
										<input type="text" class="form-control input-sm" ng-if="provisionalinvoice.blRelated=='Y'" value="Yes" ng-disabled="true" />
										<input type="text" class="form-control input-sm" ng-if="provisionalinvoice.blRelated=='N'" value="No" ng-disabled="true" />
						...
						<fieldset ng-disabled="viewDisable">
							<div class="col-md-4">
								<div class="form-group">
									...
									<div class="col-md-7">
								 		<label class="form-label-control" ng-bind="provisionalinvoice.customerName"></label>
									</div>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									...
									<div class="col-md-7">
										<label class="form-label-control" ng-bind="provisionalinvoice.mloName"></label>
									</div>
								</div>
							</div>
							<div class="col-md-4" id="blcheck">
								<div class="form-group">
									...
									<div class="col-md-7">
										<label class="form-label-control" ng-bind="provisionalinvoice.bl"></label>
									</div>
								</div>
							</div>
						</fieldset>
						...
						<fieldset ng-disabled="viewDisable">
							<div class="col-md-4">
								<div class="form-group">
									...
									<div class="col-md-7">
										<label class="form-label-control" ng-bind="provisionalinvoice.currencyName"></label>
									</div>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									...
									<div class="col-md-7">
										<label class="form-label-control" ng-bind="provisionalinvoice.exchangeRate"></label>
									</div>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									...
									<div class="col-md-7">
										<label class="form-label-control" ng-bind="provisionalinvoice.subject"></label>
									</div>
								</div>
							</div>
						</fieldset>
						...
						<fieldset ng-disabled="viewDisable">
							<div class="col-md-4">
								<div class="form-group">
									...
									<div class="col-md-7">
							 			<label class="form-label-control" ng-bind="provisionalinvoice.vesselName"></label>
									</div>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									...
									<div class="col-md-7">
								 		<label class="form-label-control" ng-bind="provisionalinvoice.voyage"></label>
									</div>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									...
									<div class="col-md-7">
										<label class="form-label-control" ng-bind="provisionalinvoice.serviceName"></label>
									</div>
								</div>
							</div>
						</fieldset>
						...
						<fieldset ng-disabled="viewDisable">
									...
									<div class="col-md-7">
										<div class="row">
											<div class="col-md-6 custom-col-md-6 pull-left ">
												...
												<label class="form-label-control" ng-bind="provisionalinvoice.unit20"></label>
											</div>
											<div class="col-md-6 custom-col-md-6 pull-left">
												<label class="col-md-3 custom-col-md-3 control-label">40'</label>
												<label class="form-label-control" ng-bind="provisionalinvoice.unit40"></label>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<div class="col-md-7">
								 		<label class="form-label-control" ng-bind="provisionalinvoice.pol"></label>
									</div>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									...
									<div class="col-md-7">
								 		<label class="form-label-control" ng-bind="provisionalinvoice.pod"></label>
									</div>
								</div>
							</div>
						</fieldset>
				...
				<div class="table-responsive">
					<table class="table table-striped b-t b-light">
						...
						<tbody ng-repeat="(trIndex, row) in provisionalinvoice.priDtl" ng-controller="pritableViewCtrl">
							<tr>
				...
				<div class="form-actions">
					<div class="row">
						<div class="col-md-12">
							...
							<button class="btn btn-success" ng-click="printProvisionalInvoiceDiv(provisionalinvoice.invoiceNo)"  type="button">
				        	  Print
				          	</button> 
						</div>
					</div>
