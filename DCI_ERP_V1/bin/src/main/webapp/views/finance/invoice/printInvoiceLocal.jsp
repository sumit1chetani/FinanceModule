	...
	<div id="content">
		...
		<table class="width_100" align="center" border="0"
				...
				<td>
					<table border="1" class="padding-top-2" width="100%"
						...
						<tr>
							...
							<tr>
								<td width="25%"><img src="${context}/img/interafrica_new.png" style=" padding:10 0 0 10; height: 60px;">
								</td>
									
								<td width="75%"> <span style="text-align: right;"><b>Interafrica Haulage Services Ltd</b></span>
								 <br><span style="text-align: right;">81250-80100 Mombasa </span>
								 <br><span style="text-align: right;">Mombasa - Nairobi Highway </span>
								 <br><span style="text-align: right;">Mombasa </span>
								 <br><span style="text-align: right;">E-Mail : accts@interafrica-haulage.com </span></td>
							 </tr>
							 </table>
							</td>
								...
								<table class="" align="left" border="1" bordercolor=""
									...
									<thead>
										<tr class="">
											...
											<th class="width_32" height="10" align="center"
											...
											<th class="width_20" height="10" align="center"
												><span class="bold">Amount</span></th>
										</tr>
									</thead>
									<tbody>
			...
			<tr>
				...
				<td align="left" colspan="2"><span><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${hdr.totalBCAmountInWords}</b><br> <br>
				</span></td>
			</tr>
			<tr>
