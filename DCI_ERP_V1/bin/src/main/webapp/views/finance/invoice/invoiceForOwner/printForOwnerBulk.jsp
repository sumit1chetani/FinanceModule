...
<style type="text/css" media="print">
	...
	<body>
		...
		<c:forEach var="object1" items="${printBulkInvoiceList.lBulkInvBean}" varStatus="loopCounter">	
							...
							<td colspan="4" class="padding-top-10">
								<table class="" align="left" border="1"  bordercolor="" cellPadding="0" cellSpacing="0" width=100%>
									...
									<tbody>
										...
										<c:forEach var="ob" items="${object1.detailList}"  varStatus="theCount"> 
