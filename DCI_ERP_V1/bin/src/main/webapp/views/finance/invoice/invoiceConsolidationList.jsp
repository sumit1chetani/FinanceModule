	...
	<div class="row">
		<div class="col-sm-12 col-xs-12 col-md-12">
			<ol class="breadcrumb padding-left-0">
				<li><a> Finance </a></li>
				<li><a>Invoice</a></li>
				<li><a>Invoice Consolidation List</a></li>
			</ol>
		</div>
	</div>
</div>
<div class="wrapper-md">
	<div class="panel panel-default">
		<div class="panel-heading font-bold">Invoice Consolidation List</div>
				...
				<table id="dt_basic"
								...
								<tbody>
									<tr data-ng-class="$index % 2 == 0? 'even' : 'odd'"
										ng-repeat="objInvoiceCons in displayedCollection">
									<td class=""><label class="i-checks m-b-none"> <input
									type="checkbox" name="post[]" ng-model="objInvoiceCons.checked"> <i></i>
									</label></td>
										<td>{{objInvoiceCons.customerName}}</td>
										<td>{{objInvoiceCons.invoiceNo}}</td>
										<td>{{objInvoiceCons.invoiceDate}}</td>
										<td>{{objInvoiceCons.currency}}</td>
										<td>{{objInvoiceCons.rate}}</td>
										<td>{{objInvoiceCons.amountAED}}</td>
										<td>{{objInvoiceCons.amountUSD}}</td>
	...
	<div align="center">
				<div class="row panel-body m-t-sm">
					<div class="col-md-12 ">
						...
						<button class="btn btn-success" type="button"
							data-ng-click="invoiceConsolidate(displayedCollection);">
