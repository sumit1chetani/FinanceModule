...
<div id="content" border="1" style="margin-bottom: 10px;width: 94%;
    margin-left: 25px;">
					...
					<table border="0" width="100%" cellpadding="0" cellspacing="0"
						...
						<tr>
							...
							<td width="75%" style="font-size: 14px;"><span
								style="text-align: center;"><b>MBK LOGISTICS PVT LTD</b></span> <br> <span style="text-align: right;"
		...
		<table width="50%"
			...
			<tr>
				<td class="width_40" style="font-size: 10px;"><b>HAWB NO</b></td>
				<c:if test="{{header.hawbNo != null}}">
					<td style="font-size: 10px;">: {{header.hawbNo}}</td>
				</c:if>
				<c:if test="{{header.hawbNo == null}">
			...
			<tr>
				<td class="width_40" style="font-size: 10px;"><b>MAWB NO</b></td>
				<c:if test="{{header.mawbNo != null}}">
					<td style="font-size: 10px;">: {{header.mawbNo}}</td>
				</c:if>
				<c:if test="{{header.mawbNo == null}">
					<td style="font-size: 10px;">: &nbsp;&nbsp; -</td>
				</c:if>
			...
			<tr>
				<td class="width_40" style="font-size: 10px;"><b>AOL</b></td>
				<td style="font-size: 10px;">: {{header.aolName}}</td>
			</tr>
			<tr>
				<td class="width_40" style="font-size: 10px;"><b>AOD</b></td>
				<td style="font-size: 10px;">: {{header.aodName}}</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="width_40" style="font-size: 10px;"><b>GROSS WEIGHT</b></td>
				<c:if test="{{header.grossWeight != null}}">
					<td style="font-size: 10px;">: {{header.grossWeight}}</td>
				</c:if>
				<c:if test="{{header.grossWeight == null}}">
					<td style="font-size: 10px;">: &nbsp;&nbsp; -</td>
				</c:if>
			...
			<tr>
				<td class="width_40" style="font-size: 10px;"><b>FLIGHT NO</b></td>
				<c:if test="{{header.flightNo != null}}">
					<td style="font-size: 10px;">: {{header.flightNo}}</td>
				</c:if>
				<c:if test="{{header.flightNo == null}}">
					<td style="font-size: 10px;">: &nbsp;&nbsp; -</td>
				</c:if>
			...
			<tr>
				<td class="width_40" style="font-size: 10px;"><b>DEPARTURE DATE<</b></td>
				<c:if test="{{header.depatureDate != ''}}">
					<td style="font-size: 10px;">: {{header.depatureDate}}</td>
				</c:if>
				<c:if test="{{header.depatureDate == ''}}">
					<td style="font-size: 10px;">: &nbsp;&nbsp; -</td>
				</c:if>
		...
		<table  width=100% align="center" border="1" cellPadding="0"
			...
			<thead>
				<tr>
					...
					<th class="width_7" align="center" style="font-size: 10px;">CGST
						AMOUNT</th>
					<th class="width_5" align="center" style="font-size: 10px;">SGST
						%</th>
					<th class="width_7" align="center" style="font-size: 10px;">SGST
						AMOUNT</th>
					<th class="width_5" align="center" style="font-size: 10px;">IGST
						%</th>
					<th class="width_7" align="center" style="font-size: 10px;">IGST
						AMOUNT</th>
			...
			<tbody>
				<tr ng-repeat="x in listdata">
					...
					<td align="right" style="font-size: 10px;">{{ x.currency }}</td>
					<td align="right" style="font-size: 10px;">{{ x.exchangeRate }}</td>
					<td   align="right" style="font-size: 10px;" ><span ng-show="x.taxAmount == 0"> {{x.amount}}</span></td>
					<td   align="right" style="font-size: 10px;" ><span ng-show="x.taxAmount != 0"> {{x.amount}}</span></td>
					<td align="right"  valign="right" style="font-size: 10px;">{{ x.cgstPrct }}</td>
					<td align="right"  valign="right" type="number"  style="font-size: 10px;">{{ x.cgstAmt }}</td>
					<td align="right" valign="right" style="font-size: 10px;">{{ x.sgstPrct }}</td>
					<td align="right" valign="right" type="number"  style="font-size: 10px;">{{ x.sgstAmt }}</td>
					<td align="right" valign="right" style="font-size: 10px;">{{ x.igstPrct}}</td>
					<td align="right" valign="right" style="font-size: 10px;" type="number" >{{ x.igstAmt }}</td>
					<td align="right" valign="right" style="font-size: 10px; "type="number"  >{{ x.subTotal | number : 2}}</td>
					
				</tr>				
				<tr>
					<td colspan="6"></td>					
					<td align="right" valign="right" style="font-size: 10px;" colspan="2">{{header.subAmtTotal}}</td>
					<td align="right" valign="right" style="font-size: 10px;" colspan="2">{{header.subCgstTaxTotal}}</td>
					<td align="right" valign="right" style="font-size: 10px;" colspan="2">{{header.subSgstTaxTotal}}</td>
					<td align="right" valign="right" style="font-size: 10px;" colspan="2">{{header.subIgstTaxTotal}}</td>
					<td align="right" valign="right" style="font-size: 10px;" colspan="2" "type="number">{{header.totalAmount | number : 2}}</td>
				</tr>
			</tbody>
		...
		<div>
			...
			<div class="row">
				<div class="col-md-12" align="center">
					...
					<button class="btn btn-success" type="button" ng-click="emailInrForm(purchaseInvoiceForm,purchaseInvoiceData)">
