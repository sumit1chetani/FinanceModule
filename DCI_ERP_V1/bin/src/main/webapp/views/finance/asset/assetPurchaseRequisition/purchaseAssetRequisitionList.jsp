...
<%-- <security:authorize access="hasRole('F0069_D')" var="isDelete" />
<security:authorize access="hasRole('F0069_A')" var="isAdd" />
<security:authorize access="hasRole('F0069_UP')" var="isUpload" /> --%>
<div id="content">
 <!-- widget grid -->
        ...
        <table id="dt_basic"
         ...
         <tbody>
          ...
          <td cs-select="objPurchaseAssetRequistion" class="text-center"></td>        
           ...
           <td>{{objPurchaseAssetRequistion.purchaseassetrequisitionStatus}}</td> 
          <td class=" td-actions text-center">
           <security:authorize access="hasRole('${form_code}_${modify}')">
           <span data-ng-if="objPurchaseAssetRequistion.isEdit">
	        <span data-ng-if="objPurchaseAssetRequistion.purchaseassetrequisitionStatus === 'Pending'">
	         <i class="fa  fa-pencil text-success text" data-ng-click="editRow(objPurchaseAssetRequistion.purchaseAssetRequisitionId,objPurchaseAssetRequistion.type)"></i>
	        </span>
	        </span>
	        </security:authorize>
			<security:authorize access="hasRole('${form_code}_${view}')">
			<span data-ng-if="objPurchaseAssetRequistion.isView">
	        <span data-ng-if="objPurchaseAssetRequistion.purchaseassetrequisitionStatus === 'Approved'">
	         <i class="fa fa-list-alt text-dark text" data-ng-click="viewRow(objPurchaseAssetRequistion.purchaseAssetRequisitionId,objPurchaseAssetRequistion.type)"></i>
	        </span>
	        </span>
	        </security:authorize>
			<security:authorize access="hasRole('${form_code}_${delete}')">
			<span data-ng-if="objPurchaseAssetRequistion.isDelete">
	        <span data-ng-if="objPurchaseAssetRequistion.purchaseassetrequisitionStatus === 'Pending'">
	         <i class="fa fa-trash-o text-danger-dker text" data-ng-click="deleteRow(objPurchaseAssetRequistion.purchaseAssetRequisitionId,$index)"></i>
	        </span>
	        </span>
	        </security:authorize>
       	 </td>
