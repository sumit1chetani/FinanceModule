    ...
    <div data-jarvis-widget id="standard-datatable-widget" data-widget-color="sttropaz"
     ...
     <div role="content">
      <div class="widget-body">
       <form class="form-horizontal" name="deprecationApprecationMethodForm" method="post"
        novalidate>
        <div class="row">
          ...
          <fieldset>
           <div class="col-sm-6 col-md-6 col-lg-6">
            <div class="form-group">
             <label class="col-md-5 control-label">Item Category <span style="color: red;">*</span></label>
             <div class="col-md-6">
              <selectivity  disabled="isEdit" list="ItemList" property="depreciationMethod.itemCategoryId" id="itemCategoryId"
               ng-model="depreciationMethod.itemCategoryId" name="itemCategoryId"
               form-name="deprecationApprecationMethodForm" validation="required"
               friendly-name="Item"></selectivity>
             </div>
            </div>
            ...
            <div class="form-group">
             ...
             <div class="col-md-6 inputGroupContainer">
              <select class="form-control journalVoucher-textBox" ng-model="depreciationMethod.methodId"
               ...
               <!-- <option value="12" ng-if="depreciationMethod.valuationType=='D'">Number of
                Depreciation</option>
               <option value="11" ng-if="depreciationMethod.valuationType=='A'">Number of
                Appreciation</option>
               <option value="13">Ending Date</option> -->
              </select>
             </div>
            </div>
         ...
         <div class="row">
          <div class="col-md-12">
           <button class="btn btn-success" type="button"
            data-ng-click="save(deprecationApprecationMethodForm,depreciationMethod)"
            data-ng-if="!isEdit">
            <i class="fa fa-save"></i>
            <spring:message code="label.save"></spring:message>
           </button>
           <button class="btn btn-success" type="button"
            data-ng-click="update(deprecationApprecationMethodForm,depreciationMethod)" data-ng-if="isEdit == true">
            <i class="fa fa-save"></i>
            <spring:message code="label.update"></spring:message>
           </button>
           <button class="btn btn-info" type="button"
            data-ng-click="reset(deprecationApprecationMethodForm)">
