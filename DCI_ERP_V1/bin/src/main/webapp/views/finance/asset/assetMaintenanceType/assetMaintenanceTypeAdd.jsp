         ...
         <div class="col-sm-12 col-md-12 col-lg-12">
          <fieldset>
           <div class="form-group">
            ...
            <div class="col-md-6">
             <input type="text" class="form-control input-sm" ng-model="assetMaintenance.assetCode" name="assetCode" data-message-id="assetCode"  validation="required" friendly-name="Maintenance Type Code" >
		     </div>
           </div>
