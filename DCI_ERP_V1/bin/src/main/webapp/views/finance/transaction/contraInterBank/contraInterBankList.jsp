			...
			<button class="btn btn-info" type="button"
					...
					<div class="col-sm-12 col-md-12 col-lg-12">
						<div class="col-sm-12 col-md-3 col-lg-3 ">
							...
							<div class="form-group">
								<label class="col-md-5 control-label">Contra No</label>
								<div class="col-md-7">
									<div id="jvCode"
										class="selectivity-input example-input selectivity-slot jvCode">
										<input type="text"
						...
						<div class="col-sm-12 col-md-3 col-lg-3">
							...
							<button class="btn btn-primary" type="button"
								data-ng-click="copyJournalVoucher(jvcode);">Copy Contra</button>
					...
					<div class="table-responsive" style="border: 1px solid #CCC;">
						<table class="table table-striped table-hover dataTable no-footer">
							<thead class="dataTables-Main-Head" style="background-color: #e2e2e2;">
								...
								<th class="width_1"></th>
									<th class="sorting" st-sort="jvNumber">Contra Number</th>
									<th class="sorting" st-sort="voucherDate">Date</th>
									<th class="sorting" st-sort="narration">Narration</th>
									<th class="sorting" st-sort="narration">BCDebit</th>
									<th class="sorting" st-sort="narration">TCDebit</th>
									<th class="sorting" st-sort="narration">BCCredit</th>
									<th class="sorting" st-sort="narration">TCCredit</th>
									<th class="sorting" st-sort="narration">Users</th>
									<th class="sorting" st-sort="Action">Action</th>
									<!-- <th class="width_1"></th>
									<th class="sorting" st-sort="jvNumber">Contra Number</th>
									<th class="sorting" st-sort="voucherDate">Date</th>
									<th class="sorting" st-sort="narration">From Bank</th>
									<th class="sorting" st-sort="narration">To Bank</th>
