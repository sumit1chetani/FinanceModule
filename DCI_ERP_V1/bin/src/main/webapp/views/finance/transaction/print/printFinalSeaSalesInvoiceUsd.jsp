...
<body>
    ...
    border-right: none;"
					...
					<table width="50%" style="float:left; padding-top:10px; padding-bottom:15px;"><tr><td class="width_30" align="left" style="font-size: 10px;"><b>To</b></td></tr><tr><td style="font-size: 10px;"><b>Customer Id:${object1.customerName}</b></td></tr>
...
<c:if test="${ob.currency == 'AED'}">
<td><b>Amount in Words: AED ${object1.totalAmountInWords}
	</b></td><br>
</c:if>

<c:if test="${ob.currency == 'INR'}">
<td><b>Amount in Words: INR ${object1.totalAmountInWords}
	</b></td><br>
</c:if>

<c:if test="${ob.currency == 'USD'}">
<td><b>Amount in Words: USD ${object1.totalAmountInWords}</b></td><br>
</c:if>
</c:if>
</c:forEach>
