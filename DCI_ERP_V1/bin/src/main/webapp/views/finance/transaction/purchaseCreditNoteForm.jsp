		...
		<div class="breadcrumb-wrapper ng-scope">
			<div class="panel panel-default panel-default-form">
				...
				<div class="panel-body">
					<form name="purchaseCreditNoteForm" class="form-horizontal"
						novalidate>
									...
									<div class="form-group">
										...
										<div class="col-md-7">
											<selectivity ng-if="edit" disabled="edit" list="companyList"
												...
												friendly-name="Company" form-name="purchaseCreditNoteForm"></selectivity>
										</div>
										<div class="col-md-7">
									...
									<div class="form-group ">
										...
										<div class="col-md-7">
											<selectivity list="acctHeadList"
												property="creditnoteAcctData.accountName"
												id="cmbAccountName" object="accounts" name="accounts"
												ng-model="creditnoteAcctData.accountName"
												validation="required" friendly-name="Customer"
												form-name="purchaseCreditNoteForm"></selectivity>
										</div>
									</div>
									...
									<div class="form-group ">
										...
										<div class="col-md-7">
											...
											<selectivity list="currencyList"
												property="creditnoteAcctData.currencyCode" name="Currency"
												id="currency" object="currency" validation="required"
												friendly-name="Currency" form-name="purchaseCreditNoteForm"
			        ...
			        ng-model="creditnoteAcctData.voyageId" ></selectivity>
									...
									<div class="form-group">
										...
										<div class="col-md-7">
											<input type="text" class="form-control input-sm text-right"
												ng-model="creditnoteAcctData.tcAmount" name="TC Amount"
												ng-keyup="amountLocalCalculation(creditnoteAcctData.tcAmount)"
												validation="pattern=/^[0-9-]+(\.[0-9-]{1,2})?$/:alt=TC Amount Should be 2 digit|required"
												step="0.001" friendly-name="TC Amount">
										</div>
									</div>
		         	...
		         	object="invoices" validation="required" friendly-name="Invoice" form-name = "purchaseCreditNoteForm"></selectivity>  -->
											<selectivity list="invoiceNoList"
												property="creditnoteAcctData.invoiceNo" id="invoiceNo"
												object="invoiceNo" name="invoiceNo"
		        ...
		        <div class="col-md-7">
		          ...
		          ng-keyup="calcbcamount(creditnoteAcctData.exchangeRate)" 	ng-model="creditnoteAcctData.exchangeRate" ng-pattern-restrict="^\d+(?:\.\d{0,3})?$"/>
									...
									<div class="form-group">
										...
										<div class="col-md-7">
											<input type="text" class="form-control input-sm text-right"
												...
												name="Exchange Rate" validation="required"
												friendly-name="Exchange Rate"
												ng-blur="exchageratehdr(creditnoteAcctData.exchangeRate)">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-7">
											<input type="text" class="form-control input-sm text-right"
												ng-model="creditnoteAcctData.bcAmount" name="Amount"
												ng-blur="amountCalculation(creditnoteAcctData.bcAmount)"
												validation="pattern=/^[0-9-]+(\.[0-9-]{1,2})?$/:alt=BC Amount Should be 2 digit|required"
												step="0.001" friendly-name="BC Amount">
										</div>
									</div>
									...
									<!-- <div class="form-group ">
										...
										<div class="col-md-7">
											...
											<selectivity list="modeList"
												property="creditnoteAcctData.mode"
												ng-model="creditnoteAcctData.mode" id="mode_id" name="mode"
												object="mode" validation="required" friendly-name="Mode"
												form-name="purchaseCreditNoteForm"></selectivity>
										...
										<div class="col-md-7">
											<div class="input-group input-append date" id="inv_date">
												<input type="text" class="form-control input-sm"
													...
													ng-model="creditnoteAcctData.invoiceDate" name="Date"
													id="invoiceDate"> <span
									...
									<div class="form-group">
										...
										<div class="col-md-7">
											<input type="text" class="form-control input-sm"
												...
												data-ng-model="creditnoteAcctData.narration"
									...
									<div class="form-group">
										...
										<div class="col-md-7">
											<input type="text" class="form-control input-sm"
												...
												data-ng-model="creditnoteAcctData.creditNoteNo"
								...
								<tbody
									...
									<tr>
										...
										<td class="width_10">
											<div class="row">
												<div class="col-xs-12">
													<selectivity ng-if="edit" disabled="edit"
														list="companyDtlList"
														property="row.company_id_dtl" id="company_id_dtl"
														ng-model="row.company_id_dtl"
														name="company_id_dtl{{trIndex}}" validation="required"
														friendly-name="dtl Company"
														form-name="purchaseCreditNoteForm"></selectivity>
												</div>
												<div class="col-xs-12">
													<selectivity ng-if="!edit" list="companyDtlList"
														property="row.company_id_dtl" id="company_id_dtl"
														ng-model="row.company_id_dtl"
														name="company_id_dtl{{trIndex}}" validation="required"
														friendly-name="dtl Company"
											...
											<div class="row">
												<div class="col-xs-12" ng-if="!edit">
													<selectivity list="crdtlAcctHeadList"
														...
														name="crdtlAccountHead{{trIndex}}" validation="required"
														friendly-name="{{ 'Row' + $index + '(Account Head)'}}"
														form-name="purchaseCreditNoteForm"></selectivity>
												</div>
												<div class="col-xs-12" ng-if="edit">
													<selectivity list="crdtlAcctHeadList"
														property="row.crdtlAccountHead1"
														id="crdtlAccountHead1{{trIndex}}" object="accHead"
														ng-model="row.crdtlAccountHead1"
														name="crdtlAccountHead1{{trIndex}}" validation="required"
														friendly-name="{{ 'Row' + $index + '(Account Head)'}}"
														form-name="purchaseCreditNoteForm"></selectivity>
												</div>
											</div>
										...
										<td>
											...
											<div class="row" ng-if="row.isSubAccountCode">
												<div class="col-xs-12">
													<selectivity list="row.subAccountCodeList"
														property="row.subAcctCode" id="subAcctCode{{$index}}"
														name="subAcctCode{{$index}}" ng-model="row.subAcctCode"
														validation="required"
										...
										<td>
											...
											<div class="row" ng-if="edit">
												<div class="col-xs-12" ng-if="row.isCurrencyBlocked">
													<selectivity list="currencyList" property="row.currency1"
														id="currency1{{trIndex}}" object="currency1"
														name="currency1{{trIndex}}" validation="required"
														friendly-name="{{ 'Row' + $index + '(Currency)'}}"
														ng-model="row.currency1" property="row.currency1"
														form-name="purchaseInvoiceForm"
														disabled="row.isCurrencyBlocked"></selectivity>
												</div>
												<div class="col-xs-12" ng-if="!row.isCurrencyBlocked">
										...
										<td>
											<div class="row" ng-if="!edit">
												<div class="col-xs-12">
													<input type="text" class="form-control input-sm text-right"
														...
														ng-blur="amountCalculationexchange(row.exchangeRate,trIndex,row)"
														ng-pattern-restrict="^\d+(?:\.\d{0,3})?$"
													...
													<input type="hidden"
														...
														id="txtFromCurrency{{trIndex}}"
														ng-model="row.fromCurrency"
														name="From Currency{{trIndex}}"
														ng-pattern-restrict="^\d+(?:\.\d{0,3})?$" readonly /> <input
														type="hidden" class="form-control input-sm text-right"
														id="txtToCurrency{{trIndex}}" ng-model="row.toCurrency"
														name="To Currency{{trIndex}}"
											...
											<div class="row" ng-if="edit">
												<div class="col-xs-12">
													<input type="text" class="form-control input-sm text-right"
														id="exchangeRate1{{trIndex}}" ng-model="row.exchangeRate1"
														ng-blur="amountCalculationexchange(row.exchangeRate1,trIndex,row)"
														ng-pattern-restrict="^\d+(?:\.\d{0,3})?$"
														name="exchangeRate1{{trIndex}}" validation="required"
														friendly-name="{{ 'Row' + $index + '(Exchange rate)'}}">
										...
										<td colspan="12">
											<div class="col-sm-12">
												...
												<div class="col-sm-2 padding-top-5"
													...
													<div class="col-md-8">
														<selectivity list="modeList" property="row.mode"
															id="mode{{trIndex}}" ng-model="row.mode"
															name="mode{{trIndex}}"> </selectivity>
													</div>
												...
												<div class="col-sm-2 padding-top-5"
													...
													<div class="col-md-8">
														<selectivity list="modeList" property="row.mode"
															id="voyageCode{{trIndex}}" ng-model="row.mode"
															validation="required" name="mode{{trIndex}}"
												...
												<div class="col-sm-2 padding-top-5"
													...
													<label class="col-md-5 control-label"> Job Order </label>
													<div class="col-md-7">
														<selectivity list="jobList" property="row.job"
															id="job{{trIndex}}" ng-model="row.job"
															name="job{{trIndex}}"> </selectivity>
													</div>
												</div>
												<div class="col-sm-2 padding-top-5"
													ng-if="row.isVessel && row.isVesselMan">
													...
													<div class="col-md-7">
														<selectivity list="jobList" property="row.job"
															id="job{{trIndex}}" ng-model="row.job"
															validation="required" name="job{{trIndex}}"
															friendly-name="{{ 'Row' + $index + '(job)'}}"
															form-name="purchaseCreditNoteForm"> </selectivity>
													</div>
												</div>
												...
												<div class="col-sm-2 padding-top-5" ng-if="row.isCustomer ">
													...
													<div class="col-md-7">
														<selectivity list="customerList"
															property="row.customerCode" id="customerCode{{trIndex}}"
												...
												<div class="col-sm-2 padding-top-5" ng-if="row.isSupplier">
													...
													<div class="col-md-7">
														<selectivity list="supplierList"
															property="row.supplierCode" id="supplierCode{{trIndex}}"
							...
							<div class="col-md-12">
								<div class="col-sm-12">
									<div class="form-group pull-right">
										...
										<div class="col-md-3">
											<input type="text" class="form-control input-sm text-right"
												ng-model="totalTCAmount" readonly name="TC Total"
												placeholder="0.0">
										</div>
										...
										<div class="col-md-3">
											<input type="text" class="form-control input-sm text-right"
												ng-model="totalBCAmount" readonly name="BC Total"
												placeholder="0.0">
										</div>
