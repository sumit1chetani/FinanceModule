<div class="breadcrumb-wrapper ng-scope">
				...
				<div class="row book-widget-row">
					<div class="col-sm-12">
						<div class="col-sm-4">
							...
							<div class="form-group" id="bankaccountgroup"
								ng-if="pmtTypeGroup.show && !reconcile">
							...
							<div class="form-group" id="bankaccountgroup"
								...
								<div class="col-md-7">
									<selectivity list="bankAccountList"
										...
										object="acctList" validation="required"
										friendly-name="Bank Account" name="accountbankName"
										ng-model="cashbankpaymentModelData.accountName" disabled="true"></selectivity>
								</div>
							</div>
							
								<div class="form-group" id="bankaccountgroup"
					             ng-if="cashbankpaymentModelData.accountName=='TDS'">
								<label class="col-md-5 control-label">TDS<span
									style="color: red;"> *</span></label>
								<div class="col-md-7">
									<selectivity list="tdsList"
										property="cashbankpaymentModelData.tds"
										form-name="cashbankpaymentForm" id="tds"
										object="acctList" validation="required"
										friendly-name="Bank Account" name="tds"
										ng-model="cashbankpaymentModelData.accountName"></selectivity>
								</div>
							</div>
					...
					<br>
						...
						<div class="col-sm-4">
							...
							<div class="form-group" ng-if="reconcile==false">
							...
							<div class="form-group" ng-if="reconcile==true">
								<label class="col-md-5 control-label">Exchange Rate<span
									style="color: red;"> *</span></label>
								<div class="col-md-7">
									<input type="text" class="form-control input-sm text-right"
										...
										ng-pattern-restrict="^\d+(?:\.\d{0,3})?$"
										ng-model="cashbankpaymentModelData.exchangeRate"
										validation="required" friendly-name="Exchange Rate" ng-disabled="true"/>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group" ng-if="reconcile==true" >
								...
								<div class="col-md-7">
									<input type="text" class="form-control input-sm text-right"
										...
										ng-keyup="tcToBcHdrAmtCalculation(cashbankpaymentModelData.tcAmountHdr)"
										validation="pattern=/^[0-9-]+(\.[0-9-]{1,2})?$/:alt=TC Amount Should be 2 digit|required"
										step="0.01" friendly-name="TC Amount" ng-disabled="true"/>
								</div>
							</div>
						...
						<div class="col-sm-4">
							<div class="form-group" ng-if="pmtTypeGroup.show">
								<label class="col-md-5 control-label"> Cheque/DD/UTR Ref No.<span
									style="color: red;"> *</span></label>
								<div class="col-md-7">
							...
							<div class="form-group" ng-if="reconcile==true">
								...
								<div class="col-md-7">
									<input type="text" class="form-control input-sm text-right"
										...
										ng-blur="bcToTcHdrAmtCalculation(cashbankpaymentModelData.bcAmountHdr)"
										validation="pattern=/^[0-9-]+(\.[0-9-]{1,2})?$/:alt=BC Amount Should be 2 digit|required"
										step="0.01" friendly-name="BC Amount"  ng-disabled="true"/>
								</div>
							</div>
						...
						<div class="col-sm-12 col-md-12 col-lg-12">
							<div class="content">
								<div class="form-actions">
									<div class="row">
										<div class="col-md-12">
											<button class="btn btn-success" type="button" ng-if="!edit" type="button"
												ng-click="submit(cashbankpaymentForm)">
												<i class="fa fa-save"></i> Save
											</button>
											<button class="btn btn-success" type="button" ng-if="!edit" type="button"
												ng-click="submitwithexg(cashbankpaymentForm)">
												<i class="fa fa-save"></i> Save with Exg Gain/Loss
											</button>
 ...
 <script type="text/ng-template" id="cbpaymentExchangeRate">
<div style="height:25%;" >
<div class="modal-header" style="background-color:#c3c4c7; font-size: 18px;"> Are you sure! </div>
<span > balance amount </span>
<span style="color:#d63006;font-size: 14px;">{{exchangeAmt}} </span>
<span > converted into Exchange Rate</span>
<div class="row">
</div>
<div class="modal-footer">
	<button class="btn btn-info" type="button" ng-click="SaveConfirm()">OK</button>
