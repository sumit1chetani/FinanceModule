      ...
      <table class="table table-striped b-t b-light">
        <thead>
         ...
         <!--    <th colspan=1 class="width_1"></th> -->
            ...
            <th colspan=1 class="width_13 text-center">Charge Head<span style="color:red;"> *</span></th>
        
            <th colspan=1 class="width_10 text-center">Sac No<span style="color:red;"> *</span></th>
            ...
            <th colspan=1 class="width_10 text-center"> Amount<span style="color:red;"> *</span></th>
         <!--    <th colspan=1 class="width_1"></th> -->
          </tr>
        </thead>
        	...
        	<tr>
								...
								<!-- <td>
									...
									<div class="col-xs-12" ng-if="row.isSubAccountCode">
										<selectivity list="row.subAccountCodeList"
											property="row.subAcctCode" id="subAcctCode{{$index}}"
											form-name="purchaseCreditNoteForm" ng-model="row.subAcctCode"
											...
											<div class="row">
												<div class="col-xs-12">
													<input type="text" class="form-control input-sm text-right"
														...
														form-name="purchaseCreditNoteForm" disabled>
												</div>
											</div>
										</td>
     ...
     <!--  <div class="padding-right-5" id="AddOrRmvebtn">
		...
		<div class="col-md-12">
					<div class="form-group" style="float: right;">
										...
										<div class="col-md-6">
											<input type="text" class="form-control input-sm text-right ng-pristine ng-untouched ng-valid" ng-model="creditnoteDtlTotalAmt.totalTCAmount" readonly="" name="creditnoteDtlTotalAmt.totalTCAmount" placeholder="0.0">
										</div>
								...
								<div class="form-group" style="float: right;">
									...
									<div class="col-md-6">
										<input type="text" class="form-control input-sm text-right ng-pristine ng-untouched ng-valid" ng-model="creditnoteDtlTotalAmt.totaltaxAmount" readonly="" name="totaltaxAmount" placeholder="0.0">
									</div>
...
<!-- 	<div class="row">
		<div class="col-md-12">
										...
										<div class="col-md-3">
											<input type="text" class="form-control input-sm text-right" ng-model="totaltaxAmount" readonly
