...
<body style="border:1px solid black">
								...
								<table border="0" width="100%" cellpadding="0" cellspacing="0"
									...
									<tr>
										...
										<td width="60%" style="word-wrap: break-word;padding-left: 2%;padding-right: 15%;">
											...
											<span style="text-align: left;font-size: 13px;">${object1.branchAddress1}</span> <br> 
    ...
    border-right: none;"
					...
					<table width="50%" style="float:left; padding-top:10px; padding-bottom:15px;"><tr>
							...
							<tr><td class="width_40"  style="font-size: 10px;"><b>BCG NO</b></td><c:if test="${object1.bcgNo != null}"><td style="font-size: 10px;">: ${object1.bcgNo}</td></c:if><c:if test="${object1.bcgNo == null}"><td style="font-size: 10px;">: &nbsp;&nbsp; -</td></c:if></tr>
							...
							<tr><td class="width_40"  style="font-size: 10px;"><b>FPOD</b></td><td style="font-size: 10px;">: ${object1.destination}</td></tr>
    ...
    border-right: none;"
						...
						<thead>
							<tr>
								...
								<th class="width_12" align="center" style="font-size: 10px;">TOTAL(SGD)</th>
							</tr>
						</thead>
						<tbody>
							<c:forEach var="ob"
                              ...
                              <td colspan="7"></td>  
                               <td align="right" valign="right" style="font-size: 10px;" ><fmt:formatNumber type="number"
                                ...
                                <td align="right" valign="right" style="font-size: 10px;" ><fmt:formatNumber type="number"
												minFractionDigits="2" maxFractionDigits="2"
												value="${object1.subAmtTaxTotal+object1.subIgstTaxTotal}" /></td>                     
                              <td align="right" valign="right" style="font-size: 10px;"><fmt:formatNumber type="number"
												minFractionDigits="2" maxFractionDigits="2"
						...
						<table style="font-size: 12px;">
						    ...
						    <tr>
						    <c:if test="${object1.branchId != 3}"><td>Please issue all payment in favour of &nbsp"MBK Logistix Private Limited"</td></c:if>
						    <c:if test="${object1.branchId == 3}"><td>Please issue all payment in favour of &nbsp"MBK Logistix Private Limited"</td></c:if>
						    </tr>
						</table>
					</table></td>
	...
	<div>
		...
		<br><font size="1" face="arial"> Remarks :</font>
		<br><br><br>
