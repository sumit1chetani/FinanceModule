    ...
    <div class="row book-widget-row">
     <div class="col-sm-12 col-md-4 col-lg-4">
      ...
      ng-options="option.id for option in customerTypelist" data-dropdownmultiselect>    
        ...
        <div class="col-md-7">
                  ...
                  <select id="pol" multiple="multiple"  name="pol" ng-model="freightmanifest.lpol"
      ng-options="option.text for option in polList" data-dropdownmultiselect>    
        ...
        <div class="col-md-7">
            ...
            <select id="pod" multiple="multiple"  name="pod" ng-model="freightmanifest.lpod"
     ...
     <div class="col-sm-12 col-md-4 col-lg-4">
      ...
      ng-options="option.creditCategory for option in creditCategorylist" data-dropdownmultiselect>    
       ...
       <select id="branch" multiple="multiple"  name="branch" ng-model="freightmanifest.lbranch" validation="required"
      ng-options="option.text for option in branchList" data-dropdownmultiselect>    
        <option data-ng-repeat="option in branchList" 
        value="{{getbranch(option)}}" data-ng-bind-template="{{option.branch}}"></option>
     </select>  
        </div>
       </div>
     ...
     <div class="col-sm-12 col-md-4 col-lg-4">
      ...
      <label class="control-label text-left"  id="invoicefromDate" name="invoicefromDate" data-ng-model="freightmanifest.invoicefromDate" validation="required" form_name="freightmanifestform" friendly-name="From Date">{{freightmanifest.invoicefromDate}}</label>
        </div>
       </div>
      ...
      <label class="control-label text-left"  id="invoicetoDate" name="invoicetoDate" data-ng-model="freightmanifest.invoicetoDate" validation="required" form_name="freightmanifestform" friendly-name="To Date">{{freightmanifest.invoicetoDate}}</label>
        </div>
       </div> 
