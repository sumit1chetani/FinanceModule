...
<div class="breadcrumb-wrapper ng-scope">
 <div class="panel panel-default panel-default-list" st-table="displayedCollection" st-safe-src="rowCollection">
  <div class="panel-heading  padding-right-0 padding-left-0">
   ...
   <div class="table-responsive" style=" border: 1px solid #CCC;">
    <table id="dt_basic" class="table table-striped table-bordered table-hover dataTable no-footer" width="100%" role="grid" aria-describedby="dt_basic_info">
     <thead class="dataTables-Main-Head" style="background-color: #e2e2e2;">
      <tr role="row">
       <th class="width_1"></th>
       <th class="sorting width_15" st-sort="creditNoteCode">Cr Code</th>
       <th class="sorting width_10" st-sort="creditNoteDate">Date</th>
      <!--  <th class="sorting width_10" st-sort="">Account Head</th> -->
       <th class="sorting width_10" st-sort="invoiceNo">Inv No</th>
       <th class="sorting width_10" st-sort="location">Location</th>
       <th class="sorting width_15" st-sort="company">Company</th>
       <th class="sorting width_15 text-wrap" st-sort="creditAmount">Amt</th>
       <th class="sorting width_10 text-wrap text-wrap-amtusd" st-sort="creditAmountUSD">Amt USD</th>
       <th class="sorting width_40 text-wrap" st-sort="approveStatus">Approved</th>
       <th class="">Action</th>
      </tr>
     </thead>
       ...
       <security:authorize access="hasRole('${form_code}_${modify}')">
        <span class="width_15" data-ng-if="objCreditNoteListItem.approveStatus =='N' ">
         <i class="fa fa-pencil text-success text" data-toggle="tooltip" title="Edit"
          data-ng-click="editRowBtn(objCreditNoteListItem.creditNoteCode)" tooltip="Edit"></i>
        </span>
       </security:authorize> 
        <security:authorize access="hasRole('${form_code}_${delete}')">
        <span class="width_15" ng-if="objCreditNoteListItem.approveStatus == 'N'">
         ...
         data-ng-click="deleteRow(objCreditNoteListItem.creditNoteCode,$index)" tooltip="Delete"></i>
        </span>
        </security:authorize>
       </td>
      </tr>
