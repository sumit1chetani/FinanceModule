								...
								<div class="form-group" ng-if="reconcile==true">
									...
									<div class="col-md-7 inputGroupContainer">
										<selectivity list="bankList" property="objCBReceipt.bankAcc"
											id="bankAcc_id" name="bankAcc_id"
											ng-model="objCBReceipt.bankAcc" validation="required"
											friendly-name="Bank Account" form-name="cashBankReceiptForm" disabled="true"></selectivity>
									</div>
								</div>
								...
								<div class="form-group" ng-if="reconcile==false">
									...
									<div class="col-md-7">
										<input type="text" class="form-control input-sm text-right"
											...
											ng-pattern-restrict="^\d+(?:\.\d{0,3})?$"
											ng-model="objCBReceipt.exchangeRate" validation="required"
											friendly-name="Exchange Rate" ng-disabled="true">
									</div>
								</div>
						...
						<div class="col-sm-12 col-md-12 col-lg-12">
							<div class="content">
								<div class="form-actions">
									<div class="row">
										<div class="col-md-12">
											<button id="addBtn" class="btn btn-success"  ng-if="!edit" ng-hide="isView" type="button"
