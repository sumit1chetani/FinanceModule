    ...
    <div class="row book-widget-row">
     <div class="col-sm-12 col-md-4 col-lg-4">
      <fieldset>
       <div class="form-group">
        ...
        <div class="col-md-8">
                      <select id="customerType" multiple="multiple"  name="customerType" ng-model="booking.lCustomerType" validatin="required"
      ng-options="option.id for option in customerTypelist" data-dropdownmultiselect>    
        ...
        <div class="col-md-7">
                  ...
                  <select id="pol" multiple="multiple"  name="pol" ng-model="booking.lpol"
      ng-options="option.text for option in polList" data-dropdownmultiselect>    
        ...
        <div class="col-md-7">
            ...
            <select id="pod" multiple="multiple"  name="pod" ng-model="booking.lpod"
      ng-options="option.text for option in podList" data-dropdownmultiselect>    
        ...
        <div class="col-md-8">
               <select id="status" multiple="multiple"  name="status" ng-model="booking.lstatus"
     ...
     <div class="col-sm-12 col-md-4 col-lg-4">
      <fieldset>
        ...
        <div class="col-md-8">
               <select id="branch" multiple="multiple"  name="branch" ng-model="booking.lbranch"
      ng-options="option.text for option in branchList" data-dropdownmultiselect>    
        ...
        <div class="col-md-8">
               <select id="service" multiple="multiple"  name="service" ng-model="booking.lservice"
...
<!--      		<div class="form-group ">
      ...
      ng-options="option.portCode for option in podList" data-dropdownmultiselect>    
       ...
       <div class="form-group">
        ...
        <div class="col-md-8">
            ...
            <select id="aod" multiple="multiple"  name="pod" ng-model="booking.laod"
      ng-options="option.text for option in aodList" data-dropdownmultiselect>    
       ...
       <div class="form-group">
        ...
        <div class="col-md-8">
                  ...
                  <select id="aol" multiple="multiple"  name="aol" ng-model="booking.laol"
     ...
     <div class="col-sm-12 col-md-4 col-lg-4">
      ...
      ng-options="option.text for option in customerList" data-dropdownmultiselect>    
        ...
        <div class="col-md-8">
          <ng-bs3-datepicker data-ng-model="booking.fromDate" name="fromDate" id="fromDate"  validation="required"/>
      <label class="control-label text-left"  id="fromDate" name="fromDate" data-ng-model="booking.fromDate">{{booking.fromDate}}</label>
        </div>
       </div>
        ...
        <div class="col-md-8">
          <ng-bs3-datepicker data-ng-model="booking.toDate" name="toDate" id="toDate" validation="required" />
      <label class="control-label text-left"  id="toDate" name="toDate" data-ng-model="booking.toDate">{{booking.toDate}}</label>
        </div>
       </div> 
        ...
        <div class="col-md-8">
               <select id="sales" multiple="multiple"  name="sales" ng-model="booking.lsales"
      ng-options="option.text for option in salesTypeList" data-dropdownmultiselect>    
        ...
        <div class="col-md-8">
               <select id="term" multiple="multiple"  name="term" ng-model="booking.lterm"
  ...
  <div  data-role="content" class="form-horizontal panel"  data-collapse="isCollapsed">
   <ul class="dragList row list-unstyled">     
          <li class="col-md-3 col-sm-3 col-lg-3" >
              <div class="row" >
              <label  class="control-label col-md-8" style="width: 61%">SELECT ALL :</label> 
    ...
    <div class="panel panel-default panel-default-list"
        ...
        <tr data-ng-class="$index % 2 == 0? 'even' : 'odd'" ng-repeat="booking in displayedCollection">
