 ...
 <div class="panel panel-default panel-default-form">
  <div class="panel-heading panel-heading-form font-bold">
   <ol class="breadcrumb padding-left-0">
    ...
    <li>
     <a x-ui-sref="app.finance.transaction.journalvoucher.list">Contra InterBank</a>
    </li>
	        ...
	        <div class="col-sm-12">
	        	<div class="form-group pull-right">
		         ...
		         <div class="col-md-2" id="totals">
		         	...
		         	<input type="text" class="form-control input-sm text-right" id="totaltcDebit" ng-model="journalVoucher.totalTcDebitAmt1" readonly>
		         </div>
		         <div class="col-md-2" id="totals">
		         	<input type="text" class="form-control input-sm text-right" id="totalbcDebit" ng-model="journalVoucher.totalBcDebitAmt1" readonly>
		         </div>
		         <div class="col-md-2" id="totals">
		          <input type="text" class="form-control input-sm text-right" id="totaltcCredit" ng-model="journalVoucher.totalTcCreditAmt1" readonly>
		         </div>
		         <div class="col-md-2" id="totals">
		          <input type="text" class="form-control input-sm text-right" id="totalbcCredit" ng-model="journalVoucher.totalBcCreditAmt1" readonly>
		         </div>
		       </div>
