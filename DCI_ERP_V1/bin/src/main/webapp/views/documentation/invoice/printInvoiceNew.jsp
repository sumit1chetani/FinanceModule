...
<fmt:formatNumber
		...
		<tr>
         ...
         groupingUsed = "false" value = "${subTotal}" /> --%>
			...
			<%-- <td class="fntSiz10px"
				style="height: 35px; border-left: 1px dotted; border-top: 1px dotted; font-weight: bold; text-align: right;">${hdr.currency}
				<c:set var="totaltaxAmount" value="${((taxpercent)/100)*taxableamount}" /> 
				<c:set var="finalAmt" value="${totalamount}" /> <fmt:formatNumber
