			...
			<form name="inwardmanifestReportForm" class="form-horizontal">
				<div class="row">
					...
					<div class="col-sm-12 col-md-3 col-lg-3">
						<fieldset>
							<div class="form-group">
								<label class="control-label col-md-5">  POD <span
									style="color: red;">*</span>
								</label>
								<div class="col-md-7">
									<selectivity list="portList"
										property="inwardmanifestReport.fpod" id="fpod"
										object="fpod"></selectivity>
								</div>
							</div>        
						</fieldset>
					</div>
				...
				<div class="form-actions">
					<div class="row">
						<div class="col-md-12 ">
							...
							<button id="exportXl" class="btn btn-primary" data-ng-click="Export(rowCollection,inwardmanifestReport.voyage)" type="button" title="Excel Export">
