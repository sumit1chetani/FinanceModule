	...
	<div class="panel-body float-left padding-0">
		<div class="row">
			<div class="col-sm-12 col-md-12 col-lg-12 ">
				<fieldset>
					<legend>DO Revalidation </legend>
					
					
					<div class="form-group" >
						<label class="col-md-2 control-label line-height-30">Do Extension  Date<span style="color: red;"> *</span>
						</label>
						<div class="col-md-3">
		...
		<div class="col-sm-12 col-md-12 col-lg-12">
			<div class="form-actions m-b-none">
				<button class="btn btn-info" type="button"
					ng-click="revalidation()">OK</button>
