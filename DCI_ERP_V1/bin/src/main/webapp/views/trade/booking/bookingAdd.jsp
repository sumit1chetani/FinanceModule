					...
					<div class="col-sm-12">
						...
						<div class="col-md-4">
							...
							<div class="form-group">
									...
									<div class="col-md-7">
										<selectivity list="rPodList" ng-model="bookingData.pod1" disabled="legCheckpod1"
							...
							<div class="col-md-4">
							<div class="form-group">
									<label class="col-md-5 control-label">POD 2 </label>
									<div class="col-md-7">
										<selectivity list="rPodList" ng-model="bookingData.pod2" disabled="legCheckpod2"
											friendly-name="pod2" disabled="value"
											property="bookingData.pod2" id="pod2" name="pod2"
											form-name="bookingForm" ></selectivity>
									</div>
								</div>
