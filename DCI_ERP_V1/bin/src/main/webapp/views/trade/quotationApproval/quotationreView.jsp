...
<td class=" width_9"><selectivity list="currencyList"
									...
									<td class=" width_9">
									<label hidden="true">{{row.quotedRate}}</label>
									<input type="text"
										class="form-control input-sm text-right" name="quotedRate"
										property="row.quotedRate1" id="quotedRate{{trIndex}}"
										ng-model="row.quotedRate1"
										friendly-name="{{ 'Row' + ($index+1) + '(quotedRate1)'}}"
										ng-keyup="Calculation(trIndex,row)"  /></td>
								...
								<div class="row">
									<div class="col-md-12">
										...
										<button class="btn btn-success" type="button"
											...
											ng-click="SubmitreView(quotation.quotationNo)">
											<i class=""></i> Submit
										</button>
										<button class="btn btn-danger" ng-click="cancelReview(quotation.quotationNo)"
											type="button">
