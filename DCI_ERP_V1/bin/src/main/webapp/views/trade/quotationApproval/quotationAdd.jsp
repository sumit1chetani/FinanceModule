					...
					<div class="col-sm-12 col-md-4 col-lg-4">
						...
						<div class="form-group">
								...
								<div class="col-md-7">
									...
									<selectivity list="CustList"
										ng-model="quotation.custcategory" disabled="true"
					...
					<div class="col-sm-12 col-md-4 col-lg-4">
						<fieldset>
							<div class="form-group ">
								...
								<div class="col-md-7 ">
									<ng-bs3-datepicker
										ng-disabled="createQuote" data-ng-model="quotation.validTill"
								...
								<div class="col-md-7">
										...
										property="quotation.pol" id="pol"
										name="pol" ng-model="quotation.pol"
								...
								<div class="col-md-7">
										...
										property="quotation.pod" id="pod"
										name="pod" ng-model="quotation.pod"
					...
					<!-- 		<div class="form-group ">
						...
						<!-- 	<div class="form-group ">
								...
								<div class="col-md-7">
										<input type="text" class="form-control input-sm"
										name="origin" 
										property="quotation.origin" id="origin" ng-model="quotation.origin"
								...
								<div class="col-md-7">
										...
										property="quotation.freight" id="freight"
										name="freight" ng-model="quotation.freight"
										object="freight" friendly-name="freight"
										validation="required" form-name="quotationForm"
										></selectivity>
							</div>
							</div>
								...
								<div class="col-md-7">
										<selectivity list="shipmentTermlist"
										property="quotation.otCharge" id="otCharge"
										name="otCharge" ng-model="quotation.otCharge"
										object="otCharge" friendly-name="otCharge"
										validation="required" form-name="quotationForm"
										></selectivity>
							</div>
							</div>
							...
							<div class="form-group" ng-if="edit">
								...
								<div class="col-md-7">
										...
										name="status" 
										property="quotation.status" id="origin" ng-model="quotation.status"
										friendly-name="status" disabled="true"/>
							</div>
