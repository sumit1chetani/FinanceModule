define([ 'hrms/hr/hr' ], function(module) {
    ...
    module.registerController('exitinterviewListCtrl', function($scope, $state, $http, ngDialog, logger, $location, $controller, $injector, sharedProperties, toaster, $rootScope, validationService, $stateParams) {
        $scope.rowCollection = [];
