'use strict';
app.controller('designationCtrl', function($scope, $rootScope, $http, $location, logger, utilsService,$state,sharedProperties,$window,ngDialog) {
        ...
        $scope.emptyObject={};
        $scope.add = function() {
            $state.go('app.master.employee.designation-Add');    
        };
        // Redirecting Page For Edit Functionality
        $scope.editRow = function(desgnCode) {
            $location.url('/designation/edit?desgnCode='+desgnCode);
        };
        
        
        $scope.getList = function() {
            var url = 'app/designation/list?limit=' + $scope.limitCount + '&offset=' + $scope.offsetCount;
        ...
        $scope.deleteRow = function(dCode) {
            ngDialog.openConfirm().then(function() {
                ...
                var url = 'app/designation/delete?desgnCode=' + dCode;
        ...
        $scope.view=function(desgnCode){
            $location.url('/designation/view?desgnCode='+desgnCode);
        }
