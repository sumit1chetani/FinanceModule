///define([ 'hospital/accounts/accounts' ], function(module) {
   ...
   /// 'use strict';
    app.controller('budgetDefinitionListCtrl', function($scope, $state, $stateParams,$http, ngDialog, logger, $location, $controller, $injector, sharedProperties, toaster, $rootScope, utilsService) {
...
//        $scope.getBudgetListUtil();
        ...
        $scope.getBudgetListUtil();
        $scope.add = function() {
            $state.go("app.finance.accounts.budgetDefinitions.add");
        };
