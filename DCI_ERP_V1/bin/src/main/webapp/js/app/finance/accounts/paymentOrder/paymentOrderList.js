//define([ 'hospital/accounts/accounts' ], function(module) {
    'use strict';
    app.controller('paymentOrderList', function($scope, $stateParams, $state, $http, ngDialog,
        ...
        $scope.cancel = function() {
            $state.go('app.hospital.accounts.paymentInformation.list');
        };
        ...
        $scope.search = function(companyCode) {

            $http.post('app/paymentOrder/searchList',companyCode).success(function(data) {
                if (data.success == true) {
                    $scope.rowCollection =data.paymentOrderBeanslist;

                    angular.forEach(data.paymentOrderBeanslist, function(value, key) {
        ...
        /*  $scope.$watch('paymentorder.companyCode', function(newValue, oldValue) {
            if(newValue!=null && newValue!=undefined && newValue != ''){
                for(var i=0;i<$scope.rowCollection.length;i++){
                $scope.rowCollection[i].companyCode=newValue;
            }}
          });  */
