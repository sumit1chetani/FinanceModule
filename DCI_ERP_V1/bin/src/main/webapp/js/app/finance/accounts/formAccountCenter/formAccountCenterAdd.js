define([ 'hospital/accounts/accounts' ], function(module) {
    ...
    module.registerController('formAccountCenterAddCtrl', function($scope, $state, $filter ,$http, $location, sharedProperties, $injector, logger, toaster, validationService) {
