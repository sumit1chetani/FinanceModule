//define([ 'payroll/payroll/payroll' ], function(module) {
    ...
    'use strict';
   	...
   	app.controller('loanReportCtrl', function($stateParams,$scope, $state, $http, ngDialog, logger, $location, $controller, $injector, sharedProperties, toaster, $rootScope, validationService,utilsService, $window,$timeout) {

  //  module.registerController('loanReportCtrl', function($scope,$state,$http,ngDialog, logger,$location,$controller,$injector, sharedProperties, toaster,$rootScope,validationService)  {
 ...
 $scope.getDepartmentList = function(){
            ...
            $http.get("payroll/payroll/payrollgeneration/DepartmentList").success(function(datas) {
                  console.log("MonthYearList");
                 
                      $scope.department  = datas.departmentList;
        ...
        $scope.$watch('deduction.department', function(newValue, oldValue) {
          
            if(newValue!="" && newValue!=null){
                $http.post("payroll/payroll/loanrepayment/loanlist", newValue)
                .success(function(response) {
                    console.log(response);
                  //  console.log(response);
                  $scope.displayedCollection = response.loanTobeDeductedList ;
