...
(function(root, factory) {
    ...
    renderTimePicker = function(qnt, step, selected, cssClass) {
        var html = '<select class="pika-select ' + cssClass + '">', i = 0, option;
    ...
    renderTime = function(self, opts) {
        var h24 = opts.hours24format, results = '', minutesStep = opts.minutesStep, secondsStep = opts.secondsStep, isDateSel = isDate(self._d), isMinDate = isDateSel && isDate(opts.minDate) && compareDates(opts.minDate, self._d), isMaxDate = isDateSel && isDate(opts.maxDate) && compareDates(opts.maxDate, self._d), date, disabled;
        ...
        if (opts.splitTimeView) {
            ...
            results = renderTimePicker(h24 ? 24 : 12, 1, self._hours - (h24 ? 0 : 12), 'pika-select-hours') + ' : ' + renderTimePicker(60, minutesStep, round(self._minutes, minutesStep), 'pika-select-minutes');
    ...
    Pikaday = function(options) {
        ...
        self._onMouseDown = function(e) {
            ...
            e = e || window.event;
            var target = e.target || e.srcElement, d = self._d;
            ...
            if (!(hasClass(target, 'is-disabled') || hasClass(target.parentElement, 'is-disabled'))) {
                if (hasClass(target, 'pika-button') && !hasClass(target, 'is-empty')) {
                    ...
                    self.setDate(new Date(target.getAttribute('data-pika-year'), target.getAttribute('data-pika-month'), target.getAttribute('data-pika-day'), self._hours, self._minutes, opts.showSeconds ? self._seconds : 0));
        ...
        self._onChange = function(e) {
            e = e || window.event;
            var target = e.target || e.srcElement, hours, parts;
            if (!target) {
                return;
            }
    ...
    Pikaday.prototype = {
        ...
        toString : function(format) {
            var opts = this._o, h24 = opts.hours24format, timeString = '', h;
