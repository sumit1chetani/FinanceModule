...
(function(angular) {
    ...
    function chosen($timeout) {
        ...
        /*
         * initialize the list of items to watch to trigger the chosen:updated
         * event
         */
        watchCollection = [];
        ...
        /*
         * Add the list of event handler of the chosen in the scope.
         */
        ...
        linker = function($scope, iElm, iAttr) {
            var maxSelection = parseInt(iAttr.maxSelection, 10), searchThreshold = parseInt(iAttr.searchThreshold, 10);
            ...
            EVENTS.forEach(function(event) {
                ...
                if (typeof $scope[eventNameAlias] === 'function') { // check if
                    // the
                    // handler
                    // is a
                    // function
