  ...
  var app = angular.module('neuboard', [
        ...
        'growlNotifications',
         ...
         'angular.filter',
         'TreeWidget',
         'ngDialog', 'smart-table','angular-loading-bar',
         'validation', 'validation.rule',
         'angular.chosen',
         'ghiscoding.validation','toaster','ui.bootstrap.datetimepicker', 'ng-bs3-datepicker','ngDraggable','checklist-model','colorpicker'
    ]);
...
app.config([ '$translateProvider', function($translateProvider) {
  ...
  app.config(function(cfpLoadingBarProvider) {
	   cfpLoadingBarProvider.includeBar = true;
	    cfpLoadingBarProvider.spinnerTemplate = '<div id="loading-bar-spinner">' 
	        + '<div class="cg-busy-default-sign">' + '<div class="cg-busy-default-spinner">' 
	   ...
	   //+'<div> <img src="img/truck_gif_5.gif" style="width:100%"></img></div>'
	    + '</div>' 
	    + '<div class="cg-busy-default-text ng-binding">Loading...</div>' + '</div>' 
	    + '</div>';
	});
  ...
  app.config([ '$validationProvider', function($validationProvider) {
      ...
      /**
       * Setup a new Expression and default message In this example, we setup a IP
       * address Expression and default Message
       */
      expression = {
      ...
      $validationProvider.setDefaultMsg({
          twodecimalnumber : {
              ...
              success : 'Valid Decimal'
          }
      }).setExpression({
          twodecimalnumber : /[0-9]+(\.[0-9][0-9]?)?/
      });
      ...
      $validationProvider.setDefaultMsg({
          ...
          threedecimalnumber : /[0-9]+(\.[0-9][0-9][0-9]?)?/
      });
  ...
  app.filter('ngListSelectFor', function(){
  ...
  function logoutJS (){
      localStorage.setItem('logout-event-pdfs', 0);
  }
  
  window.addEventListener('storage', function(event){
      if (event.key == 'logout-event-pdfs') { 
          if(parseInt(localStorage.getItem('logout-event-pdfs'))==0){
//        	  localStorage.clear();
              location.reload();
          }
      }
